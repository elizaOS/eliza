...
This nonproduction integration receipt preserves both source-owner status
documents without treating either lane as accepted or merge-ready.

## Devices / Linux source receipt
...
```
## Account deletion source receipt
