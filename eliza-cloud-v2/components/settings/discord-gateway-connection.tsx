                        ...
                        <div className="flex items-center gap-4 p-4 cursor-pointer hover:bg-muted/50 transition-colors">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3 text-xs text-muted-foreground mt-1">
                              <span>{conn.guildCount} server{conn.guildCount !== 1 ? "s" : ""}</span>
                              <span>·</span>
                            ...
                            <>
                              ...
                              <div className="grid gap-4 sm:grid-cols-2">
                                <div className="space-y-2">
                                  ...
                                  <div className="flex gap-2">
                                    <Select
                                      ...
                                      onValueChange={(v) => updateEditState(conn.id, "characterId", v)}
                                    >
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Select
                                    ...
                                    onValueChange={(v) => updateEditState(conn.id, "responseMode", v)}
                                  >
                                    <SelectTrigger>
                                      <SelectValue />
                                    </SelectTrigger>
                              ...
                              <div className="space-y-2">
                                ...
                                <Input
                                  ...
                                  value={edit.botToken}
                                  onChange={(e) => updateEditState(conn.id, "botToken", e.target.value)}
                                />
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() => updateEditState(conn.id, "isActive", !edit.isActive)}
                                >
                              ...
                              <div className="flex items-center justify-between pt-2">
                                <AlertDialog>
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      <AlertDialogTitle>Delete Discord Bot Connection?</AlertDialogTitle>
                                      <AlertDialogDescription>
                                        This will disconnect the bot and remove it from all servers. The bot
                                        will stop responding to messages immediately.
                                      </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
