            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  By accessing and using the elizaOS platform
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  ...
                  (information or software) on elizaOS for personal,
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  You must provide a valid email address and any other
                  information requested in order to complete the signup process.
                  You are responsible for maintaining the security of your
                  account and password. elizaOS cannot and will not be liable
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  Your use of the elizaOS API is subject to rate limits and
                  usage quotas. You agree not to exceed these limits or attempt
                  to circumvent them. We reserve the right to modify, suspend,
                  or discontinue the API at any time with or without notice.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  ...
                  Service. All fees are non-refundable unless otherwise stated.
                  We reserve the right to change our pricing structure at any
                  time with reasonable notice to users.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  The materials on elizaOS are provided on an &apos;as is&apos;
                  basis. elizaOS makes no warranties, expressed or implied, and
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  In no event shall elizaOS or its suppliers be liable for any
                  damages (including, without limitation, damages for loss of
                  data or profit, or due to business interruption) arising out
                  of the use or inability to use the materials on elizaOS, even
                  if elizaOS or an authorized representative has been notified
              ...
              <section className="space-y-4">
                ...
                <p className="text-white/80 leading-relaxed">
                  elizaOS may revise these terms of service at any time without
