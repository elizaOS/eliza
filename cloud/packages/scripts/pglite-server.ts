 ...
 *
 *   bun run packages/scripts/pglite-server.ts          # default :5432, .eliza/.pgdata
 *   PGLITE_PORT=55432 bun run packages/scripts/pglite-server.ts
 *   PGLITE_DATA_DIR=/tmp/eliza-pglite bun run packages/scripts/pglite-server.ts
 *   PGLITE_IN_MEMORY=1 bun run packages/scripts/pglite-server.ts
 */
