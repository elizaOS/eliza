...
export type AgentSandboxStatus = "pending" | "provisioning" | "running" | "stopped" | "disconnected" | "error";
...
export type AdminModerationActionName = "ban" | "unban" | "mark_spammer" | "mark_scammer" | "clear_status" | "clear_flags" | "add_admin" | "revoke_admin";
