...
-- See packages/db/migrations/_drafts_steward_link/README.md.
--
...
--      As of writing, the application reads them in:
...
--      All these callsites must be removed in a separate code PR that
--      lands BEFORE this migration runs.
--
