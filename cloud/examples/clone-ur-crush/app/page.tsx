          ...
          for (const line of lines) {
            if (line.startsWith('data: ')) {
              try {
                ...
                if (e instanceof Error && !e.message.includes('JSON') && !e.message.includes('Unexpected')) {
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <h1 className="text-5xl sm:text-6xl font-bold mb-4 gradient-text" style={{ 
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            {currentStep === 2 && (
            <div>
              <label htmlFor="description" className="block text-sm sm:text-base font-medium text-gray-700 mb-2 flex items-center justify-between gap-2">
                <span>Tell me about her <span className="text-red-500">*</span></span>
                <button
                  type="button"
            ...
            {currentStep === 3 && (
            <div>
              <label htmlFor="howYouMet" className="block text-sm sm:text-base font-medium text-gray-700 mb-2 flex items-center justify-between gap-2">
                <span>How did you two meet? <span className="text-red-500">*</span></span>
                <button
                  type="button"
                  ...
                  <div className="w-full flex flex-col items-center">
                    ...
                    <div className="relative mb-4">
                      {photoPreview ? (
                        ...
                        >
                          <Sparkles className="w-20 h-20 text-gray-500 mb-2" strokeWidth={1.5} />
            ...
            <div>
              ...
              <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-6 bg-gradient-to-br from-gray-50 to-white space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    <label htmlFor="sayHello" className="block text-xs sm:text-sm font-medium text-gray-600 mb-1 flex items-center justify-between">
                  ...
                  <div>
                    <label htmlFor="sayGoodbye" className="block text-xs sm:text-sm font-medium text-gray-600 mb-1 flex items-center justify-between">
                  ...
                  <div>
                    <label htmlFor="sayHowAreYou" className="block text-xs sm:text-sm font-medium text-gray-600 mb-1 flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, sayHowAreYou: e.target.value })}
                      className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-gray-900 bg-white text-sm sm:text-base"
                  ...
                  <div>
                    <label htmlFor="sayGood" className="block text-xs sm:text-sm font-medium text-gray-600 mb-1 flex items-center justify-between">
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="sayBad" className="block text-xs sm:text-sm font-medium text-gray-600 mb-1 flex items-center justify-between">
