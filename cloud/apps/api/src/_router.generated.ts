 ...
 *
 * 553 routes mounted, 0 skipped (still Next-shaped).
 */
...
import _route_cron_cleanup_expired_app_auth_codes_route from "../cron/cleanup-expired-app-auth-codes/route";
...
import _route_v1_provisioning_agent_chat_route from "../v1/provisioning-agent/chat/route";
import _route_v1_provisioning_agent_route from "../v1/provisioning-agent/route";
...
export function mountRoutes(app: Hono<AppEnv>): void {
  ...
  app.route(
    ...
    _route_cron_cleanup_expired_app_auth_codes_route,
  );
  app.route(
