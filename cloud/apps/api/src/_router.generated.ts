 ...
 *
 * 500 routes mounted, 0 skipped (still Next-shaped).
 */
...
import _route_v1_apis_streaming_sessions_p_id_route from "../v1/apis/streaming/sessions/[id]/route";
import _route_v1_apis_streaming_sessions_route from "../v1/apis/streaming/sessions/route";
...
export function mountRoutes(app: Hono<AppEnv>): void {
  ...
  app.route("/api/v1/knowledge/check", _route_v1_knowledge_check_route);
  app.route("/api/v1/knowledge/pre-upload", _route_v1_knowledge_pre_upload_route);
  app.route("/api/v1/knowledge/query", _route_v1_knowledge_query_route);
  app.route("/api/v1/knowledge/submit", _route_v1_knowledge_submit_route);
  app.route("/api/v1/knowledge/upload-file", _route_v1_knowledge_upload_file_route);
  app.route("/api/v1/knowledge/:id", _route_v1_knowledge_p_id_route);
  app.route("/api/v1/knowledge", _route_v1_knowledge_route);
  app.route(
