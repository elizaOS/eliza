...
app.post("/", async (c) => {
  try {
    ...
    for (const file of files) {
      documents.push(await createKnowledgeDocument(user, scope, await fileToKnowledgeInput(file)));
    }
    ...
    logger.error("[KnowledgeRoute] Failed to upload knowledge files", {
