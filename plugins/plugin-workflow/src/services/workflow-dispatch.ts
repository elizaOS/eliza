...
/**
 * Construct the dispatch service. Registered under
 * `"WORKFLOW_DISPATCH"` on the runtime by the plugin's `init` lifecycle hook.
 */
 ...
 * static `start()`. Our dispatch is a closure-based singleton, so we set the
