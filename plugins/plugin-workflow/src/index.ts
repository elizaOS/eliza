 ...
 */
import { EmbeddedWorkflowService } from "./services/index";
import { WorkflowService } from "./services/index";
import { activeWorkflowsProvider } from "./providers/index";
import { logger } from "@elizaos/core";
import { registerWorkflowDispatchService } from "./services/index";
...
import { workflowStatusProvider } from "./providers/index";
...
export const workflowPlugin: Plugin = {
    name: 'workflow',
    description: 'Create and administer native Smithers workflows through elizaOS Cloud, chat, and widgets.',
    ...
    init: async (_config: Record<string, string>, runtime: IAgentRuntime): Promise<void> => {
        ...
        logger.info({ src: 'plugin:workflow:plugin:init' }, 'Native Smithers workflow plugin initialized successfully');
    },
};
...
export { handleTriggerRoutes, type TriggerRouteContext, type TriggerRouteHelpers, } from './trigger-routes.js';
