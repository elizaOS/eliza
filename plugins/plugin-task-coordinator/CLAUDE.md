...
- `CodingAgentSettingsSection` — agent settings panel (per-framework tabs: Eliza Code, Pi Agent, Claude, Codex; auth, model, approval-preset config).
...
|---|---|---|
| elizaos (Eliza Code) | `ENV_PREFIX.elizaos` | `ELIZA_CODE` |
