...
view contract for web and desktop hosts; only signed native builds register
lazy in-process loaders for the same components because native policy rejects
agent-served executable JavaScript.
