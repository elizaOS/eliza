...
const ACTION_NAME = "OWNER_SUBSCRIPTIONS";
...
export const subscriptionsAction: Action & {
  ...
  descriptionCompressed:
    "paid sub audit+cancel via browser: audit | cancel(serviceSlug confirmed) | status(cancellationId); not email-list-unsubscribe owner",
