...
export const bookTravelAction: Action & {
  ...
  descriptionCompressed:
    "approval-gated real travel booking flights/hotels missing-detail collection draft-confirm calendar-sync after-approval owner",
  ...
  handler: async (runtime, message, state, options, callback) => {
    if (!(await hasOwnerAccess(runtime, message))) {
      return {
        ...
        data: { actionName: "OWNER_BOOK_TRAVEL", error: "PERMISSION_DENIED" },
      };
    }
