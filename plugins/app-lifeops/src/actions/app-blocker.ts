...
async function resolveAppBlockPlanWithLlm(args: {
  ...
  const prompt = [
    ...
    "",
    "Examples:",
    '  "Block Twitter and Instagram for 2 hours" on Android -> shouldAct: true; response: null; packageNames[0]: com.twitter.android; packageNames[1]: com.instagram.android; durationMinutes: 120',
