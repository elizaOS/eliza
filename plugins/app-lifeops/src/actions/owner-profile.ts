...
import { resolveDefinitionFromIntent } from "./owner-life.js";
...
export const ownerProfileAction: Action & {
  ...
  descriptionCompressed:
    "persist owner state: save(name,location,age,prefs) + capture_phone(number) + set_reminder_preference(intensity) + configure_escalation(rules) owner",
  ...
  parameters: [
    ...
    },
    {
      ...
      description:
        "Reusable flight and hotel preference checklist or summary.",
      schema: { type: "string" as const },
    },
    {
      name: "phoneNumber",
    ...
    {
      name: "intent",
      description: "Free-form intent text for the reminder-preference operation.",
      schema: { type: "string" as const },
    },
    {
      name: "timeoutMinutes",
