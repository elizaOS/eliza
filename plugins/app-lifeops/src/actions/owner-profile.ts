...
export const updateOwnerProfileAction: Action & {
  ...
  description:
    ...
    "Use only for the owner, never for other contacts. " +
    "Do not use this for todos, goals, reminders, temporary plans, or live task state.",
  descriptionCompressed:
    "persist stable owner facts and reusable preferences when stated/confirmed; not todos/goals/reminders/temp-plans owner",
