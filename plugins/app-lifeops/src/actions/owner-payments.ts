...
const ACTION_NAME = "OWNER_PAYMENTS";
...
export const paymentsAction: Action & {
  ...
  descriptionCompressed:
    "payments+spending: dashboard list-sources add-source remove-source import-csv list-transactions spending-summary recurring-charges; bank/CSV/Plaid/PayPal owner",
