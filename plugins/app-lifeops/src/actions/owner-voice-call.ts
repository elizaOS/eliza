...
const ACTION_NAME = "OWNER_VOICE_CALL";
...
export const ownerVoiceCallAction: Action & {
  ...
  descriptionCompressed:
    "Twilio voice: place(number) call_owner(escalation policy) call_external(name→phone via relationships allowlist-check) draft-confirm approval-queue owner",
