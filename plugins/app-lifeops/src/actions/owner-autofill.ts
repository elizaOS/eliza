...
const ACTION_NAME = "OWNER_AUTOFILL";
...
export const ownerAutofillAction: Action & {
  ...
  descriptionCompressed:
    "browser autofill: fill(field,domain) whitelist-add(domain,confirm) whitelist-list; allowlist-gated browser-feature-gated owner",
