...
export const ownerResolveRequestAction: Action & {
  ...
  descriptionCompressed:
    "approve|reject pending request from queue: send_email send_message book_travel voice_call multilingual owner",
