...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_ollama", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-ollama.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-ollama action/provider/evaluator docs.");
}
