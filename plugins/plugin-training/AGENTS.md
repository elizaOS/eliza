...
- **`ELIZA_DISABLE_TRAINING_CRONS=1`** is set automatically when `NODE_ENV=test` by the trajectory logger; set it in tests to avoid cron registration side-effects.
