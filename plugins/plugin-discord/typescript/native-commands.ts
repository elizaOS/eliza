...
export function buildCommandArgMenu(params: {
  ...
  const { commandName, arg, choices, userId, title, buttonsPerRow = 4 } = params;
 ...
 */
export function createCommandArgs(argName: string, value: string | number | boolean): CommandArgs {
  return {
 ...
 */
export function buildCommandText(commandName: string, args?: CommandArgs): string {
