...
ATTACHMENT_IDS_TEMPLATE = """# Messages we are summarizing
{{recentMessages}}
...
ATTACHMENT_SUMMARIZATION_TEMPLATE = """# Summarized so far (we are adding to this)
{{currentSummary}}
...
CHANNEL_INFO_TEMPLATE = """# Messages we are searching for channel information
{{recentMessages}}
...
CREATE_POLL_TEMPLATE = """# Creating a Discord poll
{{recentMessages}}
...
DATE_RANGE_TEMPLATE = """# Messages we are summarizing (the conversation is continued after this)
{{recentMessages}}
...
GET_USER_INFO_TEMPLATE = """# Getting Discord user information
{{recentMessages}}
...
JOIN_CHANNEL_TEMPLATE = """# Messages we are searching for channel join information
{{recentMessages}}
...
LEAVE_CHANNEL_TEMPLATE = """# Messages we are searching for channel leave information
{{recentMessages}}
...
MEDIA_ATTACHMENT_ID_TEMPLATE = """# Messages we are transcribing
{{recentMessages}}
...
MEDIA_URL_TEMPLATE = """# Messages we are searching for a media URL
{{recentMessages}}
...
PIN_MESSAGE_TEMPLATE = """# Pinning a Discord message
{{recentMessages}}
...
REACT_TO_MESSAGE_TEMPLATE = """# Adding reactions to Discord messages
{{recentMessages}}
...
SEARCH_MESSAGES_TEMPLATE = """# Searching for Discord messages
{{recentMessages}}
...
SEND_DM_TEMPLATE = """# Messages we are searching for DM information
{{recentMessages}}
...
SUMMARIZATION_TEMPLATE = """# Summarized so far (we are adding to this)
{{currentSummary}}
...
__all__ = [
    "ATTACHMENT_IDS_TEMPLATE",
    "ATTACHMENT_SUMMARIZATION_TEMPLATE",
    "CHANNEL_INFO_TEMPLATE",
    "CREATE_POLL_TEMPLATE",
    "DATE_RANGE_TEMPLATE",
    "GET_USER_INFO_TEMPLATE",
    "JOIN_CHANNEL_TEMPLATE",
    "LEAVE_CHANNEL_TEMPLATE",
    "MEDIA_ATTACHMENT_ID_TEMPLATE",
    "MEDIA_URL_TEMPLATE",
    "PIN_MESSAGE_TEMPLATE",
    "REACT_TO_MESSAGE_TEMPLATE",
    "SEARCH_MESSAGES_TEMPLATE",
    "SEND_DM_TEMPLATE",
    "SUMMARIZATION_TEMPLATE",
    "TRANSCRIPTION_TEMPLATE",
    "UNPIN_MESSAGE_TEMPLATE",
]
