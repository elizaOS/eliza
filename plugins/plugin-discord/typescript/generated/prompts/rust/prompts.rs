...
pub const ATTACHMENT_IDS_TEMPLATE: &str = r#"# Messages we are summarizing
{{recentMessages}}
...
pub const ATTACHMENT_SUMMARIZATION_TEMPLATE: &str = r#"# Summarized so far (we are adding to this)
{{currentSummary}}
...
pub const CHANNEL_INFO_TEMPLATE: &str = r#"# Messages we are searching for channel information
{{recentMessages}}
...
pub const CREATE_POLL_TEMPLATE: &str = r#"# Creating a Discord poll
{{recentMessages}}
...
pub const DATE_RANGE_TEMPLATE: &str = r#"# Messages we are summarizing (the conversation is continued after this)
{{recentMessages}}
...
pub const GET_USER_INFO_TEMPLATE: &str = r#"# Getting Discord user information
{{recentMessages}}
...
pub const JOIN_CHANNEL_TEMPLATE: &str = r#"# Messages we are searching for channel join information
{{recentMessages}}
...
pub const LEAVE_CHANNEL_TEMPLATE: &str = r#"# Messages we are searching for channel leave information
{{recentMessages}}
...
pub const MEDIA_ATTACHMENT_ID_TEMPLATE: &str = r#"# Messages we are transcribing
{{recentMessages}}
...
pub const MEDIA_URL_TEMPLATE: &str = r#"# Messages we are searching for a media URL
{{recentMessages}}
...
pub const PIN_MESSAGE_TEMPLATE: &str = r#"# Pinning a Discord message
{{recentMessages}}
...
pub const REACT_TO_MESSAGE_TEMPLATE: &str = r#"# Adding reactions to Discord messages
{{recentMessages}}
...
pub const SEARCH_MESSAGES_TEMPLATE: &str = r#"# Searching for Discord messages
{{recentMessages}}
...
pub const SEND_DM_TEMPLATE: &str = r#"# Messages we are searching for DM information
{{recentMessages}}
...
pub const SUMMARIZATION_TEMPLATE: &str = r#"# Summarized so far (we are adding to this)
{{currentSummary}}
...
pub const TRANSCRIPTION_TEMPLATE: &str = r#"# Transcription of media file
{{mediaTranscript}}

# Instructions: Return only the full transcript of the media file without any additional prompt or commentary."#;

pub const UNPIN_MESSAGE_TEMPLATE: &str = r#"# Unpinning a Discord message
{{recentMessages}}
