...
const discordPlugin: Plugin = {
    ...
    init: async (_config: Record<string, string>, runtime: IAgentRuntime) => {
        ...
        if ((!token || token.trim() === "") &&
            ...
            logger.warn("Discord bot token not provided - Discord plugin is loaded but will not be functional");
            logger.warn("To enable Discord functionality, provide DISCORD_API_TOKEN or DISCORD_BOT_TOKENS in your .env file");
        }
    },
...
export { DEFAULT_DISCORD_AUDIO_LANES, DISCORD_AUDIO_LANE_AMBIENT, DISCORD_AUDIO_LANE_MUSIC, DISCORD_AUDIO_LANE_SFX, DISCORD_AUDIO_LANE_TTS, type DiscordAudioLane, type DiscordAudioLaneConfig, getDiscordAudioLaneConfig, normalizeDiscordAudioLane, } from "./audio-lanes";
export type { DiscordAudioPlaybackHandle, DiscordAudioSinkPlayOptions, DiscordAudioSinkStatus, IDiscordAudioSink, } from "./audio-sink";
...
export { DISCORD_LOCAL_SERVICE_NAME, DiscordLocalService, } from "./discord-local-service";
...
export { GUILD_MANAGEMENT_OPERATIONS, GuildManagementError, type GuildManagementGates, type GuildManagementOperation, type GuildManagementReceipt, type GuildManagementRequest, normalizeGuildManagementOperation, resolveGuildManagementGates, } from "./guild-management";
export { BUILT_IN_GUILD_TEMPLATES, type GuildTemplate, type GuildTemplateChannel, type GuildTemplateRole, validateGuildTemplate, } from "./guild-templates";
...
export { buildDiscordProbeScript, captureDiscordDeliveryStatus, closeDiscordTab, DISCORD_APP_URL, DISCORD_PROVIDER_ID, type DiscordDmInboxProbe, type DiscordMessageSearchResult, type DiscordTabIdentity, type DiscordTabProbe, type DiscordVisibleDmPreview, discordBrowserWorkspaceAvailable, discordUserAccountPartitionFor, emptyDiscordDmInboxProbe, ensureDiscordTab, navigateDiscordTabToHome, probeDiscordCapturedPage, probeDiscordDocumentState, probeDiscordTab, searchDiscordMessages, } from "./user-account-scraper/discord-browser-scraper";
export { type DiscordDesktopCdpStatus, getDiscordDesktopCdpStatus, relaunchDiscordDesktopForCdp, sendDiscordViaDesktopCdp, } from "./user-account-scraper/discord-desktop-cdp";
export { DISCORD_USER_ACCOUNT_SCRAPER_SERVICE_TYPE, type DiscordUserAccountScraper, DiscordUserAccountScraperImpl, } from "./user-account-scraper/service";
export type { DiscordVoicePlaybackOptions, DiscordVoiceTarget, DiscordVoiceTargetRegistration, } from "./voice-target-registry";
