...
function createGitHubRouteHandler(method: "GET" | "POST" | "DELETE") {
    return async (req: unknown, res: unknown, runtime: unknown): Promise<void> => {
        ...
        await handleGitHubRoutes({
            ...
            applyRuntimeToken: (token) => agentRuntime.setSetting("GITHUB_TOKEN", token, true),
...
export { notificationTriageAction, scoreNotification, type TriagedNotification, } from "./actions/notification-triage.js";
export { prOpAction } from "./actions/pr-op.js";
export { createGitHubConnectorAccountProvider, createGitHubConnectorAccountProviderForTest, GitHubOAuthHttpError, } from "./connector-account-provider.js";
