...
describe("sendSmsAction", () => {
    ...
    describe("handler", () => {
        it("should send SMS successfully", async () => {
            const message: Memory = {
                content: { text: "Send SMS to +18885551234 saying 'Hello, this is a test!'" },
            } as Memory;
        ...
        it("should handle long messages", async () => {
            const longMessage = "This is a very long message that exceeds the typical SMS character limit. ".repeat(10);
            const message: Memory = {
            ...
            (chunkTextForSms as any).mockReturnValue([longMessage.substring(0, 160), longMessage.substring(160, 320)]);
