...
describe("sendMmsAction", () => {
    ...
    describe("metadata", () => {
        it("should have correct name and description", () => {
            ...
            expect(sendMmsAction.description).toBe("Send an MMS (multimedia message) with images, audio, or video via Twilio");
        });
    ...
    describe("handler", () => {
        it("should send MMS with URL successfully", async () => {
            const message: Memory = {
                content: { text: "Send picture to +18885551234 with https://example.com/image.jpg saying 'Check this out!'" },
            } as Memory;
        ...
        it("should extract message content correctly", async () => {
            const testCases = [
                {
                    input: "Send picture to +18885551234 with https://example.com/img.jpg saying 'Look at this!'",
