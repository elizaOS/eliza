...
describe("makeCallAction", () => {
    ...
    describe("metadata", () => {
        it("should have correct name and description", () => {
            ...
            expect(makeCallAction.description).toBe("Make a phone call via Twilio with a message or custom TwiML");
        });
    ...
    describe("handler", () => {
        it("should make call successfully with message", async () => {
            const message: Memory = {
                content: { text: "Call +18885551234 and say 'This is an important reminder'" },
            } as Memory;
