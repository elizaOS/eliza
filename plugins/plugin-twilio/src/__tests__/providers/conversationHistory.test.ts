...
describe("conversationHistoryProvider", () => {
    ...
    describe("metadata", () => {
        it("should have correct name and description", () => {
            ...
            expect(conversationHistoryProvider.description).toBe("Provides recent SMS/MMS conversation history with a phone number");
        });
    });
    ...
    describe("get", () => {
        ...
        it("should handle when service is not initialized", async () => {
            ...
            expect(result.text).toBe("No Twilio conversation history available - service not initialized");
        });
