            ...
            fn: async (runtime: IAgentRuntime) => {
                ...
                if (webhookUrl && webhookUrl.includes("localhost")) {
                    try {
                        ...
                        logger.warn("Could not test webhook endpoints locally:", error);
                    }
                }
            },
        },
        ...
        },
        {
            ...
            fn: async (runtime: IAgentRuntime) => {
                ...
                if (!phoneNumber || !testNumber) {
                    throw new Error("TWILIO_PHONE_NUMBER and TWILIO_TEST_PHONE_NUMBER must be set for interactive testing");
                }
