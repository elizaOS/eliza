...
async function build(): Promise<void> {
  ...
  console.log("🔨 Building @elizaos/plugin-lobster for Node (ESM)...");
  ...
  console.log("🌐 Building @elizaos/plugin-lobster for Browser...");
  ...
  console.log("🧱 Building @elizaos/plugin-lobster for Node (CJS)...");
