...
async function readTextCapped(response: Response, maxBytes: number): Promise<string | undefined> {
...
async function callMcp(
    ...
    options: Required<Pick<KeylessWebSearchOptions, "timeoutMs" | "maxResponseBytes" | "fetchImpl">>
