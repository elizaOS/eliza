// Auto-enable check for @elizaos/plugin-executecode.
//
...
/** Enable when `config.features.executeCode` is truthy / not explicitly disabled. */
export function shouldEnable(ctx: PluginAutoEnableContext): boolean {
  return isFeatureEnabled(ctx.config, "executeCode");
}
