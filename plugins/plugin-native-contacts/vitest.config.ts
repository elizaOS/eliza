...
export default defineConfig({
  resolve: {
    ...
    alias: [
      ...
      {
        find: /^@elizaos\/plugin-native-contacts\/bridge\/web$/,
        replacement: resolve(
          rootDir,
      ...
      {
        find: /^@elizaos\/plugin-native-contacts\/bridge$/,
        replacement: resolve(
          rootDir,
      ...
      },
      {
        ...
        // fails. Anchor it to source, matching plugin-native-phone and wallet-ui.
