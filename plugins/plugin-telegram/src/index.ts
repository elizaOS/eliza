...
import { TELEGRAM_OWNER_PAIRING_SERVICE_TYPE } from "./owner-pairing-service";
import { TELEGRAM_SERVICE_NAME } from "./constants";
import { TelegramAccountService } from "./account-client-service";
import { TelegramOwnerPairingServiceImpl } from "./owner-pairing-service";
...
import { stopTelegramAccountAuthSession } from "./account-setup-routes";
...
import { type TelegramOwnerPairingService } from "./owner-pairing-service";
const telegramPlugin: Plugin = {
    ...
    async dispose(runtime: IAgentRuntime) {
        ...
        if (personal instanceof TelegramAccountService)
            await personal.stop();
...
export { TELEGRAM_STANDALONE_SERVICE_NAME, TelegramStandaloneService, } from "./standalone/service";
export { MessageManager, stopTelegramAccountAuthSession, TELEGRAM_OWNER_PAIRING_SERVICE_TYPE, type TelegramOwnerPairingService, TelegramOwnerPairingServiceImpl, TelegramService, };
