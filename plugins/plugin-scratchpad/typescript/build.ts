...
async function build(): Promise<void> {
  ...
  console.log("🔨 Building @elizaos/plugin-scratchpad for Node (ESM)...");
  ...
  console.log("🌐 Building @elizaos/plugin-scratchpad for Browser...");
  ...
  console.log("🧱 Building @elizaos/plugin-scratchpad for Node (CJS)...");
