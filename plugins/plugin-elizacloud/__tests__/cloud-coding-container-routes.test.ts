...
describe("cloud coding-container routes", () => {
  ...
  it("forwards coding-agent container requests with Claude/Codex/Eliza Code agent ids", async () => {
  ...
  it("rejects malformed request shapes before hitting the service", async () => {
    ...
    expect(response.jsonBody()).toEqual({
      error: 'Invalid option: expected one of "claude"|"codex"|"elizaos"|"elizaos"',
    });
  });
