...
import { type ModelRegistrationMetadata } from "@elizaos/core";
...
function makeCloudBrainedRuntime(settings: Record<string, string>) {
    ...
    const runtime = {
        ...
        models,
        registerModel: (modelType: string, handler: unknown, provider: string, priority?: number, metadata?: ModelRegistrationMetadata) => {
