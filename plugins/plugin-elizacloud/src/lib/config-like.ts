...
function ensureLinkedAccounts(config: MutableElizaConfig): LinkedAccountFlagsConfig {
    config.linkedAccounts ??= {};
    return config.linkedAccounts;
}
function ensureServiceRouting(config: MutableElizaConfig): ServiceRoutingConfig {
    config.serviceRouting ??= {};
    return config.serviceRouting;
}
function persistDeploymentTarget(config: MutableElizaConfig, deploymentTarget: DeploymentTargetConfig | null | undefined): void {
    if (!deploymentTarget) {
...
function persistLinkedAccounts(config: MutableElizaConfig, linkedAccounts: LinkedAccountFlagsConfig | null | undefined): void {
    if (!linkedAccounts)
        return;
...
function persistServiceRouting(config: MutableElizaConfig, serviceRouting: ServiceRoutingConfig | null | undefined, clearRoutes: readonly ServiceCapability[] = []): void {
...
export function applyCanonicalSetupConfig(config: MutableElizaConfig, args: {
