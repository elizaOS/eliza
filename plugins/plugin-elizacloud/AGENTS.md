...
| Var | Default |
|---|---|
| `ELIZAOS_CLOUD_EMBEDDING_MODEL` | `thenlper/gte-small` (canonical; mismatches fail closed) |
| `ELIZAOS_CLOUD_EMBEDDING_DIMENSIONS` | `384` (canonical; mismatches fail closed) |
