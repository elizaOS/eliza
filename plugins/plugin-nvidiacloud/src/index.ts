...
import { handleObjectLarge, handleObjectSmall, handleTextEmbedding, handleTextLarge, handleTextSmall } from './models';
...
export const nvidiaCloudPlugin: Plugin = {
  ...
  description: 'NVIDIA NIM cloud — OpenAI-compatible chat, objects, and embeddings via integrate.api.nvidia.com',
  config: {
    ...
    NVIDIA_EMBEDDING_INPUT_TYPE: optionalConfigValue('NVIDIA_EMBEDDING_INPUT_TYPE'),
    NVIDIA_EMBEDDING_DIMENSIONS: optionalConfigValue('NVIDIA_EMBEDDING_DIMENSIONS'),
  ...
  models: {
    ...
    [ModelType.OBJECT_SMALL]: async (runtime: IAgentRuntime, params: ObjectGenerationParams) => {
      return handleObjectSmall(runtime, params) as Promise<Record<string, JsonValue>>;
    },
    [ModelType.OBJECT_LARGE]: async (runtime: IAgentRuntime, params: ObjectGenerationParams) => {
      return handleObjectLarge(runtime, params) as Promise<Record<string, JsonValue>>;
    },
