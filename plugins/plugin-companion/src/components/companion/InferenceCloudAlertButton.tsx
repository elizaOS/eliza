...
export const InferenceCloudAlertButton = memo(
  function InferenceCloudAlertButton(props: InferenceCloudAlertButtonProps) {
    ...
    const { ref, agentProps } = useAgentElement<HTMLButtonElement>({
      id: "inference-cloud-alert",
      role: "button",
      label: notice.tooltip,
      group: "companion-header-actions",
      status: notice.variant === "danger" ? "error" : "warn",
      description: "Open settings to resolve the inference availability notice",
    });
