...
const autoTraderPlugin: Plugin = {
  ...
  description: 'Autonomous trading plugin with LLM-powered strategies, Jupiter integration, and risk management',
  services: [
    AutoTradingManager,
    SwapService,
...
export type { TradingConfig, TradingStatus } from './services/AutoTradingManager.ts';
export { SwapService, KNOWN_TOKENS } from './services/SwapService.ts';
export type { SwapQuote, SwapParams, SwapResult, WalletBalance } from './services/SwapService.ts';
export { TokenValidationService } from './services/TokenValidationService.ts';
export type { RugCheckReport, ValidationResult, TradingRequirements, TradingActivity } from './services/TokenValidationService.ts';
