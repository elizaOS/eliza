...
ANALYZE_TRENDING_TOKENS_TEMPLATE = """You are an expert cryptocurrency analyst evaluating trending tokens for potential trading opportunities.
...
BACKTEST_ANALYSIS_TEMPLATE = """You are analyzing backtest results for a trading strategy.
...
EXECUTE_SWAP_TEMPLATE = """Execute a token swap on Solana using Jupiter aggregator.
...
PORTFOLIO_ANALYSIS_TEMPLATE = """You are a portfolio analyst reviewing the current trading portfolio and performance.
...
POSITION_EXIT_TEMPLATE = """You are managing an active trading position. Analyze whether to exit, partially close, or hold based on current conditions.
...
RISK_ASSESSMENT_TEMPLATE = """You are a risk management specialist evaluating a potential trade before execution.
...
START_TRADING_TEMPLATE = """Start automated trading with the specified strategy and parameters.
...
TRADING_DECISION_TEMPLATE = """You are an expert cryptocurrency trading analyst. Analyze the following market data and portfolio context to make a trading decision.
...
__all__ = [
    "ANALYZE_TRENDING_TOKENS_TEMPLATE",
    "BACKTEST_ANALYSIS_TEMPLATE",
    "EXECUTE_SWAP_TEMPLATE",
    "PORTFOLIO_ANALYSIS_TEMPLATE",
    "POSITION_EXIT_TEMPLATE",
    "RISK_ASSESSMENT_TEMPLATE",
    "START_TRADING_TEMPLATE",
