...
pub const ANALYZE_TRENDING_TOKENS_TEMPLATE: &str = r#"You are an expert cryptocurrency analyst evaluating trending tokens for potential trading opportunities.
...
pub const BACKTEST_ANALYSIS_TEMPLATE: &str = r#"You are analyzing backtest results for a trading strategy.
...
pub const EXECUTE_SWAP_TEMPLATE: &str = r#"Execute a token swap on Solana using Jupiter aggregator.
...
pub const PORTFOLIO_ANALYSIS_TEMPLATE: &str = r#"You are a portfolio analyst reviewing the current trading portfolio and performance.
...
pub const POSITION_EXIT_TEMPLATE: &str = r#"You are managing an active trading position. Analyze whether to exit, partially close, or hold based on current conditions.
...
pub const RISK_ASSESSMENT_TEMPLATE: &str = r#"You are a risk management specialist evaluating a potential trade before execution.
...
pub const START_TRADING_TEMPLATE: &str = r#"Start automated trading with the specified strategy and parameters.
...
pub const TRADING_DECISION_TEMPLATE: &str = r#"You are an expert cryptocurrency trading analyst. Analyze the following market data and portfolio context to make a trading decision.
