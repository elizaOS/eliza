...
function memory(id: string, text: string, createdAt: number, overrides: Partial<Memory>): Memory {
  return {
    id: id as UUID,
    agentId: AGENT,
    entityId: REQUESTER,
...
async function seededAdapter(): Promise<InMemoryDatabaseAdapter> {
  ...
  await adapter.createMemories(
    [
      memory("30000000-0000-0000-0000-000000000001", "needle allowed global", 100, {}),
      memory("30000000-0000-0000-0000-000000000002", "needle allowed private", 200, {
        embedding: vector(0.9, 0.1),
        metadata: { type: "custom", scope: "private" },
      }),
      memory("30000000-0000-0000-0000-000000000003", "needle denied private", 500, {
        entityId: STRANGER,
        embedding: vector(1, 0),
        metadata: { type: "custom", scope: "private" },
      }),
      memory("30000000-0000-0000-0000-000000000004", "needle denied room", 400, {
        roomId: OTHER_ROOM,
        embedding: vector(1, 0),
      }),
      memory("30000000-0000-0000-0000-000000000005", "needle denied world", 300, {
        roomId: OTHER_WORLD_ROOM,
        worldId: OTHER_WORLD,
        embedding: vector(1, 0),
      }),
      memory("30000000-0000-0000-0000-000000000006", "needle allowed unstamped participant", 600, {
        entityId: STRANGER,
        embedding: vector(1, 0),
...
describe("InMemoryDatabaseAdapter access context", () => {
  ...
  it("filters before message ranking and vector top-k", async () => {
    ...
    expect(vectorRows[0]?.content.text).toBe("needle allowed unstamped participant");
  });
