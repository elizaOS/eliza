  ...
  it("answers explicit planner subactions from the real calendar feed even when the text mentions flights", async () => {
    const getCalendarFeed = vi.fn(async () => ({
      ...
      events: [
        {
          id: "evt-flight",
          externalId: "provider-evt-flight",
          agentId: "agent-flight-test",
          provider: "google",
          side: "owner",
          calendarId: "primary",
          ...
          attendees: [],
          metadata: {},
          syncedAt: "2026-07-08T09:59:00.000Z",
          updatedAt: "2026-07-08T09:50:00.000Z",
        },
        {
          id: "evt-board",
          externalId: "provider-evt-board",
          agentId: "agent-flight-test",
          provider: "google",
          side: "owner",
          calendarId: "primary",
          ...
          metadata: {},
          syncedAt: "2026-07-08T09:59:00.000Z",
          updatedAt: "2026-07-08T09:51:00.000Z",
        },
      ],
      source: "synced",
      state: "complete",
      sources: [
        {
          key: {
            provider: "google",
            side: "owner",
            grantId: "connector-account:flight-test",
            connectorAccountId: "flight-test",
            calendarId: "primary",
          },
          summary: "Primary",
          accessRole: "owner",
