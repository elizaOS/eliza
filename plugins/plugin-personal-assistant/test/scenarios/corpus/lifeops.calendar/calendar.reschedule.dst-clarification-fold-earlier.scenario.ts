...
export default calendarDstClarificationJourney({
  id: "calendar.reschedule.dst-clarification-fold-earlier",
  date: "2027-11-07",
  ...
  choice:
    "Use the earlier occurrence of 1:30 AM, UTC-07:00, in America/Los_Angeles on November 7, 2027. Yes, move Cedar review there and keep it 15 minutes.",
  expectedStart: "2027-11-07T08:30:00.000Z",
  expectedEnd: "2027-11-07T08:45:00.000Z",
});
