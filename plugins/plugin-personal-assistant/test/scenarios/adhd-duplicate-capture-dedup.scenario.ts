  ...
  turns: [
    {
      ...
      text: "remind me at 9pm tonight to take the recycling out before bed — the truck comes stupid early tomorrow and i always miss it.",
    },
    {
      kind: "message",
      name: "casey re-asks for the identical thing a beat later",
      text: "wait — did i already tell you to remind me about the recycling at 9pm tonight? i genuinely can't tell if i said it out loud or just thought it. don't double it up if i did.",
    },
  ],
  finalChecks: [
    {
