...
| `lifeops_household_coordination` | `HouseholdCoordinationRuntimeService` | `src/lifeops/household/service.ts` | Role-scoped household access, versioned proposals, affected-party approvals, agreements, and redacted exports |
...
- See root `CLAUDE.md` for repo-wide architecture commandments, logger conventions, ESM rules, and naming.
