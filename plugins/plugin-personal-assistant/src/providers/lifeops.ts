    ...
    try {
      ...
      return {
        text: [
          ...
          "Use MESSAGE action=triage/list_inbox/search_inbox for Gmail, email, and cross-channel inbox review: 'triage my Gmail inbox', 'summarize my unread emails', 'triage my inbox', 'give me my inbox digest', daily briefs, missed-call repair, and group-chat handoff. Gmail replies are saved as drafts through the connected Gmail capability and are never sent. Use MESSAGE action=respond for non-Gmail connector replies and MESSAGE action=manage for supported archive, label, or mark-read requests. Do not use MESSAGE just because the user mentioned email or messages while venting.",
          "Use MESSAGE action=send_draft for supported non-Gmail outbound messages on the owner's behalf. Examples: 'send a Telegram message to Jane saying I am running late', 'send a Signal message to Priya saying thanks', 'DM Bob on Discord', or 'text Sam that I am outside'. Always prefer MESSAGE action=send_draft over CALENDAR for relaying a message, even if the message text mentions a meeting.",
