...
import { AuthenticatedRuntimeSpeakerVerifierService } from "./lifeops/family-communications/index.js";
import { BLOCK_RULE_RECONCILE_TASK_NAME } from "./website-blocker/chat-integration/index.js";
import { CalendarCardAccessStore } from "./lifeops/calendar-card.js";
import { EventType } from "@elizaos/core";
import { FOLLOWUP_TRACKER_TASK_NAME } from "./followup/index.js";
import { FamilyCommunicationsRuntimeService } from "./lifeops/family-communications/index.js";
...
import { HouseholdOperationsRuntimeService } from "./lifeops/household-operations/index.js";
import { LIFEOPS_TASK_NAME } from "./lifeops/runtime.js";
import { LifeOpsRepository } from "./lifeops/repository.js";
import { MEETING_JOIN_CHANNEL_KEY } from "@elizaos/plugin-calendar";
import { MEETING_TRANSCRIPT_FINALIZED_EVENT } from "@elizaos/core/meetings";
import { OwnerCalendarMutationGatewayService } from "./lifeops/calendar-mutations/index.js";
import { PROACTIVE_TASK_NAME } from "./activity-profile/proactive-worker.js";
import { ParentingGuidanceRuntimeService } from "./lifeops/parenting/index.js";
...
import { ResourceCapacityRuntimeService } from "./lifeops/resource-capacity/index.js";
import { SchoolSourceFactRuntimeService } from "./lifeops/school/index.js";
import { XDmAdapter } from "@elizaos/plugin-x/lifeops-message-adapter";
import { activateLifeOpsActivitySignals } from "./lifeops/activity-signal-lifecycle.js";
...
import { calendarActionPromotionOptions } from "./actions/calendar.js";
...
import { createActivitySignalBus } from "./lifeops/signals/bus.js";
import { createAnchorRegistry } from "./lifeops/registries/index.js";
import { createApprovalQueue } from "./lifeops/approval-queue.js";
import { createChannelRegistry } from "./lifeops/channels/index.js";
import { createConnectorRegistry } from "./lifeops/connectors/index.js";
import { createDefaultCircadianInsightContract } from "@elizaos/plugin-health";
import { createDefaultOraclePack } from "./lifeops/oracles/index.js";
import { createDelegationInboundMessageHandler } from "./lifeops/delegation-contracts/inbound-event.js";
import { createEventKindRegistry } from "./lifeops/registries/index.js";
import { createFamilyCommunicationsAction } from "./lifeops/family-communications/index.js";
import { createFamilyRegistry } from "./lifeops/registries/index.js";
import { createFoodDomainAction } from "./lifeops/food/index.js";
import { createHouseholdInboundApprovalMessageHandler } from "./lifeops/household/inbound-approval.js";
import { createHouseholdOperationsAction } from "./lifeops/household-operations/index.js";
import { createLocalConditionsAction } from "./lifeops/oracles/index.js";
import { createMultilingualPromptRegistry } from "./lifeops/i18n/prompt-registry.js";
import { createOwnerFactStore } from "./lifeops/owner/fact-store.js";
...
import { createParentingGuidanceAction } from "./lifeops/parenting/index.js";
import { createResourceCapacityAction } from "./lifeops/resource-capacity/index.js";
import { createScheduledTaskCandidateBackstopRule } from "./lifeops/scheduled-task/candidate-backstop.js";
import { createSchoolSourceFactAction } from "./lifeops/school/index.js";
import { createSendPolicyRegistry } from "./lifeops/send-policy/index.js";
...
import { createWorkflowStepRegistry } from "./lifeops/registries/index.js";
...
import { deactivateLifeOpsActivitySignals } from "./lifeops/activity-signal-lifecycle.js";
...
import { ensureBlockRuleReconcileTask } from "./website-blocker/chat-integration/index.js";
import { ensureFollowupTrackerTask } from "./followup/index.js";
import { ensureLifeOpsSchedulerTask } from "./lifeops/runtime.js";
import { ensureProactiveAgentTask } from "./activity-profile/proactive-worker.js";
...
import { getSelfControlPermissionState } from "@elizaos/plugin-blocker/services/website-blocker/index";
import { goalsPlugin } from "@elizaos/plugin-goals/plugin";
import { handleAgentMessageSentForQuestionFollowup } from "./lifeops/scheduled-task/unanswered-question-followup.js";
import { handleBriefMessageMutation } from "./lifeops/briefing/message-engagement-handler.js";
import { handleMeetingJoinDispatch } from "@elizaos/plugin-calendar";
import { handleMeetingTranscriptFinalized } from "./lifeops/meeting-ghost/event-handler.js";
import { handleOwnerMessageForQuestionFollowup } from "./lifeops/scheduled-task/unanswered-question-followup.js";
...
import { installLifeOpsScheduledTaskEventBridge } from "./lifeops/scheduled-task/runtime-wiring.js";
import { isAppFirstRunComplete } from "./activity-profile/proactive-worker.js";
import { isDarwin } from "./platform/host.js";
import { issueAuthenticatedMessageSpeakerAttestation } from "./lifeops/family-communications/index.js";
import { lifeOpsProvider } from "./providers/lifeops.js";
import { lifeOpsSchema } from "./lifeops/schema.js";
import { logger } from "@elizaos/core";
import { messagingTriageActions } from "@elizaos/plugin-assistant";
import { openSelfControlPermissionLocation } from "@elizaos/plugin-blocker/services/website-blocker/index";
import { ownerAgreementKnowledgeAction } from "./actions/agreement-knowledge.js";
import { ownerAlarmsAction } from "./actions/owner-surfaces.js";
import { ownerDocumentsAction } from "./actions/document.js";
import { ownerGoalsAction } from "./actions/owner-surfaces.js";
import { ownerHealthAction } from "./actions/owner-surfaces.js";
import { ownerPrivateAction } from "./lifeops/access.js";
import { ownerPrivateProvider } from "./lifeops/access.js";
import { ownerProfileExtractionEvaluator } from "./lifeops/owner/profile-extraction-evaluator.js";
import { ownerRemindersAction } from "./actions/owner-surfaces.js";
import { ownerRoutinesAction } from "./actions/owner-surfaces.js";
import { ownerScreenTimeAction } from "./actions/owner-surfaces.js";
...
import { personalAssistantAction } from "./actions/owner-surfaces.js";
...
import { reconcileInterruptedMessageDraftDispatches } from "./lifeops/scheduled-task/message-draft-dispatch.js";
import { registerActivitySignalBus } from "./lifeops/signals/bus.js";
import { registerAnchorRegistry } from "./lifeops/registries/index.js";
import { registerAppLifeOpsAnchors } from "./lifeops/registries/index.js";
import { registerAppLifeOpsBusFamilies } from "./lifeops/registries/index.js";
import { registerAppLifeOpsEventKinds } from "./lifeops/registries/index.js";
import { registerBlockRuleReconcilerWorker } from "./website-blocker/chat-integration/index.js";
import { registerBuiltinTelemetryFamilies } from "./lifeops/registries/index.js";
import { registerCalendarTimeZoneResolver } from "@elizaos/core/lifeops-normalize/calendar-time-zone";
import { registerCandidateActionBackstopRule } from "@elizaos/core";
import { registerChannelRegistry } from "./lifeops/channels/index.js";
import { registerCircadianInsightContract } from "@elizaos/plugin-health";
import { registerConnectorRegistry } from "./lifeops/connectors/index.js";
import { registerCoreFactMemoryBridge } from "./lifeops/owner/core-fact-memory-bridge.js";
import { registerDefaultBlockerPack } from "./lifeops/registries/index.js";
import { registerDefaultChannelPack } from "./lifeops/channels/index.js";
import { registerDefaultConnectorPack } from "./lifeops/connectors/index.js";
import { registerDefaultFeatureFlagPack } from "./lifeops/registries/index.js";
import { registerDefaultPackCatalog } from "./default-packs/spine-registration.js";
import { registerDefaultPromptPack } from "./lifeops/i18n/prompt-registry.js";
import { registerDefaultWorkflowStepPack } from "./lifeops/registries/index.js";
import { registerDirectActionRoutingRule } from "@elizaos/core";
import { registerDossierActivityAnchor } from "./lifeops/scheduled-task/runtime-wiring.js";
import { registerEventKindRegistry } from "./lifeops/registries/index.js";
import { registerExternalOracleRegistry } from "./lifeops/oracles/index.js";
import { registerFamilyRegistry } from "./lifeops/registries/index.js";
import { registerFollowupTrackerWorker } from "./followup/index.js";
import { registerHealthAnchors } from "@elizaos/plugin-health";
import { registerHealthBusFamilies } from "@elizaos/plugin-health";
import { registerHealthConnectors } from "@elizaos/plugin-health";
import { registerHealthDefaultPacks } from "@elizaos/plugin-health";
...
import { registerLifeOpsTaskWorker } from "./lifeops/runtime.js";
import { registerLocalActivityAdapterRegistry } from "./lifeops/oracles/index.js";
import { registerLocalizedExamplesProvider } from "@elizaos/core";
import { registerMessageDraftScheduledTaskBridge } from "./lifeops/scheduled-task/message-draft-dispatch.js";
import { registerMultilingualPromptRegistry } from "./lifeops/i18n/prompt-registry.js";
import { registerOwnerFactStore } from "./lifeops/owner/fact-store.js";
import { registerOwnerSendApprovalWorker } from "./lifeops/messaging/owner-send-policy.js";
import { registerPersonalAssistantCalendarSourcesHost } from "./actions/calendar-sources.js";
import { registerPersonalAssistantConflictDetectHost } from "./actions/conflict-detect.js";
import { registerProactiveTaskWorker } from "./activity-profile/proactive-worker.js";
import { registerScheduledTaskRunnerBootHook } from "@elizaos/plugin-scheduling";
import { registerSendPolicy } from "@elizaos/plugin-assistant";
import { registerSendPolicyRegistry } from "./lifeops/send-policy/index.js";
import { registerWorkflowStepRegistry } from "./lifeops/registries/index.js";
import { remindersPlugin } from "@elizaos/plugin-reminders";
import { requestSelfControlPermission } from "@elizaos/plugin-blocker/services/website-blocker/index";
import { resolveAuthenticatedFamilyPrincipal } from "./lifeops/family-communications/index.js";
import { resolveConfiguredOwnerTimeZone } from "./lifeops/owner/fact-store.js";
import { resolveReferentAction } from "./actions/resolve-referent.js";
import { resolveRequestAction } from "./actions/resolve-request.js";
import { resolveTrustedChildWeekItems } from "./lifeops/family-communications/index.js";
...
import { type Prober } from "@elizaos/shared";
import { unregisterMessageDraftScheduledTaskBridge } from "./lifeops/scheduled-task/message-draft-dispatch.js";
...
const handleDelegationInboundMessage = createDelegationInboundMessageHandler({
    ...
    createApprovalQueue: (runtime) => createApprovalQueue(runtime, { agentId: runtime.agentId }),
    processTurn: processDelegationInboundTurn,
});
const handleHouseholdInboundApproval = createHouseholdInboundApprovalMessageHandler();
...
const WEBSITE_BLOCKING_PLATFORM: Platform = process.platform === "darwin" ||
...
const websiteBlockingPermissionProber: Prober = {
    ...
    request: async () => toSharedPermissionState(await requestSelfControlPermission()),
    openSettings: openSelfControlPermissionLocation,
};
export function registerLifeOpsWebsiteBlockingPermissionProber(runtime: IAgentRuntime): boolean {
    ...
    for (let attempt = 0; attempt <= delays.length; attempt += 1) {
        ...
        try {
            ...
            if (attempt < delays.length) {
                args.runtime.logger.warn(`${args.prefix} ${args.label} init failed (attempt ${attempt + 1}/${delays.length + 1}), retrying in ${delays[attempt]}ms: ${message}`);
                await startup.wait(delays[attempt]);
                continue;
            }
            args.runtime.logger.error(`${args.prefix} ${args.label} init failed after ${delays.length + 1} attempts: ${message}`);
...
function isGoogleConnectorPlugin(plugin: Plugin): boolean {
    return (plugin.name === GOOGLE_CONNECTOR_PLUGIN_NAME ||
...
async function importGoogleConnectorPluginModule(): Promise<Record<string, unknown>> {
    try {
        return (await import(GOOGLE_CONNECTOR_PLUGIN_PACKAGE)) as Record<string, unknown>;
    }
    catch (error) {
        const stagedDependencyUrl = new URL("../node_modules/@elizaos/plugin-google-workspace/dist/index.js", import.meta.url);
        try {
            return (await import(stagedDependencyUrl.href)) as Record<string, unknown>;
        }
        catch {
            throw error;
        }
...
export async function ensureLifeOpsGooglePluginRegistered(runtime: IAgentRuntime): Promise<void> {
    ...
    if (!plugin) {
        throw new Error(`${GOOGLE_CONNECTOR_PLUGIN_PACKAGE} did not export a valid plugin`);
    }
    if (runtime.plugins.some(isGoogleConnectorPlugin)) {
        return;
    }
 ...
 */
export async function ensureLifeOpsCalendarPluginRegistered(runtime: IAgentRuntime): Promise<void> {
    ...
    await runtime.registerPlugin({
        ...calendarPlugin,
        actions: (calendarPlugin.actions ?? []).filter((action) => !composedByPersonalAssistant.has(action.name)),
    });
}
/**
 ...
 */
export async function ensureLifeOpsPdfPluginRegistered(runtime: IAgentRuntime): Promise<void> {
 ...
 * static import.
 */
export async function ensureLifeOpsRemindersPluginRegistered(runtime: IAgentRuntime): Promise<void> {
 ...
 */
export async function ensureLifeOpsInboxPluginRegistered(runtime: IAgentRuntime): Promise<void> {
 ...
 * import.
 */
export async function ensureLifeOpsGoalsPluginRegistered(runtime: IAgentRuntime): Promise<void> {
...
export async function ensureLifeOpsHealthPluginRegistered(runtime: IAgentRuntime): Promise<void> {
    ...
    registerCircadianInsightContract(runtime, createDefaultCircadianInsightContract());
}
const LIFEOPS_TASK_INIT_FAILURE_CACHE_KEY = "eliza:lifeops:plugin:init-failures";
async function recordTaskInitFailure(runtime: IAgentRuntime, label: string, message: string): Promise<void> {
    try {
        const existing = (await runtime.getCache<Record<string, string>>(LIFEOPS_TASK_INIT_FAILURE_CACHE_KEY)) ?? {};
...
function scheduleTaskEnsureAfterRuntimeInit(args: {
    ...
    PersonalAssistantStartupService.forRuntime(args.runtime).runAfterInit(() => ensureTaskWithRetries(args), async (error) => {
        const message = error instanceof Error ? error.message : String(error);
        args.runtime.logger.error(`${args.prefix} ${args.label} init failed after runtime initialization (plugin stays loaded, this subsystem is degraded): ${message}`);
...
const rawPersonalAssistantPlugin: Plugin = {
    ...
    description: "Personal assistant workspace: executive workflows, owner approvals, scheduled tasks, calendar, inbox, documents, reminders, money admin, and focused owner-operation views.",
    ...
    actions: [
        ...
        ...promoteSubactionsToActions(calendarAction, calendarActionPromotionOptions),
        ...
        ...platformGatedActionUmbrellas.flatMap((action) => promoteSubactionsToActions(action)),
        ...
        ...promoteSubactionsToActions(scheduledTaskAction, {
            overrides: {
                create: {
                    description: "subaction = create — schedule a raw ScheduledTask (explicit structural trigger required). NOT for a new habit/routine/recurring personal reminder the owner asks for in chat — use OWNER_ROUTINES_CREATE / OWNER_REMINDERS_CREATE (definition + reminder plan).",
                    descriptionCompressed: "raw ScheduledTask create (explicit trigger required); NEW habit/routine/daily reminder -> OWNER_ROUTINES_CREATE/OWNER_REMINDERS_CREATE",
                },
            },
        }),
    ...
    views: [
        {
            ...
            description: "Connect, seed, inspect, and recover Gmail, Google Calendar, and Apple Calendar.",
            icon: "Cable",
        ...
        },
        {
            ...
            description: "Private parenting agreements, linked calendars, school dates, and monthly coordination packets.",
            icon: "UsersRound",
            path: "/lifeops/family",
            responseContext: {
    ...
    events: {
        ...
        [EventType.MESSAGE_RECEIVED]: [
            detachInboundScan("scheduled-task-inbound", handleScheduledTaskInboundMessage),
            detachInboundScan("inbound-reply-completion", async (payload: MessagePayload): Promise<void> => {
                await completeFiredTasksOnOwnerReply(payload.runtime, payload.message);
            }),
            // Owner re-engaged: any still-scheduled unanswered-question follow-up
            // for the room is stale — dismiss it (#14676).
            detachInboundScan("question-followup-cancel", handleOwnerMessageForQuestionFollowup),
            detachInboundScan("delegation-contract-inbound", handleDelegationInboundMessage),
            detachInboundScan("household-approval-inbound", handleHouseholdInboundApproval),
        ],
    ...
    init: async (_pluginConfig: Record<string, unknown>, runtime: IAgentRuntime) => {
        ...
        registerCalendarTimeZoneResolver(runtime, (_runtime, now) => resolveConfiguredOwnerTimeZone(runtime, now));
        runtime.registerEvent(MEETING_TRANSCRIPT_FINALIZED_EVENT, async (payload) => handleMeetingTranscriptFinalized(payload as EventPayload & MeetingTranscriptFinalizedPayload));
        ...
        registerCandidateActionBackstopRule(runtime, createScheduledTaskCandidateBackstopRule());
        registerDirectActionRoutingRule(runtime, createTrackedWorkRecapDirectRoutingRule());
        registerDirectActionRoutingRule(runtime, createOwnerReminderDirectRoutingRule());
        registerDirectActionRoutingRule(runtime, createUndatedOwnerTodoDirectRoutingRule());
        ...
        if (mockoonApplied.length > 0) {
            logger.info({ mockoonConnectors: mockoonApplied }, `[lifeops] LIFEOPS_USE_MOCKOON=1 — redirecting ${mockoonApplied.length} connector base URL(s) to mock servers`);
        }
        ...
        startup.runAfterInit(() => registerLifeOpsCalendarGate(runtime), (error) => {
            logger.error(`[lifeops] failed to register calendar host gate: ${error instanceof Error ? error.message : String(error)}`);
        });
        ...
        registerScheduledTaskRunnerBootHook(runtime, async (service) => {
            const { ensureFamilyBackupCleanupSchedule } = await import("./lifeops/family-workflows/backup-cleanup-schedule.js");
            await ensureFamilyBackupCleanupSchedule(runtime, service.getRunner({ agentId: runtime.agentId }));
        });
        ...
        registerLocalizedExamplesProvider(runtime, createOwnerLocaleExamplesProvider(runtime));
        ...
        const proactiveAgentDisabled = isDisabledByEnv("ELIZA_DISABLE_PROACTIVE_AGENT");
        if (!proactiveAgentDisabled) {
            ...
            runtime.logger.info("[proactive] Proactive agent task skipped — ELIZA_DISABLE_PROACTIVE_AGENT=1");
        }
        ...
        const lifeOpsSchedulerDisabled = isDisabledByEnv("ELIZA_DISABLE_LIFEOPS_SCHEDULER");
    ...
    dispose: async (runtime: IAgentRuntime) => {
        ...
        for (const name of taskNames) {
            try {
                ...
                for (const task of tasks) {
                    if (task.name === name && task.id) {
                        try {
                            ...
                            runtime.logger.warn(`[lifeops:dispose] Failed to delete task ${name} (${task.id}): ${msg}`);
                        }
                    }
                }
            }
                ...
                const msg = err instanceof Error ? err.message : String(err);
                runtime.logger.warn(`[lifeops:dispose] Failed to list tasks for "${name}": ${msg}`);
            }
        }
        ...
        for (const name of taskNames) {
            try {
                ...
                const msg = err instanceof Error ? err.message : String(err);
                runtime.logger.warn(`[lifeops:dispose] Failed to unregister task worker "${name}": ${msg}`);
            }
        }
    },
};
export const personalAssistantPlugin: Plugin = rawPersonalAssistantPlugin;
export { createGlobalPauseStore, createHandoffStore, createPendingPromptsStore, describeResumeCondition, evaluateResume, type GlobalPauseStatus, type GlobalPauseStore, type GlobalPauseWindow, type HandoffEnterOpts, type HandoffStatus, type HandoffStore, type PendingPromptRecordInput, type PendingPromptsStore, type ResumeCondition, type ResumeEvaluation, type ResumeEvaluationInput, resolveGlobalPauseStore, resolveHandoffStore, resolvePendingPromptsStore, } from "@elizaos/plugin-assistant";
export { appBlockerProvider } from "@elizaos/plugin-blocker/providers/app-blocker";
export { getAppBlockerPermissionState, getAppBlockerStatus, getCachedAppBlockerStatus, getInstalledApps, requestAppBlockerPermission, selectAppsForBlocking, startAppBlock, stopAppBlock, } from "@elizaos/plugin-blocker/services/app-blocker/index";
...
export { computeOverdueFollowups, FOLLOWUP_DEFAULT_THRESHOLD_DAYS, FOLLOWUP_MEMORY_TABLE, FOLLOWUP_TRACKER_INTERVAL_MS, FOLLOWUP_TRACKER_TASK_NAME, FOLLOWUP_TRACKER_TASK_TAGS, getFollowupTrackerRoomId, listOverdueFollowupsAction, markFollowupDoneAction, reconcileFollowupsOnce, registerFollowupTrackerWorker, setFollowupThresholdAction, writeOverdueDigestMemory, } from "./followup/index.js";
export { type AnticipationFeedbackOutput, anticipationFeedbackEvaluator, parseAnticipationFeedbackOutput, } from "./lifeops/anticipation/evaluator.js";
export { type AnticipationOutcome, type AnticipationStats, listUnprocessedDispatches, type ProactiveDispatchMarker, readAnticipationStats, recordAnticipationFeedback, recordProactiveDispatch, } from "./lifeops/anticipation/store.js";
...
export type { CheckinKind, CheckinReport, EscalationLevel, MeetingEntry, OverdueTodo, RecentWin, RecordAcknowledgementRequest, RunCheckinRequest, } from "./lifeops/checkin/types.js";
export { FirstRunService, type ScheduledTaskRunnerLike, setScheduledTaskRunner, } from "./lifeops/first-run/service.js";
export { createFirstRunStateStore, createOwnerFactStore, createSeededDefaultsStore, type FirstRunRecord, type FirstRunStateStore, type OwnerFactStore, type OwnerFacts, type OwnerFactsPatch, type SeededDefaultsMarker, type SeededDefaultsStore, } from "./lifeops/first-run/state.js";
export { FTU_GOAL_CONFIDENCE_THRESHOLD, type FtuGoalDiscoveryOutput, ftuGoalDiscoveryEvaluator, parseFtuGoalOutput, } from "./lifeops/ftu-goal/evaluator.js";
export { createFtuGoalStateStore, type DiscoveredFtuGoal, type FtuGoalRecord, type FtuGoalStateStore, type FtuGoalStatus, } from "./lifeops/ftu-goal/state.js";
export { type AgreementGuestGrantPreview, AgreementKnowledgeError, AgreementKnowledgeRuntimeService, AgreementKnowledgeService, type AgreementObligationStatus, type HouseholdKnowledgeGrant, type HouseholdKnowledgePin, type KnowledgePinTargetType, type ParentingAgreementArtifact, type ParentingAgreementObligation, type ParentingAgreementView, } from "./lifeops/household/agreement-knowledge.js";
export { createMultilingualPromptRegistry, getDefaultPromptExamplePair, getDefaultPromptRegistry, getMultilingualPromptRegistry, type MultilingualPromptRegistry, PROMPT_REGISTRY_DEFAULT_LOCALE, type PromptExampleEntry, type PromptLocale, type PromptRegistryFilter, registerDefaultPromptPack, registerMultilingualPromptRegistry, resolveActionExamplePairs, } from "./lifeops/i18n/prompt-registry.js";
export { type EscalationRule, getOwnerFactStore, type OwnerChronotype, type OwnerFactEntry, type OwnerFactProvenance, type OwnerFactProvenanceSource, type OwnerFactWindow, type OwnerQuietHours, type OwnerScheduleStyle, ownerFactsToView, type PolicyPatchEscalationRule, type PolicyPatchReminderIntensity, type ReminderIntensity, registerOwnerFactStore, resolveOwnerFactStore, } from "./lifeops/owner/fact-store.js";
// LifeOps runtime exports
export { ensureLifeOpsSchedulerTask, executeLifeOpsSchedulerTask, LIFEOPS_TASK_INTERVAL_MS, LIFEOPS_TASK_JITTER_MS, LIFEOPS_TASK_NAME, LIFEOPS_TASK_TAGS, registerLifeOpsTaskWorker, resolveLifeOpsTaskIntervalMs, } from "./lifeops/runtime.js";
export { resetLifeOpsScenarioState } from "./lifeops/scenario-reset.js";
export type { AnchorConsolidationPolicy, AnchorContribution, AnchorRegistry, CompletionCheckContribution, CompletionCheckRegistry, EscalationLadder, EscalationLadderRegistry, EscalationStep, GateDecision, ProcessDueScheduledTasksRequest, ProcessDueScheduledTasksResult, ProcessScheduledTaskInboundMessageRequest, ProcessScheduledTaskInboundMessageResult, ScheduledTask, ScheduledTaskCompletionCheck, ScheduledTaskCompletionResult, ScheduledTaskContextRequest, ScheduledTaskDueContext, ScheduledTaskDueDecision, ScheduledTaskEscalation, ScheduledTaskFilter, ScheduledTaskKind, ScheduledTaskLogEntry, ScheduledTaskOutput, ScheduledTaskPipeline, ScheduledTaskPriority, ScheduledTaskRef, ScheduledTaskRunner, ScheduledTaskRunnerHandle, ScheduledTaskShouldFire, ScheduledTaskState, ScheduledTaskStatus, ScheduledTaskSubject, ScheduledTaskTrigger, ScheduledTaskVerb, TaskGateContribution, TaskGateRegistry, TerminalState, } from "./lifeops/scheduled-task/index.js";
export { createAnchorRegistry, createCompletionCheckRegistry, createConsolidationRegistry, createEscalationLadderRegistry, createInMemoryScheduledTaskLogStore, createInMemoryScheduledTaskStore, createScheduledTaskRunner, createTaskGateRegistry, DEFAULT_ESCALATION_LADDERS, PRIORITY_DEFAULT_LADDER_KEYS, processDueScheduledTasks, processScheduledTaskInboundMessage, registerBuiltInCompletionChecks, registerBuiltInGates, registerDefaultEscalationLadders, registerFallbackAnchors, STATE_LOG_DEFAULT_RETENTION_DAYS, } from "./lifeops/scheduled-task/index.js";
export type { CreateRuntimeRunnerOptions } from "./lifeops/scheduled-task/runtime-wiring.js";
export { createRuntimeScheduledTaskRunner, registerLifeOpsScheduledTaskSubjectStore, } from "./lifeops/scheduled-task/runtime-wiring.js";
export type { GetScheduledTaskRunnerOptions } from "./lifeops/scheduled-task/service.js";
export { getScheduledTaskRunner, ScheduledTaskRunnerService, } from "./lifeops/scheduled-task/service.js";
export { threadOpsFieldEvaluator } from "./lifeops/work-threads/field-evaluator-thread-ops.js";
export { type CreateWorkThreadInput, createWorkThreadStore, type ThreadSourceRef, type UpdateWorkThreadInput, type WorkThread, type WorkThreadEvent, type WorkThreadEventType, type WorkThreadListFilter, type WorkThreadStatus, type WorkThreadStore, } from "./lifeops/work-threads/index.js";
...
export { pendingApprovalsProvider, renderPendingApprovalsText, } from "./providers/pending-approvals.js";
export type { PendingPrompt, PendingPromptsProvider, } from "./providers/pending-prompts.js";
export { createPendingPromptsProvider, pendingPromptsProvider, } from "./providers/pending-prompts.js";
export type { RecentTaskStatesProvider, RecentTaskStatesSummary, } from "./providers/recent-task-states.js";
export { createRecentTaskStatesProvider, recentTaskStatesProvider, } from "./providers/recent-task-states.js";
