 ...
 */
import { CALENDAR_GUEST_AVAILABILITY_GRANTS_ATTRIBUTE } from "./guest-availability-grants.js";
import { CALENDAR_GUEST_AVAILABILITY_GRANTS_SCHEMA } from "./guest-availability-grants.js";
import { CALENDAR_GUEST_AVAILABILITY_GRANTS_TAG } from "./guest-availability-grants.js";
...
import { type StoredCalendarGuestAvailabilityGrant } from "./guest-availability-grants.js";
...
function storedGrant(grantId: string, overrides: Partial<StoredCalendarGuestAvailabilityGrant> = {}): StoredCalendarGuestAvailabilityGrant {
    return {
        grantId,
...
describe("guest availability grants — real PGlite knowledge graph", () => {
    ...
    it("rejects missing and expired grants", async () => {
        await expect(resolve("gav_6849860a6c614420ae0eaa4932559547")).rejects.toMatchObject({
