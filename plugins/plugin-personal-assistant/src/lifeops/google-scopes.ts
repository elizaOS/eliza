...
const GOOGLE_CAPABILITY_SCOPE_MAP: Record<LifeOpsGoogleCapability, string[]> = {
  ...
  "google.gmail.draft.create": [GOOGLE_GMAIL_COMPOSE_SCOPE],
  // Managing labels and archive/read-state flows.
  "google.gmail.manage": [GOOGLE_GMAIL_MODIFY_SCOPE],
};
...
export function googleScopesToCapabilities(
  ...
  if (granted.has(GOOGLE_GMAIL_COMPOSE_SCOPE)) {
    capabilities.push("google.gmail.draft.create");
  }
  if (granted.has(GOOGLE_GMAIL_MODIFY_SCOPE)) {
