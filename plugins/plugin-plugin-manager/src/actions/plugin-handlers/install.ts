/**
 * @module plugin-plugin-manager/actions/plugin-handlers/install
 *
...
export async function runInstall({
  ...
  // Honor explicit source selection by toggling the clone override scoped
  // to this call. Restore the previous value when done.
