...
import type { WiFiNetwork as WifiNet } from "@elizaos/plugin-native-wifi/bridge";
...
/**
 * Real-shaped @elizaos/plugin-native-wifi/bridge WiFiNetwork (matches definitions.ts —
