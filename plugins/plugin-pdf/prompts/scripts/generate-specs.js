...
function generateTypeScript(actionsSpec, providersSpec) {
	...
	const content = `/**
 * Auto-generated canonical action/provider docs for plugin-pdf.
...
function generateRust(actionsSpec, providersSpec) {
	...
	const content = `//! Auto-generated canonical action/provider docs for plugin-pdf.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
	...
	console.log("Generated plugin-pdf action/provider docs.");
}
