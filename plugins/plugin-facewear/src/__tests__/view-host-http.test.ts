/**
 * Full HTTP integration tests for the viewHostRoute.
 *
 * Unlike the unit tests in view-host.test.ts (which call the route handler
...
describe("viewHostRoute — real HTTP server integration", () => {
