...
// SmartglassesSpatialView). The legacy full-screen dashboards (FacewearAppView,
// SmartglassesView) and the TUI shims stay exported because the app shell mounts
// them as overlay pages.
