...
export class BlueskyWorkflowCredentialProvider extends Service {
  ...
  override capabilityDescription = 'Supplies Bluesky credentials to the workflow plugin.';

  static async start(runtime: IAgentRuntime): Promise<BlueskyWorkflowCredentialProvider> {
