...
const externalDeps = ["@elizaos/core"] as const;
...
async function build(): Promise<void> {
  ...
  console.log("Building @elizaos/plugin-avian for Node...");
  ...
  console.log("Building @elizaos/plugin-avian for Browser...");
  ...
  console.log("Building @elizaos/plugin-avian for Node (CJS)...");
