...
```bash
bun run --cwd plugins/plugin-hearwear lint
bun run --cwd plugins/plugin-hearwear typecheck
bun run --cwd plugins/plugin-hearwear test
bun run --cwd plugins/plugin-hearwear build
