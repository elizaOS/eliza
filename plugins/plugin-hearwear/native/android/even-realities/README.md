...
The G1 implements the same core command framing used by `plugin-hearwear`:
...
- The agent (plugin-hearwear) should detect this device type and skip TTS audio (G1 has no speaker)
