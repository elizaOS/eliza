// LifeOps chat-prefill builders, chat-launcher / chat-adapter hooks, and the
// `eliza:chat:prefill` event plumbing, split out of LifeOpsChatAdapter.tsx so
// that file exports only the React component and stays Fast-Refresh-compatible
// (Vite full-reloads a component file that also exports hooks / plain
// functions). Sibling sections import these helpers directly.
