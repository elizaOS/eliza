...
- **`maxTokens` is a checked boundary** at 32k (Opus 4) or 64k (all others). Explicit unsupported requests fail before dispatch; omitted budgets use the model limit because Anthropic requires `max_tokens`.
