...
function buildTelemetry(
  ...
  return {
    ...
    humanAgents: state.agents.human.length,
    orcAgents: state.agents.orc.length,
    laneHumanUnits: activeLane?.human,
    laneOrcUnits: activeLane?.orc,
    laneFrontline: activeLane?.frontline,
