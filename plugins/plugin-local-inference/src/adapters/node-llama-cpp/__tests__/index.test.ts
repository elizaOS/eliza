...
describe("Local AI Plugin", () => {
	...
	describe("Model handlers", () => {
		...
		it("should have TEXT_TOKENIZER_ENCODE model handler", () => {
			...
			expect(typeof localAiPlugin.models?.TEXT_TOKENIZER_ENCODE).toBe(
				"function",
			);
		});
		...
		it("should have TEXT_TOKENIZER_DECODE model handler", () => {
			...
			expect(typeof localAiPlugin.models?.TEXT_TOKENIZER_DECODE).toBe(
				"function",
			);
		});
	...
	describe("local-inference compatibility routing", () => {
		...
		it("routes image description to an active local-inference backend", async () => {
			...
			const result = await localAiPlugin.models?.[
	...
	describe("Plugin tests", () => {
		...
		it("should have local_ai_plugin_tests test suite", () => {
			const testSuite = localAiPlugin.tests?.find(
				(t) => t.name === "local_ai_plugin_tests",
			);
		...
		it("should have initialization test", () => {
			...
			const initTest = testSuite?.tests.find(
				(t) => t.name === "local_ai_test_initialization",
			);
