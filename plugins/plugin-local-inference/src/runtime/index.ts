 ...
 *
 * Consumers (app/runtime/eliza.ts, agent bootstrap) import from
...
// Speaker-name provenance policy (#12498). Explicit owner corrections call it
// through IDENTIFY_SPEAKER; meeting adapters can add roster/calendar evidence
// without weakening the same confirmation and withholding rules.
export {
