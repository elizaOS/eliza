...
export class ConversationRegistry {
    ...
    open(args) {
        ...
        const parallel = typeof args.parallel === "number" && args.parallel > 0
     ...
     */
    pickLowestLoadedSlot(parallel, conversationId) {
        if (parallel <= 1)
            return 0;
        let bestSlot = 0;
    ...
    compositeKey(conversationId, modelId) {
