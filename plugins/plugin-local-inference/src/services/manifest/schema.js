...
// Required-kernel set per tier. Mirrors the active tier policy:
// - 0.8B/2B require turboquant + qjl + polarquant and explicitly ship no
//   mandatory drafter; larger tiers also require dflash.
...
export const TURN_DETECTOR_MEAN_LATENCY_MS_LIMIT = 30;
/** Eval-gate threshold: minimum macro-F1 on MELD test (7-class). */
export const EMOTION_CLASSIFIER_MELD_F1_THRESHOLD = 0.35;
/** Eval-gate threshold: minimum macro-F1 on IEMOCAP test (4-class). */
export const EMOTION_CLASSIFIER_IEMOCAP_F1_THRESHOLD = 0.6;
...
export const ELIZA_1_RELEASE_CHANNELS = ["recommended", "base-v1"];
