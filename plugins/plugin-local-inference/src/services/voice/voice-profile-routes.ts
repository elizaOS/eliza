 ...
 * build time via `bun run --cwd packages/app voice:create-profile`.
 */
 ...
 *
 * Called by `bun run --cwd packages/app voice:create-profile` after the freeze pipeline
