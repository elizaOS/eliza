...
export function downloadedAssetName(version: Pick<VoiceModelVersion, "id" | "version">, assetFilename: string): string {
 ...
 */
export function planWakeWordStaging(version: VoiceModelVersion, bundleVoiceDir: string, wakeDir: string = wakeStagingDir()): WakeStageCopy[] {
    if (version.id !== "wakeword")
        return [];
 ...
 */
export async function stageWakeWordModel(version: VoiceModelVersion, bundleVoiceDir: string, wakeDir: string = wakeStagingDir()): Promise<string[]> {
