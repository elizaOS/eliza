...
```
cmake -B build -S plugins/plugin-local-inference/native/qjl-cpu
cmake --build build -j
```
...
cmake -B build-arm64 -S plugins/plugin-local-inference/native/qjl-cpu \
...
```
python3 plugins/plugin-local-inference/native/qjl-cpu/scripts/gen_fixtures.py \
  --out plugins/plugin-local-inference/native/qjl-cpu/test/fixtures/qjl_fixtures.bin \
  --n 100
```
...
```
build/qjl_bench --parity plugins/plugin-local-inference/native/qjl-cpu/test/fixtures/qjl_fixtures.bin
```
