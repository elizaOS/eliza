...
```
cmake -B plugins/plugin-local-inference/native/voice-classifier-cpp/build \
      -S plugins/plugin-local-inference/native/voice-classifier-cpp
cmake --build plugins/plugin-local-inference/native/voice-classifier-cpp/build -j
ctest --test-dir plugins/plugin-local-inference/native/voice-classifier-cpp/build --output-on-failure
```
