...
EXTRACT_GOAL_TEMPLATE = """# Task: Extract Goal Information
...
EXTRACT_GOAL_SELECTION_TEMPLATE = """# Task: Extract Goal Selection Information
...
EXTRACT_GOAL_UPDATE_TEMPLATE = """# Task: Extract Goal Update Information
