    ...
    try {
      ...
      if (!targetData?.targetType || !targetData?.source) {
        ...
        return {
          ...
          data: {
            error:
              "I couldn't determine where you want me to send the message. Could you please specify the target (user or room) and platform?",
          },
          text: "I couldn't determine where you want me to send the message. Could you please specify the target (user or room) and platform?",
        };
      }
      ...
      if (targetData.targetType === 'user') {
        ...
        if (!targetEntity) {
          ...
          return {
            ...
            data: {
              error:
                "I couldn't find the user you want me to send a message to. Could you please provide more details about who they are?",
            },
            text: "I couldn't find the user you want me to send a message to. Could you please provide more details about who they are?",
          };
        }
        ...
        if (!userComponent) {
          ...
          return {
            ...
            values: { error: true },
            data: {
              error: `I couldn't find ${source} information for that user. Could you please provide their ${source} details?`,
            },
            text: `I couldn't find ${source} information for that user. Could you please provide their ${source} details?`,
          };
        }
        ...
        if (!targetRoom) {
          ...
          return {
            ...
            data: {
              error:
                "I couldn't find the room you want me to send a message to. Could you please specify the exact room name?",
            },
            text: "I couldn't find the room you want me to send a message to. Could you please specify the exact room name?",
          };
        }
