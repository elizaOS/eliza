...
describe("built-in Eliza calendar (real PGlite)", { timeout: 30_000 }, () => {
  ...
  it.each([
    {
      text: "Move my notary appointment to 4pm for two hours.",
      start: "2026-09-11T16:00:00",
      end: "2026-09-11T18:00:00",
      expectedStart: "2026-09-11T20:00:00.000Z",
      expectedEnd: "2026-09-11T22:00:00.000Z",
      durationChanged: true,
    },
    {
      text: "Mueve mi cita a las 16:00 durante dos horas.",
      start: "2026-09-11T16:00:00",
      end: "2026-09-11T18:00:00",
      expectedStart: "2026-09-11T20:00:00.000Z",
      expectedEnd: "2026-09-11T22:00:00.000Z",
    ...
    {
      text: "Move my Friday notary appointment a week later at 4pm.",
      start: "2026-09-18T16:00:00",
      end: "2026-09-18T16:30:00",
      expectedStart: "2026-09-18T20:00:00.000Z",
      expectedEnd: "2026-09-18T20:30:00.000Z",
      durationChanged: false,
    },
    {
      text: "Move my notary appointment to Friday at 4pm.",
      start: "2026-09-18T16:00:00",
      end: "2026-09-18T17:00:00",
      expectedStart: "2026-09-18T20:00:00.000Z",
      expectedEnd: "2026-09-18T21:00:00.000Z",
      durationChanged: true,
    },
  ])(
    "preserves the typed range in the store for $text",
    async ({
      text,
      start,
      end,
      ...
      await service.createCalendarEventMutation(INTERNAL_URL, {
        ...
        idempotencyKey: "notary-update-contract",
      });
      const action = createCalendarActionRunner({
        runTextModel: vi.fn(async () => null),
      ...
      const result = await action.handler(
        runtime,
        {
          ...
          entityId: "00000000-0000-0000-0000-000000000102",
          roomId: "00000000-0000-0000-0000-000000000103",
          createdAt: Date.parse("2026-09-12T02:15:00.000Z"),
          content: { text },
        } as Memory,
        undefined,
        {
      ...
      // A changed duration is preserved and remains subject to evaluation;
      // it must not be silently made into a self-verified plain move.
      if (durationChanged) expect(result?.verifiedUserFacing).not.toBe(true);
      const moved = (
        result?.data as
