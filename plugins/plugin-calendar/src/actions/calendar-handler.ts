...
const calendarAction: CalendarHandlerAction = {
  ...
  description:
    ...
    "DO NOT use this action for email inbox work or drafting emails — use MESSAGE for inbox review and the connected Gmail draft capability for Gmail drafts. Gmail MCP cannot send mail. " +
