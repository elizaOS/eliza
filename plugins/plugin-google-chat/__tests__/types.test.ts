...
describe("GoogleChatTypes", () => {
  ...
  describe("GoogleChatEventTypes", () => {
    it("should have correct event type values", () => {
      expect(GoogleChatEventTypes.MESSAGE_RECEIVED).toBe("GOOGLE_CHAT_MESSAGE_RECEIVED");
      expect(GoogleChatEventTypes.MESSAGE_SENT).toBe("GOOGLE_CHAT_MESSAGE_SENT");
      expect(GoogleChatEventTypes.SPACE_JOINED).toBe("GOOGLE_CHAT_SPACE_JOINED");
      expect(GoogleChatEventTypes.SPACE_LEFT).toBe("GOOGLE_CHAT_SPACE_LEFT");
      expect(GoogleChatEventTypes.REACTION_RECEIVED).toBe("GOOGLE_CHAT_REACTION_RECEIVED");
      expect(GoogleChatEventTypes.REACTION_SENT).toBe("GOOGLE_CHAT_REACTION_SENT");
      expect(GoogleChatEventTypes.WEBHOOK_READY).toBe("GOOGLE_CHAT_WEBHOOK_READY");
      expect(GoogleChatEventTypes.CONNECTION_READY).toBe("GOOGLE_CHAT_CONNECTION_READY");
    });
  ...
  describe("extractResourceId", () => {
    ...
    it("should extract ID from reaction resource name", () => {
      expect(extractResourceId("spaces/ABC/messages/MSG/reactions/RXN1")).toBe("RXN1");
    });
  ...
  describe("Error Classes", () => {
    describe("GoogleChatPluginError", () => {
      ...
      it("should store cause when provided", () => {
        ...
        const error = new GoogleChatPluginError("test error", "TEST_CODE", cause);
    ...
    describe("GoogleChatConfigurationError", () => {
      ...
      it("should store the setting name", () => {
        const error = new GoogleChatConfigurationError("missing value", "GOOGLE_CHAT_AUDIENCE");
