  ...
  describe("sendMessage", () => {
    ...
    describe("validate", () => {
      it("should return true for google-chat source", async () => {
        ...
        const result = await sendMessage.validate({} as never, mockMessage as never);
  ...
  describe("sendReaction", () => {
    ...
    describe("validate", () => {
      it("should return true for google-chat source", async () => {
        ...
        const result = await sendReaction.validate({} as never, mockMessage as never);
        expect(result).toBe(true);
      });
  ...
  describe("listSpaces", () => {
    ...
    describe("validate", () => {
      it("should return true for google-chat source", async () => {
        ...
        const result = await listSpaces.validate({} as never, mockMessage as never);
        expect(result).toBe(true);
      });
