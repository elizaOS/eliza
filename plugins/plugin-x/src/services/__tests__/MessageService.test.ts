...
describe("TwitterMessageService", () => {
  ...
  describe("deleteMessage", () => {
    it("should delete a message", async () => {
      await service.deleteMessage("tweet-123", AGENT_ID);
    ...
    it("should throw error on failure", async () => {
      ...
      await expect(
        service.deleteMessage("tweet-123", AGENT_ID),
  ...
  describe("getMessage", () => {
    it("should fetch a single message", async () => {
      ...
      const message = await service.getMessage("tweet-123", AGENT_ID);
  ...
  describe("markAsRead", () => {
    it("should log that marking as read is not implemented", async () => {
      ...
      await service.markAsRead(["tweet-1", "tweet-2"], AGENT_ID);
