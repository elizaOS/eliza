...
import type { TwitterOAuth1Provider } from "../auth-providers/types";

/**
 * Narrow view of the portions of the `TwitterApi` v2 client we exercise in
 * these tests. Keeping this explicit avoids needing to stand in for the full
 * upstream class surface.
 */
interface MockTwitterApi {
  v2: { me: Mock };
}
...
const TwitterApiMockCtor = TwitterApi as unknown as Mock;
...
describe("TwitterAuth", () => {
  ...
  beforeEach(() => {
    ...
    TwitterApiMockCtor.mockImplementation(function TwitterApiMock() {
