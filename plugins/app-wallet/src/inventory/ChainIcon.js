...
export function ChainIcon({ chain, size = "md", className = "", }) {
    ...
    return (_jsx("svg", { viewBox: def.viewBox, fill: "currentColor", className: `${sizeClass} ${className}`.trim(), "aria-hidden": "true", children: def.paths.map((d) => (_jsx("path", { d: d }, d))) }));
}
