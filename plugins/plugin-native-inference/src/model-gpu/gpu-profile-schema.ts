 ...
 * `plugins/plugin-native-inference/src/model-catalog/gpu-profiles.ts` is the *other*
 ...
 * `plugins/plugin-native-inference/src/model-catalog/gpu-profiles.ts`. Duplicated here
