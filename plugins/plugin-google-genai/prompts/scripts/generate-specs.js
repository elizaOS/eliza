...
function generateTypeScript(actionsSpec, providersSpec) {
  ...
  const content = `/**
 * Auto-generated canonical action/provider docs for plugin-google-genai.
...
function generateRust(actionsSpec, providersSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider docs for plugin-google-genai.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-google-genai action/provider docs.");
}
