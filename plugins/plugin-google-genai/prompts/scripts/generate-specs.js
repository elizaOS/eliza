...
function generateTypeScript(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `/**
 * Auto-generated canonical action/provider/evaluator docs for plugin-google-genai.
...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_google-genai", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-google-genai.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-google-genai action/provider/evaluator docs.");
}
