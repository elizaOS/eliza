...
export async function validateXConfig(
	...
	const config: TwitterConfig = {
		...
		X_API_SECRET:
			getXSetting(runtime, "X_API_SECRET") ||
			getXSetting(runtime, "X_API_SECRET_KEY"),
		...
		X_ENGAGEMENT_INTERVAL_MIN:
			getXSetting(runtime, "X_ENGAGEMENT_INTERVAL_MIN") || "20",
		X_ENGAGEMENT_INTERVAL_MAX:
			getXSetting(runtime, "X_ENGAGEMENT_INTERVAL_MAX") || "40",
		X_DISCOVERY_INTERVAL_MIN:
			getXSetting(runtime, "X_DISCOVERY_INTERVAL_MIN") || "15",
		X_DISCOVERY_INTERVAL_MAX:
			getXSetting(runtime, "X_DISCOVERY_INTERVAL_MAX") || "30",
		X_MAX_ENGAGEMENTS_PER_RUN:
			getXSetting(runtime, "X_MAX_ENGAGEMENTS_PER_RUN") || "5",
