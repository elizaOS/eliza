...
export class Client {
  ...
  async sendNotePost(
    ...
    return await createCreateNotePostRequest(
      text,
      this.auth,
      replyToPostId,
      mediaData,
  ...
  async sendLongPost(
    ...
    return await createCreateLongPostRequest(
      text,
      this.auth,
      replyToPostId,
      mediaData,
  ...
  async sendPostV2(
    ...
    return await createCreatePostRequestV2(
      text,
      this.auth,
      replyToPostId,
      options,
   ...
   * @returns An {@link AsyncGenerator} of posts from the provided user.
   */
  public getPostsAndRepliesByUserId(
    userId: string,
    maxPosts = 200,
  ): AsyncGenerator<Post, void> {
    if (!this.auth) {
  ...
  public async sendQuotePost(
    ...
    return await createQuotePostRequest(
      text,
      quotedPostId,
      this.auth,
      options?.mediaData,
   ...
   */
  public async fetchAllQuotedPosts(
    postId: string,
