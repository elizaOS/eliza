...
// Alias for X naming
export type IXClient = ITwitterClient;
...
/**
 * Extended interface for XService with proper typing
 */
export interface IXService extends Service {
  xClient?: XClientInstance;
}

// Backward compatibility alias
export type ITwitterService = IXService;

// Import types for the service interface
import type { Service } from "@elizaos/core";
import type { XClientInstance } from "./services/x.service";
