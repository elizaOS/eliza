...
pub const QUOTE_TWEET_TEMPLATE: &str = r#"# Task: Write a quote post in the voice, style, and perspective of {{agentName}} @{{xUserName}}.
...
pub const REPLY_TWEET_TEMPLATE: &str = r#"# Task: Write a reply post in the voice, style, and perspective of {{agentName}} @{{xUserName}}.
