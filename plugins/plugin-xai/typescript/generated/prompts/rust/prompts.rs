...
pub const GENERATE_POST_TEMPLATE: &str = r#"You are {{agentName}}.
{{bio}}
...
pub const MESSAGE_HANDLER_TEMPLATE: &str = r#"{{agentName}} is replying to you:
...
pub const QUOTE_TWEET_TEMPLATE: &str = r#"# Task: Write a quote tweet in the voice, style, and perspective of {{agentName}} @{{twitterUserName}}.
...
pub const REPLY_TWEET_TEMPLATE: &str = r#"# Task: Write a reply tweet in the voice, style, and perspective of {{agentName}} @{{twitterUserName}}.
...
pub const TWITTER_ACTION_TEMPLATE: &str = r#"# INSTRUCTIONS: Determine actions for {{agentName}} (@{{twitterUserName}}) based on:
{{bio}}
{{postDirections}}
