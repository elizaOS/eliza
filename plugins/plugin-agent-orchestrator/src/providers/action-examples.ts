  ...
  get: async (runtime: IAgentRuntime, message: Memory, _state: State) => {
    try {
      ...
      const detailedText = [
        ...
        "  Investigate why production login returns 401s in https://github.com/acme/app and fix it,REPLY|CREATE_TASK,repo=https://github.com/acme/app; task=Investigate login 401s implement fix run tests summarize root cause",
        "  Research browser automation options compare them and draft a recommendation doc,REPLY|CREATE_TASK,agents=Research Playwright tradeoffs | Compare Stagehand Playwright browser-use | Draft recommendation memo",
        ...
        "guidance:",
        "  preferCreateTask: use ACPX CREATE_TASK for open-ended multi-step async work",
