...
export const codingAgentExamplesProvider: Provider = {
  ...
  get: async (runtime: IAgentRuntime, message: Memory, _state: State) => {
    ...
    const detailedText = [
      ...
      "    task: Investigate the production login 401s, implement the fix, run the relevant tests, and summarize the root cause.",
      "",
      ...
      "params:",
      "  CREATE_TASK:",
      '    agents: Research Playwright tradeoffs and browser sandboxing. Your identifier is "research". | Compare Stagehand, Playwright, and browser-use for Eliza. Your identifier is "comparison". | Draft a recommendation memo in TASK_AGENTS.md using the findings. Your identifier is "writer".',
      "",
      'User: "Tell the running sub-agent to accept that prompt and continue."',
      "Assistant:",
      "actions: REPLY, SEND_TO_AGENT",
      "params:",
      "  SEND_TO_AGENT:",
      "    input: Yes, accept it and continue.",
      "",
