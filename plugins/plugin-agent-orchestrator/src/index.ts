          ...
          overrides: {
            spawn_agent: {
              ...
              descriptionCompressed:
                "ACP sub-agent claude|codex|opencode for delegation/adapter/multi-step; prefer FILE/BASH",
            },
          },
        }),
      ]
