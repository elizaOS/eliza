 ...
 * but hasn't set any `ELIZA_OPENCODE_*` variables.
 *
 ...
 * tuning. Users can override via `ELIZA_OPENCODE_MODEL_POWERFUL` (which
 ...
 *      becomes a fully working opencode config, no `ELIZA_OPENCODE_*`
