...
/**
 * Agent types that authenticate per pooled account. Claude and Codex use their
 * own external CLI account pools. Eliza Code and Pi Agent authenticate through
 * the runtime/provider configuration instead.
 */
