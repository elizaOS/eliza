 ...
 * with app's slot registry at import time.
 *
 * The root app loads this module from its main entry so app's slot
 ...
 *
 * This keeps app → app-task-coordinator off the static import graph
