...
function makeDataset(): OptimizationExample[] {
  return [
    {
      id: "1",
      input: { user: "alpha bravo" },
      expectedOutput: "alpha bravo",
      reward: 1,
    },
    {
      id: "2",
      input: { user: "charlie delta" },
      expectedOutput: "charlie delta",
      reward: 1,
    },
    {
      id: "3",
      input: { user: "echo foxtrot" },
      expectedOutput: "echo foxtrot",
      reward: 0.5,
    },
    {
      id: "4",
      input: { user: "golf hotel" },
      expectedOutput: "golf hotel",
      reward: 0.5,
    },
  ];
}
