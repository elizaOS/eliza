      ...
      fn: async (runtime: IAgentRuntime) => {
        ...
        for (const scenario of scenarios) {
          ...
          if (hasVisionContext) {
            ...
            if (
              state.values.sceneDescription &&
              typeof state.values.sceneDescription === "string"
            ) {
              console.log(
...

    {
      ...
      fn: async (runtime: IAgentRuntime) => {
        ...
        if (!isActive) {
          ...
          if (
            !state.values.cameraStatus ||
            typeof state.values.cameraStatus !== "string" ||
            !state.values.cameraStatus.includes("not connected")
          ) {
