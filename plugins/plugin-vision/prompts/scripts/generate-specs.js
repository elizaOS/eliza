...
function generateTypeScript(actionsSpec, providersSpec) {
  ...
  const content = `/**
 * Auto-generated canonical action/provider docs for plugin-vision.
...
function generateRust(actionsSpec, providersSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider docs for plugin-vision.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-vision action/provider docs.");
}
