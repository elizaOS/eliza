...
function generateTypeScript(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `/**
 * Auto-generated canonical action/provider/evaluator docs for plugin-vision.
...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_vision", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-vision.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-vision action/provider/evaluator docs.");
}
