...
export class SlackWorkflowCredentialProvider extends Service {
  ...
  override capabilityDescription = 'Supplies Slack credentials to the workflow plugin.';

  static async start(runtime: IAgentRuntime): Promise<SlackWorkflowCredentialProvider> {
