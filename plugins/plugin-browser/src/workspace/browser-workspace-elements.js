import { buildBrowserWorkspaceCssStringLiteral, normalizeBrowserWorkspaceText, } from "./browser-workspace-helpers.js";
import { getJSDOMClass } from "./browser-workspace-jsdom.js";
export function buildBrowserWorkspaceElementSelector(element) {
    const escapeFn = globalThis.CSS?.escape;
    const escapedId = typeof escapeFn === "function"
        ? escapeFn(element.id)
...
export function createBrowserWorkspaceElementSummary(element) {
...
export function collectBrowserWorkspaceInspectElements(document) {
...
export function resolveBrowserWorkspaceIframeDocument(runtime, frameElement, baseUrl) {
...
export function resolveWebBrowserWorkspaceCommandDocument(tab, dom, runtimeState) {
...
export function getBrowserWorkspaceElementSearchTexts(element) {
...
export function browserWorkspaceTextMatches(candidate, wanted, exact = false) {
...
export function isBrowserWorkspaceElementVisible(element) {
...
export function findBrowserWorkspaceElementByLabel(document, labelText, exact = false) {
...
export function getBrowserWorkspaceNativeRole(element) {
...
export function findBrowserWorkspaceElementByRole(document, role, name, exact = false) {
...
export function trimBrowserWorkspaceQuotedValue(value) {
...
export function normalizeBrowserWorkspaceSelectorSyntax(selector) {
...
export function parseBrowserWorkspaceSemanticSelector(selector) {
...
export function mergeBrowserWorkspaceSelectorCommand(command, selector) {
...
export function queryBrowserWorkspaceSelector(root, selector) {
    try {
...
export function queryAllBrowserWorkspaceSelector(root, selector) {
    try {
...
export function findBrowserWorkspaceElementByText(document, needle) {
...
export function resolveBrowserWorkspaceFindElement(document, command) {
...
export function resolveBrowserWorkspaceElement(document, selector, text, command) {
...
export function getBrowserWorkspaceElementBox(element) {
...
export function getBrowserWorkspaceElementValue(element) {
...
export function getBrowserWorkspaceElementStyles(element, window) {
...
export function findClosestBrowserWorkspaceForm(element) {
    if (!element) {
        return null;
    }
