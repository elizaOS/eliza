...
export function escapeBrowserWorkspacePdfText(value) {
    return value
        .replaceAll("\\", "\\\\")
        .replaceAll("(", "\\(")
        .replaceAll(")", "\\)");
}
export function createBrowserWorkspacePdfBuffer(title, bodyText) {
    const lines = [
...
export function createBrowserWorkspaceSyntheticScreenshotData(title, url, bodyText, viewport) {
...
export function createBrowserWorkspaceSnapshotRecord(title, url, bodyText) {
    return {
...
export function buildBrowserWorkspaceDocumentSnapshotText(document) {
...
export function diffBrowserWorkspaceSnapshots(before, after) {
    return {
        changed: !before ||
...
export function readBrowserWorkspaceStorage(storage) {
    const entries = {};
...
export function readBrowserWorkspaceCookies(document) {
...
export function applyBrowserWorkspaceStateToWebDocument(document, snapshot) {
