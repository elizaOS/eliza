...
export const BROWSER_PARITY_MATRIX: readonly BrowserParityCapability[] = [
  ...
  {
    id: "double-click",
    actionValue: "double_click",
    elizaVerb: "BROWSER_DOUBLE_CLICK",
    dispatchesTo: "dblclick",
    status: "have",
    surface: WORKSPACE,
  },
  {
  ...
  {
    id: "scroll-into-view",
    actionValue: "scroll_into_view",
    elizaVerb: "BROWSER_SCROLL_INTO_VIEW",
  ...
  },
  {
    id: "uncheck",
    actionValue: "uncheck",
    elizaVerb: "BROWSER_UNCHECK",
    dispatchesTo: "uncheck",
    status: "have",
    surface: WORKSPACE,
  },
  {
  ...
  },
  {
    id: "inspect",
    actionValue: "inspect",
    elizaVerb: "BROWSER_INSPECT",
    dispatchesTo: "inspect",
    status: "have",
    surface: WORKSPACE,
  },
  {
