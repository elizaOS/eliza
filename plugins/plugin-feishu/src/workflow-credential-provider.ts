...
export class FeishuWorkflowCredentialProvider extends Service {
  ...
  override capabilityDescription = 'Supplies Feishu/Lark credentials to the workflow plugin.';

  static async start(runtime: IAgentRuntime): Promise<FeishuWorkflowCredentialProvider> {
