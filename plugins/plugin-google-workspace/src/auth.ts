...
export const GOOGLE_OAUTH_PROVIDER_METADATA: GoogleOAuthProviderMetadata = {
  ...
  managedDesktopClientIdSetting: "ELIZA_GOOGLE_OAUTH_DESKTOP_CLIENT_ID",
  confidentialClientIdSetting: "GOOGLE_CLIENT_ID",
  confidentialClientSecretSetting: "GOOGLE_CLIENT_SECRET",
  responseType: "code",
  accessType: "offline",
  prompt: "consent",
  supportsPkce: true,
