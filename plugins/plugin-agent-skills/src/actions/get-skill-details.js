...
export const getSkillDetailsAction = {
    ...
    handler: async (runtime, message, _state, options, callback) => {
        try {
            ...
            const opts = options;
            const explicitSlug = typeof opts?.parameters?.slug === "string"
                ? opts.parameters.slug
                : typeof opts?.slug === "string"
                    ? opts.slug
                    : null;
            const slug = explicitSlug || extractSlugFromText(message.content?.text || "");
            if (!slug) {
                return {
                    success: false,
...
${details.latestVersion.changelog ? `**Changelog:** ${details.latestVersion.changelog}` : ""}`;
            ...
            if (callback)
                await callback({ text: boundedText });
            return {
                success: true,
                text: boundedText,
                data: {
...
//# sourceMappingURL=get-skill-details.js.map