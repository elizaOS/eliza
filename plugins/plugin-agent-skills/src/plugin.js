...
import { catalogAwarenessProvider, skillInstructionsProvider, skillsSummaryProvider, } from "./providers/skills";
// Services
...
export const agentSkillsPlugin = {
    ...
    init: async (_config, runtime) => {
        ...
        if (service) {
            ...
            runtime.logger.info(`AgentSkills: Ready — ${stats.loaded} skills loaded, ` +
