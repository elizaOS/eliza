...
export const enabledSkillsProvider = {
    name: "enabled_skills",
    description: "Canonical list of enabled, eligible skills with descriptions for USE_SKILL",
    ...
    get: async (runtime, _message, _state) => {
        try {
            ...
            const enabled = eligible.filter((skill) => service.isSkillEnabled(skill.slug));
            if (enabled.length === 0) {
                return { text: "" };
            }
...
//# sourceMappingURL=enabled-skills.js.map