 ...
 */
import { SKILL_COMPATIBILITY_MAX_LENGTH, SKILL_DESCRIPTION_MAX_LENGTH, SKILL_NAME_MAX_LENGTH, SKILL_NAME_PATTERN, } from "./types";
// ============================================================
// FRONTMATTER PARSING
// ============================================================
/**
...
function isSkillMetadata(value) {
    if (!isRecord(value)) {
        return false;
    }
...
function toSkillFrontmatter(value) {
 ...
 */
export function validateSkillDirectory(_path, content, directoryName) {
    const errors = [];
    const warnings = [];
    // Parse frontmatter
 ...
 */
export function generateSkillsJson(skills, options = {}) {
    if (skills.length === 0) {
        return "";
    }
