...
expiry, revision, and owner scope. The planner receives complete redacted stdout and stderr. Results beyond the
JavaScript string boundary fail explicitly before publication, without a partial
result. The opaque artifact survives process restart until expiry and
