...
plugins/plugin-coding-tools/
  src/
    ...
    lib/
      ...
      workspace-delta.ts           local Git workspace fingerprinting for the SHELL WorkspaceDeltaReceipt
