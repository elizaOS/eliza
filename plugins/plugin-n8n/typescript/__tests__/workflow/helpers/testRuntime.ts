...
import {
  ...
  N8nWorkflowService,
} from "../../../workflow/services/n8n-workflow-service";
import type { N8nPluginConfig } from "../../../workflow/types/index";
import { N8nApiClient } from "../../../workflow/utils/api";

/**
 * Interface to access private members of N8nWorkflowService for testing.
 * This allows type-safe testing without using `as any`.
 */
interface N8nWorkflowServiceTestable extends N8nWorkflowService {
  apiClient: N8nApiClient;
  serviceConfig: N8nPluginConfig;
  runtime: IAgentRuntime;
}

/**
 * Parameters for useModel calls
 */
...
export interface E2ETestConfig {
  ...
  useModelResponse?: (type: ModelType, params: UseModelParams) => Promise<unknown>;
...
export function createE2ERuntime(config: E2ETestConfig = {}) {
  ...
  const testableService = service as unknown as N8nWorkflowServiceTestable;
  testableService.apiClient = apiClient;
  testableService.serviceConfig = {
    apiKey: "test-api-key",
    host: "https://n8n.test",
  };
  ...
  testableService.runtime = runtime;
