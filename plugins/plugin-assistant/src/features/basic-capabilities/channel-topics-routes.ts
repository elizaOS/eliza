...
export const CHANNEL_TOPICS_SEARCH_ROUTE: Route = {
    ...
    description: "Search recent per-channel topics across all rooms; returns matching rooms ranked by relevance.",
    async handler(req, res, runtime) {
        ...
        const svc = runtime.getService("channel_topics") as (TopicSearchService & object) | null;
