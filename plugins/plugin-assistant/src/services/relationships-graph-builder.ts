...
function buildSummaries(
  ...
  return clusters.map((cluster) => {
    ...
    if (isOwner && ownerInfo.ownerEntityId) {
      ...
      if (ownerInfo.ownerExternalIdentity) {
        upsertProfile(profiles, {
          entityId: ownerInfo.ownerEntityId,
          source: ownerInfo.ownerExternalIdentity.source,
          userId: ownerInfo.ownerExternalIdentity.userId,
          displayName,
          canonical: true,
        });
      }
