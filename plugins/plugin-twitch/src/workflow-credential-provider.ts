...
export class TwitchWorkflowCredentialProvider extends Service {
  ...
  override capabilityDescription = 'Supplies Twitch credentials to the workflow plugin.';

  static async start(runtime: IAgentRuntime): Promise<TwitchWorkflowCredentialProvider> {
