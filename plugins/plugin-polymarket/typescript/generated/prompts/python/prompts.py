...
CHECK_ORDER_SCORING_TEMPLATE = """You are an AI assistant. Your task is to extract one or more order IDs for checking their scoring status.
...
GET_ACCOUNT_ACCESS_STATUS_TEMPLATE = """You are an AI assistant. Your task is to confirm if the user wants to check their Polymarket account access status, such as U.S. certification requirements.
...
GET_ACTIVE_ORDERS_TEMPLATE = """You are an AI assistant. Your task is to extract parameters for retrieving active orders for a specific market.
...
GET_BEST_PRICE_TEMPLATE = """You are an AI assistant. Your task is to extract token ID and side parameters for retrieving the best price for a market.
...
GET_MARKET_TEMPLATE = """You are an AI assistant. Your task is to extract market identification parameters from the user's message.
...
GET_MIDPOINT_PRICE_TEMPLATE = """You are an AI assistant. Your task is to extract token identification parameters for retrieving midpoint price data.
...
GET_ORDER_BOOK_DEPTH_TEMPLATE = """You are an AI assistant. Your task is to extract token identification parameters for retrieving order book depth data.
...
GET_ORDER_BOOK_TEMPLATE = """You are an AI assistant. Your task is to extract token identification parameters for retrieving order book data.
...
GET_ORDER_DETAILS_TEMPLATE = """You are an AI assistant. Your task is to extract the order ID for retrieving order details.
...
GET_PRICE_HISTORY_TEMPLATE = """Extract the token ID and interval from the user's message for getting price history.
...
GET_SAMPLING_MARKETS_TEMPLATE = """You are an AI assistant. Your task is to extract optional pagination parameters for retrieving Polymarket markets with rewards enabled (sampling markets).
...
GET_SIMPLIFIED_MARKETS_TEMPLATE = """You are an AI assistant. Your task is to extract optional pagination parameters for retrieving simplified Polymarket markets.
...
GET_SPREAD_TEMPLATE = """You are an AI assistant. Your task is to extract token identification parameters for retrieving spread data for a market.
...
GET_TRADE_HISTORY_TEMPLATE = """You are an AI assistant. Your task is to extract parameters for retrieving a user's trade history.
...
ORDER_TEMPLATE = """You are an AI assistant. Your task is to extract order parameters from the user's message.
...
RETRIEVE_ALL_MARKETS_TEMPLATE = """You are an AI assistant. Your task is to extract optional filter parameters for retrieving Polymarket prediction markets.
...
SETUP_WEBSOCKET_TEMPLATE = """Your task is to extract parameters for subscribing to Polymarket WebSocket channels from the user query.
...
__all__ = [
    "CHECK_ORDER_SCORING_TEMPLATE",
    "GET_ACCOUNT_ACCESS_STATUS_TEMPLATE",
    "GET_ACTIVE_ORDERS_TEMPLATE",
    "GET_BEST_PRICE_TEMPLATE",
    "GET_MARKET_TEMPLATE",
    "GET_MIDPOINT_PRICE_TEMPLATE",
    "GET_ORDER_BOOK_DEPTH_TEMPLATE",
    "GET_ORDER_BOOK_TEMPLATE",
    "GET_ORDER_DETAILS_TEMPLATE",
    "GET_PRICE_HISTORY_TEMPLATE",
    "GET_SAMPLING_MARKETS_TEMPLATE",
    "GET_SIMPLIFIED_MARKETS_TEMPLATE",
    "GET_SPREAD_TEMPLATE",
    "GET_TRADE_HISTORY_TEMPLATE",
    "ORDER_TEMPLATE",
    "RETRIEVE_ALL_MARKETS_TEMPLATE",
    "SETUP_WEBSOCKET_TEMPLATE",
]
