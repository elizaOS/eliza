 ...
 *
 *   - GUI / XR — the rich WebGL surface ({@link VectorBrowserView}) is the
 *     `componentExport`; the 3D point cloud (three.js) and the 2D canvas
 *     projection are INFEASIBLE in a terminal, so they stay GUI/XR-only.
