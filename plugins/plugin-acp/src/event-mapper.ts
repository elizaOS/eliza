...
import type { GatewayAttachment } from "./types.js";

/**
 * Extract text content from an array of ACP content blocks
 */
...
/**
 * Extract image attachments from an array of ACP content blocks
 */
...
/**
 * Format a tool call title from its name and arguments
 */
