...
export const inboxTriageProvider: Provider = {
  ...
  description:
    ...
    "Use MESSAGE action=triage/list_inbox/search_inbox/respond/draft_reply/send_draft for cross-channel triage, digest, and non-Gmail responses. Gmail search/read and saved reply drafts use the Gmail connector; Gmail never sends. " +
    "If the request is just 'my inbox', MESSAGE should use the cross-channel path.",
