...
export const formCreationTemplate = `# Task: Identify Form Type
...
export const FORM_CREATION_TEMPLATE = formCreationTemplate;

export const formExtractionTemplate = `# Task: Extract Form Field Values
