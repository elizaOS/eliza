...
export class PlatformManager {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      logger.error(`Platform detection failed: ${String(error)}`);
      throw error;
    }
  }
  ...
  private async detectGPU(): Promise<SystemGPU | null> {
    ...
    try {
      ...
      logger.error(`GPU detection failed: ${String(error)}`);
      return null;
    }
  }
  ...
  private async detectMacGPU(): Promise<SystemGPU> {
    try {
      ...
      logger.error(`Mac GPU detection failed: ${String(error)}`);
      return {
  ...
  private async detectWindowsGPU(): Promise<SystemGPU | null> {
    try {
      ...
      logger.error(`Windows GPU detection failed: ${String(error)}`);
      return null;
    }
  }
  ...
  private async detectLinuxGPU(): Promise<SystemGPU | null> {
    try {
      ...
      try {
        ...
        logger.error(`Linux GPU detection failed: ${String(error)}`);
        return null;
      }
    }
    return null;
