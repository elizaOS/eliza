/**
 * Auto-enable gate for the Agent Plugins client.
...
/** Enable when `config.features.agentPlugins` is truthy / not explicitly disabled. */
export function shouldEnable(ctx: PluginAutoEnableContext): boolean {
	return isFeatureEnabled(ctx.config, "agentPlugins");
}
