...
export type TunnelBackendCtor = typeof LocalTailscaleService | typeof CloudTailscaleService;
...
const ALLOWED_MODES: ReadonlySet<TailscaleBackendMode> = new Set(['local', 'cloud', 'auto']);
