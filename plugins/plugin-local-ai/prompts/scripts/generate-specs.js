...
function generateTypeScript(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `/**
 * Auto-generated canonical action/provider/evaluator docs for plugin-local-ai.
...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_local-ai", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-local-ai.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-local-ai action/provider/evaluator docs.");
}
