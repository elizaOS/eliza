...
use elizaos_plugin_edge_tts::types::{escape_xml, infer_extension, resolve_voice, speed_to_rate};
use elizaos_plugin_edge_tts::{
...
fn test_resolve_voice_preset_alloy() {
    assert_eq!(resolve_voice(Some("alloy"), "default"), "en-US-GuyNeural");
}
...
fn test_resolve_voice_preset_fable() {
    assert_eq!(resolve_voice(Some("fable"), "default"), "en-GB-RyanNeural");
}

#[test]
fn test_resolve_voice_preset_onyx() {
    assert_eq!(resolve_voice(Some("onyx"), "default"), "en-US-DavisNeural");
}

#[test]
fn test_resolve_voice_preset_nova() {
    assert_eq!(resolve_voice(Some("nova"), "default"), "en-US-JennyNeural");
}
