...
import { WaypointsService, WAYPOINTS_SERVICE_TYPE } from "../services/waypoints-service.js";
...
export const minecraftWaypointsProvider: Provider = {
  ...
  get: async (runtime: IAgentRuntime, _message: Memory, _state?: State): Promise<ProviderResult> => {
    ...
    if (!service) {
      return { text: "Waypoints service not available", values: { count: 0 }, data: { waypoints: [] } };
    }
