...
function generateTypeScript(actionsSpec, providersSpec) {
	...
	const content = `/**
 * Auto-generated canonical action/provider docs for plugin-groq.
...
function generateRust(actionsSpec, providersSpec) {
	...
	const content = `//! Auto-generated canonical action/provider docs for plugin-groq.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
	...
	console.log("Generated plugin-groq action/provider docs.");
}
