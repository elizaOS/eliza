...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_rss", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-rss.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-rss action/provider/evaluator docs.");
}
