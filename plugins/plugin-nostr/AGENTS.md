...
- **NIP-04 only:** Encryption uses `nostr-tools/nip04` (XOR-AES). NIP-44 (ChaCha20) is not implemented. DM content is always decrypted in-process; plaintext is never persisted by this plugin directly.
