/**
 * SMS thread presentation built from spatial primitives for the shipped GUI
 * view. It consumes a resolved snapshot plus an action callback; Android SMS
 * role checks and bridge calls stay in MessagesView.
 */
