...
const computerUseRoutes: Route[] = [
    ...
    ...(["pause", "resume", "stop"] as const).map((operation): Route => ({
        type: "POST",
    ...
    },
    {
        ...
        publicReason: "Approval event stream is consumed by the local approval UI before API auth.",
        handler: computerUseRouteHandler(),
    },
    {
        type: "POST",
...
export const computerUsePlugin: Plugin = {
    ...
    description: "Desktop automation — take screenshots, control mouse and keyboard, " +
    ...
    init: async (_pluginConfig, runtime) => {
        registerDirectActionRoutingRule(runtime, createComputerUseDirectRoutingRule());
    },
    ...
    views: [
        {
            ...
            description: "Live host, browser, sandbox, and remote-guest computer-use sessions",
            icon: "MonitorUp",
