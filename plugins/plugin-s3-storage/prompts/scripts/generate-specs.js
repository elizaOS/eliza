...
function generateTypeScript(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `/**
 * Auto-generated canonical action/provider/evaluator docs for plugin-s3-storage.
...
function generatePython(actionsSpec, providersSpec, evaluatorsSpec) {
  const outDir = path.join(PLUGIN_ROOT, "python", "elizaos_plugin_s3-storage", "generated", "specs");
  ensureDir(outDir);
...
function generateRust(actionsSpec, providersSpec, evaluatorsSpec) {
  ...
  const content = `//! Auto-generated canonical action/provider/evaluator docs for plugin-s3-storage.
//! DO NOT EDIT - Generated from prompts/specs/**.
...
function main() {
  ...
  console.log("Generated plugin-s3-storage action/provider/evaluator docs.");
}
