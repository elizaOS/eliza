#!/usr/bin/env bun
/**
 * Dual build script for @elizaos/plugin-memory (Node + Browser)
 */

const externalDeps = ["@elizaos/core", "drizzle-orm"];
...
async function build() {
  ...
  console.log("🔨 Building @elizaos/plugin-memory for Node...");
  ...
  console.log("🌐 Building @elizaos/plugin-memory for Browser...");
  ...
  console.log("🧱 Building @elizaos/plugin-memory for Node (CJS)...");
