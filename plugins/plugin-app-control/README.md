...
Contextual visual continuation is selected before planning from the authorized live view catalog. It adds navigation alongside domain work; opening Calendar never proves that an event was drafted or saved. The same turn receives the VIEWS navigation result before its final reply.
