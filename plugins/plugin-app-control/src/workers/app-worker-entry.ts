 ...
 * and statePath containment for fs after resolving symlinks. The
 * manifest-level `fs.read` and `fs.write` declarations currently authorize
 * the operation class; path narrowing is enforced by the per-app statePath
 * sandbox.
 */
