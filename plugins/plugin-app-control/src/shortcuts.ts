...
const VIEW_TARGET_PATTERN =
	"settings|notes?|calendar|agenda|schedule|inbox|messages|mailbox|mail|email|e-mail|emails|browser|web browser|wallet|app builder|task coordinator|home|home screen|home page|home dashboard|dashboard|main screen|main page|main chat|chat";
