    ...
    return {
        ...
        handler: async (runtime, message, _state, options, callback) => {
            ...
            switch (mode) {
                ...
                case "broadcast": {
                    const eventType = readStringOption(actionOptions, "eventType") ??
                    ...
                    const payload = actionOptions?.payload !== null &&
                ...
                case "interact": {
                    let viewId = readStringOption(actionOptions, "view") ??
                    ...
                    const params = actionOptions?.params !== null &&
                        typeof actionOptions?.params === "object" &&
                        !Array.isArray(actionOptions?.params)
                        ? actionOptions.params
                        : undefined;
                    const timeoutMs = typeof actionOptions?.timeoutMs === "number" &&
                ...
                case "pin": {
                    const pinViewId = readStringOption(actionOptions, "view") ??
                        readStringOption(actionOptions, "id") ??
                        readStringOption(actionOptions, "name");
                    if (!pinViewId) {
                ...
                case "window": {
                    const windowViewId = readStringOption(actionOptions, "view") ??
                        readStringOption(actionOptions, "id") ??
                        readStringOption(actionOptions, "name");
