...
function extractEditTarget(message, options) {
...
async function dispatchEditAgent({ runtime, view, intent, workdir, originRoomId, callback, }) {
...
// Public entry
// ---------------------------------------------------------------------------
export async function runViewsEdit({ runtime, message, options, views, callback, repoRoot, }) {
    ...
    if (!targetStr) {
        const text = 'Tell me which view to edit. Try: "edit the wallet view" or "update the LifeOps plugin".';
        await callback?.({ text });
        return { success: false, text };
    }
...
//# sourceMappingURL=views-edit.js.map