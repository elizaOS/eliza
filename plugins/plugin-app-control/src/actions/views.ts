/**
 * Discovers, opens, manages, and authors plugin-contributed views.
 * Sub-modes share owner checks and view resolution behind one planner action.
 */
