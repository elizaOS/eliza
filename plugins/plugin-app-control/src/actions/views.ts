...
export function createViewsAction(deps: ViewsActionDeps = {}): Action {
	...
	return {
		...
		description:
			"Manage UI views. List available views, report or close the current view, search views, show the view manager, arrange layouts, and invoke capabilities that a view declares, including Notes and native device controls. Use OPEN_VIEW to open or switch one surface. Calendar event reads and writes belong to CALENDAR.",
		descriptionCompressed:
			"manage/close/arrange views; invoke declared Notes/device capabilities; opening uses OPEN_VIEW; Calendar records use CALENDAR",
