...
export const appControlPlugin = {
	...
	async dispose(runtime) {
		await runtime.getService(VerificationRoomBridgeService.serviceType)?.stop();
		await runtime.getService(AppWorkerHostService.serviceType)?.stop();
		await runtime.getService(AppVerificationService.serviceType)?.stop();
		await runtime.getService(AppRegistryService.serviceType)?.stop();
	},
	views: [
		{
			id: "views-manager",
