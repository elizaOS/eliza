...
async function build(): Promise<void> {
  ...
  console.log("Building @elizaos/plugin-cerebras for Node...");
  ...
  console.log("Building @elizaos/plugin-cerebras for Browser...");
  ...
  console.log("Building @elizaos/plugin-cerebras for Node (CJS)...");
