...
```bash
bun run --cwd plugins/plugin-smartglasses lint
bun run --cwd plugins/plugin-smartglasses typecheck
bun run --cwd plugins/plugin-smartglasses test
bun run --cwd plugins/plugin-smartglasses build
