 ...
 */
import { buildRuntimeCapabilityNodes } from "@elizaos/core/automation-node-contributors";
...
import { type RuntimeCapabilityNodeSpec } from "@elizaos/core/automation-node-contributors";
...
export function buildWalletAutomationNodes({ runtime, }: AutomationNodeContributorContext): AutomationNodeDescriptor[] {
