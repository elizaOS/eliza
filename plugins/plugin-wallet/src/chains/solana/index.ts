...
import { SOLANA_WALLET_COMPAT_SERVICE_NAME } from "./service";
import { SolanaService } from "./service";
import { SolanaWalletService } from "./service";
...
export const solanaPlugin: Plugin = {
    ...
    async dispose(runtime: IAgentRuntime) {
        ...
        await solana?.stop();
        const wallet = runtime.getService<SolanaWalletService>(SOLANA_WALLET_COMPAT_SERVICE_NAME as ServiceTypeName);
        await wallet?.stop();
    },
};
