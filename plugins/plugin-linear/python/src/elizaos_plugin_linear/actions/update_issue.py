...
update_issue_action = create_action(
    ...
    examples=[
        [
            ActionExample(name="User", content={"text": 'Update issue ENG-123 title to "Fix login button"'}),
            ActionExample(name="Assistant", content={"text": "I'll update the title of issue ENG-123.", "actions": ["UPDATE_LINEAR_ISSUE"]}),
        ],
    ],
    validate=validate,
    handler=handler,
