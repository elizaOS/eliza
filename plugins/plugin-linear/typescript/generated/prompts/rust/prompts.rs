...
pub const CREATE_COMMENT_TEMPLATE: &str = r#"Extract comment details from the user's request to add a comment to a Linear issue.
...
pub const CREATE_ISSUE_TEMPLATE: &str = r#"Given the user's request, extract the information needed to create a Linear issue.
...
pub const DELETE_ISSUE_TEMPLATE: &str = r#"Given the user's request to delete/archive a Linear issue, extract the issue identifier.
...
pub const GET_ACTIVITY_TEMPLATE: &str = r#"Extract activity filter criteria from the user's request.
...
pub const GET_ISSUE_TEMPLATE: &str = r#"Extract issue identification from the user's request.
...
pub const LIST_PROJECTS_TEMPLATE: &str = r#"Extract project filter criteria from the user's request.
...
pub const LIST_TEAMS_TEMPLATE: &str = r#"Extract team filter criteria from the user's request.
...
pub const SEARCH_ISSUES_TEMPLATE: &str = r#"Extract search criteria from the user's request for Linear issues.
...
pub const UPDATE_ISSUE_TEMPLATE: &str = r#"Given the user's request to update a Linear issue, extract the information needed.
