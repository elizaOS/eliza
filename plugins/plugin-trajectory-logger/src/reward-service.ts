 ...
 * Delegates to @babylon/training's ArchetypeScoringService when available,
...
export class RewardService {
   ...
   *
   * For LLM-judge scoring, use @babylon/training's ArchetypeScoringService directly.
   *
  ...
  async scoreTrajectory(trajectory: Trajectory): Promise<number> {
    ...
    // If LLM scoring is needed, caller should use @babylon/training directly
