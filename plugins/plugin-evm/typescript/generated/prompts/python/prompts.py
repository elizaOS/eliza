...
BRIDGE_TEMPLATE = """Given the recent messages and wallet information below:
...
EXECUTE_PROPOSAL_TEMPLATE = """Given the recent messages and wallet information below:
...
PROPOSE_TEMPLATE = """Given the recent messages and wallet information below:
...
QUEUE_PROPOSAL_TEMPLATE = """Given the recent messages and wallet information below:
...
SWAP_TEMPLATE = """Given the recent messages and wallet information below:
...
TOKEN_BALANCE_TEMPLATE = """Extract the token ticker and blockchain from the user's message.
...
TRANSFER_TEMPLATE = """Given the recent messages and wallet information below:
...
VOTE_TEMPLATE = """Given the recent messages and wallet information below:
...
__all__ = [
    "BRIDGE_TEMPLATE",
    "EXECUTE_PROPOSAL_TEMPLATE",
    "PROPOSE_TEMPLATE",
    "QUEUE_PROPOSAL_TEMPLATE",
    "SWAP_TEMPLATE",
    "TOKEN_BALANCE_TEMPLATE",
    "TRANSFER_TEMPLATE",
    "VOTE_TEMPLATE",
]
