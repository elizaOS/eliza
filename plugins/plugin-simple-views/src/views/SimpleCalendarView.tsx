  ...
  return (
    <button
      ...
      style={{
        ...
        minWidth: 0,
        minHeight: "clamp(46px, 8vw, 72px)",
        border: selected
          ? "1px solid var(--accent, #ff6a1f)"
          : "1px solid color-mix(in srgb, var(--border, rgba(255,255,255,.14)) 82%, transparent)",
        borderRadius: 11,
        ...
        gap: 5,
        transition:
          "background 150ms ease, border-color 150ms ease, opacity 150ms ease",
      }}
    >
      <span
        style={{
