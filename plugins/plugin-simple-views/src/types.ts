/**
 * Shared domain contracts for the developer-only Notes and Simple Calendar
...
export const SIMPLE_VIEWS_MAX_COLLECTION_ITEMS = 100;
export const SIMPLE_VIEWS_MAX_TEXT_LENGTH = 4_000;
...
export function isStickyColor(value: unknown): value is StickyColor {
  return STICKY_COLORS.some((color) => color === value);
}
