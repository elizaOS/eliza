/**
 * PostgreSQL tables built from core abstract schemas.
...
// Dimension map for embeddings (previously in schema/embedding.ts)
...
export type EmbeddingTableColumn = (typeof embeddingTable)[EmbeddingDimensionColumn];
