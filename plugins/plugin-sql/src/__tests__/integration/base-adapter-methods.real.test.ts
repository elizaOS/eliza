...
describe("Base Adapter Methods Integration Tests", () => {
  ...
  describe("Error Handling", () => {
    it("should handle duplicate entity creation gracefully", async () => {
      ...
      // createEntities is idempotent: a duplicate id returns the EXISTING id, not
      // an empty array (base.ts createEntities, isDuplicateKeyError branch). This
      // assertion had drifted because the real suite ran in no CI lane (#10718).
