...
## Lifecycle agent scopes

`withAgentScope(agentId, callback)` creates a temporary transaction adapter for
trusted import/lifecycle work. Graph writes use the target agent; the importing
