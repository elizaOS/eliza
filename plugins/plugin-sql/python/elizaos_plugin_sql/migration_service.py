...
_SQLALCHEMY_IMPORT_ERROR: ModuleNotFoundError | None = None
...
try:
    ...
    # Allow importing schema helpers (e.g. derive_schema_name) in lightweight
...
def _require_sqlalchemy() -> None:
    ...
    raise ModuleNotFoundError(
        "sqlalchemy is required for elizaos_plugin_sql.migration_service. "
        "Install plugin dependencies (e.g. `pip install sqlalchemy alembic`)."
