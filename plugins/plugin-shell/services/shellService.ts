...
const DEFAULT_BACKGROUND_MS = clampNumber(
	readEnvInt("SHELL_BACKGROUND_MS"),
	10_000,
	10,
	120_000,
);
...
export class ShellService extends Service {
	...
	async exec(
		...
		const pendingMaxOutput =
			this.shellConfig.pendingMaxOutputChars ?? DEFAULT_PENDING_MAX_OUTPUT;
		const defaultBackgroundMs =
			this.shellConfig.defaultBackgroundMs ?? DEFAULT_BACKGROUND_MS;
