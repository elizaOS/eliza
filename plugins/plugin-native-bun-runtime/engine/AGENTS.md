...
bun run --cwd plugins/plugin-native-bun-runtime engine:check:strict
bun run --cwd plugins/plugin-native-bun-runtime engine:build:sim
bun run --cwd plugins/plugin-native-bun-runtime engine:build:device
bun run --cwd plugins/plugin-native-bun-runtime engine:smoke:sim
