...
- The bridge contract ABI is documented at `plugins/plugin-native-bun-runtime/engine/Sources/ElizaBunEngineShim/eliza_bun_engine.h`. Breaking changes bump `__ELIZA_BRIDGE_VERSION__`.
