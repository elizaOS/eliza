...
ERROR_ANALYSIS_TEMPLATE = """{{{mcpProvider.text}}}
...
FEEDBACK_TEMPLATE = """{{{mcpProvider.text}}}
...
RESOURCE_ANALYSIS_TEMPLATE = """{{{mcpProvider.text}}}
...
RESOURCE_SELECTION_TEMPLATE = """{{{mcpProvider.text}}}
...
TOOL_REASONING_TEMPLATE = """{{{mcpProvider.text}}}
...
TOOL_SELECTION_ARGUMENT_TEMPLATE = """{{recentMessages}}
...
TOOL_SELECTION_NAME_TEMPLATE = """{{mcpProvider.text}}
