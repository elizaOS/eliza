...
import { createToolSelectionFeedbackPrompt } from "./validation";
import { toolSelectionArgumentTemplate } from "@elizaos/shared";
import { toolSelectionNameTemplate } from "@elizaos/shared";
import { type HandlerCallback } from "@elizaos/core";
import { type IAgentRuntime } from "@elizaos/core";
import { type McpProvider } from "../types";
import { type Memory } from "@elizaos/core";
import { type State } from "@elizaos/core";
import { type ToolSelectionArgument } from "./schemas";
import { type ToolSelectionName } from "./schemas";
import { validateToolSelectionArgument } from "./validation";
import { validateToolSelectionName } from "./validation";
...
export async function createToolSelectionName({ runtime, state, message, callback, mcpProvider, }: CreateToolSelectionOptions): Promise<ToolSelectionName | null> {
...
export async function createToolSelectionArgument({ runtime, state, message, callback, mcpProvider, toolSelectionName, }: CreateToolSelectionOptions): Promise<ToolSelectionArgument | null> {
