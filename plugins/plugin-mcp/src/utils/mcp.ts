...
export async function createMcpMemory(runtime: IAgentRuntime, message: Memory, type: "tool" | "resource", serverName: string, content: string, metadata: Readonly<Record<string, unknown>>): Promise<void> {
    const memory: Memory = {
