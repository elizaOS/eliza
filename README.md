...
- 📞 **Voice Calling**: [ClawdTalk](https://clawdtalk.com) is an open-source project that enables voice calling for AI agents via [Telnyx](https://telnyx.com) infrastructure, and can integrate with ElizaOS through the plugin system. [GitHub](https://github.com/team-telnyx/clawdtalk-client).
