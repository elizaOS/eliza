...
Nearly every surface has a working example in [`packages/examples/`](packages/examples) — 30+ and growing. Each runs independently with its own README. It’s the fastest way to see the framework in action. See [Examples](#examples) below.
