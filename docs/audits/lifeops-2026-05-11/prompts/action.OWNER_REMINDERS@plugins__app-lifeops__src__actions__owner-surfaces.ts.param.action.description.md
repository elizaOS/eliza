# `action.OWNER_REMINDERS@plugins/app-lifeops/src/actions/owner-surfaces.ts.param.action.description`

- **Kind**: action-parameter
- **Owner**: plugins/app-lifeops
- **File**: `plugins/app-lifeops/src/actions/owner-surfaces.ts:230`
- **Token count**: 29
- **Last optimized**: never
- **Action**: OWNER_REMINDERS
