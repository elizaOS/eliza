# `action.FILE@plugins/plugin-coding-tools/src/actions/file.ts.param.old_string.description`
...
- **Action**: FILE
- **Parameter**: old_string (required: no)

## Current text
```
Exact substring to replace for action=edit.
```
