# `action.SKILL@plugins/plugin-agent-skills/src/actions/sync-catalog.ts.param.action.description`

- **Kind**: action-parameter
- **Owner**: plugins/plugin-agent-skills
- **File**: `plugins/plugin-agent-skills/src/actions/sync-catalog.ts:20`
- **Token count**: 31
