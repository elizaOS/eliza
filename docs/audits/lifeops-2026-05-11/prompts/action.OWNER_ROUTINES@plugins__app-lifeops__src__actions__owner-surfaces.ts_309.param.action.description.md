# `action.OWNER_ROUTINES@plugins/app-lifeops/src/actions/owner-surfaces.ts:309.param.action.description`

- **Kind**: action-parameter
- **Owner**: plugins/app-lifeops
- **File**: `plugins/app-lifeops/src/actions/owner-surfaces.ts:309`
- **Token count**: 29
