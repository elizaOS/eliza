# `planner.schema.baseline`

- **Kind**: planner
- **Task**: action_planner
- **Owner**: packages/core
- **File**: `packages/core/src/prompts/planner.ts:31`
- **Token count**: 189
...
- Repeated phrase: `{ type: "object", additionalproperties: false,` — appears more than once; consider deduping for token savings.
