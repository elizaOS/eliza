# `action.FILE@plugins/plugin-coding-tools/src/actions/file.ts.param.type.description`
...
- **Action**: FILE
- **Parameter**: type (required: no)

## Current text
```
Optional ripgrep file type for action=grep.
```
