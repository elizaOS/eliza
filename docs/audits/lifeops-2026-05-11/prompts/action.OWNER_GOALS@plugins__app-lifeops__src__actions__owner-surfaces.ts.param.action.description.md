# `action.OWNER_GOALS@plugins/app-lifeops/src/actions/owner-surfaces.ts.param.action.description`

- **Kind**: action-parameter
- **Owner**: plugins/app-lifeops
- **File**: `plugins/app-lifeops/src/actions/owner-surfaces.ts:256`
- **Token count**: 29
