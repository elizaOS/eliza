# `action.MESSAGE@packages/core/src/features/advanced-capabilities/actions/message.ts.param.action.description`
...
- Compressed variant exists (14 chars vs 256 chars — 95% shorter). Consider promoting it when planner cache pressure is high.
