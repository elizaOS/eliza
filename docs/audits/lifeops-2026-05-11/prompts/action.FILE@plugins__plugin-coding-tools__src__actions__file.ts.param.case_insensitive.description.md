# `action.FILE@plugins/plugin-coding-tools/src/actions/file.ts.param.case_insensitive.description`
...
- **Action**: FILE
- **Parameter**: case_insensitive (required: no)

## Current text
```
For action=grep, match case-insensitively.
```
