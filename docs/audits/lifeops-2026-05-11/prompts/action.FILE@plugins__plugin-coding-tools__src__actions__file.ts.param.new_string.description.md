# `action.FILE@plugins/plugin-coding-tools/src/actions/file.ts.param.new_string.description`
...
- **Action**: FILE
- **Parameter**: new_string (required: no)

## Current text
```
Replacement substring for action=edit.
```
