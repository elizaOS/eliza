# `action.ENTITY@plugins/app-lifeops/src/actions/entity.ts.param.toEntityId.description`
...
- **Action**: ENTITY
- **Parameter**: toEntityId (required: no)

## Current text
```
Target entity id for set_relationship.
```
