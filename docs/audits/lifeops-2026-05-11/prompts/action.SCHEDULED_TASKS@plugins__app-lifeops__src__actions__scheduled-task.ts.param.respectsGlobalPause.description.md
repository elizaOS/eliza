# `action.SCHEDULED_TASKS@plugins/app-lifeops/src/actions/scheduled-task.ts.param.respectsGlobalPause.description`
...
- **Parameter**: respectsGlobalPause (required: no)
