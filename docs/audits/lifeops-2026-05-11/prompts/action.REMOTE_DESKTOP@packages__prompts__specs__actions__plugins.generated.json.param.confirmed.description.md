# `action.REMOTE_DESKTOP@packages/prompts/specs/actions/plugins.generated.json.param.confirmed.description`
...
## Current text
```
Must be true for start (security sensitive).
```

## Compressed variant
```
true required for start (security)
```
