# `action.CHECK_AVAILABILITY@plugins/app-lifeops/src/actions/lib/scheduling-handler.ts.param.startAt.description`
...
- **Parameter**: startAt (required: yes)

## Current text
```
ISO-8601 start of the window to check.
```
