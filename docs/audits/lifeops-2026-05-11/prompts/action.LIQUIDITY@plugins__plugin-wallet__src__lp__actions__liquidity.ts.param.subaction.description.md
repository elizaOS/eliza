# `action.LIQUIDITY@plugins/plugin-wallet/src/lp/actions/liquidity.ts.param.subaction.description`

- **Kind**: action-parameter
- **Owner**: plugins/plugin-wallet
- **File**: `plugins/plugin-wallet/src/lp/actions/liquidity.ts:594`
- **Token count**: 6
