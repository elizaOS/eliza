# `action.TASKS@plugins/plugin-agent-orchestrator/src/actions/sandbox-stub.ts.param.keepAliveAfterComplete.description`
...
- **Action**: TASKS
- **Parameter**: keepAliveAfterComplete (required: no)
