# `action.FILE@plugins/plugin-coding-tools/src/actions/file.ts.param.offset.description`
...
- **Action**: FILE
- **Parameter**: offset (required: no)

## Current text
```
For action=read, zero-based line offset.
```
