# `planner.template.baseline`

- **Kind**: planner
- **Task**: action_planner
- **Owner**: packages/core
- **File**: `packages/core/src/prompts/planner.ts:3`
- **Token count**: 608
...
- Repeated phrase: `a relevant exposed tool can` — appears more than once; consider deduping for token savings.
