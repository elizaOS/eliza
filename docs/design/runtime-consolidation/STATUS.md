...
| Canonical action and turn contracts | Tool calls use `PlannerToolCall { id?, name, params? }`; legacy argument wrappers and aliases are removed. Action results require explicit success. TurnOutcome distinguishes completed/denied/cancelled/failed independently of delivery. |
