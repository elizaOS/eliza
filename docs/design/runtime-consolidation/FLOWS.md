...
| E2 | `MESSAGE_SENT` event | [plugins/plugin-assistant/src/features/basic-capabilities/index.ts](../../../plugins/plugin-assistant/src/features/basic-capabilities/index.ts) | Debug log of the sent message | assistant logging; envelope validation occurs before delivery |
...
| L1 | Log call / thrown failure | [core logger](../../../packages/core/src/logger.ts); core [packages/core/src/security/redact.ts](../../../packages/core/src/security/redact.ts) | Structured redacted log | core logger; preserve cyclic-object and secret handling |
