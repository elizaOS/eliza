...
samantha config at line 51). The same threshold is reused across all
...
voice clones (the samantha config) relax this to `0.55`
(`packages/training/scripts/kokoro/configs/kokoro_samantha.yaml:53`)
