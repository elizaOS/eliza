...
|--------------------------------------------------|-----------------------|------------------|------------------|--------|--------|--------|-------|-------|-------|-----------------------------|-------|
| eliza-1 LM (Qwen3.5 0.8B/2B/4B/9B + Qwen3.6 27B) | app                   | app              | app              | app    | app    | app    | app   | app   | yes   | yes (LLM_ARCH_QWEN3/QWEN35) | Baseline. PolarQuant + QJL + fused TurboQuant Q3/Q4 ship today. K-quant ladder Q3..Q8 via sibling `gguf-q{3,4,5,6}_k_m_apply.py` plus `gguf-q8_0_apply.py` (Q4 default; Q6/Q8 are release verification artifacts). |
