...
- [ ] Local state key: `eliza.lifeops.lastBriefingAt` in whatever local-state system the desktop already uses (check existing patterns first — do not add a new persistence layer).
