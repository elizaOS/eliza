        ...
        {combatants.map((combatant, index) => (
          ...
          >
            ...
            <div className="w-8 text-center">
              ...
              <div className="font-bold text-slate-200">{combatant.initiative}</div>
            </div>
            ...
            <div className="flex-1 min-w-0">
              <div className={clsx(
                ...
                combatant.type === 'pc' ? 'text-green-400' :
                combatant.type === 'npc' ? 'text-blue-400' :
                'text-red-400'
              )}>
                {combatant.name}
              </div>
            ...
            <div className="text-right">
              ...
              <div className={clsx(
                'font-bold',
                combatant.hp.current <= 0 ? 'text-red-500' :
                combatant.hp.current <= combatant.hp.max * 0.25 ? 'text-red-400' :
                combatant.hp.current <= combatant.hp.max * 0.5 ? 'text-yellow-400' :
                'text-green-400'
              )}>
