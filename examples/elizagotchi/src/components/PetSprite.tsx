...
import type { LifeStage, Mood, AnimationType } from "../game/types";
...
const EggSprite: React.FC<{ animation?: AnimationType }> = ({ animation }) => {
  ...
  return (
    <g className={wobbleClass}>
      ...
      {animation === "hatching" && (
        <>
          <path d="M35 50 L40 55 L35 60 L42 65" stroke="#8B4513" strokeWidth="2" fill="none" className="crack" />
          <path d="M60 45 L55 52 L62 58" stroke="#8B4513" strokeWidth="2" fill="none" className="crack" />
        </>
      )}
    </g>
  );
...
const BabySprite: React.FC<{ mood: Mood; animation?: AnimationType }> = ({ mood, animation }) => {
  const bounce = animation === "happy" || animation === "playing" ? "bouncing" : "";
  const eyeType = mood === "sleeping" ? "closed" : mood === "happy" ? "happy" : "normal";
  ...
  return (
    <g className={bounce}>
      ...
      {eyeType === "closed" ? (
        <>
          <path d="M40 60 Q45 64 50 60" stroke="#333" strokeWidth="2" fill="none" />
          <path d="M50 60 Q55 64 60 60" stroke="#333" strokeWidth="2" fill="none" />
        </>
      ) : eyeType === "happy" ? (
        <>
          <path d="M38 62 Q42 58 46 62" stroke="#333" strokeWidth="2.5" fill="none" />
          <path d="M54 62 Q58 58 62 62" stroke="#333" strokeWidth="2.5" fill="none" />
        </>
      ) : (
        <>
      ...
      {/* Mouth */}
      {mood === "happy" ? (
        <path d="M45 72 Q50 78 55 72" stroke="#333" strokeWidth="2" fill="none" />
      ) : mood === "sad" ? (
        <path d="M45 76 Q50 72 55 76" stroke="#333" strokeWidth="2" fill="none" />
      ) : (
...
const ChildSprite: React.FC<{ mood: Mood; animation?: AnimationType }> = ({ mood, animation }) => {
  const bounce = animation === "happy" || animation === "playing" ? "bouncing" : "";
  const eyeType = mood === "sleeping" ? "closed" : mood === "happy" ? "happy" : "normal";
  ...
  return (
    <g className={bounce}>
      ...
      {/* Ears */}
      <ellipse cx="30" cy="38" rx="8" ry="12" fill="url(#petGradient)" transform="rotate(-15 30 38)" />
      <ellipse cx="70" cy="38" rx="8" ry="12" fill="url(#petGradient)" transform="rotate(15 70 38)" />
      <ellipse cx="30" cy="38" rx="4" ry="7" fill="#FFB6C1" transform="rotate(-15 30 38)" />
      <ellipse cx="70" cy="38" rx="4" ry="7" fill="#FFB6C1" transform="rotate(15 70 38)" />
      ...
      {eyeType === "closed" ? (
        <>
          <path d="M38 55 Q44 60 50 55" stroke="#333" strokeWidth="2" fill="none" />
          <path d="M50 55 Q56 60 62 55" stroke="#333" strokeWidth="2" fill="none" />
        </>
      ) : eyeType === "happy" ? (
        <>
          <path d="M36 58 Q42 52 48 58" stroke="#333" strokeWidth="2.5" fill="none" />
          <path d="M52 58 Q58 52 64 58" stroke="#333" strokeWidth="2.5" fill="none" />
        </>
      ) : (
        <>
      ...
      {/* Mouth */}
      {mood === "happy" ? (
        <path d="M43 72 Q50 80 57 72" stroke="#333" strokeWidth="2" fill="none" />
      ) : mood === "sad" ? (
        <path d="M43 78 Q50 72 57 78" stroke="#333" strokeWidth="2" fill="none" />
      ) : mood === "hungry" ? (
...
const TeenSprite: React.FC<{ mood: Mood; animation?: AnimationType }> = ({ mood, animation }) => {
  const bounce = animation === "happy" || animation === "playing" ? "bouncing" : "";
  const eyeType = mood === "sleeping" ? "closed" : mood === "happy" ? "happy" : mood === "angry" ? "angry" : "normal";
  ...
  return (
    <g className={bounce}>
      ...
      {/* Ears */}
      <ellipse cx="25" cy="40" rx="10" ry="14" fill="url(#petGradient)" transform="rotate(-20 25 40)" />
      <ellipse cx="75" cy="40" rx="10" ry="14" fill="url(#petGradient)" transform="rotate(20 75 40)" />
      <ellipse cx="25" cy="40" rx="5" ry="8" fill="#FFB6C1" transform="rotate(-20 25 40)" />
      <ellipse cx="75" cy="40" rx="5" ry="8" fill="#FFB6C1" transform="rotate(20 75 40)" />
      ...
      {eyeType === "closed" ? (
        <>
          <path d="M35 50 Q42 56 49 50" stroke="#333" strokeWidth="2.5" fill="none" />
          <path d="M51 50 Q58 56 65 50" stroke="#333" strokeWidth="2.5" fill="none" />
        </>
      ) : eyeType === "happy" ? (
        <>
          <path d="M34 52 Q42 45 50 52" stroke="#333" strokeWidth="3" fill="none" />
          <path d="M50 52 Q58 45 66 52" stroke="#333" strokeWidth="3" fill="none" />
        </>
      ) : eyeType === "angry" ? (
        <>
      ...
      {/* Mouth */}
      {mood === "happy" ? (
        <path d="M40 70 Q50 82 60 70" stroke="#333" strokeWidth="2.5" fill="none" />
      ) : mood === "sad" ? (
        <path d="M40 78 Q50 70 60 78" stroke="#333" strokeWidth="2.5" fill="none" />
      ) : mood === "angry" ? (
...
const AdultSprite: React.FC<{ mood: Mood; animation?: AnimationType }> = ({ mood, animation }) => {
  const bounce = animation === "happy" || animation === "playing" || animation === "celebrating" ? "bouncing" : "";
  const eyeType = mood === "sleeping" ? "closed" : mood === "happy" ? "happy" : "normal";
  ...
  return (
    <g className={bounce}>
      ...
      {/* Ears */}
      <ellipse cx="22" cy="38" rx="12" ry="16" fill="url(#petGradient)" transform="rotate(-25 22 38)" />
      <ellipse cx="78" cy="38" rx="12" ry="16" fill="url(#petGradient)" transform="rotate(25 78 38)" />
      <ellipse cx="22" cy="38" rx="6" ry="10" fill="#FFB6C1" transform="rotate(-25 22 38)" />
      <ellipse cx="78" cy="38" rx="6" ry="10" fill="#FFB6C1" transform="rotate(25 78 38)" />
      ...
      {eyeType === "closed" ? (
        <>
          <path d="M32 48 Q40 55 48 48" stroke="#333" strokeWidth="3" fill="none" />
          <path d="M52 48 Q60 55 68 48" stroke="#333" strokeWidth="3" fill="none" />
        </>
      ) : eyeType === "happy" ? (
        <>
          <path d="M32 50 Q40 42 48 50" stroke="#333" strokeWidth="3" fill="none" />
          <path d="M52 50 Q60 42 68 50" stroke="#333" strokeWidth="3" fill="none" />
        </>
      ) : (
        <>
      ...
      {mood === "happy" ? (
        <>
          <path d="M38 68 Q50 82 62 68" stroke="#333" strokeWidth="2.5" fill="none" />
          <path d="M42 70 Q50 78 58 70" fill="#FF6B6B" />
        </>
      ) : mood === "sad" ? (
        <path d="M38 78 Q50 68 62 78" stroke="#333" strokeWidth="2.5" fill="none" />
      ) : (
        <path d="M42 72 Q50 76 58 72" stroke="#333" strokeWidth="2" fill="none" />
      )}
...
const ElderSprite: React.FC<{ mood: Mood; animation?: AnimationType }> = ({ mood, animation }) => {
  ...
  return (
    <g className={animation === "happy" ? "gentle-bounce" : ""}>
      ...
      {/* Droopy ears */}
      <ellipse cx="22" cy="50" rx="10" ry="18" fill="url(#elderGradient)" transform="rotate(-10 22 50)" />
      <ellipse cx="78" cy="50" rx="10" ry="18" fill="url(#elderGradient)" transform="rotate(10 78 50)" />
      ...
      {eyeType === "closed" ? (
        <>
          <path d="M34 52 Q40 56 46 52" stroke="#333" strokeWidth="2" fill="none" />
          <path d="M54 52 Q60 56 66 52" stroke="#333" strokeWidth="2" fill="none" />
        </>
      ) : (
        <>
...
const DeadSprite: React.FC = () => {
  return (
    <g className="floating">
      {/* Halo */}
      <ellipse cx="50" cy="15" rx="18" ry="5" fill="none" stroke="#FFD700" strokeWidth="3" />
      <ellipse cx="50" cy="15" rx="18" ry="5" fill="none" stroke="#FFF" strokeWidth="1" opacity="0.5" />
      ...
      {/* Wings */}
      <ellipse cx="20" cy="50" rx="15" ry="20" fill="rgba(255,255,255,0.6)" transform="rotate(-20 20 50)" />
      <ellipse cx="80" cy="50" rx="15" ry="20" fill="rgba(255,255,255,0.6)" transform="rotate(20 80 50)" />
      
      {/* Sparkles */}
      <circle cx="25" cy="35" r="2" fill="#FFD700" className="sparkle" />
      <circle cx="75" cy="40" r="2" fill="#FFD700" className="sparkle delay-1" />
      <circle cx="40" cy="80" r="1.5" fill="#FFD700" className="sparkle delay-2" />
      <circle cx="65" cy="85" r="1.5" fill="#FFD700" className="sparkle delay-3" />
    </g>
  );
};
...
const SickOverlay: React.FC = () => (
  <g className="sick-pulse">
    ...
    <path d="M75 38 Q77 43 75 48 Q73 43 75 38" fill="#87CEEB" className="delay-1" />
...
const SleepingOverlay: React.FC = () => (
  <g>
    <text x="65" y="30" fontSize="16" fill="#6495ED" className="zzz zzz-1">Z</text>
    <text x="72" y="22" fontSize="14" fill="#6495ED" className="zzz zzz-2">z</text>
    <text x="78" y="16" fontSize="12" fill="#6495ED" className="zzz zzz-3">z</text>
  </g>
);
