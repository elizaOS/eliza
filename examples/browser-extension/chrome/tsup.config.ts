...
console.log("[elizaOS] Offscreen bundle starting...");`,
    ...
    esbuildOptions(options) {
      ...
      options.alias = {
        ...
        "@elizaos/plugin-openai": resolvePackage("@elizaos/plugin-openai", "index.browser.ts"),
        "@elizaos/plugin-anthropic": resolvePackage("@elizaos/plugin-anthropic", "index.browser.ts"),
        "@elizaos/plugin-groq": resolvePackage("@elizaos/plugin-groq", "index.browser.ts"),
        "@elizaos/plugin-google-genai": resolvePackage("@elizaos/plugin-google-genai", "index.browser.ts"),
        "@elizaos/plugin-eliza-classic": resolvePackage("@elizaos/plugin-eliza-classic", "index.browser.ts"),
        "@elizaos/plugin-localdb": resolvePackage("@elizaos/plugin-localdb", "index.browser.ts"),
