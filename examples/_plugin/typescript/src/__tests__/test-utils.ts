 ...
 * Uses IAgentRuntime interface throughout - NO MockRuntime type.
 */
 ...
 * Uses IAgentRuntime interface - NO separate MockRuntime type.
 */
 ...
 * Returns IAgentRuntime mock objects (synchronous for backward compatibility).
 */
 ...
 * Now just an alias for IAgentRuntime - NO separate MockRuntime type.
 * @deprecated Use IAgentRuntime directly instead
 */
