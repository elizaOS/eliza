...
import type { LineData, ISeriesApi } from 'lightweight-charts';
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 border border-border px-3 py-2 text-xs text-foreground"
          >
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="border border-border bg-card p-4">
                <p className="text-xs text-muted-foreground">Lifetime P&L</p>
                <p
                  className={cn(
