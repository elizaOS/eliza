...
export const users = pgTable(
  'User',
  {
    ...
    riskTolerance: text('riskTolerance').$type<'conservative' | 'moderate' | 'aggressive'>().default('moderate'),
    maxPositionSize: decimal('maxPositionSize', { precision: 18, scale: 2 }).default('100'),
