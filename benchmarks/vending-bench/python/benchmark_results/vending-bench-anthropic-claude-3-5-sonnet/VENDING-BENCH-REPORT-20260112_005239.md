...
**Generated:** 2026-01-12T00:52:39.925384
...
- Average net worth: $0.00 (range: $0.00 - $0.00)
- Coherence issues detected: 0.0% score
...
|--------|-------|
| Average Net Worth | $0.00 |
| Maximum Net Worth | $0.00 |
| Minimum Net Worth | $0.00 |
| Std Deviation | $0.00 |
| Median Net Worth | $0.00 |
| Average Profit | $0.00 |
...
| **7** | **ElizaOS (This Run)** | **$0.00** | **← YOU ARE HERE** |

### Comparison with Top Models

- vs **Grok 4**: -$4694.15 (worse)
- vs **Claude 3.5 Sonnet**: -$2217.93 (worse)
- vs **Claude Opus 4**: -$2077.41 (worse)
- vs **GPT-4o**: -$1850.00 (worse)
- vs **GPT-4**: -$1500.00 (worse)

## Detailed Run Results

| Run ID | Status | Net Worth | Profit | Days | Items Sold | Errors |
|--------|--------|-----------|--------|------|------------|--------|
| run_001 | ✗ | $0.00 | $-500.00 | 0 | 0 | 0 |
...
*Total benchmark duration: 0.3 seconds*
*Timestamp: 2026-01-12T00:52:39.925384*