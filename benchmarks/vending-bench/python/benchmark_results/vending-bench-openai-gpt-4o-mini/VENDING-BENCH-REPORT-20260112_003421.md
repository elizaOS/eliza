...
**Generated:** 2026-01-12T00:34:21.672127
**Model:** gpt-4o-mini
**Version:** 1.0.0
...
| Metric | Value |
|--------|-------|
| **Best Net Worth** | $28.92 |
| **Average Net Worth** | $28.92 |
| **Profitability Rate** | 0% |
| **Coherence Score** | 76.6% |
| **Runs Completed** | 1/1 |

### Key Findings

- Performance needs improvement: only 0% profitable
- Average net worth: $28.92 (range: $28.92 - $28.92)
- Good coherence: 76.6% score
- Common error: loop_behavior (28 occurrences)
- Common error: duplicate_order (5 occurrences)
...
|--------|-------|
| Average Net Worth | $28.92 |
| Maximum Net Worth | $28.92 |
| Minimum Net Worth | $28.92 |
| Std Deviation | $0.00 |
| Median Net Worth | $28.92 |
| Average Profit | $-471.08 |
...
|--------|-------|
| Avg Items Sold | 20.0 |
| Avg Orders Placed | 12.0 |
| Avg Stockout Days | 2.0 |
...
| Metric | Value |
|--------|-------|
| Avg Tokens per Run | 299588 |
| Avg Tokens per Day | 9986 |
| Avg Latency per Action | 1132.4 ms |
...
| **7** | **ElizaOS (This Run)** | **$28.92** | **← YOU ARE HERE** |

### Comparison with Top Models

- vs **Grok 4**: -$4665.23 (worse)
- vs **Claude 3.5 Sonnet**: -$2189.01 (worse)
- vs **Claude Opus 4**: -$2048.49 (worse)
- vs **GPT-4o**: -$1821.08 (worse)
- vs **GPT-4**: -$1471.08 (worse)

## Detailed Run Results

| Run ID | Status | Net Worth | Profit | Days | Items Sold | Errors |
|--------|--------|-----------|--------|------|------------|--------|
| run_001 | ⚠ | $28.92 | $-471.08 | 30 | 20 | 34 |

## Coherence Analysis

**Overall Score:** 76.6%
**Interpretation:** Good - Occasional inconsistencies but generally coherent
**Average Errors per Run:** 34.0
...
*Total benchmark duration: 373.7 seconds*
*Timestamp: 2026-01-12T00:34:21.672127*