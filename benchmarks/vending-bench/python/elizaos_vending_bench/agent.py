...
- Always end each day with ADVANCE_DAY once you’ve finished any necessary actions (ordering, restocking, pricing, cash collection).
    ...
    async def run_day(
        ...
        for _action_num in range(max_actions):
            ...
            context_parts.append(
                f"[TODAY]\nplaced_order={placed_order_today}\ncollected_cash={collected_cash_today}"
            )
