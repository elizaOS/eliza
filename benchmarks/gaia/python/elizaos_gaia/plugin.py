...
async def multi_provider_model_handler(
    ...
    if provider_str and model_name:
        ...
        model_config.temperature = float(params.get("temperature", 0.7))
        model_config.max_tokens = int(params.get("max_tokens", params.get("maxTokens", 4096)))
    ...
    # Call the provider
    response_text, _ = await call_provider(model_config, messages)
