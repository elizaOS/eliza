...
const removedFacewearPackage = ["@elizaos/plugin", "facewear"].join("-");
const removedFacewearWorkspace = ["plugins/plugin", "facewear"].join("-");
...
const removedFacewearRegistryTest = ["facewear", "registry"].join("-");
const facewearPackage = "@elizaos/plugin-hearwear";
const facewearWorkspace = "plugins/plugin-hearwear";
