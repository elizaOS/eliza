...
const defaultTestGreps = [
  "desktop connectors$",
  "mobile connectors$",
  "desktop (chat|apps catalog|automations|browser)$",
  "desktop (character|character knowledge|wallet|settings)$",
  "desktop app tool (lifeops|tasks|plugins|skills)$",
  "desktop app tool (fine tuning|trajectories|relationships|memories)$",
  "desktop app tool (runtime|database|logs|companion)$",
  "desktop app tool (shopify|vincent)$",
  "mobile (chat|apps catalog|automations|wallet|settings)$",
  "mobile app tool (lifeops|plugins|skills|runtime|logs)$",
