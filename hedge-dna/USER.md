...
## Working preferences (inferred; refine live)

- Prefer concrete numbers, addresses, and files over hand-waving.  
- Lead with the answer; keep risk flags explicit.  
- Bold on local analysis; ask before external/irreversible actions.  
- Update this file when they correct you about name, timezone, or taste.
