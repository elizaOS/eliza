...
window is authorized by this contract. Direct voice messages use the same source-selection and restoration contract as text; original history and recordings remain complete.
