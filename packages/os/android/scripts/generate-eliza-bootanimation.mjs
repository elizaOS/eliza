...
// into bootanimation.zip by build-bootanimation.mjs (`make bootanimation`).
...
console.log(
  `Pack it with: node packages/scripts/distro-android/build-bootanimation.mjs --frames ${BOOTANIM_DIR} --out ${BOOTANIM_DIR}/bootanimation.zip`,
);
