...
import { parseArgs as parseBranded } from "../android/build-eliza-bootanimation.mjs";
import { parseArgs as parseGeneric } from "../distro-android/build-bootanimation.mjs";

const script = fileURLToPath(
  new URL("../distro-android/build-bootanimation.mjs", import.meta.url),
);
const branded = fileURLToPath(
  new URL("../android/build-eliza-bootanimation.mjs", import.meta.url),
);
