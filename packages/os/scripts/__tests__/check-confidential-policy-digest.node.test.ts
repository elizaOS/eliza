...
//   node --test scripts/__tests__/check-confidential-policy-digest.test.ts
...
import {
  ...
  computePolicyDigest,
} from "../check-confidential-policy.ts";
import { readJson, repoRoot, sha256CanonicalJson } from "../os-release-lib.ts";
