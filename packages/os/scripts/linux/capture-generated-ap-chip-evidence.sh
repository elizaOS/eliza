...
variant_dir="$(CDPATH='' cd -- "$(dirname -- "$0")/../../linux/elizaos" && pwd)"
...
payload: dict[str, object] = {
    ...
    "next_commands": [
        ...
        "make -C ../../../os/linux/elizaos stage-agent-artifacts ARCH=riscv64 RISCV64_RUNTIME=node && make -C ../../../os/linux/elizaos riscv64-agent-runtime-smoke && make -C ../../../os/linux/elizaos legacy-iso ARCH=riscv64 PROFILE=default",
        ...
        "ELIZA_GENERATED_AP_CHIP_BOOT_CMD='<real generated-AP boot command that prints serial transcript>' ../../scripts/linux/capture-generated-ap-chip-evidence.sh run",
...
../../scripts/linux/capture-generated-ap-chip-evidence.sh run
python3 ../../../chip/scripts/check_os_rv64_chip_boot_contract.py
EOF
}
...
preflight() {
	...
	if [ -z "$boot_cmd" ]; then
		...
		printf '    next: ../../scripts/linux/capture-generated-ap-chip-evidence.sh plan\n'
		write_blocked_report
...
run_capture() {
	...
	"$variant_dir/../../scripts/linux/capture-chip-boot-evidence.py" \
