...
class ReleaseManifestRuntimeEvidenceTests(unittest.TestCase):
                ...
                json.dumps(
                    {
                        ...
                        "status": "pass",
                        "failures": [],
                        "artifacts": "<repo>/linux/elizaos/artifacts/riscv64",
                        "transcript": (
    ...
    def test_report_payload_records_actionable_hash_mismatch(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("--iso linux/elizaos/out/elizaos-linux-riscv64-gui-test.iso", finding["next_command"])
