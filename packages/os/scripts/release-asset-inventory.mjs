...
export async function renderRecoveryPullRequestBody({
  ...
  const body = [
    ...
    "- [x] N/A - checksum recovery verifies release assets in CI but executes no application backend request path.",
    ...
    "- [x] N/A - the proposed manifest is the reviewed source diff and no runtime domain store is mutated.",
    "",
