...
//   node scripts/check-confidential-profile.ts [--release]
...
import { checkConfidentialLayer } from "./check-confidential-layer.ts";
import {
  checkConfidentialPolicy,
  checkPolicyDigestConsistency,
} from "./check-confidential-policy.ts";
import { checkDstackPins } from "./check-dstack-pins.ts";
import { readJson, repoRoot } from "./os-release-lib.ts";
import { verifyManifest } from "./verify-image-reproducibility.ts";
