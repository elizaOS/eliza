...
// host here — see linux/confidential/repro-build/README.md):
//
...
//   node scripts/verify-image-reproducibility.ts --input <manifest>
//   node scripts/verify-image-reproducibility.ts --build-a A --build-b B
