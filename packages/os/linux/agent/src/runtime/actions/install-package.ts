 ...
 * by substring.
 */
export const PACKAGE_GROUPS: ReadonlyArray<{
  readonly phrase: string;
  readonly packages: readonly string[];
}> = [
  {
    phrase: "i3 desktop",
    packages: ["i3", "i3status", "i3lock", "dmenu", "xterm"],
  },
  {
    phrase: "i3 setup",
    packages: ["i3", "i3status", "i3lock", "dmenu", "xterm"],
  ...
  {
    phrase: "minimalist i3",
    packages: ["i3", "i3status", "i3lock", "dmenu", "xterm"],
  },
  {
    phrase: "sway desktop",
    packages: ["sway", "swaybg", "swayidle", "swaylock", "foot", "wofi"],
  },
  {
  ...
  {
    phrase: "dev essentials",
    packages: ["build-essential", "git", "curl", "ripgrep", "fd-find"],
  },
  {
    phrase: "developer essentials",
    packages: ["build-essential", "git", "curl", "ripgrep", "fd-find"],
  },
  {
...
export function extractPackages(text: string): ExtractResult | null {
  ...
  if (
    tokens.length === 1 &&
    tokens[0] !== undefined &&
    NON_PACKAGE_TAILS.has(tokens[0])
  ) {
    return null;
  }
...
function readOptions(options: unknown): InstallRuntimeOptions {
  ...
  if (typeof o.aptCacheFn === "function")
    out.aptCacheFn = o.aptCacheFn as AptCacheFn;
...
export const INSTALL_PACKAGE_ACTION: Action = {
  ...
  handler: async (_runtime, message, _state, options, callback) => {
    ...
    if (extracted === null) {
      ...
      if (callback)
        await callback({ text: reply, actions: ["INSTALL_PACKAGE"] });
    ...
    if (callback)
      await callback({ text: flowReply.reply, actions: ["INSTALL_PACKAGE"] });
    return {
      success: true,
