...
function readSpawnOptions(options: unknown): SpawnOptions {
  ...
  const findBinary =
    typeof o["findBinary"] === "function"
      ...
      : undefined;
  const hasBwrap =
    typeof o["hasBwrap"] === "function"
      ? (o["hasBwrap"] as () => boolean)
      : undefined;
  const spawnFn =
    typeof o["spawnFn"] === "function"
      ...
      : undefined;
  const appIdSuffix =
    typeof o["appIdSuffix"] === "string"
      ? (o["appIdSuffix"] as string)
      : undefined;
  return {
  ...
  examples: [
    [
      { name: "{{user}}", content: { text: "open https://anthropic.com" } },
      {
        name: "Eliza",
        content: {
          text: "Opening it now — close the window when you're done.",
        },
      },
    ],
    [
