...
Seeded randomness, stable serialization and example-name selection are shared
primitives here. Builds prepare the publish manifest in dist so source conditions
resolve compiled files in release artifacts.
