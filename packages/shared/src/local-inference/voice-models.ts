...
export const VOICE_MODEL_VERSIONS: ReadonlyArray<VoiceModelVersion> = [
  {
    ...
    hfRepo: "elizalabs/eliza-1-voice-speaker-encoder",
    hfRevision: "main",
    ggufAssets: [],
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-diarizer",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-turn-detector",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-emotion",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-kokoro-samantha",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
    changelogEntry:
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-omnivoice",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-vad-silero",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-voice-wakeword",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
  ...
  },
  {
    ...
    version: "0.1.0",
    publishedToHfAt: "2026-05-14T00:00:00Z",
    hfRepo: "elizalabs/eliza-1-embedding",
    hfRevision: "main",
    ggufAssets: [],
    evalDeltas: { netImprovement: true },
