...
export type AgentModelSlot = "TEXT_SMALL" | "TEXT_LARGE" | "TEXT_EMBEDDING" | "TEXT_TO_SPEECH" | "TRANSCRIPTION";
/** Subset of `AgentModelSlot` that participates in text generation. */
export type TextGenerationSlot = Extract<AgentModelSlot, "TEXT_SMALL" | "TEXT_LARGE">;
export declare const AGENT_MODEL_SLOTS: AgentModelSlot[];
export declare const TEXT_GENERATION_SLOTS: TextGenerationSlot[];
/**
 ...
 */
export type LocalRuntimeKernel = "dflash" | "turbo3" | "turbo4" | "turbo3_tcq" | "qjl_full" | "polarquant" | "openvino";
/**
...
export type CatalogQuantizationId = "q3_k_m" | "q4_0" | "q4_k_m" | "q5_k_m" | "q6_k" | "q8_0";
...
export interface CatalogModel {
    ...
    params: "360M" | "0.1B" | "0.3B" | "0.5B" | "0.8B" | "1B" | "2B" | "3B" | "4B" | "7B" | "8B" | "9B" | "14B" | "16B" | "22B" | "24B" | "27B" | "32B";
    ...
    sourceModel?: {
        finetuned: false;
        components: Partial<Record<"text" | "voice" | "asr" | "vad" | "embedding" | "vision" | "drafter", {
            repo: string;
            file?: string;
        }>>;
    };
...
export interface LocalInferenceSlotReadiness {
    ...
    active: boolean;
    ready: boolean;
    state: "unassigned" | "missing" | "downloading" | "downloaded" | "active" | "failed" | "cancelled";
