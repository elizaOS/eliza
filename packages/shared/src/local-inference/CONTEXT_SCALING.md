...
| ----------------- | ----------------- | -----: | -------: | -------: | -------------------------------------: | ------------------- |
| `eliza-1-0_6b`    | Qwen3-0.6B        |     28 |        8 |      128 |                                  40960 | ~0.5 GB (Q3_K_M)    |
| `eliza-1-1_7b`    | Qwen3-1.7B        |     28 |        8 |      128 |                                  40960 | ~1.2 GB (Q4-class)  |
...
\* `eliza-1-4b` exists in `model_registry.py` (real, `Qwen/Qwen3-4B`) but **not
