...
for package_dir in packages/shared packages/cloud-sdk packages/skills; do
...
mkdir -p node_modules/@elizaos
rm -rf node_modules/@elizaos/shared node_modules/@elizaos/cloud-sdk node_modules/@elizaos/skills
