...
check "Snap retains hard-imported app-control workspace" grep -q '"plugin-app-control"' "$SCRIPT_DIR/snap/snapcraft.yaml"
check "Snap builds hard-imported app-control workspace" grep -q -- '--filter=@elizaos/plugin-app-control' "$SCRIPT_DIR/snap/snapcraft.yaml"
check "Snap retains hard-imported agent-orchestrator workspace" grep -q '"plugin-agent-orchestrator"' "$SCRIPT_DIR/snap/snapcraft.yaml"
check "Snap builds hard-imported agent-orchestrator workspace" grep -q -- '--filter=@elizaos/plugin-agent-orchestrator' "$SCRIPT_DIR/snap/snapcraft.yaml"
check "Snap retains hard-imported app-manager workspace" grep -q '"plugin-app-manager"' "$SCRIPT_DIR/snap/snapcraft.yaml"
check "Snap builds hard-imported app-manager workspace" grep -q -- '--filter=@elizaos/plugin-app-manager' "$SCRIPT_DIR/snap/snapcraft.yaml"
