...
export function ThemeToggle({
  ...
  const resolvedClassName =
    _variant === "titlebar"
      ? `inline-flex h-9 w-9 min-h-9 min-w-9 items-center justify-center rounded-md border border-transparent bg-transparent text-muted shadow-none ring-0 transition-[background-color,color,border-color] duration-150 hover:bg-accent/10 hover:text-txt ${className ?? ""}`
