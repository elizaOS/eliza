...
export function LanguageDropdown({
  ...
  const triggerClassNameResolved =
    variant === "titlebar"
      ? `relative inline-flex h-[2.375rem] min-h-[2.375rem] min-w-0 items-center justify-center rounded-md border border-transparent bg-transparent px-2.5 py-0 text-[11px] font-medium text-muted shadow-none ring-0 transition-colors duration-150 hover:text-txt after:absolute after:inset-x-2 after:bottom-0 after:h-[3px] after:rounded-t-full after:bg-accent/70 after:opacity-0 after:transition-opacity after:duration-150 hover:after:opacity-55 ${open ? "text-accent after:opacity-100" : ""} ${triggerClassName ?? ""}`
