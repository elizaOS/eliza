...
export type SecureStoreSecretKind = "wallet.evm_private_key" | "wallet.solana_private_key" | "steward.api_url" | "steward.agent_id" | "steward.agent_token";
export type SecureStoreUnavailableReason = "not_found" | "denied" | "unavailable" | "error";
 ...
 */
export type PlatformSecureStoreBackend = "macos_keychain" | "windows_credential_manager" | "linux_secret_service"
...
export interface PlatformSecureStore {
    ...
    get(vaultId: string, kind: SecureStoreSecretKind): Promise<SecureStoreGetResult>;
    set(vaultId: string, kind: SecureStoreSecretKind, value: string): Promise<SecureStoreSetResult>;
...
//# sourceMappingURL=platform-secure-store.d.ts.map