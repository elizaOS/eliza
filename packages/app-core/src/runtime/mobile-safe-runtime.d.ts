...
export declare function detectMobileSafeRuntimeFeatures(
  probe?: MobileSafeRuntimeFeatureProbe,
): MobileSafeRuntimeFeatures;
export declare function createAndroidAvfMicrodroidProvider(
  boundary?: AndroidAvfMicrodroidBoundary,
): MobileSafeRuntimeProvider;
export declare function createUnavailableMobileSafeRuntimeProvider(
  kind: MobileSafeRuntimeProviderKind,
  reason: string,
): MobileSafeRuntimeProvider;
export declare function createIosJavaScriptCoreProvider(
  boundary?: IosJavaScriptCoreBoundary,
): MobileSafeRuntimeProvider;
export declare function createIosQuickJsProvider(
  boundary?: IosQuickJsBoundary,
): MobileSafeRuntimeProvider;
export declare function createInProcessSafeJsAppletProvider(options?: {
  now?: () => number;
}): MobileSafeRuntimeProvider;
export declare function writeMobileSafeAppletManifest(
  files: MobileSafeVirtualFileSystem,
  manifest: MobileSafeAppletManifest,
  manifestPath?: string,
): Promise<MobileSafeAppletManifest>;
export declare function readMobileSafeAppletManifest(
  files: MobileSafeVirtualFileSystem,
  manifestPath?: string,
): Promise<MobileSafeAppletManifest>;
export declare function compileMobileSafeApplet(
...
export declare function createAndroidIsolatedProcessHook(
  options?: Partial<AndroidIsolatedProcessHook>,
): AndroidIsolatedProcessHook;
export declare function createAndroidIsolatedProcessProvider(
  boundary?: AndroidIsolatedProcessBoundary,
): MobileSafeRuntimeProvider;
export declare function createMobileSafeCapabilityBroker(
  handler: (
    request: MobileSafeRuntimeCapabilityRequest,
  ) =>
    | Promise<MobileSafeRuntimeCapabilityResponse>
...
export declare function createMobileSafeVirtualFileSystemBroker(
  files: MobileSafeVirtualFileSystem,
): MobileSafeCapabilityBroker;
...
export declare function createMobileSafeVirtualFileSystemAdapter(
...
export declare class MemoryMobileSafeVirtualFileSystem
