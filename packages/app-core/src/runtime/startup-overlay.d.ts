...
export declare function parseEmbeddingProgressPercent(
  detail: string | undefined,
): number | undefined;
export declare function updateStartupEmbeddingProgress(
 ...
 */
export declare function getStartupEmbeddingAugmentation(): Record<
  string,
  unknown
> | null;
