 ...
 */
export { _resetBuildVariantForTests, BUILD_VARIANTS, type BuildVariant, DEFAULT_BUILD_VARIANT, getBuildVariant, getDirectDownloadUrl, isDirectBuild, isStoreBuild, } from "@elizaos/core";
