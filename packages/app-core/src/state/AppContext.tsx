...
function AppProviderInner({
  ...
  const {
    state: {
      ...
      startupPhase,
      startupError,
      startupRetryNonce: _startupRetryNonce,
      authRequired,
      actionNotice,
      lifecycleBusy,
      lifecycleAction,
  ...
  const {
    ...
    pluginSaving,
    setPluginSaving: _setPluginSaving,
    pluginSaveSuccess,
    setPluginSaveSuccess: _setPluginSaveSuccess,
    loadPlugins,
    ensurePluginsLoaded,
    handlePluginToggle,
    ...
    skillCreating,
    setSkillCreating: _setSkillCreating,
    skillReviewReport,
    setSkillReviewReport,
    skillReviewId,
    setSkillReviewId,
    skillReviewLoading,
    setSkillReviewLoading: _setSkillReviewLoading,
    skillToggleAction,
    setSkillToggleAction: _setSkillToggleAction,
    skillsMarketplaceQuery,
    setSkillsMarketplaceQuery,
    skillsMarketplaceResults,
    setSkillsMarketplaceResults: _setSkillsMarketplaceResults,
    skillsMarketplaceError,
    setSkillsMarketplaceError: _setSkillsMarketplaceError,
    skillsMarketplaceLoading,
    setSkillsMarketplaceLoading: _setSkillsMarketplaceLoading,
    skillsMarketplaceAction,
    setSkillsMarketplaceAction: _setSkillsMarketplaceAction,
  ...
  const {
    ...
    setCharacterDraft: _setCharacterDraft,
    setCharacterSaveSuccess: _setCharacterSaveSuccess,
    setCharacterSaveError: _setCharacterSaveError,
    setSelectedVrmIndex,
    setCustomVrmUrl,
  ...
  const {
    ...
    setWalletError: _setWalletError,
    setRegistryError: _setRegistryError,
    setMintResult: _setMintResult,
    setMintError: _setMintError,
    loadWalletConfig,
    loadBalances,
    loadNfts,
  ...
  const {
    ...
    handleCloudLoginRef: _handleCloudLoginRef,
  } = cloudHook;
  ...
  const {
    ...
    restartBackend,
    relaunchDesktop,
    showDesktopNotification: _showDesktopNotification,
