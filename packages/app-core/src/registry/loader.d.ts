...
export declare function loadRegistryFromRawEntries(
  raws: RawEntry[],
): LoadedRegistry;
...
export declare function getConnectors(
...
export declare function getEntryByNpmName(
  registry: LoadedRegistry,
  npmName: string,
): RegistryEntry | undefined;
export declare function mergeWithRuntime(
