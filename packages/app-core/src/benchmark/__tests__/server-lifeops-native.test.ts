...
describe("LifeOps native tool-call bridge", () => {
  it("builds native model messages with the LifeOps clock/context and user text", () => {
  ...
  it("also accepts OpenAI-style snake_case tool_calls from compatibility layers", () => {
    const result = normalizeLifeOpsNativePlannerResult({
      text: "",
      tool_calls: [
        {
