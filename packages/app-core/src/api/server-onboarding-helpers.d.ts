 ...
 */
export declare function hasLegacyOnboardingRequestFields(body: Record<string, unknown>): boolean;
/**
 ...
 */
export declare function extractAndPersistOnboardingApiKey(body: Record<string, unknown>): Promise<string | null>;
export declare function persistCompatOnboardingDefaults(body: Record<string, unknown>): string | null;
export declare function deriveCompatOnboardingReplayBody(body: Record<string, unknown>): {
    isCloudMode: boolean;
