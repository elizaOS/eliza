 ...
 * `eliza_csrf` cookie.
 */
export declare function createBrowserSession(
  store: AuthStore,
 ...
 */
export declare function createMachineSession(
  store: AuthStore,
 ...
 */
export declare function findActiveSession(
  store: AuthStore,
  sessionId: string,
  now?: number,
...
export declare function revokeAllSessionsForIdentity(
 ...
 */
export declare function verifyCsrfToken(
  session: {
    id: string;
    csrfSecret: string;
  },
 ...
 */
export declare function serializeSessionCookie(
  session: {
    id: string;
    expiresAt: number;
  },
 ...
 * `x-eliza-csrf` header.
 */
export declare function serializeCsrfCookie(
  session: {
    id: string;
    csrfSecret: string;
    expiresAt: number;
...
export declare function serializeSessionExpiryCookie(
  options?: SerializeSessionCookieOptions,
): string;
/** Companion expiry cookie for `eliza_csrf`. */
export declare function serializeCsrfExpiryCookie(
  options?: SerializeSessionCookieOptions,
): string;
/**
 ...
 */
export declare function parseCookieHeader(
 ...
 */
export declare function parseSessionCookie(
