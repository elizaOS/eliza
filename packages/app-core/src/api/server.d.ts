...
export { __resetCloudBaseUrlCache, ensureCloudTtsApiKeyAlias, resolveCloudTtsBaseUrl, resolveElevenLabsApiKeyForCloudMode, } from "@elizaos/shared";
export { type CompatRuntimeState, DATABASE_UNAVAILABLE_MESSAGE, getConfiguredCompatAgentName, hasCompatPersistedOnboardingState, isLoopbackRemoteAddress, readCompatJsonBody, } from "./compat-route-shared";
 ...
 */
declare function clearCompatPgliteDataDir(runtime: AgentRuntime | null, config: ElizaConfig): Promise<void>;
export declare const _clearCompatPgliteDataDirForTests: typeof clearCompatPgliteDataDir;
export declare function handleElizaCompatRoute(req: http.IncomingMessage, res: http.ServerResponse, state: CompatRuntimeState): Promise<boolean>;
...
export declare function startApiServer(...args: Parameters<typeof upstreamStartApiServer>): Promise<Awaited<ReturnType<typeof upstreamStartApiServer>>>;
