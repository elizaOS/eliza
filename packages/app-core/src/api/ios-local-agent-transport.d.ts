...
export declare function isIosInProcessLocalAgentBase(baseUrl: string | null | undefined): boolean;
export declare function primeIosFullBunRuntime(runtime: unknown): void;
export declare function handleIosLocalAgentNativeRequest(options: IosLocalAgentNativeRequestOptions): Promise<IosLocalAgentNativeRequestResult>;
...
export declare function iosInProcessAgentTransportForUrl(url: string): Promise<AgentRequestTransport | null>;
