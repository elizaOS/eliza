...
export declare function clearCompatRuntimeRestart(
  state: CompatRuntimeState,
): void;
export declare function scheduleCompatRuntimeRestart(
  state: CompatRuntimeState,
  reason: string,
): void;
export declare const DATABASE_UNAVAILABLE_MESSAGE =
  "Database not available. The agent may not be running or the database adapter is not initialized.";
export declare function isLoopbackRemoteAddress(
 ...
 */
export declare function isTrustedLocalRequest(
  req: Pick<http.IncomingMessage, "headers" | "socket">,
): boolean;
export declare function readCompatJsonBody(
  req: http.IncomingMessage,
  res: http.ServerResponse,
): Promise<Record<string, unknown> | null>;
export declare function hasCompatPersistedOnboardingState(
  config: ElizaConfig,
): boolean;
 ...
 */
export declare function getCompatDrizzleDb(
  state: CompatRuntimeState,
): unknown | null;
