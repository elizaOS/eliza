...
export declare class AccountPool {
    ...
    markInvalid(accountId: string, detail?: string, opts?: {
        providerId?: PoolProviderId;
    }): Promise<void>;
    markHealthy(accountId: string, opts?: {
        providerId?: PoolProviderId;
    }): Promise<void>;
    /**
...
export declare function __getDefaultAccountPoolSelectionForTests(providerId: PoolProviderId): {
    strategy?: Strategy;
    accountIds?: string[];
};
export declare function configureDefaultAccountPoolSelection(config?: AccountPoolSelectionConfig): void;
/**
