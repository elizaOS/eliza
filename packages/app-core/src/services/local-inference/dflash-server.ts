...
export class DflashLlamaServer implements LocalInferenceBackend {
  ...
  /**
   * Scrape llama-server's `/metrics` endpoint and return cumulative
   * speculative-decoding counters. Returns null when the server is not
   * running, metrics are unreachable, or counters are absent.
   */
