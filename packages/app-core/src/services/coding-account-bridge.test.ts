 ...
 * active-generation discovery), usage attribution, and rate-limit skipping.
 * Runs against a real temp ELIZA_HOME / ELIZA_STATE_DIR and real
...
describe("coding-account-bridge", () => {
  ...
  it("returns no selection for the retired opencode agent type", async () => {
