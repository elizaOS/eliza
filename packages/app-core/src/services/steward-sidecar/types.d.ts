...
export declare const DEFAULT_PORT = 3200;
export declare const DEFAULT_MAX_RESTARTS = 5;
export declare const HEALTH_CHECK_INTERVAL_MS = 500;
...
export declare const DEFAULT_TENANT_ID = "elizaos-desktop";
export declare const DEFAULT_TENANT_NAME = "Desktop";
export declare const DEFAULT_AGENT_ID = "eliza-wallet";
export declare const DEFAULT_AGENT_NAME = "eliza-wallet";
