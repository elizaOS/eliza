 ...
 */
export declare function ensureWalletSetup(credentials: StewardCredentials | null, apiBase: string, masterPassword: string | undefined, dataDir: string, updateStatus: (partial: Partial<StewardSidecarStatus>) => void): Promise<StewardCredentials>;
