...
interface AuthSqlWhereSelectBuilder extends AuthSqlLimitedSelectBuilder, AuthSqlOrderedSelectBuilder, PromiseLike<AuthSqlRow[]> {
}
...
export declare class AuthStore {
    ...
    findIdentityByCloudUserId(cloudUserId: string): Promise<AuthIdentityRow | null>;
    findIdentityByDisplayName(displayName: string): Promise<AuthIdentityRow | null>;
     ...
     */
    revokeAllSessionsForIdentity(identityId: string, now?: number, exceptSessionId?: string): Promise<number>;
    /**
     ...
     */
    listSessionsForIdentity(identityId: string, now?: number): Promise<AuthSessionRow[]>;
    /**
    ...
    findOwnerBindingByPendingCodeHash(pendingCodeHash: string, instanceId: string): Promise<AuthOwnerBindingRow | null>;
    findOwnerBindingByConnectorPair(input: {
        connector: string;
        externalId: string;
        instanceId: string;
    }): Promise<AuthOwnerBindingRow | null>;
    listOwnerBindingsForIdentity(identityId: string): Promise<AuthOwnerBindingRow[]>;
    updateOwnerBindingPending(id: string, pendingCodeHash: string | null, pendingExpiresAt: number | null): Promise<void>;
    markOwnerBindingVerified(id: string, verifiedAt: number, displayHandle: string): Promise<void>;
    ...
    findOwnerLoginToken(tokenHash: string): Promise<AuthOwnerLoginTokenRow | null>;
    /**
