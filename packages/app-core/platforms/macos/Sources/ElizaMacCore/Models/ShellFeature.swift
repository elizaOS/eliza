...
public struct ShellFeature: Identifiable, Equatable, Sendable {
    ...
    public static let appDefaults: [ShellFeature] = [
        ...
        ShellFeature(id: "feed", title: "Feed", detail: "Feed prediction market operator dashboard.", systemImage: "cube", state: .planned, destination: .rendererAppRoute("/apps/feed")),
