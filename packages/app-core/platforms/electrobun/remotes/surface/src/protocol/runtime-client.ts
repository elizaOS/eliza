...
export type RuntimeRemoteBridge = {
	invoke: (
		targetId: string,
		method: string,
		params?: unknown,
...
type RuntimeGlobal = typeof globalThis & {
	__ELIZA_SURFACE_RUNTIME_BRIDGE__?: RuntimeRemoteBridge;
...
export class RuntimeRemoteClient {
	...
	private readonly bridge: RuntimeRemoteBridge | null;
	...
	constructor(
		options: { bridge?: RuntimeRemoteBridge; targetId?: string } = {},
	) {
...
function createDefaultBridge(): RuntimeRemoteBridge | null {
...
function toJsonValue(value: unknown): JsonValue | undefined {
	...
	throw new Error("Runtime Remote bridge params must be JSON-serializable.");
}
	...
	return {
		...
		message:
			code === "BRIDGE_UNAVAILABLE"
				? "Runtime Remote bridge is not available."
				: "Runtime Remote request failed.",
		details,
	};
}
