...
export type ModelSatelliteErrorCode =
...
export type ModelSatelliteError = {
	code: ModelSatelliteErrorCode;
	message: string;
	modelId?: string;
	path?: string;
	status?: number;
...
export type ModelWorkerResponseMessage =
	...
	| {
			...
			requestId: string | number;
			success: false;
			error: ModelSatelliteError;
	  };

export type ModelWorkerEventMessage = {
	type: "event";
	name: ModelEventName;
	payload: ModelResponsePayload | ModelSatelliteError;
};
