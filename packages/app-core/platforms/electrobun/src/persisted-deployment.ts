 ...
 * {@link PersistedDeployment} (runtime, remote API base, and the optional
 * credential already stored for that target). Best-effort and fail-safe: any missing file, parse error,
