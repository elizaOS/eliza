...
/**
 * macOS ships as the tray-owned assistant experience. Other desktop platforms
 * retain the ordinary Workspace window. The explicit runtime setting exists so
 * generic desktop development and specialized packaging can select either
 * contract without overloading ELIZA_DESKTOP_PROFILE (the bundle-size profile).
 */
