 ...
 * classified as a failure to its diagnostic level.
 *
 ...
 * for the level, so the policy lives in one tested place.
 */
export function httpErrorDiagnosticLevel(status: number): "warn" | "error" {
