...
| Documents render pieces | `plugins/plugin-knowledge/src/components/documents/KnowledgeDocumentsView.tsx` | Plugin-owned Knowledge surface; keep document meaning and route composition in `plugin-knowledge`. |
