...
async function invokeDesktopBridgeRequestWithTimeout(options) {
  ...
  const settledPromise = call.then(
    (value) => ({
      tag: "done",
      value,
    }),
...
export {
  ...
  __require as A,
  __toESM as j,
  getAppBlockerPlugin as r,
  getBackendStartupTimeoutMs as t,
  getCameraPlugin as i,
  getCanvasPlugin as a,
  getContactsPlugin as o,
  getDesktopPlugin as s,
  getDesktopRuntimeMode as y,
  getElectrobunRendererRpc as b,
  getGatewayPlugin as c,
  getLocationPlugin as l,
  getMessagesPlugin as u,
  getMobileSignalsPlugin as d,
  getNativePlugin as f,
  getPhonePlugin as p,
  getScreenCapturePlugin as m,
  getSwabblePlugin as h,
  getSystemPlugin as g,
  getTalkModePlugin as _,
  getWebsiteBlockerPlugin as v,
  inspectExistingElizaInstall as x,
  invokeDesktopBridgeRequest as S,
  invokeDesktopBridgeRequestWithTimeout as C,
  isElectrobunRuntime as n,
  require_index_cjs as E,
  require_jsx_runtime as D,
  scanProviderCredentials as w,
  subscribeDesktopBridgeEvent as T,
};
