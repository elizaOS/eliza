...
import {
	C as APP_CATALOG_SECTION_LABELS,
	L as AppHero,
	w as filterAppsForCatalog,
	T as findAppBySlug,
	V as getAllOverlayApps,
	E as getAppCatalogSectionKey,
	z as getAppCategoryIcon,
	D as getAppShortName,
	O as getAppSlug,
	j as getInternalToolAppDescriptors,
	M as getInternalToolAppHasDetailsPage,
	F as getInternalToolApps,
	N as getInternalToolAppTargetTab,
	P as getInternalToolAppWindowPath,
	x as getRunAttentionReasons,
	n as getWidgetComponent,
	k as groupAppsForCatalog,
	I as isInternalToolApp,
	W as isOverlayApp,
	G as overlayAppToRegistryInfo,
	B as resolveRuntimeImageUrl,
} from "./registry-B89cdzKO.js";
import {
	va as getAppSlugFromPath,
	ba as getWindowNavigationPath,
	Sa as isAppWindowRoute,
	qr as navigatePreOpenedWindow,
	Jr as openExternalUrl,
	Yr as preOpenWindow,
	ua as resolveApiUrl,
	Da as shouldUseHashNavigation,
	Pa as useBranding,
	pt as useTranslation,
...
function DesktopGameWindowControls({ gameWindowId }) {
	...
	const runAction = useCallback(
		async (id, action, successMessage, refreshAfter = true) => {
			setBusyAction(id);
			setError(null);
			setMessage(null);
			try {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime.jsx)(Button, {
				...
				children: t("gameview.RefreshNativeState", {
			...
			(0, import_jsx_runtime.jsx)(Button, {
				...
				children: t("gameview.SnapshotWindow", {
					defaultValue: "Snapshot Window",
				}),
			}),
			(0, import_jsx_runtime.jsx)(Button, {
				variant: "outline",
				...
				children: t("gameview.LaunchGpuDiagnostics", {
				...
				(0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
					children: [
						(0, import_jsx_runtime.jsx)(Button, {
							...
							children: t("gameview.ShowGpuWindow", {
						...
						(0, import_jsx_runtime.jsx)(Button, {
							...
							children: t("gameview.HideGpuWindow", {
...
function GameView() {
	...
	const handleAttachViewer = useCallback(async () => {
		...
		try {
			...
			setActionNotice(
				result.message ||
					t("gameview.ViewerAttached", { defaultValue: "Viewer attached." }),
				"success",
				2200,
			);
		} catch (err) {
	...
	const handleDetachViewer = useCallback(async () => {
		...
		try {
			...
			setActionNotice(
				result.message ||
					t("gameview.ViewerDetached", { defaultValue: "Viewer detached." }),
				"success",
				2200,
			);
		} catch (err) {
	...
	const handleStop = useCallback(async () => {
		...
		try {
			...
			setActionNotice(
				...
				stopResult.needsRestart ? 5e3 : 3200,
			);
		} catch (err) {
			setActionNotice(
	...
	const renderLogsPanel = (layout = "sidebar") =>
			...
			children: [
				(0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(Button, {
							...
							size: "sm",
							className:
								"h-6 text-2xs px-2 py-0 border-border bg-card hover:border-accent",
								...
								(0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										(0, import_jsx_runtime.jsxs)("span", {
											...
											children: [
												String(activeSessionState.telemetry.heroClass)
													.charAt(0)
													.toUpperCase() +
													String(activeSessionState.telemetry.heroClass).slice(
														1,
													),
												" ",
												"Lv",
										...
										(0, import_jsx_runtime.jsxs)("span", {
											...
											children: [
												String(activeSessionState.telemetry.heroLane ?? "?"),
												" lane",
											],
										}),
										...
										activeSessionState.telemetry.autoPlay
											? (0, import_jsx_runtime.jsx)("span", {
													className:
														"px-1 py-0.5 rounded bg-ok/15 text-ok font-semibold",
													children: "AUTO",
												})
											: (0, import_jsx_runtime.jsx)("span", {
													className:
														"px-1 py-0.5 rounded bg-muted/15 text-muted",
													children: "MANUAL",
												}),
									],
								}),
								...
								activeSessionState.telemetry.heroMaxHp > 0
									? (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												(0, import_jsx_runtime.jsx)("div", {
													className:
														"flex-1 h-1.5 bg-border rounded-full overflow-hidden",
								...
								activeSessionState.telemetry.strategyVersion != null
									? (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
													...
													children: [
														(0, import_jsx_runtime.jsxs)("span", {
															children: [
																"Strategy v",
																String(
																	activeSessionState.telemetry.strategyVersion,
																),
															],
														}),
												...
												activeSessionState.telemetry.abilityPriority
													? (0, import_jsx_runtime.jsxs)("div", {
															className: "text-3xs",
															children: [
																"Priority:",
													...
													: null,
												activeSessionState.telemetry.ticksTracked != null
													? (0, import_jsx_runtime.jsxs)("div", {
															className: "text-3xs",
															children: [
																String(
																	activeSessionState.telemetry.ticksTracked,
																),
																" ",
																"ticks tracked ·",
																" ",
																...
																" ",
																"abilities learned",
																activeSessionState.telemetry.survivalRate !=
																null
				...
				activeSessionState?.suggestedPrompts?.length
					? (0, import_jsx_runtime.jsx)("div", {
							...
							children: activeSessionState.suggestedPrompts
								.slice(0, 4)
								.map((prompt) =>
				...
				activeSessionState?.recommendations?.length
					? (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, import_jsx_runtime.jsx)("div", {
									className: "font-semibold text-txt",
									children: t("gameview.Recommendations", {
				...
				logLoadError
					? (0, import_jsx_runtime.jsx)("div", {
							className:
								"border-b border-danger/25 bg-danger/8 px-2 py-1.5 text-2xs text-danger",
				...
				(0, import_jsx_runtime.jsx)("div", {
					className:
						"flex-1 min-h-0 overflow-y-auto p-2 text-xs-tight font-mono",
					children:
						Array.isArray(activeSessionState?.telemetry?.recentActivity) &&
						(activeSessionState?.telemetry).recentActivity.length > 0
							? (activeSessionState?.telemetry).recentActivity
									.slice()
									.reverse()
									.slice(0, 30)
									.map((entry, idx) =>
							...
							: Array.isArray(activeSessionState?.activity) &&
													...
													children: [
														(0, import_jsx_runtime.jsxs)("div", {
															...
															children: [
																(0, import_jsx_runtime.jsx)("span", {
																	className: "text-muted text-2xs",
																	children: formatTime(entry.timestamp ?? 0, {
																		fallback: "—",
																	}),
																}),
																(0, import_jsx_runtime.jsx)("span", {
								...
								: gameLogs.length === 0
									...
									: gameLogs.slice(0, 50).map((entry, idx) =>
											(0, import_jsx_runtime.jsxs)(
												"div",
												{
													className: "py-1 flex flex-col gap-0.5",
	...
	const renderViewerPane = () => {
		if (!hasViewer)
			return (0, import_jsx_runtime.jsxs)("div", {
				className:
					"flex h-full flex-col items-center justify-center gap-3 bg-bg px-6 text-center",
				children: [
					(0, import_jsx_runtime.jsx)("div", {
					...
					(0, import_jsx_runtime.jsx)("div", {
						...
						children:
							"This run is alive, but it does not currently expose a viewer URL. You can keep steering it from the dashboard and running-runs panel.",
					}),
				],
			});
		if (!viewerAttached)
			return (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, import_jsx_runtime.jsx)("div", {
						className: "max-w-md text-xs leading-6 text-muted",
						children:
							"The autonomous run is still active. Reattach the viewer to resume watching without restarting the session.",
					}),
					(0, import_jsx_runtime.jsx)("div", {
		...
		if (useNativeGameWindow)
			return (0, import_jsx_runtime.jsx)("div", {
				className:
					"w-full h-full flex flex-col items-center justify-center bg-bg text-muted gap-3",
				children: gameWindowId
					? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
							children: [
								(0, import_jsx_runtime.jsx)("span", {
									className: "text-sm font-semibold text-txt",
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							activeRunSummary
								? (0, import_jsx_runtime.jsx)("div", {
										className:
											"mt-1 max-w-3xl truncate text-xs-tight leading-5 text-muted-strong",
					...
					canDetachViewer
						...
						: null,
					useNativeGameWindow
						? (0, import_jsx_runtime.jsx)(DesktopGameWindowControls, {
								gameWindowId,
							})
						: null,
					hasViewer
						? (0, import_jsx_runtime.jsx)(Button, {
								...
								className: "h-7 text-xs shadow-sm hover:border-accent",
								onClick: () =>
									setState("gameOverlayEnabled", !gameOverlayEnabled),
								title: gameOverlayEnabled
									? t("game.disableOverlay")
									: t("game.keepVisible"),
								children: gameOverlayEnabled
									? t("game.unpinOverlay")
									: t("game.keepOnTop"),
							})
						: null,
			...
			showDiagnostics
				? (0, import_jsx_runtime.jsxs)("div", {
						className:
							"border-t border-border/30 bg-card/70 px-4 py-2 text-xs-tight leading-5 text-muted-strong",
						children: [
							(0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									diagnostics.map((item) =>
										(0, import_jsx_runtime.jsxs)(
											...
											{
												className:
													"rounded-full border border-border/35 bg-bg/65 px-2.5 py-1",
												children: [
													(0, import_jsx_runtime.jsxs)("span", {
														className: "text-muted",
														children: [item.label, ": "],
			...
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					!dashboardPanelEnabled || !isCompactLayout || mobileSurface === "game"
						? (0, import_jsx_runtime.jsx)("div", {
...
function resolveCardsPerRow(width) {
	...
	return clampCardsPerRow(
		Math.floor((width + CARD_GAP_PX) / (MIN_CARD_WIDTH_PX + CARD_GAP_PX)),
	);
}
		...
		while (sectionIndex < sections.length) {
			...
			if (usedSlots === 0) {
				...
				if (
					...
					if (
						minSlots +
							resolveSectionMinSlots(nextSection.apps.length, rowCapacity) <=
						rowCapacity
					)
						slots = minSlots;
				}
...
function CatalogSkeletonSection({ label, rowSizes }) {
	...
	return (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime.jsx)(Skeleton, {
						className: "h-3 w-28 rounded-full bg-bg-accent/80",
					}),
					(0, import_jsx_runtime.jsx)("div", {
			...
			(0, import_jsx_runtime.jsx)("div", {
				className: "space-y-2",
				children: rowDescriptors.map((rowDescriptor) =>
					(0, import_jsx_runtime.jsx)(
						"div",
						{
							...
							children: rowDescriptor.cardKeys.map((cardKey) =>
								(0, import_jsx_runtime.jsxs)(
									"div",
									{
										className:
											"overflow-hidden rounded-2xl border border-border/35 bg-card/72",
										children: [
											(0, import_jsx_runtime.jsx)(Skeleton, {
												className:
													"aspect-[4/3] w-full rounded-none bg-bg-accent/70",
											}),
											(0, import_jsx_runtime.jsx)("div", {
												className: "space-y-2 px-3 py-3",
												children: (0, import_jsx_runtime.jsx)(Skeleton, {
													className: "h-3 w-2/3 rounded-full bg-bg-accent/80",
												}),
											}),
										],
									},
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			error
				? (0, import_jsx_runtime.jsx)("div", {
						className:
							"mb-4 rounded-xl border border-danger/30 bg-danger/10 px-3 py-2 text-xs-tight text-danger",
						children: error,
					})
				: null,
			loading
				...
				: visibleApps.length === 0
					? (0, import_jsx_runtime.jsx)("div", {
							className:
								"rounded-2xl border border-dashed border-border/35 bg-card/72 px-6 py-16 text-center",
							children: (0, import_jsx_runtime.jsx)("div", {
							...
							children: sectionRows.map((sectionRow) => {
								...
								return (0, import_jsx_runtime.jsx)(
									"div",
									{
										...
										children: sectionRow.sections.map((section) =>
											(0, import_jsx_runtime.jsxs)(
												"section",
												{
																...
																return (0, import_jsx_runtime.jsx)(
																	"div",
																	{
																		...
																		children: row.map((app) => {
																			const isActive = activeAppNames.has(
																				app.name,
																			);
																								...
																								children: [
																									(0, import_jsx_runtime.jsx)(
																										AppHero,
																										{
																											app,
																											className:
																												"aspect-[4/3] transition-transform duration-300 group-hover:scale-[1.02]",
																										},
																									),
																									(0, import_jsx_runtime.jsx)(
																										"div",
																										{
																											className:
																												"pointer-events-none absolute inset-x-0 bottom-0 flex items-end p-2 pe-10",
																											children: (0,
																											import_jsx_runtime.jsx)(
																												"div",
																												{
																													...
																													import_jsx_runtime.jsx)(
																														...
																														{
																															className:
																																"truncate text-xs font-semibold text-white drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)]",
																															children:
																																displayName,
																														},
																													),
																						...
																						isActive
																							? (0, import_jsx_runtime.jsx)(
																									"span",
																									{
																										title: "Running",
																										className:
																											"pointer-events-none absolute right-4 top-4 h-2.5 w-2.5 rounded-full bg-ok shadow-[0_0_0_3px_rgba(16,185,129,0.35)]",
																									},
																								)
																							: null,
																						(0, import_jsx_runtime.jsx)(
...
const GENRE_ORDER = ["games", "finance", "developerUtilities", "other"];
			...
			children: (0, import_jsx_runtime.jsx)(SidebarPanel, {
				...
				children: !(
					...
					: (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								starredEntries.length > 0 &&
									(0, import_jsx_runtime.jsx)(AppsSidebarSection, {
										label: "Starred",
										icon: (0, import_jsx_runtime.jsx)(Star, {
											className: "h-3 w-3",
											"aria-hidden": true,
										}),
										children: starredEntries.map((app) =>
											(0, import_jsx_runtime.jsx)(
								...
								featuredEntries.length > 0 &&
									(0, import_jsx_runtime.jsx)(AppsSidebarSection, {
										...
										children: featuredEntries.map((app) =>
											(0, import_jsx_runtime.jsx)(
												AppsSidebarAppButton,
												{
													name: app.name,
								...
								activeEntries.length > 0 &&
									(0, import_jsx_runtime.jsx)(AppsSidebarSection, {
										...
										children: activeEntries.map(({ run, app, displayName }) =>
											(0, import_jsx_runtime.jsx)(
												AppsSidebarAppButton,
												{
													name: run.appName,
...
function AppsSidebarSection({ label, icon, children }) {
	return (0, import_jsx_runtime.jsxs)("div", {
		children: [
			(0, import_jsx_runtime.jsxs)(SidebarContent.SectionLabel, {
		...
		children: [
			...
			active
				? (0, import_jsx_runtime.jsx)("span", {
						...
						className:
							"h-1.5 w-1.5 shrink-0 rounded-full bg-ok shadow-[0_0_0_2px_rgba(16,185,129,0.25)]",
					})
				: null,
		],
	});
		...
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime.jsx)("h2", {
						className:
							"text-xs-tight font-semibold uppercase tracking-[0.18em] text-accent",
						children: "Running",
					}),
					(0, import_jsx_runtime.jsx)("div", {
						className: "h-px flex-1 bg-border/30",
				...
				children: runs.map((run) => {
					...
					return (0, import_jsx_runtime.jsxs)(
						"div",
						{
							...
							className:
								"group relative overflow-hidden rounded-2xl border border-accent/35 bg-card/72 shadow-[0_8px_24px_-12px_rgba(0,0,0,0.4)] transition-all hover:border-accent/55 focus-within:ring-2 focus-within:ring-accent/35",
							children: [
								(0, import_jsx_runtime.jsxs)("button", {
									type: "button",
									...
									onClick: () => onOpenRun(run),
									children: [
										(0, import_jsx_runtime.jsx)(AppHero, {
											app,
											className:
												"aspect-[5/4] transition-transform duration-300 group-hover:scale-[1.02]",
										}),
										(0, import_jsx_runtime.jsx)("div", {
											className:
												"pointer-events-none absolute inset-x-0 bottom-0 flex items-end p-4 pe-12",
											children: (0, import_jsx_runtime.jsx)("div", {
												className: "min-w-0 flex-1",
												children: (0, import_jsx_runtime.jsx)("div", {
													className:
														"truncate text-sm font-semibold text-white drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)]",
								...
								needsAttention
									? (0, import_jsx_runtime.jsx)("span", {
											...
											className:
												"pointer-events-none absolute right-10 top-3.5 inline-flex items-center rounded-full border border-warn/40 bg-black/40 px-2 py-0.5 text-[0.56rem] font-semibold uppercase tracking-[0.2em] text-warn backdrop-blur-sm",
											children: "!",
										})
									: null,
								onStopRun
									? (0, import_jsx_runtime.jsx)("button", {
											...
											disabled: isStopping,
											className:
												"absolute bottom-3 right-3 inline-flex h-8 w-8 items-center justify-center rounded-full bg-black/40 text-white/90 backdrop-blur-sm transition-all hover:bg-danger/80 hover:text-white disabled:cursor-not-allowed disabled:opacity-50",
											onClick: (event) => {
												event.stopPropagation();
												onStopRun(run);
											},
											children: isStopping
												? (0, import_jsx_runtime.jsx)("span", {
														className:
															"h-2 w-2 animate-pulse rounded-full bg-white",
													})
												: (0, import_jsx_runtime.jsx)(Square, {
														className: "h-3.5 w-3.5",
														"aria-hidden": true,
													}),
										})
...
function sanitizeSettings(value) {
	...
	const next = {};
	for (const [key, raw] of Object.entries(value))
		if (typeof key === "string" && key.length > 0) next[key] = raw;
	return next;
}
	...
	return (0, import_jsx_runtime.jsx)("div", {
		...
		children: items.map((item) =>
			(0, import_jsx_runtime.jsx)(
				...
				{
					className:
						"rounded-full border border-border/60 bg-card/50 px-2 py-0.5 text-xs text-muted",
					children: item,
				},
				item,
			),
...
function WidgetPreview({ declaration, pluginId }) {
	...
	if (!Component)
		return (0, import_jsx_runtime.jsx)("div", {
			className:
				"rounded-md border border-border/40 bg-card/30 px-3 py-2 text-xs text-muted",
...
function AppDetailsView({ slug, onLaunched }) {
	...
	const updateConfig = useCallback(
		(next) => {
			const merged = {
				...
				alwaysOnTop:
					next.alwaysOnTop !== void 0 ? next.alwaysOnTop : config.alwaysOnTop,
	...
	const widgets = useMemo(() => {
		if (!resolved) return [];
		return (
			plugins?.find((p) => p.id === resolved.pluginId)?.widgets ?? []
		).map((decl) => ({
			...decl,
			slot: decl.slot,
		}));
		...
		try {
			if (config.launchMode === "inline") {
				...
				if (
					...
					isOverlayLaunchApp$1(resolved.info)
				) {
	...
	if (catalogError && !resolved)
		return (0, import_jsx_runtime.jsxs)("div", {
			className:
				"flex h-full min-h-0 w-full flex-col items-center justify-center gap-2 p-6 text-center text-sm text-muted",
			children: [
				(0, import_jsx_runtime.jsx)(TriangleAlert, {
					className: "h-5 w-5 text-accent",
				}),
				(0, import_jsx_runtime.jsx)("span", { children: catalogError }),
			],
		});
	if (!resolved)
		return (0, import_jsx_runtime.jsxs)("div", {
			className:
				"flex h-full min-h-0 w-full items-center justify-center text-sm text-muted",
			children: ["Loading ", slug, "…"],
		});
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		className:
			"device-layout mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-6 lg:px-6",
		children: [
					...
					children: [
						resolved.info.heroImage
							? (0, import_jsx_runtime.jsx)("img", {
									...
									alt: "",
									className:
										"h-14 w-14 rounded-lg border border-border/40 object-cover",
								})
							: (0, import_jsx_runtime.jsx)("div", {
									className:
										"flex h-14 w-14 items-center justify-center rounded-lg border border-border/40 bg-card/40 text-xs uppercase text-muted",
						...
						(0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								(0, import_jsx_runtime.jsxs)("div", {
									className:
										"mt-1 flex flex-wrap items-center gap-2 text-[10px] uppercase tracking-[0.16em] text-muted",
									children: [
										(0, import_jsx_runtime.jsx)("span", {
											children: sourceLabel(resolved.source),
										}),
										recentRuns.length > 0
											? (0, import_jsx_runtime.jsxs)("span", {
													className:
			...
			(0, import_jsx_runtime.jsxs)("section", {
				...
				className:
					"flex flex-col gap-4 rounded-lg border border-border/45 bg-card/30 p-4",
				children: [
					(0, import_jsx_runtime.jsxs)("div", {
						className:
						...
						children: [
							...
							(0, import_jsx_runtime.jsxs)("button", {
								...
								disabled: launching,
								className:
									"inline-flex items-center justify-center gap-2 rounded-full bg-accent px-5 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-accent-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60",
								children: [
									(0, import_jsx_runtime.jsx)(Rocket, {
										className: "h-3.5 w-3.5",
										"aria-hidden": "true",
									}),
									launching
					...
					sessionFeatures.length > 0
						? (0, import_jsx_runtime.jsx)("div", {
								className: "flex flex-wrap gap-1.5",
								children: sessionFeatures.map((feature) =>
									(0, import_jsx_runtime.jsx)(
										"span",
										{
											className:
					...
					latestFailure
						? (0, import_jsx_runtime.jsxs)("div", {
								className:
									"rounded-md border border-destructive/30 bg-destructive/10 px-3 py-2 text-xs text-muted",
								children: [
									(0, import_jsx_runtime.jsx)("span", {
					...
					(0, import_jsx_runtime.jsxs)("fieldset", {
						className:
							"flex flex-col gap-2 rounded-md border border-border/40 bg-bg/20 p-3",
						children: [
							(0, import_jsx_runtime.jsxs)("legend", {
								className:
									"px-1 text-xs uppercase tracking-[0.14em] text-muted",
								children: [
							...
							(0, import_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									(0, import_jsx_runtime.jsxs)("span", {
										children: [
											"Main window",
											!supportsInlineMode ? " (not supported)" : "",
										],
									}),
								],
							}),
					...
					(0, import_jsx_runtime.jsxs)("label", {
						...
						children: [
							...
							(0, import_jsx_runtime.jsx)("span", {
								children: "Keep this app's window on top",
							}),
						],
					}),
				],
			...
			(0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					resolved.info.description
						...
						: null,
					(0, import_jsx_runtime.jsx)(ChipList, {
						items: resolved.info.capabilities ?? [],
					}),
				],
			}),
			DetailExtension
				? (0, import_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							(0, import_jsx_runtime.jsx)(DetailExtension, {
								app: resolved.info,
							}),
						],
					})
							...
							(0, import_jsx_runtime.jsx)("ul", {
								...
								children: recentRuns.map((run) =>
									(0, import_jsx_runtime.jsxs)(
										...
										{
											className:
												"flex items-center justify-between rounded-md border border-border/40 bg-card/30 px-3 py-1.5",
											children: [
												(0, import_jsx_runtime.jsx)("span", {
													className: "truncate",
													children: run.runId,
												...
												(0, import_jsx_runtime.jsx)("span", {
													className:
														"ml-2 shrink-0 uppercase tracking-[0.14em]",
													children: run.status,
												}),
											],
										},
				...
				children: [
					...
					history.length === 0
						...
						: (0, import_jsx_runtime.jsx)("ul", {
								...
								children: history.slice(0, 5).map((entry) =>
									(0, import_jsx_runtime.jsxs)(
										"li",
										{
											className:
												"rounded-md border border-border/40 bg-card/30 px-3 py-1.5",
											children: [
												(0, import_jsx_runtime.jsxs)("div", {
							...
							(0, import_jsx_runtime.jsx)("ul", {
								...
								children: widgets.map((decl) => {
									...
									return (0, import_jsx_runtime.jsxs)(
										...
										{
											className:
												"rounded-md border border-border/40 bg-card/30",
											children: [
												(0, import_jsx_runtime.jsxs)("div", {
													className:
													...
													children: [
														(0, import_jsx_runtime.jsxs)("div", {
															...
															children: [
																...
																(0, import_jsx_runtime.jsx)("div", {
																	className:
																		"truncate text-[10px] uppercase tracking-[0.14em] text-muted",
																	children: decl.slot,
																}),
															],
														}),
														(0, import_jsx_runtime.jsxs)("div", {
															...
															children: [
																(0, import_jsx_runtime.jsx)("button", {
																	...
																	onClick: () =>
																		setExpandedWidget(
																			expanded ? null : widgetKey,
																		),
																	className:
																		"rounded-full border border-border/60 px-2 py-0.5 text-[10px] uppercase tracking-[0.14em] text-muted transition-colors hover:text-foreground",
...
function AppsView() {
	...
	const [appsDetailsSlug, setAppsDetailsSlug] = useState(() =>
	...
	const loadApps = useCallback(async () => {
		...
		try {
			...
			setApps(
				[...catalogApps, ...overlayDescriptors, ...serverApps].filter((app) => {
	...
	const handleLaunch = useCallback(
		async (app) => {
			...
			try {
				...
				const primaryRun =
					(result.run ? mergeRun(result.run) : null)?.find(
						(run) => run.appName === app.name,
					) ?? result.run;
				...
				setActionNotice(
					t("appsview.LaunchedNoViewer", { name: app.displayName ?? app.name }),
					"error",
					4e3,
				);
			} catch (err) {
		...
		async (run) => {
			if (!run.viewer?.url) {
				if (run.launchUrl) {
					try {
						...
						setActionNotice(
							t("appsview.OpenedInNewTab", { name: run.displayName }),
							"success",
							2600,
						);
					} catch {
						setActionNotice(
							t("appsview.PopupBlockedOpen", { name: run.displayName }),
							"error",
							4200,
						);
					}
				...
				setActionNotice(
					t("appsview.LaunchedNoViewer", { name: run.displayName }),
					"info",
					3200,
				);
				return;
			...
			try {
				...
				if (nextRun.viewer?.postMessageAuth && !nextRun.viewer.authMessage)
					setActionNotice(
						t("appsview.IframeAuthMissing", { name: nextRun.displayName }),
						"error",
						4800,
					);
	...
	const handleStopRun = useCallback(
		async (run) => {
			...
			try {
				...
				setState(
					"appRuns",
					appRuns.filter((r) => r.runId !== run.runId),
				);
	...
	return (0, import_jsx_runtime.jsx)(PageLayout, {
		...
		children: (0, import_jsx_runtime.jsxs)("div", {
			className:
				"device-layout mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 py-4 lg:px-6",
			children: [
				appWindows.length > 0
					? (0, import_jsx_runtime.jsx)("section", {
							...
							children: appWindows.map((windowRecord) => {
								...
								return (0, import_jsx_runtime.jsxs)(
									...
									{
										className:
											"inline-flex min-w-0 items-center gap-2 rounded-full border border-border/55 bg-card/70 px-3 py-1.5 text-xs text-muted",
										children: [
											(0, import_jsx_runtime.jsx)("span", {
												className:
													"max-w-44 truncate font-medium text-foreground",
												children: windowRecord.displayName,
											}),
											(0, import_jsx_runtime.jsxs)("button", {
												type: "button",
												className:
													"inline-flex items-center gap-1.5 rounded-full border border-border/60 px-2 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-muted transition-colors hover:border-accent hover:text-foreground disabled:cursor-not-allowed disabled:opacity-60",
												onClick: () =>
													void handleToggleAppWindowAlwaysOnTop(windowRecord),
												disabled: busy,
												"aria-label": windowRecord.alwaysOnTop
				...
				hasActiveRun
					? (0, import_jsx_runtime.jsx)("div", {
							...
							children: (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className:
									"rounded-full border border-ok/35 bg-ok/10 px-3 py-1.5 text-xs-tight font-medium text-ok transition-colors hover:bg-ok/15",
					...
					: null,
				appsDetailsSlug
					? (0, import_jsx_runtime.jsx)(AppDetailsView, {
					...
					: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
							children: [
								(0, import_jsx_runtime.jsx)(RunningAppsRow, {
									runs: sortedRuns,
									catalogApps: apps,
									busyRunId,
									onOpenRun: (run) => void handleOpenRun(run),
...
var AppsPageView_exports = /* @__PURE__ */ __exportAll({
	AppsPageView: () => AppsPageView,
});
function AppsPageView({
	inModal,
	appsView: AppsViewRenderer = AppsView,
	gameView: GameViewRenderer = GameView,
} = {}) {
	...
	useEffect(() => {
		...
		try {
			...
			if (currentPath !== expected)
				if (shouldUseHashNavigation()) window.location.hash = expected;
	...
	if (appsSubTab === "games" && hasActiveGame)
		return (0, import_jsx_runtime.jsx)(GameViewRenderer, {});
	if (inModal)
		return (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
export {
	APPS_SECTION_VISIBILITY_KEY as p,
	AppsPageView as t,
	AppsPageView_exports as n,
	AppsView as r,
	buildDisconnectedSessionState as c,
	buildViewerSessionKey as y,
	CHAT_SIDEBAR_VISIBILITY_STORAGE_KEY as m,
	DESKTOP_GAME_CLICK_AUDIT as a,
	DesktopGameWindowControls as o,
	GameView as s,
	getAppDetailExtension as d,
	getAppOperatorSurface as l,
	isWidgetVisible as h,
	loadChatSidebarVisibility as g,
	registerDetailExtension as f,
	registerOperatorSurface as u,
	resolveEmbeddedViewerUrl as b,
	resolvePostMessageTargetOrigin as x,
	resolveViewerReadyEventType as S,
	saveChatSidebarVisibility as _,
	shouldUseEmbeddedAppViewer as C,
	useRegistryCatalog as i,
	widgetVisibilityKey as v,
};
