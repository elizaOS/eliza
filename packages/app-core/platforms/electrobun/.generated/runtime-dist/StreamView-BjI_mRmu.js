...
function StatusBar({
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    className:
      "flex items-center justify-between bg-card/80 shadow-sm backdrop-blur-xl shrink-0 px-3 py-2 lg:px-4",
      ...
      (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          (0, import_jsx_runtime.jsx)("span", {
            className: `w-2.5 h-2.5 rounded-full ${streamLive ? "bg-danger ring-2 ring-danger/25 animate-pulse" : "bg-muted"}`,
          }),
          (0, import_jsx_runtime.jsx)("span", {
        ...
        children: [
          streamLive &&
            (0, import_jsx_runtime.jsxs)("span", {
              className:
                "inline-flex min-h-9 items-center gap-1.5 rounded-xl border border-border/45 bg-card/92 px-2.5 py-1.5 text-xs-tight text-muted-strong shadow-sm font-mono text-2xs",
              children: [
                (0, import_jsx_runtime.jsx)("span", {
                  className: "text-txt",
...
var StreamView_exports = /* @__PURE__ */ __exportAll({
...
function StreamView({ inModal } = {}) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      (0, import_jsx_runtime.jsx)(StatusBar, {
        agentName,
        streamAvailable,
        streamLive,
        streamLoading,
      ...
      (0, import_jsx_runtime.jsx)("div", {
        ...
        children: !streamAvailable
          ? (0, import_jsx_runtime.jsxs)("div", {
              className:
                "max-w-lg rounded-3xl border border-border/60 bg-card/94 p-6 text-center shadow-xl backdrop-blur-xl",
              children: [
                (0, import_jsx_runtime.jsx)("p", {
                  className:
                    "text-xs-tight uppercase tracking-[0.24em] text-muted",
                ...
                (0, import_jsx_runtime.jsxs)("p", {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)("code", {
                      className:
                        "rounded-md border border-border/45 bg-bg-hover px-1.5 py-0.5 text-xs text-txt-strong",
          ...
          : (0, import_jsx_runtime.jsxs)("div", {
              className:
                "max-w-md rounded-3xl border border-border/60 bg-card/94 p-6 text-center shadow-xl backdrop-blur-xl",
              children: [
                (0, import_jsx_runtime.jsx)("div", {
                  className: `mx-auto mb-4 h-3 w-3 rounded-full ${streamLive ? "bg-danger ring-4 ring-danger/20 animate-pulse" : "bg-muted"}`,
                }),
                (0, import_jsx_runtime.jsx)("h2", {
...
//#endregion
export { StreamView as t, StreamView_exports as n };
