...
import {
	T as resolveCharacterVoiceConfigFromAppConfig,
	E as useChatAvatarVoiceBridge,
	d as useMediaQuery,
	C as useVoiceChat,
} from "./hooks-C3v9uETL.js";
import {
	ConfigFieldErrors,
	ConfigRenderer,
	defaultRegistry,
...
import {
	ia as confirmDesktopAction,
	Hi as ELIZA_CLOUD_STATUS_UPDATED_EVENT,
	Fn as fetchWithCsrf,
	wn as getVrmPreviewUrl,
	rt as isRoutineCodingAgentMessage,
	da as resolveAppAssetUrl,
	Gr as ttsDebug,
	Fr as useChatComposer,
	u as useCompanionSceneStatus,
	dt as usePtySessions,
	Xi as VOICE_CONFIG_UPDATED_EVENT,
} from "./state-BC9WO-N8.js";
import {
	d as client,
	m as PULSE_STATUSES,
	h as STATUS_DOT,
	j as stripAssistantStageDirections,
	n as useApp,
} from "./useApp-Dh-r7aR7.js";
...
function CodingAgentSettingsSection(props) {
	...
	return Component
		? (0, import_jsx_runtime.jsx)(Component, { ...props })
		: null;
}
...
function AgentActivityBox({ sessions, onSessionClick }) {
	...
	return (0, import_jsx_runtime.jsx)("div", {
		className:
			"px-3 py-2 space-y-1 z-[1] mb-2 relative rounded-2xl border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))] shadow-[0_12px_36px_rgba(0,0,0,0.12)] ring-1 ring-inset ring-white/6 backdrop-blur-[22px]",
		children: sessions.map((s) =>
			(0, import_jsx_runtime.jsxs)(
				"button",
				{
					...
					className:
						"flex items-center gap-1.5 min-w-0 w-full text-left cursor-pointer hover:bg-bg-hover rounded px-1 -mx-1 transition-colors",
					children: [
						(0, import_jsx_runtime.jsx)("span", {
							className: `inline-block w-1.5 h-1.5 rounded-full shrink-0 ${STATUS_DOT[s.status] ?? "bg-muted"}${PULSE_STATUSES.has(s.status) ? " animate-pulse" : ""}`,
						}),
						(0, import_jsx_runtime.jsx)("span", {
							className:
								"text-xs-tight font-medium text-txt max-w-[120px] truncate shrink-0",
							children: s.label,
						}),
						(0, import_jsx_runtime.jsx)("span", {
...
function useStatePath(statePath, ctx) {
	return [
		statePath ? getByPath(ctx.state, statePath) : void 0,
		useCallback(
			(v) => {
...
const SeparatorComponent = (props) => {
	return props.orientation === "vertical"
		...
		: (0, import_jsx_runtime.jsx)("hr", { className: "my-2" });
};
						...
						children: (0, import_jsx_runtime.jsx)("tr", {
							children: columns.map((col) =>
								(0, import_jsx_runtime.jsx)(
									...
									{
										className:
											"text-left px-2.5 py-1.5 font-semibold text-muted",
										children: col,
									},
									col,
								),
			...
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, import_jsx_runtime.jsxs)("span", {
						...
						children: [current + 1, " / ", items.length],
					}),
					(0, import_jsx_runtime.jsx)(Button, {
						type: "button",
						variant: "outline",
...
const ImageComponent = (props) => {
	...
	return resolvedSrc
		...
		: (0, import_jsx_runtime.jsx)("div", {
				className:
					"bg-[var(--bg-hover)] border border-border flex items-center justify-center text-xs text-muted",
				style: {
					width: w,
					height: h,
				},
...
const ProgressComponent = (props) => {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime.jsx)("div", {
				className:
					"w-full h-2 bg-[var(--bg-hover)] border border-border overflow-hidden",
				children: (0, import_jsx_runtime.jsx)("div", {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(0, import_jsx_runtime.jsx)("div", {
				...
				children: Array.from({ length: max }, (_, i) => i + 1).map(
					(starValue) =>
						(0, import_jsx_runtime.jsx)(
							"span",
							{
...
const SpinnerComponent = (props) => {
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			(0, import_jsx_runtime.jsx)("div", {
				className: `${props.size === "lg" ? "w-8 h-8" : props.size === "sm" ? "w-4 h-4" : "w-6 h-6"} border-2 border-border border-t-accent rounded-full animate-spin`,
			}),
			props.label
				? (0, import_jsx_runtime.jsx)("span", {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			open &&
				(0, import_jsx_runtime.jsx)("div", {
					className:
						"absolute top-full left-0 mt-1 min-w-[120px] border border-border bg-card shadow-md z-10",
					children: items.map((item) =>
						(0, import_jsx_runtime.jsx)(
							Button,
							{
								...
								variant: "ghost",
								className:
									"block w-full text-left px-3 py-1.5 text-xs hover:bg-[var(--bg-hover)] rounded-none justify-start h-auto",
								onClick: () => {
									setOpen(false);
									if (ctx.onAction)
...
const MetricComponent = (props) => {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		className:
			"flex flex-col gap-0.5 p-3 rounded-lg border border-border bg-card",
		children: [
			(0, import_jsx_runtime.jsx)("div", {
					...
					(0, import_jsx_runtime.jsxs)(
						"div",
						{
							...
							children: [
								...
								(0, import_jsx_runtime.jsx)("div", {
									className:
										"w-full bg-accent transition-all duration-300 min-h-[2px]",
			...
			(0, import_jsx_runtime.jsxs)("svg", {
				...
				children: [
					(0, import_jsx_runtime.jsx)("title", {
						children: String(props.title ?? "Line graph"),
					}),
	...
	return (0, import_jsx_runtime.jsxs)(Button, {
		...
		children: [
			...
			show &&
				(0, import_jsx_runtime.jsx)("div", {
					className:
						"absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 text-2xs bg-txt text-card whitespace-nowrap z-10",
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			open &&
				(0, import_jsx_runtime.jsxs)("div", {
					className:
						"absolute top-full left-0 mt-1 p-3 border border-border bg-card shadow-md z-10 min-w-[150px]",
					children: [
						(0, import_jsx_runtime.jsx)("div", {
							className: "text-xs",
							children: String(props.content ?? ""),
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			(0, import_jsx_runtime.jsxs)(Button, {
				...
				variant: "ghost",
				className:
					"w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold hover:bg-[var(--bg-hover)] transition-colors rounded-none justify-start h-auto",
				onClick: () => setOpen(!open),
				children: [
					(0, import_jsx_runtime.jsx)("span", {
				...
				"div",
				{
					children: [
						(0, import_jsx_runtime.jsxs)(Button, {
							...
							variant: "ghost",
							className:
								"w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold hover:bg-[var(--bg-hover)] rounded-none justify-start h-auto",
							onClick: () => toggle(i),
							children: [
								(0, import_jsx_runtime.jsx)("span", {
									className: "text-2xs transition-transform",
									style: {
										transform: openSet.has(i) ? "rotate(90deg)" : "none",
									},
									children: "▶",
								}),
								item.title,
				...
				(0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(Button, {
							...
							size: "icon",
							className:
								"text-muted hover:text-txt text-lg leading-none px-1 h-auto w-auto",
							onClick: close,
							children: "×",
						}),
					],
...
const DrawerComponent = (props, children, ctx) => {
	...
	return (0, import_jsx_runtime.jsx)("div", {
		...
		children: (0, import_jsx_runtime.jsxs)("div", {
			className:
				"w-full max-h-[80vh] bg-card p-5 shadow-lg overflow-y-auto animate-[slide-up_200ms_ease]",
			children: [
				(0, import_jsx_runtime.jsx)("div", {
					className: "w-10 h-1 bg-border mx-auto mb-3 rounded-full",
				}),
				props.title
					? (0, import_jsx_runtime.jsx)("div", {
							className: "font-bold text-sm",
...
function ElementRenderer({ elementId }) {
	...
	if (!component)
		return (0, import_jsx_runtime.jsxs)("div", {
			className:
				"text-2xs text-destructive border border-dashed border-destructive p-2",
			children: [t("ui-renderer.UnknownComponent"), " ", el.type],
		});
			...
			children: listData.map((item) => {
				...
				const childNodes = el.children.map((childId) =>
					(0, import_jsx_runtime.jsx)(
						...
						{
							value: itemCtx,
							children: (0, import_jsx_runtime.jsx)(ElementRenderer, {
								elementId: childId,
							}),
						},
						childId,
				...
				return (0, import_jsx_runtime.jsx)(
					React.Fragment,
					{ children: component(resolvedProps, childNodes, itemCtx, el) },
					itemKey,
				);
			}),
		});
...
function UiRenderer({ spec, onAction, loading, auth, validators }) {
	...
	if (loading && Object.keys(spec.elements).length === 0)
		return (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				(0, import_jsx_runtime.jsx)("div", {
					className: "h-4 bg-[var(--bg-hover)] w-3/4",
				}),
				(0, import_jsx_runtime.jsx)("div", {
					className: "h-3 bg-[var(--bg-hover)] w-1/2",
				}),
				(0, import_jsx_runtime.jsx)("div", {
					className: "h-3 bg-[var(--bg-hover)] w-5/6",
				}),
			],
		});
					...
					Button,
					{
						...
						children: isSelected
							? (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [
										(0, import_jsx_runtime.jsx)(Check, {
...
function parseSegments(text) {
	...
	for (const patch of findPatchRegions(cleaned))
		if (!regions.some((r) => patch.start < r.end && patch.end > r.start))
			regions.push({
				start: patch.start,
				end: patch.end,
				segment: {
...
function buildInlinePluginConfigModel(plugin, values) {
	...
	if (!(pluginParams.length > 0) || !plugin?.id)
		return {
	...
	for (const [key, value] of Object.entries(values))
		if (value != null && value !== "") setKeys.add(key);
	return {
...
function InlinePluginConfig({ pluginId: rawPluginId }) {
	...
	if (loading)
		return (0, import_jsx_runtime.jsx)("div", {
			className:
				"my-2 px-3 py-2 border border-border bg-card text-xs text-muted italic",
				...
				children: [
					(0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, import_jsx_runtime.jsx)("span", {
								children: t("messagecontent.PluginConfigurationTitle", {
				...
				children: [
					schema &&
						...
						(0, import_jsx_runtime.jsx)(Button, {
							...
							size: "sm",
							className:
								"px-4 py-1.5 h-7 text-xs shadow-sm bg-accent text-accent-fg hover:opacity-90 disabled:opacity-40",
							onClick: handleSave,
					...
					!isEnabled
						? (0, import_jsx_runtime.jsx)(Button, {
								...
								size: "sm",
								className:
									"px-4 py-1.5 h-7 text-xs border-ok/50 text-ok bg-ok/5 hover:bg-ok/10 hover:text-ok disabled:opacity-40",
						...
						: (0, import_jsx_runtime.jsx)(Button, {
								...
								size: "sm",
								className:
									"px-4 py-1.5 h-7 text-xs text-muted hover:border-danger hover:text-danger disabled:opacity-40",
		...
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, import_jsx_runtime.jsx)("span", {
						className:
							"text-2xs font-semibold text-muted uppercase tracking-wider",
					...
					(0, import_jsx_runtime.jsx)(Button, {
						...
						size: "sm",
						className:
							"h-auto p-0 text-2xs text-txt hover:underline decoration-accent/50 underline-offset-2",
						onClick: () => setShowRaw((v) => !v),
						children: showRaw
							? t("messagecontent.HideJson", { defaultValue: "Hide JSON" })
							: t("messagecontent.ViewJson", { defaultValue: "View JSON" }),
					}),
				],
			}),
			showRaw &&
				(0, import_jsx_runtime.jsx)("div", {
					...
					children: (0, import_jsx_runtime.jsx)("pre", {
						className:
							"text-2xs text-muted font-mono whitespace-pre-wrap break-words m-0",
						children: raw,
					}),
				}),
			(0, import_jsx_runtime.jsx)("div", {
...
function useChatVoiceController(options) {
	...
	const beginVoiceCapture = useCallback(
		(mode = "compose") => {
			...
			suppressedAssistantSpeechIdRef.current =
				findLatestAssistantMessage(conversationMessages)?.id ?? null;
...
const fallbackTranslate = (key, options) =>
...
function normalizeInboxChatSelection(value) {
	...
	return {
		avatarUrl:
			typeof candidate.avatarUrl === "string" ? candidate.avatarUrl : void 0,
		canSend:
			typeof candidate.canSend === "boolean" ? candidate.canSend : void 0,
		id,
		source,
		title,
		transportSource,
		...
		worldLabel:
			typeof candidate.worldLabel === "string" ? candidate.worldLabel : void 0,
	};
}
function ChatView({ variant = "default", onPtySessionClick }) {
				...
				(file) =>
					new Promise((resolve, reject) => {
						...
						reader.onerror = () =>
							reject(
								reader.error ??
									/* @__PURE__ */ new Error("Failed to read file"),
							);
						reader.onabort = () =>
							reject(/* @__PURE__ */ new Error("File read aborted"));
	...
	const messagesContent =
		visibleMsgs.length === 0 && !chatSending
			? (0, import_jsx_runtime.jsx)("div", {
					className:
						"flex h-full items-center justify-center px-6 text-center text-xs text-muted",
					children: t("chatview.NoMessagesYet", {
			...
			: (0, import_jsx_runtime.jsx)(ChatTranscript, {
					...
					renderMessageContent: (message) =>
						(0, import_jsx_runtime.jsx)(MessageContent, { message }),
					typingIndicator:
	...
	const auxiliaryNode = (0, import_jsx_runtime.jsxs)(
				...
				droppedFiles.length > 0
					? (0, import_jsx_runtime.jsx)("div", {
							...
							children: droppedFiles.map((f) =>
								(0, import_jsx_runtime.jsx)("span", { children: f }, f),
							),
						})
					: null,
	...
	const composerNode = isGameModal
		? (0, import_jsx_runtime.jsx)(ChatComposerShell, {
				...
				before: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
					children: [
						(0, import_jsx_runtime.jsx)(CodingAgentControlChip, {}),
						(0, import_jsx_runtime.jsx)(AgentActivityBox, {
	...
	if (activeTerminalSessionId)
		return (0, import_jsx_runtime.jsx)(TerminalChannelPanel, {
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					activeInboxChat.source
						? (0, import_jsx_runtime.jsx)(ChatSourceIcon, {
						...
						: activeInboxChat.avatarUrl
							? (0, import_jsx_runtime.jsx)("img", {
									...
									className:
										"h-8 w-8 shrink-0 rounded-full border border-border/35 object-cover shadow-[0_10px_18px_-16px_rgba(15,23,42,0.45)]",
								})
							: null,
				],
			}),
			(0, import_jsx_runtime.jsx)("div", {
				...
				children:
					loading && messages.length === 0
						? (0, import_jsx_runtime.jsx)("div", {
								className:
									"flex h-full items-center justify-center text-xs text-muted",
								children: t("inboxview.Loading", {
						...
						: messages.length === 0
							? (0, import_jsx_runtime.jsx)("div", {
									className:
										"flex h-full items-center justify-center text-center text-xs text-muted",
									children: t("inboxview.EmptyRoom", {
			...
			activeInboxChat.canSend === false
				? (0, import_jsx_runtime.jsx)("div", {
						className:
							"bg-bg-hover/40 px-5 py-3 text-xs-tight leading-5 text-muted",
				...
				: (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, import_jsx_runtime.jsx)("div", {
								className:
									"rounded-md border border-warn/40 bg-warn/10 px-3 py-2 text-2xs leading-snug text-warn",
...
function findPageScopedConversation(conversations, scope, pageId) {
	const matching = conversations.filter(
		(conversation) =>
			...
			(conversation.metadata?.pageId ?? void 0) === (pageId ?? void 0),
	);
...
async function resolvePageScopedConversation(params) {
	...
	if (existing) {
		...
		const metadataMatches =
			...
			(existing.metadata?.pageId ?? void 0) === (pageId ?? void 0);
...
function PageScopedChatPane({
	...
	useEffect(() => {
		...
		if (
			desiredSource === (conversation.metadata?.sourceConversationId ?? void 0)
		)
			return;
		const desiredMetadata = buildPageScopedConversationMetadata(scope, {
			pageId,
		...
		const readers = imageFiles.map(
			(file) =>
				new Promise((resolve, reject) => {
					...
					reader.onerror = () =>
						reject(
							reader.error ?? /* @__PURE__ */ new Error("Failed to read image"),
						);
					reader.onabort = () =>
						reject(/* @__PURE__ */ new Error("Image read aborted"));
					reader.readAsDataURL(file);
				}),
		);
		Promise.all(readers)
	...
	const handleClearConversation = useCallback(async () => {
		...
		try {
			setConversation(
				await resetPageScopedConversation({
					scope,
					title,
					pageId,
				}),
	...
	const introCard = (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				className:
					"mb-1 flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-muted",
				children: [
					(0, import_jsx_runtime.jsx)(Sparkles, {
			...
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						(0, import_jsx_runtime.jsxs)(
							"article",
							{
								...
								children: [
									(0, import_jsx_runtime.jsx)("div", {
										className:
											"mb-0.5 text-[10px] font-semibold uppercase tracking-wider text-muted",
												...
												children: message.images.map((image) =>
													(0, import_jsx_runtime.jsx)(
														"img",
														{
															...
															alt: image.name,
															className:
																"h-16 w-16 rounded-md border border-border/40 object-cover",
														},
					...
					sending && !firstTokenReceived
						? (0, import_jsx_runtime.jsxs)("div", {
								className:
									"mr-8 flex items-center gap-1.5 rounded-lg bg-bg/40 px-3 py-2",
								children: [
						...
						children: [
							showClearButton
								? (0, import_jsx_runtime.jsxs)("button", {
										...
										className:
											"inline-flex items-center gap-1 rounded-full px-2 py-1 text-[11px] font-medium text-muted transition-colors hover:text-txt disabled:cursor-not-allowed disabled:opacity-40",
										onClick: () => void handleClearConversation(),
										disabled:
											clearing || (!conversation && !hasClearableContent),
										"aria-label": clearing
											? "Clearing page chat"
											: "Clear page chat",
										children: [
											clearing
												...
												: (0, import_jsx_runtime.jsx)(RotateCcw, {
														className: "h-3 w-3",
													}),
											(0, import_jsx_runtime.jsx)("span", {
												children: clearing ? "Clearing…" : "Clear",
											}),
										],
									})
								: (0, import_jsx_runtime.jsx)("div", {}),
...
function AppWorkspaceChatCollapseButton({
	...
	return (0, import_jsx_runtime.jsx)("button", {
		...
		"data-testid": testId,
		className:
			"inline-flex h-6 w-6 items-center justify-center rounded-[var(--radius-sm)] bg-transparent text-muted transition-colors hover:text-txt",
...
function AppWorkspaceChatDockToggleButton({ collapsed, testId }) {
	...
	return (0, import_jsx_runtime.jsx)("button", {
		...
		"data-testid": testId,
		className:
			"fixed bottom-2 right-2 z-40 inline-flex h-6 w-6 items-center justify-center rounded-[var(--radius-sm)] bg-transparent text-muted transition-colors hover:text-txt",
...
function MobileWorkspacePaneSwitcher({
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		className:
			"grid shrink-0 grid-cols-[1fr_auto_1fr] items-center border-b border-border/35 bg-bg/92 px-2 py-1.5",
...
function AppWorkspaceChrome({
	...
	const mobileSidebarControlsValue = useMemo(
	...
	const chatContent =
		chat ??
		(chatScope
			? (0, import_jsx_runtime.jsx)(PageScopedChatPane, {
					...pageScopedChatPaneProps,
					scope: chatScope,
				})
					...
					children: (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(!chatDisabled || mobileSidebarControl !== null)
								? (0, import_jsx_runtime.jsx)(MobileWorkspacePaneSwitcher, {
							...
							chatDisabled
								? null
								: effectiveCollapsed
									? (0, import_jsx_runtime.jsx)("aside", {
									...
									: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
											children: [
												isMobileViewport
													? (0, import_jsx_runtime.jsx)("aside", {
															className:
																"flex min-h-0 min-w-0 w-full flex-1 flex-col overflow-hidden bg-bg",
															"data-testid": `${testId}-chat-sidebar`,
															children: (0, import_jsx_runtime.jsx)("div", {
																className:
													...
													? (0, import_jsx_runtime.jsxs)("aside", {
															...
															children: [
																(0, import_jsx_runtime.jsx)("hr", {
																	...
																	className:
																		"absolute inset-y-0 left-0 z-20 m-0 h-full w-3 -translate-x-1/2 cursor-col-resize touch-none select-none border-0 bg-transparent transition-colors hover:bg-accent/20",
																}),
																(0, import_jsx_runtime.jsx)("div", {
																	className:
																		"flex min-h-0 flex-1 flex-col overflow-hidden",
...
//#endregion
export {
	__resetCompanionSpeechMemoryForTests as u,
	AgentActivityBox as w,
	APP_WORKSPACE_CHROME_CHAT_STORAGE_KEY as t,
	APP_WORKSPACE_CHROME_CHAT_WIDTH_STORAGE_KEY as n,
	AppWorkspaceChatCollapseButton as r,
	AppWorkspaceChrome as i,
	ChatView as c,
	ChoiceWidget as v,
	CodingAgentControlChip as T,
	CodingAgentSettingsSection as E,
	CodingAgentTasksPanel as D,
	compilePatches as f,
	evaluateUiVisibility as b,
	findPatchRegions as p,
	getBrowserPageScopeCopy as s,
	getSupportedComponents as x,
	looksLikePatch as m,
	MessageContent as d,
	normalizeDisplayText as h,
	normalizePluginId as g,
	PageScopedChatPane as o,
	PtyConsoleBase as O,
	registerTaskCoordinatorSlots as k,
	runValidation as S,
	sanitizeLinkHref as C,
	TerminalChannelPanel as l,
	tryParsePatch as _,
	UiRenderer as y,
	useAppWorkspaceChatChrome as a,
};
