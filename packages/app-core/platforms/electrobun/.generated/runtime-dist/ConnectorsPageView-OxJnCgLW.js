...
import {
  a as buildManagedDiscordSettingsReturnUrl,
  v as resolveManagedDiscordAgentChoice,
} from "./cloud-dashboard-utils-Dedro-JF.js";
import {
  k as __exportAll,
  D as require_jsx_runtime,
} from "./electrobun-runtime-zXJ9acDW.js";
import {
  i as useSignalPairing,
  t as useWhatsAppPairing,
} from "./hooks-C3v9uETL.js";
import { ConfigRenderer, defaultRegistry } from "./index.js";
import {
  a as buildPluginListState,
  o as getPluginResourceLinks,
  s as iconImageSource,
  c as paramsToSchema,
  l as pluginResourceLinkLabel,
  u as resolveIcon,
  n as SUBGROUP_LABELS,
  r as SUBGROUP_NAV_ICONS,
  d as subgroupForPlugin,
  i as TELEGRAM_ALLOW_ALL_HIDDEN,
} from "./plugin-list-utils-D3K7UKwI.js";
...
const XTwitterIcon = makeIcon(
  "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z",
);
const WhatsappIcon = makeIcon(
...
function PluginCard({
  ...
  const requiredParams = hasParams
    ? p.parameters.filter((param) => param.required)
    : [];
  ...
  return (0, import_jsx_runtime.jsxs)(
    "li",
    {
      ...
      onDragStart:
        allowCustomOrder && onDragStart ? (e) => onDragStart(e, p.id) : void 0,
      onDragOver:
        allowCustomOrder && onDragOver ? (e) => onDragOver(e, p.id) : void 0,
      ...
      children: [
          ...
          children: [
            allowCustomOrder &&
              (0, import_jsx_runtime.jsx)("span", {
                className:
                  "text-2xs text-muted opacity-30 hover:opacity-70 cursor-grab active:cursor-grabbing shrink-0 select-none leading-none",
                title: t("pluginsview.DragToReorder"),
                children: t("pluginsview.X2807"),
              }),
            (0, import_jsx_runtime.jsxs)("span", {
              className:
                "font-bold text-sm flex items-center gap-1.5 min-w-0 truncate flex-1",
              children: [
                (() => {
            ...
            isShowcase
              ? (0, import_jsx_runtime.jsx)("span", {
                  className:
                    "text-2xs font-bold tracking-wider px-2.5 py-[2px] border border-accent text-txt bg-accent-subtle shrink-0",
        ...
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            (0, import_jsx_runtime.jsx)("span", {
              className:
                "text-2xs px-1.5 py-px border border-border bg-surface text-muted lowercase tracking-wide whitespace-nowrap",
            ...
            p.enabled &&
              ...
              (0, import_jsx_runtime.jsx)("span", {
                ...
                title:
                  p.loadError ||
                  "Plugin is enabled but not loaded in the runtime",
                children: inactiveLabel,
              }),
            isToggleBusy &&
              (0, import_jsx_runtime.jsx)("span", {
                className:
                  "text-2xs px-1.5 py-px border border-accent bg-accent-subtle text-txt lowercase tracking-wide whitespace-nowrap",
        ...
        (p.tags?.length ?? 0) > 0 &&
          (0, import_jsx_runtime.jsx)("div", {
            ...
            children: p.tags?.slice(0, 4).map((tag) =>
              (0, import_jsx_runtime.jsx)(
                "span",
                {
                  className:
                    "whitespace-nowrap border border-border/50 bg-bg-accent/80 px-1.5 py-px text-2xs lowercase tracking-wide text-muted-strong",
                  children: tag,
                },
                `${p.id}:${tag}`,
              ),
            ...
            children: pluginLinks.map((link) =>
              (0, import_jsx_runtime.jsx)(
                Button,
                {
                  ...
                  size: "sm",
                  className:
                    "h-6 px-2 text-2xs font-bold border-border/40 text-muted hover:text-txt hover:border-accent hover:bg-accent/5 backdrop-blur-sm transition-all",
                  onClick: (e) => {
                    e.stopPropagation();
          ...
          children: [
            hasParams && !isShowcase
              ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                  children: [
                    (0, import_jsx_runtime.jsx)("span", {
                      className: `inline-block w-2 h-2 rounded-full shadow-[0_0_10px_currentColor] shrink-0 ${allParamsSet ? "bg-ok text-ok" : "bg-destructive text-destructive"}`,
                    }),
                    (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "text-xs-tight font-bold tracking-wide text-muted",
                      children: [
                        setCount,
                        "/",
                        totalCount,
              ...
              : !hasParams && !isShowcase
                ? (0, import_jsx_runtime.jsx)("span", {
                    className:
                      "text-xs-tight font-bold tracking-wide text-muted/60",
            ...
            isStoreInstallMissing &&
              ...
              (0, import_jsx_runtime.jsx)(Button, {
                ...
                size: "sm",
                className:
                  "h-7 px-3 text-2xs font-bold tracking-wide shadow-sm max-w-[140px] truncate",
                disabled: isInstalling || isUpdating || isUninstalling,
                onClick: (e) => {
                  e.stopPropagation();
                  onInstall(p.id, p.npmName ?? "");
                },
                children: isInstalling
                  ? installProgressLabel(
            ...
            canUninstall &&
              (0, import_jsx_runtime.jsx)(Button, {
                ...
                size: "sm",
                className:
                  "h-7 px-3 text-2xs font-bold tracking-wide text-destructive border-destructive/40 hover:border-destructive",
                disabled: isInstalling || isUpdating || isUninstalling,
                onClick: (e) => {
                  e.stopPropagation();
                  onUninstall(p.id, p.npmName ?? "");
                },
                children: isUninstalling
        ...
        p.enabled &&
          ...
          (0, import_jsx_runtime.jsx)("div", {
            className:
              "px-3 py-1.5 border-t border-destructive bg-[rgba(153,27,27,0.04)] text-xs",
            children: p.validationErrors.map((err) =>
              (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  className: "text-destructive mb-0.5 text-2xs",
                  children: [err.field, ": ", err.message],
                },
        ...
        p.enabled &&
          ...
          (0, import_jsx_runtime.jsx)("div", {
            className: "px-3 py-1",
            children: p.validationWarnings.map((w) =>
              (0, import_jsx_runtime.jsx)(
                "div",
                {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      (0, import_jsx_runtime.jsx)("div", {
        ...
        children: t("pluginsview.ConnectionMode", {
  ...
  return (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
          ...
          ? (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: t("pluginsview.BlueBubblesWebhookTarget", {
                    defaultValue: "Webhook target",
                  }),
                }),
                (0, import_jsx_runtime.jsx)("code", {
                  className:
                    "block break-all rounded-lg border border-border/40 bg-bg/70 px-3 py-2 text-xs-tight text-muted-strong",
        ...
        (0, import_jsx_runtime.jsx)("div", {
          className: "text-muted",
          children: t("pluginsview.BlueBubblesWebhookHint", {
            defaultValue:
...
function DiscordLocalConnectorPanel() {
  ...
  const loadChannels = useCallback(async (guildId) => {
    ...
    try {
      setChannels(
        (await client.listDiscordLocalChannels(guildId)).channels.filter(
          isTextLikeChannel,
        ),
      );
    } catch (nextError) {
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            connectedUser
              ? (0, import_jsx_runtime.jsx)("code", {
                  className:
                    "rounded-md border border-border/40 bg-bg/60 px-2 py-1 text-xs-tight text-muted-strong",
        ...
        !status?.available
          ? (0, import_jsx_runtime.jsx)("div", {
              className: "text-muted",
              children: t("pluginsview.DiscordLocalUnavailable", {
                defaultValue:
        ...
        status?.authenticated
          ? (0, import_jsx_runtime.jsxs)("div", {
              className:
                "space-y-3 rounded-xl border border-border/40 bg-bg/60 p-3",
              children: [
                (0, import_jsx_runtime.jsx)("div", {
                  className: "text-muted",
                  children: t("pluginsview.DiscordLocalSubscriptionsHint", {
                    defaultValue:
                ...
                guilds.length > 0
                  ? (0, import_jsx_runtime.jsxs)("label", {
                      ...
                      children: [
                        (0, import_jsx_runtime.jsx)("span", {
                          className: "font-medium text-txt",
                          children: t("common.server", {
                            defaultValue: "Server",
                          }),
                        }),
                        (0, import_jsx_runtime.jsx)("select", {
                          className:
                            "h-9 w-full rounded-xl border border-border/40 bg-bg px-3 text-sm text-txt",
                  ...
                  : loadingGuilds
                    ? (0, import_jsx_runtime.jsx)("div", {
                        className: "text-muted",
                        children: t("pluginsview.DiscordLocalLoadingGuilds", {
                          defaultValue: "Loading Discord servers…",
                        }),
                      })
                    : (0, import_jsx_runtime.jsx)("div", {
                        className: "text-muted",
                        children: t("pluginsview.DiscordLocalNoGuilds", {
                          defaultValue:
                ...
                selectedGuildId
                  ? (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        (0, import_jsx_runtime.jsx)("div", {
                          className: "font-medium text-txt",
                          children: t("pluginsview.DiscordLocalChannels", {
                        ...
                        loadingChannels
                          ? (0, import_jsx_runtime.jsx)("div", {
                              className: "text-muted",
                              children: t(
                                "pluginsview.DiscordLocalLoadingChannels",
                          ...
                          : channels.length > 0
                            ? (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "max-h-56 space-y-2 overflow-y-auto rounded-lg border border-border/30 bg-bg/40 p-2",
                                children: channels.map((channel) => {
                                  return (0, import_jsx_runtime.jsxs)(
                                    "label",
                                    {
                                      className:
                                        "flex items-center gap-3 rounded-lg px-2 py-1 hover:bg-bg-hover",
                                      children: [
                                        ...
                                        (0, import_jsx_runtime.jsx)("span", {
                                          className:
                                            "min-w-0 flex-1 truncate text-sm text-txt",
                            ...
                            : (0, import_jsx_runtime.jsx)("div", {
                                className: "text-muted",
                                children: t(
                                  "pluginsview.DiscordLocalNoChannels",
                                  {
                                    defaultValue:
                        ...
                        (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            (0, import_jsx_runtime.jsx)(Button, {
                              ...
                              size: "sm",
                              className:
                                "h-8 rounded-xl px-4 text-xs-tight font-semibold",
                              onClick: () => {
                            ...
                            (0, import_jsx_runtime.jsx)("span", {
                              className: "text-muted",
                              children: t(
                                "pluginsview.DiscordLocalSelectedCount",
                                {
      ...
      children: [
        permissionAction
          ? (0, import_jsx_runtime.jsx)(Button, {
              ...
              children: t("pluginsview.IMessageOpenFullDiskAccess", {
      ...
      children: [
        ...
        permissionAction
          ? (0, import_jsx_runtime.jsx)("ol", {
              ...
              children: permissionAction.instructions.map((instruction) =>
                (0, import_jsx_runtime.jsx)(
                  "li",
        ...
        (0, import_jsx_runtime.jsx)("div", {
          className: "text-muted",
          children: t("pluginsview.IMessagePermissionHint", {
            defaultValue:
    ...
    return (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime.jsx)("div", {
          ...
          children: t("signalqroverlay.PairUsingSignalDesktop", {
            defaultValue:
        ...
        (0, import_jsx_runtime.jsx)(Button, {
          ...
          children: t("signalqroverlay.ConnectSignal", {
          ...
          children: qrDataUrl
            ...
            : (0, import_jsx_runtime.jsx)("div", {
                ...
                children: (0, import_jsx_runtime.jsx)("span", {
                  ...
                  children: t("signalqroverlay.GeneratingQR", {
        ...
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            (0, import_jsx_runtime.jsx)("div", {
              ...
              children: t("signalqroverlay.ScanWithSignalDesktop", {
                defaultValue: "Scan with Signal Desktop",
              }),
            }),
            (0, import_jsx_runtime.jsxs)("ol", {
              className:
                "m-0 list-decimal space-y-1 pl-4 text-xs-tight text-muted",
              children: [
                (0, import_jsx_runtime.jsx)("li", {
                  children: t("signalqroverlay.OpenSignalDesktop", {
                    defaultValue: "Open Signal Desktop on your Mac.",
                  }),
                }),
                (0, import_jsx_runtime.jsx)("li", {
                  children: t("signalqroverlay.OpenLinkedDevices", {
                    defaultValue:
                      "Open Signal settings and choose Linked Devices.",
                  }),
                }),
                (0, import_jsx_runtime.jsx)("li", {
                  children: t("signalqroverlay.ScanPrompt", {
                    defaultValue:
  ...
  return (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime.jsx)("div", {
          className: "font-semibold text-txt",
          children: t("pluginsview.TelegramAccountSetupTitle", {
            defaultValue: "Connect your Telegram account",
          }),
        }),
        (0, import_jsx_runtime.jsx)("div", {
          className: "text-muted",
          children: t("pluginsview.TelegramAccountSetupHint", {
            defaultValue:
        ...
        connectedLabel
          ? (0, import_jsx_runtime.jsx)("div", {
              className:
                "rounded-lg border border-border/40 bg-bg/60 px-3 py-2 text-xs-tight text-muted-strong",
              children: status?.serviceConnected
          ...
          ? (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                (0, import_jsx_runtime.jsx)("input", {
                  ...
                  className:
                    "h-8 w-full rounded-lg border border-border/50 bg-bg/70 px-3 text-xs-tight text-txt placeholder:text-muted/50 focus:border-accent focus:outline-none",
                }),
                (0, import_jsx_runtime.jsx)(Button, {
                  variant: "default",
                  size: "sm",
                ...
                (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    (0, import_jsx_runtime.jsx)("input", {
                      ...
                      className:
                        "h-8 flex-1 rounded-lg border border-border/50 bg-bg/70 px-3 text-xs-tight text-txt placeholder:text-muted/50 focus:border-accent focus:outline-none",
                      onKeyDown: (event) => {
        ...
        status?.restartRequired
          ? (0, import_jsx_runtime.jsxs)("div", {
              className:
                "space-y-2 rounded-lg border border-border/40 bg-bg/60 px-3 py-2 text-xs-tight text-muted-strong",
              children: [
                (0, import_jsx_runtime.jsx)("div", {
                  children: t("pluginsview.TelegramAccountRestartHint", {
                    defaultValue:
        ...
        status?.status === "waiting_for_provisioning_code"
          ? (0, import_jsx_runtime.jsx)("div", {
              className: "text-muted",
              children: t("pluginsview.TelegramAccountProvisioningExplain", {
                defaultValue:
    ...
    return (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
      ...
      children: (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)("div", {
            className: "text-muted",
            children: t("pluginsview.TelegramConnectedHint", {
              defaultValue:
  ...
  return (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime.jsx)("div", {
          className: "font-semibold text-txt",
          children: t("pluginsview.TelegramSetupTitle", {
        ...
        (0, import_jsx_runtime.jsxs)("ol", {
          ...
          children: [
            ...
            (0, import_jsx_runtime.jsx)("li", {
              children: t("pluginsview.TelegramStep2", {
                defaultValue:
                  "Send /newbot and follow the prompts to create your bot",
              }),
            }),
            (0, import_jsx_runtime.jsx)("li", {
              children: t("pluginsview.TelegramStep3", {
      ...
      children: [
        (0, import_jsx_runtime.jsx)("div", {
          ...
          children: qrDataUrl
            ...
            : (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex h-40 w-40 items-center justify-center sm:h-48 sm:w-48",
                style: {
                  border: "1px solid var(--border)",
                  background: "var(--bg-hover)",
                },
        ...
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            (0, import_jsx_runtime.jsxs)("ol", {
              className:
                "text-xs-tight space-y-1 list-decimal pl-4 m-0 text-muted",
              children: [
                (0, import_jsx_runtime.jsx)("li", {
                  children: t("whatsappqroverlay.OpenWhatsAppOnYou"),
                }),
                (0, import_jsx_runtime.jsxs)("li", {
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)("strong", {
                      children: t("whatsappqroverlay.Menu"),
                    }),
                    " or",
                    " ",
                    (0, import_jsx_runtime.jsx)("strong", {
                    ...
                    " ",
                    (0, import_jsx_runtime.jsx)("strong", {
                      children: t("whatsappqroverlay.LinkedDevices"),
                    }),
                  ],
                }),
                (0, import_jsx_runtime.jsxs)("li", {
                  children: [
                    ...
                    " ",
                    (0, import_jsx_runtime.jsx)("strong", {
                      children: t("whatsappqroverlay.LinkADevice"),
                    }),
                  ],
                }),
                (0, import_jsx_runtime.jsx)("li", {
                  children: t("whatsappqroverlay.PointYourPhoneAt"),
                }),
              ],
            }),
            (0, import_jsx_runtime.jsxs)("div", {
...
function ConnectorSetupPanel({ pluginId }) {
  ...
  if (
    ...
    return BrowserBridgeSetupPanel
      ? (0, import_jsx_runtime.jsx)(BrowserBridgeSetupPanel, {})
      : null;
  }
  if (normalized.includes("telegramaccount"))
    return (0, import_jsx_runtime.jsx)(TelegramAccountConnectorPanel, {});
  if (normalized.includes("plugintelegram"))
    return (0, import_jsx_runtime.jsx)(TelegramBotSetupPanel, {});
  switch (normalized) {
    case "whatsapp":
      return (0, import_jsx_runtime.jsx)(WhatsAppQrOverlay, {
        accountId: "default",
      });
    case "signal":
      return (0, import_jsx_runtime.jsx)(SignalQrOverlay, {
        accountId: "default",
      });
    case "discordlocal":
      return (0, import_jsx_runtime.jsx)(DiscordLocalConnectorPanel, {});
    case "bluebubbles":
      return (0, import_jsx_runtime.jsx)(BlueBubblesStatusPanel, {});
    case "imessage":
      return (0, import_jsx_runtime.jsx)(IMessageStatusPanel, {});
    case "telegram":
      return (0, import_jsx_runtime.jsx)(TelegramBotSetupPanel, {});
    default:
      return null;
...
function TelegramChatModeToggle({ allowAll, onToggle }) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    className:
      "flex items-center justify-between rounded-lg border border-border bg-[var(--card,rgba(255,255,255,0.03))] px-4 py-3 mb-4",
    children: [
      (0, import_jsx_runtime.jsxs)("div", {
...
function TelegramPluginConfig({ plugin, pluginConfigs, onParamChange }) {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      (0, import_jsx_runtime.jsx)(TelegramChatModeToggle, {
        allowAll,
        onToggle: toggle,
      }),
...
function PluginConfigForm({
  ...
  const setKeys = useMemo(
    () => new Set(params.filter((p) => p.isSet).map((p) => p.key)),
    [params],
  );
...
function ConnectorPluginCard({
  ...
  const startManagedDiscordOauth = async (agent, options) => {
    await handleOpenPluginExternalUrl(
      (
  ...
  const handleConfirmManagedDiscordAgent = async () => {
    ...
    try {
      await startManagedDiscordOauth(agent, {
        gatewayDeploying: await ensureManagedDiscordGatewayProvisioned(agent),
      });
    } catch (error) {
      openCloudAgentsView();
      setActionNotice(
  ...
  const connectorHeaderMedia = (0, import_jsx_runtime.jsx)("span", {
    ...
    children: BrandIcon
      ? (0, import_jsx_runtime.jsx)(BrandIcon, {
    ...
    children: [
      (0, import_jsx_runtime.jsxs)("span", {
        ...
        children: [
          (0, import_jsx_runtime.jsx)("span", {
            className:
              "whitespace-normal break-words [overflow-wrap:anywhere] text-sm font-semibold leading-snug text-txt",
      ...
      (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          plugin.enabled &&
            ...
            (0, import_jsx_runtime.jsx)("span", {
              className:
                "mt-1.5 flex flex-wrap items-center gap-2 text-xs-tight text-muted",
  ...
  const connectorHeaderActions = (0, import_jsx_runtime.jsxs)(
    import_jsx_runtime.Fragment,
    {
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Button, {
          ...
          children: (0, import_jsx_runtime.jsx)(ChevronRight, {
  ...
  const connectorSetupPanel = setupPanelPluginId
    ? (0, import_jsx_runtime.jsx)(ConnectorSetupPanel, {
      ...
      children: (0, import_jsx_runtime.jsxs)(PagePanel.CollapsibleSection, {
        ...
        children: [
          connectorMode.modes.length > 1 &&
            (0, import_jsx_runtime.jsx)(ConnectorModeSelector, {
          ...
          plugin.id === "discord" &&
            ...
            (0, import_jsx_runtime.jsxs)(PagePanel.Notice, {
              tone: "default",
              className: "mb-4",
              actions: (0, import_jsx_runtime.jsx)(Button, {
                variant: "outline",
                size: "sm",
                className:
                  "h-8 rounded-[var(--radius-lg)] px-4 text-xs-tight font-semibold",
                onClick: () => {
                  handleOpenManagedDiscord();
                },
                disabled: managedDiscordBusy,
                children: managedDiscordBusy
                  ? "..."
                  : elizaCloudConnected
                  ...
                  ? (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        (0, import_jsx_runtime.jsxs)(Select, {
                          ...
                          children: [
                            (0, import_jsx_runtime.jsx)(SelectTrigger, {
                              className:
                                "h-9 min-w-[14rem] rounded-[var(--radius-lg)] border-border/40 bg-bg/80 text-sm",
                            ...
                            (0, import_jsx_runtime.jsx)(SelectContent, {
                              children: managedDiscordAgents.map((agent) =>
                                (0, import_jsx_runtime.jsx)(
                                  SelectItem,
                                  {
                        ...
                        (0, import_jsx_runtime.jsx)(Button, {
                          ...
                          size: "sm",
                          className:
                            "h-9 rounded-[var(--radius-lg)] px-4 text-xs-tight font-semibold",
                          onClick: () => {
                            handleConfirmManagedDiscordAgent();
                          },
                          disabled:
                            managedDiscordBusy ||
                            !managedDiscordSelectedAgentId,
                          children: managedDiscordBusy
                            ? "..."
                            : t("common.continue", {
          ...
          cloudOAuthConnector
            ? (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
                tone: "default",
                className: "mb-4",
                actions: (0, import_jsx_runtime.jsx)(Button, {
                  variant: "outline",
            ...
            ? (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
                ...
                actions: elizaCloudConnected
                  ...
                  : (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      children: t("pluginsview.OpenElizaCloud", {
                        defaultValue: "Open Eliza Cloud",
                      }),
                    }),
                children: elizaCloudConnected
              ...
              children: pluginLinks.map((link) =>
                (0, import_jsx_runtime.jsx)(
                  Button,
                  {
                    ...
                    size: "sm",
                    className:
                      "h-8 rounded-[var(--radius-lg)] border-border/40 bg-card/40 px-3 text-xs-tight font-semibold text-muted transition-all hover:border-accent hover:bg-accent/5 hover:text-txt",
                    onClick: () => {
          ...
          isStoreInstallMissing &&
            ...
            (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
              ...
              actions: (0, import_jsx_runtime.jsx)(Button, {
                ...
                size: "sm",
                className:
                  "h-8 rounded-[var(--radius-lg)] px-4 text-xs-tight font-bold",
                disabled: installingPlugins.has(plugin.id),
                onClick: () =>
                  void handleInstallPlugin(plugin.id, plugin.npmName ?? ""),
                children: installingPlugins.has(plugin.id)
                  ? installProgressLabel(
          ...
          showPluginConfig
            ? (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  plugin.id === "telegram"
                    ? (0, import_jsx_runtime.jsx)(TelegramPluginConfig, {
                        plugin,
                        pluginConfigs,
          ...
          plugin.validationErrors &&
            ...
            (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
              ...
              children: plugin.validationErrors.map((error) =>
                (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    children: [
          ...
          plugin.validationWarnings &&
            ...
            (0, import_jsx_runtime.jsx)(PagePanel.Notice, {
              tone: "default",
              className: "mt-3 text-xs",
              children: plugin.validationWarnings.map((warning) =>
                (0, import_jsx_runtime.jsx)(
                  "div",
                  { children: warning.message },
                  `${plugin.id}:${warning.field}:${warning.message}`,
                ),
              ),
            }),
          plugin.version
                ...
                (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                  children: [
                    (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      size: "sm",
                      className:
                        "h-8 rounded-[var(--radius-lg)] px-4 text-xs-tight font-semibold text-muted hover:text-txt",
...
function ConnectorPluginGroups(props) {
  ...
  return groups.map((group) =>
    (0, import_jsx_runtime.jsxs)(
      ...
      {
        className:
          "relative rounded-[var(--radius-lg)] border border-border/30 px-2 pb-2 pt-5",
        children: [
          (0, import_jsx_runtime.jsx)("span", {
            className:
              "absolute -top-2.5 left-3 bg-bg px-2 text-2xs font-semibold uppercase tracking-wider text-muted",
            children: group.label,
          }),
          (0, import_jsx_runtime.jsx)("div", {
            className: "space-y-4",
            children: group.plugins.map((plugin) =>
              (0, import_jsx_runtime.jsx)(
                ConnectorPluginCard,
                {
                  ...props,
  ...
  return (0, import_jsx_runtime.jsx)(Dialog, {
    ...
    children: (0, import_jsx_runtime.jsxs)(AdminDialog.Content, {
      ...
      children: [
        (0, import_jsx_runtime.jsxs)(AdminDialog.Header, {
          ...
          children: [
            (0, import_jsx_runtime.jsxs)(DialogTitle, {
              className:
                "font-bold text-base flex items-center gap-2 flex-1 min-w-0 tracking-wide text-txt",
              children: [
                (0, import_jsx_runtime.jsx)(SettingsDialogIcon, { plugin }),
                plugin.name,
              ],
            }),
            ...
            (0, import_jsx_runtime.jsx)(AdminDialog.MetaBadge, {
              children: categoryLabel,
            }),
            plugin.version &&
              (0, import_jsx_runtime.jsxs)(AdminDialog.MonoMeta, {
                children: ["v", plugin.version],
              }),
            isShowcase &&
              (0, import_jsx_runtime.jsx)("span", {
                className:
                  "text-2xs font-bold tracking-widest px-2.5 py-[2px] border border-accent/30 text-txt bg-accent/10 rounded-full",
                children: t("pluginsview.DEMO"),
              }),
          ],
        }),
        (0, import_jsx_runtime.jsxs)(AdminDialog.BodyScroll, {
          children: [
            (0, import_jsx_runtime.jsxs)("div", {
              className:
                "px-5 pt-4 pb-1 flex items-center gap-3 flex-wrap text-xs text-muted",
              children: [
                plugin.description &&
                  (0, import_jsx_runtime.jsx)("span", {
                  ...
                  (0, import_jsx_runtime.jsx)("span", {
                    ...
                    children: plugin.tags?.map((tag) =>
                      (0, import_jsx_runtime.jsx)(
                        ...
                        {
                          className:
                            "whitespace-nowrap border border-border/40 bg-bg-accent/80 px-1.5 py-px text-2xs lowercase tracking-wide text-muted-strong",
                          children: tag,
                        },
                  ...
                  plugin.pluginDeps &&
                    ...
                    (0, import_jsx_runtime.jsxs)("span", {
                      ...
                      children: [
                        ...
                        plugin.pluginDeps.map((dep) =>
                          (0, import_jsx_runtime.jsx)(
                            "span",
                            {
                              className:
                                "text-2xs px-1.5 py-px border border-border bg-accent-subtle text-muted rounded-sm",
                              children: dep,
                            },
                            dep,
                          ),
        ...
        !isShowcase &&
          (0, import_jsx_runtime.jsxs)(AdminDialog.Footer, {
            ...
            children: [
              plugin.source === "store" &&
                ...
                (0, import_jsx_runtime.jsx)(Button, {
                  ...
                  size: "sm",
                  className:
                    "h-8 px-4 text-xs-tight font-bold tracking-wide shadow-sm",
                  disabled: installingPlugins.has(plugin.id),
                  onClick: () =>
              ...
              plugin.loadError &&
                (0, import_jsx_runtime.jsx)("span", {
                  className:
                    "px-3 py-1.5 text-xs-tight text-danger font-bold tracking-wide",
                  title: plugin.loadError,
                  children: t("pluginsview.PackageBrokenMis"),
                }),
              plugin.isActive &&
                (0, import_jsx_runtime.jsx)(Button, {
                  variant: testResults.get(plugin.id)?.success
                    ? "default"
                  ...
                  children: formatDialogTestConnectionLabel(
                    testResults.get(plugin.id),
                  ),
                }),
              (0, import_jsx_runtime.jsx)(Button, {
                variant: "ghost",
                size: "sm",
                className:
                  "h-8 px-4 text-xs font-bold text-muted hover:text-txt transition-all",
              ...
              children: [
                    ...
                    (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, import_jsx_runtime.jsx)(Button, {
                          ...
                          children: selectedPlugin.enabled
                            ? t("common.on")
                            : t("common.off"),
                        }),
                      ],
                ...
                (selectedPlugin.tags?.length ?? 0) > 0 &&
                  (0, import_jsx_runtime.jsx)("div", {
                    ...
                    children: selectedPlugin.tags?.map((tag) =>
                      (0, import_jsx_runtime.jsx)(
                        "span",
                        {
                          className:
                            "text-2xs px-1.5 py-px border border-border bg-black/10 text-muted lowercase tracking-wide whitespace-nowrap",
                          children: tag,
                        },
                ...
                selectedPluginLinks.length > 0 &&
                  (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "plugins-game-detail-links flex flex-wrap gap-2 px-3 pb-3",
                    children: selectedPluginLinks.map((link) =>
                      (0, import_jsx_runtime.jsx)(
                        Button,
                        {
                          variant: "outline",
                          ...
                          type: "button",
                          className:
                            "plugins-game-link-btn border border-border bg-transparent px-2.5 py-1 text-xs-tight text-muted transition-colors hover:border-accent hover:text-txt",
                          onClick: () => {
                            onOpenExternalUrl(link.url);
                          },
                          children: pluginResourceLinkLabel(t, link.key),
                ...
                selectedPlugin.parameters &&
                  ...
                  (0, import_jsx_runtime.jsx)("div", {
                    ...
                    children: selectedPlugin.parameters.map((param) =>
                      (0, import_jsx_runtime.jsxs)(
                        "div",
                        {
                          id: `field-${param.key}`,
                          children: [
                            (0, import_jsx_runtime.jsx)("label", {
                              ...
                              className:
                                "text-xs-tight tracking-wider text-muted block mb-1",
                              children: param.key,
                            }),
                            (0, import_jsx_runtime.jsx)(Input, {
                              id: `input-${param.key}`,
                ...
                (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      children: pluginSaving.has(selectedPlugin.id)
                        ? savingLabel
...
function ConnectorSidebar({
  ...
  return (0, import_jsx_runtime.jsx)(AppPageSidebar, {
    ...
    header: (0, import_jsx_runtime.jsx)(SidebarHeader, {
      search: {
        value: pluginSearch,
    ...
    collapsedRailItems: visiblePlugins.map((plugin) => {
      ...
      return (0, import_jsx_runtime.jsx)(
        SidebarContent.RailItem,
        {
          ...
          children: (0, import_jsx_runtime.jsx)(SidebarContent.RailMedia, {
            children: RailBrandIcon
              ? (0, import_jsx_runtime.jsx)(RailBrandIcon, {
                  className: "h-5 w-5 shrink-0",
                })
              : renderResolvedIcon(plugin),
          }),
        ...
        children: [
          (0, import_jsx_runtime.jsx)("div", {
            ...
            children: (0, import_jsx_runtime.jsxs)(Select, {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(SettingsControls.SelectTrigger, {
                  "aria-label":
                    mode === "social"
                  ...
                  children: (0, import_jsx_runtime.jsx)(SelectValue, {
                    children: filterSelectLabel,
                  }),
                }),
                (0, import_jsx_runtime.jsx)(SelectContent, {
                  children: subgroupTags.map((tag) =>
                    (0, import_jsx_runtime.jsxs)(
                      SelectItem,
                      {
                        value: tag.id,
                        children: [tag.label, " (", tag.count, ")"],
                      },
                      tag.id,
                    ),
                  ),
          ...
          visiblePlugins.length === 0
            ? (0, import_jsx_runtime.jsx)(SidebarContent.EmptyState, {
                className: "px-4 py-6",
                children: hasActivePluginFilters
            ...
            : visiblePlugins.map((plugin) => {
                ...
                return (0, import_jsx_runtime.jsxs)(
                  SidebarContent.Item,
                  {
                    ...
                    children: [
                      (0, import_jsx_runtime.jsxs)(SidebarContent.ItemButton, {
                        role: "option",
                        ...
                        children: [
                          (0, import_jsx_runtime.jsx)(SidebarContent.ItemIcon, {
                            ...
                            children: SidebarBrandIcon
                              ? (0, import_jsx_runtime.jsx)(SidebarBrandIcon, {
                          ...
                          (0, import_jsx_runtime.jsx)(SidebarContent.ItemBody, {
                            children: (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "block truncate text-sm font-semibold leading-5 text-txt",
                              children: plugin.name,
                            }),
                          }),
                        ],
                      ...
                      (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, import_jsx_runtime.jsx)(Button, {
                            ...
                            size: "icon",
                            className:
                              "h-8 w-8 shrink-0 rounded-none border-0 bg-transparent text-muted transition-colors hover:bg-transparent hover:text-txt",
...
function PluginListView({ label, contentHeader, mode = "all", inModal }) {
  const {
    ...
    pluginSearch = "",
    pluginSettingsOpen = /* @__PURE__ */ new Set(),
    pluginSaving,
    pluginSaveSuccess,
    loadPlugins,
  ...
  const [uninstallingPlugins, setUninstallingPlugins] = useState(
    /* @__PURE__ */ new Set(),
  );
  ...
  const installProgressLabel = (message) =>
    message || t("common.installing", { defaultValue: "Installing..." });
  ...
  const [togglingPlugins, setTogglingPlugins] = useState(
    /* @__PURE__ */ new Set(),
  );
  ...
  const effectiveStatusFilter = isSidebarEditorShellMode
    ? pluginStatusFilter
    : "all";
        ...
        return (0, import_jsx_runtime.jsxs)(
          SidebarContent.Item,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsxs)(SidebarContent.ItemBody, {
                children: [
                  (0, import_jsx_runtime.jsx)(SidebarContent.ItemTitle, {
                    className:
                      "whitespace-nowrap break-normal [overflow-wrap:normal]",
                    children: tag.label,
                  }),
                  (0, import_jsx_runtime.jsx)(SidebarContent.ItemDescription, {
                    children: t("pluginsview.AvailableCount", {
                      count: tag.count,
  ...
  const runWithPluginManager = useCallback(
    async (_pluginName, _notices, task) => task(),
    [],
  );
  ...
  const renderPluginGrid = (plugins) =>
    (0, import_jsx_runtime.jsx)("ul", {
      className:
        "grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-3 m-0 p-0 list-none",
  ...
  const [connectorExpandedIds, setConnectorExpandedIds] = useState(
    () => /* @__PURE__ */ new Set(),
  );
  const [connectorSelectedId, setConnectorSelectedId] = useState(() =>
  ...
  const gameVisiblePlugins = visiblePlugins.filter(
    (p) => p.id !== "__ui-showcase__",
  );
  const effectiveGameSelected = gameVisiblePlugins.find(
    (p) => p.id === gameSelectedId,
  )
    ? gameSelectedId
    : (gameVisiblePlugins[0]?.id ?? null);
  const selectedPlugin =
    gameVisiblePlugins.find((p) => p.id === effectiveGameSelected) ?? null;
  ...
  if (isSidebarEditorShellMode) {
    ...
    return (0, import_jsx_runtime.jsxs)("main", {
      ...
      children: [
        contentHeader
          ? (0, import_jsx_runtime.jsx)(PageLayoutHeader, {
  ...
  if (inModal)
    return (0, import_jsx_runtime.jsx)(PluginGameModal, {
      effectiveGameSelected,
      gameMobileDetail,
      gameNarrow,
      gameVisiblePlugins,
  ...
  return (0, import_jsx_runtime.jsx)(PagePanel.Frame, {
    ...
    children: (0, import_jsx_runtime.jsxs)(PagePanel, {
      ...
      variant: "shell",
      className:
        "settings-shell plugins-game-modal plugins-game-modal--inline flex-col lg:flex-row",
      "data-testid": "plugins-shell",
      children: [
        showDesktopSubgroupSidebar &&
          (0, import_jsx_runtime.jsx)(AppPageSidebar, {
        ...
        (0, import_jsx_runtime.jsx)(PagePanel.ContentArea, {
          children: (0, import_jsx_runtime.jsx)("div", {
            ...
            children: (0, import_jsx_runtime.jsxs)(PagePanel, {
              ...
              children: [
                !isConnectorShellMode &&
                  (0, import_jsx_runtime.jsx)(PagePanel.Header, {
                    ...
                    actions: (0, import_jsx_runtime.jsx)(PagePanel.Meta, {
                      className:
                        "border-border/45 px-2.5 py-1 font-bold tracking-[0.16em] text-muted",
                ...
                (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                      ...
                      ? (0, import_jsx_runtime.jsx)("div", {
                          ...
                          children:
                            ...
                            (0, import_jsx_runtime.jsx)(Button, {
                              ...
                              size: "sm",
                              className:
                                "h-9 rounded-[var(--radius-sm)] px-4 text-xs-tight font-bold tracking-[0.12em]",
                    ...
                    showSubgroupFilters &&
                      (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "mb-5 flex items-center gap-2 flex-wrap lg:hidden",
                        "data-testid": "plugins-subgroup-chips",
                        children: subgroupTags.map((tag) =>
                          renderSubgroupFilterButton(tag),
                        ),
                      }),
                    (0, import_jsx_runtime.jsx)("div", {
                      ...
                      children:
                        sorted.length === 0
                          ? (0, import_jsx_runtime.jsx)(PagePanel.Empty, {
                              variant: "surface",
                              className:
                                "min-h-[18rem] rounded-[1.6rem] px-5 py-10",
                              description: t("pluginsview.NoneAvailableDesc", {
                                defaultValue:
                                  "No {{label}} are available right now.",
                                label: resultLabel,
                              }),
                          ...
                          : visiblePlugins.length === 0
                            ? (0, import_jsx_runtime.jsx)(PagePanel.Empty, {
                                variant: "surface",
                                className:
                                  "min-h-[16rem] rounded-[1.6rem] px-5 py-10",
                                description: showSubgroupFilters
 ...
 */
var ConnectorsPageView_exports = /* @__PURE__ */ __exportAll({
  ConnectorsPageView: () => ConnectorsPageView,
});
...
//#endregion
export {
  BlueBubblesStatusPanel as u,
  ConnectorSetupPanel as i,
  ConnectorsPageView as t,
  ConnectorsPageView_exports as n,
  DiscordLocalConnectorPanel as l,
  getBrandIcon as d,
  hasConnectorSetupPanel as a,
  PluginsView as r,
  registerConnectorSetupPanel as o,
  SignalQrOverlay as c,
  WhatsAppQrOverlay as s,
};
