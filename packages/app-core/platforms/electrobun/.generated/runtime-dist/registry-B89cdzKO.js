  ...
  return (0, import_jsx_runtime.jsxs)("section", {
    ...
    children: [
      (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              (0, import_jsx_runtime.jsx)(Music, {
      ...
      (0, import_jsx_runtime.jsx)("div", {
        ...
        children: MUSIC_LIBRARY_COMMANDS.map((command) =>
          (0, import_jsx_runtime.jsxs)(
            "div",
            {
              className:
                "min-w-0 rounded-xl border border-border/35 bg-card/45 px-3 py-2",
              children: [
                (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "mb-1 flex items-center gap-1.5 text-xs font-medium text-txt",
                  children: [
                    (0, import_jsx_runtime.jsx)("span", {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      !imageOnly
        ? (0, import_jsx_runtime.jsx)("div", {
            className:
              "absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(255,255,255,0.32),transparent_30%),radial-gradient(circle_at_82%_20%,rgba(255,255,255,0.18),transparent_26%),radial-gradient(circle_at_50%_100%,rgba(0,0,0,0.16),transparent_35%)]",
          })
        : null,
      imageSrc
        ...
        : (0, import_jsx_runtime.jsxs)("div", {
            className:
              "absolute inset-0 flex flex-col items-center justify-center gap-0.5 text-white",
            children: [
      ...
      active && !imageOnly
        ? (0, import_jsx_runtime.jsx)("span", {
            className:
              "absolute right-1.5 top-1.5 h-2.5 w-2.5 rounded-full border border-card bg-ok shadow-sm",
          })
        : null,
      !imageOnly
        ? (0, import_jsx_runtime.jsx)("div", {
            className:
              "absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-black/12 to-transparent",
          })
        : null,
      imageSrc && !imageOnly
        ? (0, import_jsx_runtime.jsx)("div", {
      ...
      useImage && imageSrc
        ...
        : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              ...
              (0, import_jsx_runtime.jsx)("div", {
                className:
                  "pointer-events-none absolute -right-6 -bottom-8 h-[68%] w-[68%] text-white/[0.22]",
      ...
      !imageOnly
        ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              (0, import_jsx_runtime.jsx)("div", {
                className:
                  "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,rgba(255,255,255,0.22),transparent_55%)]",
              }),
              (0, import_jsx_runtime.jsx)("div", {
                className:
                  "pointer-events-none absolute inset-x-0 bottom-0 h-3/5 bg-gradient-to-t from-black/60 via-black/20 to-transparent",
              }),
            ],
          })
        : null,
...
function filterAppsForCatalog(
  apps,
  {
    activeAppNames = /* @__PURE__ */ new Set(),
    isProd,
    searchQuery = "",
    showAllApps,
...
function groupAppsForCatalog(
  apps,
  { favoriteAppNames = /* @__PURE__ */ new Set() } = {},
) {
  const sections = [];
...
function WidgetSection({
  ...
  const titleContent = (0, import_jsx_runtime.jsxs)(
    import_jsx_runtime.Fragment,
    {
      children: [
        (0, import_jsx_runtime.jsx)("span", {
          className:
            "inline-flex shrink-0 items-center justify-center text-muted [&>svg]:h-3.5 [&>svg]:w-3.5",
          children: icon,
        }),
        (0, import_jsx_runtime.jsx)("span", {
          className:
            "truncate text-[11px] leading-none font-semibold uppercase tracking-[0.16em] text-muted",
          children: title,
        }),
      ],
    },
        ...
        children: [
          onTitleClick
            ? (0, import_jsx_runtime.jsx)("button", {
                ...
                className:
                  "inline-flex min-w-0 flex-1 items-center gap-1.5 rounded-[var(--radius-sm)] bg-transparent px-0.5 py-1 text-left transition-colors hover:text-txt",
                children: titleContent,
              })
            : (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex min-w-0 flex-1 items-center gap-1.5 px-0.5 py-1",
                children: titleContent,
              }),
          action,
        ],
...
const fallbackTranslate$1 = (key, vars) =>
...
function ActivityItemsContent({ events }) {
  if (events.length === 0)
    return (0, import_jsx_runtime.jsx)(EmptyWidgetState, {
  ...
  return (0, import_jsx_runtime.jsx)("div", {
    ...
    children: events.map((event) => {
      ...
      return (0, import_jsx_runtime.jsxs)(
        ...
        {
          className:
            "flex items-start gap-1.5 rounded-md px-1.5 py-1 transition-colors hover:bg-bg-hover/40",
          children: [
            (0, import_jsx_runtime.jsx)("span", {
              className:
                "shrink-0 whitespace-nowrap pt-0.5 text-3xs font-medium tabular-nums text-muted",
            ...
            (0, import_jsx_runtime.jsxs)("span", {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(EventIcon, {
            ...
            (0, import_jsx_runtime.jsx)("span", {
              className:
                "min-w-0 flex-1 break-words pt-0.5 text-2xs leading-4 text-txt",
  ...
  return (0, import_jsx_runtime.jsx)("div", {
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        (0, import_jsx_runtime.jsx)("div", {
          className:
            "w-20 shrink-0 overflow-hidden rounded-md border border-white/10 bg-black/10",
        ...
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mt-1 flex flex-wrap items-center gap-1.5 text-3xs text-muted",
              children: [
                (0, import_jsx_runtime.jsx)("span", {
                ...
                (0, import_jsx_runtime.jsx)("span", {
                  children: formatIsoTime(run.lastHeartbeatAt ?? run.updatedAt),
                }),
              ],
            }),
            (0, import_jsx_runtime.jsx)("div", {
            ...
            attentionReasons.length > 0
              ? (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "mt-1.5 flex items-center gap-1.5 text-3xs text-warn",
                  children: [
...
function AppRunsWidget(_props) {
  ...
  const attentionMap = useMemo(
    () => new Map(runs.map((run) => [run.runId, getRunAttentionReasons(run)])),
    [runs],
  );
  ...
  useEffect(() => {
    let cancelled = false;
    loadMergedCatalogApps({ includeHiddenApps: true })
      .then((apps) => {
  ...
  return (0, import_jsx_runtime.jsxs)(WidgetSection, {
    ...
    action: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)(Button, {
          ...
          children: (0, import_jsx_runtime.jsx)(SquareArrowOutUpRight, {
            className: "h-3.5 w-3.5",
          }),
        }),
      ],
    ...
    children: [
      error
        ? (0, import_jsx_runtime.jsx)("div", {
            className:
              "mb-2 rounded-md border border-danger/30 bg-danger/10 px-2 py-1.5 text-xs-tight text-danger",
            children: error,
          })
        : null,
      runs.length === 0
        ? loading
          ...
          : (0, import_jsx_runtime.jsx)(EmptyWidgetState, {
              icon: (0, import_jsx_runtime.jsx)(Activity, {
                className: "h-8 w-8",
              }),
        ...
        : (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex flex-wrap items-center gap-3 text-3xs text-muted",
                children: [
                  (0, import_jsx_runtime.jsxs)("span", {
              ...
              attentionRuns.length > 0
                ? (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "rounded-lg border border-warn/30 bg-warn/10 p-2",
                    children: [
                      (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "mb-1.5 flex items-center gap-1.5 text-3xs font-semibold uppercase tracking-[0.08em] text-warn",
                        children: [
                          (0, import_jsx_runtime.jsx)(AlertTriangle, {
                            className: "h-3 w-3",
                          }),
              ...
              (0, import_jsx_runtime.jsx)("div", {
                className: "flex flex-col gap-2",
                children: runs.slice(0, 4).map((run) =>
                  (0, import_jsx_runtime.jsx)(
                    AppRunCard,
                    {
                      run,
      ...
      children: rows.map((tab) => {
        ...
        return (0, import_jsx_runtime.jsxs)(
          "button",
          {
            ...
            className:
              "flex items-center gap-2 rounded-[var(--radius-sm)] px-0.5 py-0.5 text-left transition-colors hover:bg-bg-hover/40",
            children: [
              (0, import_jsx_runtime.jsx)("span", {
              ...
              (0, import_jsx_runtime.jsx)("span", {
                className:
                  "shrink-0 text-3xs uppercase tracking-wider text-muted/70",
...
function MusicPlayerSidebarWidget(_props) {
  ...
  useEffect(() => {
    ...
    const handler = () => {
      ...
      setAudioError(
        `${MEDIA_ERROR_NAMES[code] ?? `UNKNOWN(${code})`}: ${err?.message || "no details"}`,
      );
    };
  ...
  return (0, import_jsx_runtime.jsx)(WidgetSection, {
    ...
    action: (0, import_jsx_runtime.jsx)("button", {
      ...
      className:
        "inline-flex h-5 w-5 items-center justify-center rounded-[var(--radius-sm)] bg-transparent text-muted transition-colors hover:text-txt",
    ...
    children: (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
        isPlaying
          ? (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                (0, import_jsx_runtime.jsx)("button", {
                  ...
                  className:
                    "inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-[var(--radius-sm)] bg-transparent text-muted transition-colors hover:text-txt",
                  children: audioPaused
                ...
                (0, import_jsx_runtime.jsx)("span", {
                  className:
                    "min-w-0 flex-1 truncate text-3xs font-semibold text-txt",
          ...
          : (0, import_jsx_runtime.jsx)(EmptyWidgetState, {
              icon: (0, import_jsx_runtime.jsx)(Music, {
                className: "h-5 w-5",
              }),
              title:
                player.kind === "error"
        ...
        (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            showDescription
              ? (0, import_jsx_runtime.jsx)("p", {
                  className:
                    "mt-1 line-clamp-2 text-xs-tight leading-5 text-muted",
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      visibleTodos.map((todo) =>
        (0, import_jsx_runtime.jsx)(TodoRow, { todo }, todo.id),
      ),
      remainingCount > 0
...
const PRIMARY_CHAIN_KEYS = ["ethereum", "base", "bsc", "avax", "solana"];
/**
...
function ChainBadge({ chain }) {
  ...
  if (url)
    return (0, import_jsx_runtime.jsx)("img", {
      ...
      height: 16,
      className:
        "inline-flex h-4 w-4 shrink-0 rounded-full bg-bg/40 object-cover",
      onError: () => setErrored(true),
    });
  return (0, import_jsx_runtime.jsx)("span", {
    className:
      "inline-flex h-4 shrink-0 items-center rounded-full border border-border/35 bg-bg/40 px-1.5 font-mono text-[0.52rem] font-semibold leading-none text-muted",
    title: label,
    role: "img",
    "aria-label": label,
...
function ChainBadges({ chains }) {
  return (0, import_jsx_runtime.jsx)("span", {
    ...
    children: chains.map((chain) =>
      (0, import_jsx_runtime.jsx)(ChainBadge, { chain }, chain),
    ),
  });
}
          ...
          children: [
            evmAddress
              ? (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    (0, import_jsx_runtime.jsx)(ChainBadges, {
                      chains: evmChains,
                    }),
                    (0, import_jsx_runtime.jsxs)("div", {
            ...
            solanaAddress
              ? (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    (0, import_jsx_runtime.jsx)(ChainBadge, {
                      chain: "solana",
                    }),
                    (0, import_jsx_runtime.jsxs)("div", {
                      className: "flex items-center gap-1 min-w-0",
            ...
            hasAnyBalanceRow
              ? (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "mt-1 flex flex-col gap-1 border-t border-border/20 pt-1.5",
                  children: [
                    (0, import_jsx_runtime.jsxs)("div", {
...
function seedLegacyWidgets(definitions) {
  for (const def of definitions)
    registerWidgetComponent(def.pluginId, def.id, def.Component);
}
...
//#endregion
export {
  APP_CATALOG_SECTION_LABELS as C,
  AppHero as L,
  AppIdentityTile as R,
  BUILTIN_WIDGET_DECLARATIONS as t,
  CHAIN_CONFIGS as l,
  chainKeyToWalletRpcChain as d,
  EmptyWidgetState as y,
  filterAppsForCatalog as w,
  findAppBySlug as T,
  getAllOverlayApps as V,
  getAppCatalogSectionKey as E,
  getAppCategoryIcon as z,
  getAppShortName as D,
  getAppSlug as O,
  getAvailableOverlayApps as H,
  getChainConfig as f,
  getContractLogoUrl as p,
  getExplorerTokenUrl as m,
  getExplorerTxUrl as h,
  getInternalToolAppDescriptors as j,
  getInternalToolAppHasDetailsPage as M,
  getInternalToolApps as F,
  getInternalToolAppTargetTab as N,
  getInternalToolAppWindowPath as P,
  getNativeLogoUrl as g,
  getOverlayApp as U,
  getRunAttentionReasons as x,
  getStablecoinAddress as _,
  getWidgetComponent as n,
  groupAppsForCatalog as k,
  isInternalToolApp as I,
  isOverlayApp as W,
  loadMergedCatalogApps as S,
  normalizeInventoryImageUrl as c,
  overlayAppToRegistryInfo as G,
  PRIMARY_CHAIN_KEYS as u,
  registerBuiltinWidgetDeclarations as r,
  registerBuiltinWidgets as i,
  registerOverlayApp as K,
  registerWidgetComponent as a,
  resolveChainKey as v,
  resolveChatSidebarWidgets as o,
  resolveRuntimeImageUrl as B,
  resolveWidgetsForSlot as s,
  shouldShowAppInAppsView as A,
  WidgetSection as b,
};
