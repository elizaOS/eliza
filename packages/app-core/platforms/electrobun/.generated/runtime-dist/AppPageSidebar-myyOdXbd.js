...
const AppPageSidebar = React$1.forwardRef(function AppPageSidebar(
	{
		bottomAction,
		className,
					...
					children: [
						collapsible
							? (0, import_jsx_runtime.jsx)("button", {
									...
									className:
										"inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-[var(--radius-sm)] bg-transparent text-muted transition-colors hover:text-txt",
	...
	return (0, import_jsx_runtime.jsx)(Sidebar, {
		...
		className: joinClassNames(
			desktopDefaultVariant ? PAGE_SIDEBAR_ROOT_CLASS : void 0,
			className,
		),
		...
		collapseButtonClassName: joinClassNames(
			desktopDefaultVariant ? PAGE_SIDEBAR_COLLAPSE_BUTTON_CLASS : void 0,
			collapseButtonClassName,
		),
