...
function PrimaryButton({ children, disabled, icon, onClick, type = "button" }) {
  return (0, import_jsx_runtime.jsxs)("button", {
    ...
    onClick,
    className:
      "inline-flex h-9 items-center justify-center gap-2 rounded border border-border bg-primary px-3 text-sm font-medium text-primary-foreground disabled:cursor-not-allowed disabled:opacity-50",
    children: [
      icon,
...
function SecondaryButton({
  ...
  return (0, import_jsx_runtime.jsxs)("button", {
    ...
    onClick,
    className:
      "inline-flex h-9 items-center justify-center gap-2 rounded border border-border bg-bg px-3 text-sm font-medium text-txt disabled:cursor-not-allowed disabled:opacity-50",
    children: [
      icon,
      (0, import_jsx_runtime.jsx)("span", {
        className: "truncate",
  ...
  return (0, import_jsx_runtime.jsxs)("label", {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)("input", {
        ...
        className:
          "h-10 rounded border border-border bg-bg px-3 text-sm text-txt outline-none focus:border-primary",
      }),
    ],
  });
}
  ...
  return (0, import_jsx_runtime.jsxs)("label", {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)("textarea", {
        ...
        onChange: (event) => onChange(event.target.value),
        className:
          "min-h-24 rounded border border-border bg-bg px-3 py-2 text-sm text-txt outline-none focus:border-primary",
      }),
    ],
  });
}
function StatusNotice({ error, notice }) {
  if (error)
    return (0, import_jsx_runtime.jsx)("div", {
      className:
        "rounded border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive",
      children: error,
    });
  if (notice)
    return (0, import_jsx_runtime.jsx)("div", {
      className:
        "rounded border border-border bg-bg px-3 py-2 text-sm text-muted",
      children: notice,
    });
  return null;
}
...
function PhonePageView() {
  ...
  const createContact = async () => {
    ...
    try {
      ...
      setNotice(
        `Created contact ${
          (
            await plugins.contacts.plugin.createContact({
              displayName: name,
  ...
  const importVCardText = async (text) => {
    ...
    try {
      ...
      setNotice(
        `Imported ${(await plugins.contacts.plugin.importVCard({ vcardText: text })).imported.length} contact(s).`,
      );
      setVcardText("");
      await refresh();
      setActivePanel("contacts");
        ...
        children: [
          (0, import_jsx_runtime.jsx)("div", {
            ...
            children: (0, import_jsx_runtime.jsx)(SecondaryButton, {
              disabled: busy,
              icon: (0, import_jsx_runtime.jsx)(RefreshCw, {
                className: "h-4 w-4",
              }),
              onClick: refresh,
              children: "Refresh",
          ...
          (0, import_jsx_runtime.jsx)("div", {
            ...
            children:
              calls.length > 0
                ? calls.map((call) =>
                    (0, import_jsx_runtime.jsxs)(
                      "button",
                      {
                        ...
                        className:
                          "rounded border border-border bg-bg p-3 text-left text-sm hover:border-primary",
                        children: [
                          (0, import_jsx_runtime.jsxs)("div", {
                            className:
                          ...
                          (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "mt-1 flex flex-wrap items-center justify-between gap-2 text-xs text-muted",
                            children: [
                              (0, import_jsx_runtime.jsx)("span", {
                                children: call.number || "unknown number",
                              }),
                              (0, import_jsx_runtime.jsx)("span", {
                                children: formatTimestamp(call.date),
                              }),
                            ],
                          }),
                          call.agentTranscript || call.transcription
                            ? (0, import_jsx_runtime.jsx)("div", {
                                className:
                                  "mt-2 line-clamp-2 text-xs text-muted",
                                children:
                                  call.agentSummary ||
                ...
                : (0, import_jsx_runtime.jsx)(EmptyState, {
                    children: "No calls returned by Android.",
                  }),
          }),
        ],
      });
              ...
              contacts.length > 0
                ? contacts.map((contact) => {
                    ...
                    return (0, import_jsx_runtime.jsx)(
                      ...
                      {
                        className:
                          "rounded border border-border bg-bg p-3 text-sm",
                            ...
                            (0, import_jsx_runtime.jsxs)("div", {
                              ...
                              children: [
                                (0, import_jsx_runtime.jsx)(SecondaryButton, {
                                  ...
                                  icon: (0, import_jsx_runtime.jsx)(PhoneCall, {
                                    className: "h-4 w-4",
                                  }),
                                  onClick: () => {
                                ...
                                (0, import_jsx_runtime.jsx)(SecondaryButton, {
                                  ...
                                  onClick: () =>
                                    openMessagesForNumber(contactNumber),
                                  children: "SMS",
                                }),
                              ],
                            }),
                ...
                : (0, import_jsx_runtime.jsx)(EmptyState, {
                    children: "No contacts returned by Android.",
                  }),
          }),
        ],
      });
            ...
            (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                (0, import_jsx_runtime.jsx)(PrimaryButton, {
                  disabled: busy,
                  icon: (0, import_jsx_runtime.jsx)(FileUp, {
                    className: "h-4 w-4",
                  }),
          ...
          ? (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                selectedCall.transcription
                  ? (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "rounded border border-border bg-bg p-3 text-sm text-txt",
                      children: [
                        (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "mb-1 text-xs font-medium uppercase text-muted",
                ...
                (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    (0, import_jsx_runtime.jsx)(PrimaryButton, {
                      ...
                      icon: (0, import_jsx_runtime.jsx)(NotebookText, {
                        className: "h-4 w-4",
                      }),
                    ...
                    (0, import_jsx_runtime.jsx)(SecondaryButton, {
                      ...
                      icon: (0, import_jsx_runtime.jsx)(MessageSquare, {
                        className: "h-4 w-4",
                      }),
        ...
        children: [
                ...
                children: DIALPAD_KEYS.map((key) =>
                  (0, import_jsx_runtime.jsx)(
                    "button",
                    {
                      ...
                      className:
                        "aspect-[1.6] rounded border border-border bg-bg text-lg font-semibold text-txt hover:border-primary",
                      children: key,
                    },
                    key,
                  ),
          ...
          (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              (0, import_jsx_runtime.jsx)("div", {
                className:
                  "grid gap-1 rounded border border-border bg-bg p-3 text-sm text-muted",
                children:
                  status.length > 0
                    ? status.map((line) =>
                        (0, import_jsx_runtime.jsx)(
                  ...
                  roles.length > 0
                    ? roles.map((role) =>
                        (0, import_jsx_runtime.jsxs)(
                          ...
                          {
                            className:
                              "flex flex-wrap items-center justify-between gap-2 rounded border border-border bg-card p-2 text-sm",
                            children: [
                              (0, import_jsx_runtime.jsxs)("div", {
                                className: "min-w-0",
                                children: [
                              ...
                              (0, import_jsx_runtime.jsx)(SecondaryButton, {
                                ...
                                icon: (0, import_jsx_runtime.jsx)(ShieldCheck, {
                                  className: "h-4 w-4",
                                }),
                    ...
                    : (0, import_jsx_runtime.jsx)(EmptyState, {
                        children: "No Android roles returned.",
                      }),
                  (0, import_jsx_runtime.jsx)(SecondaryButton, {
                    disabled: busy,
                    icon: (0, import_jsx_runtime.jsx)(Settings, {
                      className: "h-4 w-4",
                    }),
                  ...
                  (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime.jsx)(PrimaryButton, {
                        ...
                        icon: (0, import_jsx_runtime.jsx)(UserPlus, {
                          className: "h-4 w-4",
                        }),
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)("div", {
        className: "flex flex-wrap gap-2",
        children: PHONE_PANEL_ITEMS.map((item) =>
          (0, import_jsx_runtime.jsxs)(
            "button",
            {
              type: "button",
              ...
              children: [
                item.icon,
                (0, import_jsx_runtime.jsx)("span", { children: item.label }),
              ],
            },
            item.id,
          ),
...
function MessagesPageView() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      setMessages(
        (await plugins.messages.plugin.listMessages({ limit: 100 })).messages,
      );
    } catch (err) {
      setError(err instanceof Error ? err.message : String(err));
    } finally {
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    className:
      "mx-auto grid w-full max-w-5xl gap-4 p-4 lg:grid-cols-[minmax(280px,360px)_1fr]",
    children: [
      (0, import_jsx_runtime.jsx)(Panel, {
        title: "Compose",
              ...
              ? (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        (0, import_jsx_runtime.jsx)("span", {
                          children: incomingSms.sender || "unknown sender",
                        }),
                        (0, import_jsx_runtime.jsx)("span", {
                          children: incomingSms.timestamp
          ...
          (0, import_jsx_runtime.jsx)("div", {
            ...
            children:
              messages.length > 0
                      ...
                      "div",
                      {
                        ...
                        children: [
                          (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              (0, import_jsx_runtime.jsx)("span", {
                                children: message.address || "unknown address",
                              }),
                              (0, import_jsx_runtime.jsxs)("span", {
                                children: [
                ...
                : (0, import_jsx_runtime.jsx)(EmptyState, {
                    children: "No messages returned by Android.",
                  }),
          }),
        ],
      }),
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      if (typeof plugins.contacts.plugin.listContacts !== "function")
        throw new Error("ElizaContacts plugin is unavailable");
      setContacts(
        (await plugins.contacts.plugin.listContacts(listOptions)).contacts,
      );
    } catch (err) {
      setError(err instanceof Error ? err.message : String(err));
    } finally {
