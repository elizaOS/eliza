...
uv run python scripts/validate_multi_robot_training_readiness.py --profiles hiwonder-ainex asimov-1 unitree-g1 unitree-h1 --commands "stand up" "walk forward" "turn left" "turn right" --video-evidence evidence/agent_videos
