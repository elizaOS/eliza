...
Minimum adjacent-interface clearance: 1.113 mm
Minimum neck/head/face adjacent-interface clearance: 68.034 mm
Minimum neck/head/face non-adjacent clearance: 297.955 mm
Minimum static non-adjacent clearance: 68.054 mm
Minimum operating dynamic non-adjacent sweep clearance: 29.313 mm
...
Open release gaps:
- STEP export status: exported (69/69 parts).
- STEP blocked parts: 0.
- Design source audit: pass (52 shell parts checked).
- Panel gap validation: pass (0 sampled nearby pairs below their seam/articulation gate).
- Worst adjacent/interface clearance: {"base_body": "right_shoulder_yaw_link", "base_geom": "geom_123", "base_geom_type": "mesh", "base_sample_point_m": [0.08148, -0.13786, 0.78664], "body_tree_distance": 1, "clearance_mm": 1.113, "part": "right_forearm_outer_blade", "part_body": "right_elbow_link", "part_sample_point_m": [0.08202, -0.13779, 0.78567], "part_to_base_vector_m": [-0.00054, -6e-05, 0.00097], "part_to_base_vector_mm": [-0.539, -0.065, 0.971]}.
- Worst non-adjacent static clearance: {"base_body": "left_shoulder_yaw_link", "base_geom": "geom_107", "base_geom_type": "mesh", "base_sample_point_m": [0.03551, 0.10323, 0.75048], "body_tree_distance": 5, "clearance_mm": 68.054, "part": "pelvis_front_shell", "part_body": "pelvis", "part_sample_point_m": [0.024, 0.044, 0.719], "part_to_base_vector_m": [0.01151, 0.05923, 0.03148], "part_to_base_vector_mm": [11.509, 59.229, 31.477]}.
- Worst operating non-adjacent dynamic pose: right_hip_yaw_joint_low__right_knee_joint_low.
