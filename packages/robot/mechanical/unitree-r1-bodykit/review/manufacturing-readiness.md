...
Parametric morphs applied: 11
Minimum adjacent-interface clearance: 1.526 mm
...
- Parametric reconstruction audit: needs-work (34 shell primitives still need loft reconstruction).
- Panel gap validation: pass (0 sampled nearby pairs below their seam/articulation gate).
- Worst adjacent/interface clearance: {"base_body": "waist_roll_link", "base_geom": "geom_69", "base_geom_type": "mesh", "base_sample_point_m": [0.0, -0.01625, 0.76815], "body_tree_distance": 1, "clearance_mm": 1.526, "part": "torso_abdomen_black", "part_body": "torso_link", "part_sample_point_m": [0.00037, -0.01622, 0.76667], "part_to_base_vector_m": [-0.00037, -3e-05, 0.00148], "part_to_base_vector_mm": [-0.371, -0.031, 1.48]}.
