...
def test_fembot_mold_dfm_screens_smooth_loft_processes() -> None:
    ...
    assert report["summary"]["injection_wall_adjustment_preview_cavity_clearance_failures"] == 26
    ...
    assert report["summary"]["injection_draw_ratio_screen_failures"] == 10
    assert report["summary"]["vacuform_draw_ratio_failures"] == 21
    ...
    assert shells["WAIST_YAW"]["injection_molding"]["draw_ratio_screen_ok"] is False
