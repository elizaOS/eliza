/** Routes an iPhone alarm request into the concrete owner scheduling surfaces available to the runtime; it does not claim native device creation. */
import { scenario } from "@elizaos/scenario-runner/schema";

export default scenario({
  lane: "live-only",
  id: "reminder.alarm.routes-ios-scheduling-flow",
