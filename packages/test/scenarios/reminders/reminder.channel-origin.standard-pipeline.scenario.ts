/** Proves a reminder requested from a messaging channel persists through the standard two-phase LifeOps pipeline; it does not claim device fan-out. */
import { scenario } from "@elizaos/scenario-runner/schema";

export default scenario({
  lane: "live-only",
  id: "reminder.channel-origin.standard-pipeline",
  title: "Reminder created from phone uses the standard reminder pipeline",
  domain: "reminders",
  evidenceScope: "domain-contract",
  tags: ["reminders", "lifeops", "channel-origin"],
  description:
