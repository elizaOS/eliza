/** Drives an unacknowledged reminder through every configured rung and proves none was suppressed as acknowledged. */
import { scenario } from "@elizaos/scenario-runner/schema";

/**
 * Deterministic unacknowledged-reminder control driving the real
...
const TITLE = "Call dentist unacknowledged ladder";
...
export default scenario({
  ...
  id: "reminder.escalation.unacknowledged-ladder",
  title: "Unacknowledged reminder continues through its escalation ladder",
  domain: "reminders",
  ...
  turns: [
    ...
    {
      kind: "api",
      name: "inspect unacknowledged reminder lifecycle",
      method: "GET",
