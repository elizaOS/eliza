/** Routes a Mac alarm request into the supported owner-calendar fallback and verifies the committed event result. */
...
export default scenario({
  lane: "live-only",
  id: "reminder.alarm.routes-macos-calendar-event",
