/** Drives the deterministic reminder processor and proves three ordered in-app ladder rungs before acknowledgement. */
...
export default scenario({
  ...
  id: "reminder.ladder.delivers-three-rungs",
  title: "Reminder ladder fires across all three rungs before acknowledgement",
  domain: "reminders",
  evidenceScope: "domain-contract",
  tags: ["pr", "deterministic", "reminders", "lifeops", "ladder"],
  description:
    "Deterministic reminder-ladder contract. Three in-app rungs must fire one per process pass before acknowledgement; this scenario makes no device-bus or cross-device delivery claim.",
