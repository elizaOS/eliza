/** Proves that acknowledging one delivered reminder rung suppresses every later in-app rung in the same plan. */
...
export default scenario({
  ...
  id: "reminder.ladder.acknowledged-suppresses-later",
  title: "Acknowledging one rung suppresses the remaining ladder",
  domain: "reminders",
  evidenceScope: "domain-contract",
  tags: ["pr", "deterministic", "reminders", "lifeops", "acknowledgement"],
  description:
    "Deterministic acknowledgement contract for one reminder plan. The first in-app rung fires, the owner acknowledges it, and every later rung is recorded as blocked_acknowledged rather than delivered.",
