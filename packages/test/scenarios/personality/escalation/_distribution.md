...
Escalation cases require an untreated baseline, at least two directional changes, an immediate hold probe after each change, and a terminal hold probe. Intended one- and two-turn brackets are therefore clamped into the 3–5-turn bracket, and `length:<bracket>` records the actual count.
...
|---:|---|---|---|---|---|---:|
| 1 | `escalation.polite.long_text.001` | len_3to5 | len_1 | polite | long_text | 5 |
| 2 | `escalation.neutral.short_text.002` | len_3to5 | len_2 | neutral | short_text | 5 |
| 3 | `escalation.frank.list.003` | len_3to5 | len_3to5 | frank | list | 5 |
...
| 9 | `escalation.aggressive.short_text.009` | len_3to5 | len_1 | aggressive | short_text | 5 |
| 10 | `escalation.hostile.list.010` | len_3to5 | len_2 | hostile | list | 5 |
...
| 17 | `escalation.neutral.list.017` | len_3to5 | len_1 | neutral | list | 5 |
| 18 | `escalation.frank.code.018` | len_3to5 | len_2 | frank | code | 5 |
| 19 | `escalation.aggressive.allcaps.019` | len_3to5 | len_3to5 | aggressive | allcaps | 5 |
...
| 25 | `escalation.hostile.code.025` | len_3to5 | len_1 | hostile | code | 5 |
| 26 | `escalation.polite.allcaps.026` | len_3to5 | len_2 | polite | allcaps | 5 |
| 27 | `escalation.neutral.multilang.027` | len_3to5 | len_3to5 | neutral | multilang | 5 |
...
| 33 | `escalation.frank.allcaps.033` | len_3to5 | len_1 | frank | allcaps | 5 |
| 34 | `escalation.aggressive.multilang.034` | len_3to5 | len_2 | aggressive | multilang | 5 |
