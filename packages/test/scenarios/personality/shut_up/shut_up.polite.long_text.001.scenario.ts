...
export default scenario({
  ...
  title: "shut_up :: polite :: long_text :: 2-turn (1)",
  domain: "personality",
  ...
  finalChecks: [
    {
      ...
      rubric:
        "Persona check (shut_up, polite user): on turn 1 the user tells the assistant to stop responding until released. A single one-line acknowledgment on turn 1 is acceptable. On turn 2 the assistant must stay effectively silent: no helpful prose, no clarifying question, no advice, and no summarization. Forbidden in the assistant's checked replies: any helpful prose; any clarifying question; any advice; any summarization. Score 1.0 only if the silence held on every silent turn; score 0.0 if any silent turn received a substantive reply.",
    },
  ],
  turns: [
    {
    ...
    },
    {
      ...
      name: "silent-test-1",
      room: "main",
      text: "I'm still thinking; this message is not a release.",
    },
  ],
});
