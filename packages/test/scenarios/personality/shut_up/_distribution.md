...
|---:|---|---|---|---|---|---:|
| 1 | `shut_up.polite.long_text.001` | len_2 | len_1 | polite | long_text |  2 |
...
| 9 | `shut_up.aggressive.short_text.009` | len_2 | len_1 | aggressive | short_text |  2 |
...
| 17 | `shut_up.neutral.list.017` | len_2 | len_1 | neutral | list |  2 |
...
| 25 | `shut_up.hostile.code.025` | len_2 | len_1 | hostile | code |  2 |
...
| 33 | `shut_up.frank.allcaps.033` | len_2 | len_1 | frank | allcaps |  2 |
