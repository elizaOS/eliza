...
try {
  ...
  for (const subpath of ['node', 'browser', 'edge', 'testing', 'runtime', 'client-public', 'media', 'media/attachments', 'media/fetch', 'media/image-description-cache', 'media/local-store', 'media/mime', 'media/mime-sniffer']) {
