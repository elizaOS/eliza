...
export async function generateTypeScriptDeclarations() {
	...
	await fs.writeFile(
		"dist/roles-rank.js",
		`// Roles-rank subpath entry point (explicit)\nexport * from './node/roles-rank.js';\n`,
	);
	await fs.writeFile(
		"dist/errors.js",
		`// Errors subpath entry point (explicit)\nexport * from './node/errors.js';\n`,
	);
	await fs.writeFile(
