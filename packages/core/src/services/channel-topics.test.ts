/**
 * Consolidated from colocated and __tests__/channel-topics suites.
 * Preserves all unique assertions including LRU, hydration, persistence, and matchTopicRooms.
...
// --- Merged from colocated: matchTopicRooms cross-channel search ---

describe("matchTopicRooms (merged from colocated)", () => {
