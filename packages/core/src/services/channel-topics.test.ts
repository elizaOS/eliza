 ...
 * room.metadata, hydration on restart, missing-room handling, and cross-room
 * search matching. The suite uses AgentRuntime and the real in-memory database adapter.
 */
import { afterEach, beforeEach, describe, expect, it } from "vitest";
import { createCharacter } from "../character.js";
import { InMemoryDatabaseAdapter } from "../database/inMemoryAdapter.js";
import { AgentRuntime } from "../runtime.js";
import type { Room, UUID } from "../types/index.js";
