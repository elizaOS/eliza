...
/**
 * SECRETS_UPDATE_SETTINGS action - extracts and saves setup settings from natural language.
 */
export const updateSettingsAction: Action = {
	...
	description:
		"Saves a configuration setting during the setup process. Use when setup with a world owner or admin.",
	parameters: [
		{
			name: "key",
