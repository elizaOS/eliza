...
const __bundle_safety_FEATURES_ADVANCED_CAPABILITIES_EXPERIENCE_INDEX__ = [_bs_1_searchExperiencesAction, _bs_2_experiencePatternEvaluator, _bs_3_experienceProvider];
// biome-ignore lint/suspicious/noExplicitAny: bundle-safety sink.
(globalThis as any).__bundle_safety_FEATURES_ADVANCED_CAPABILITIES_EXPERIENCE_INDEX__ = __bundle_safety_FEATURES_ADVANCED_CAPABILITIES_EXPERIENCE_INDEX__;
