...
function cloneForRecord<T>(value: T, redactText?: (text: string) => string): T {
...
class JsonFileTrajectoryRecorder implements TrajectoryRecorder {
	...
	private readonly redactToolDiagnostics: ToolDiagnosticTextRedactor;
	...
	constructor(opts: CreateJsonFileRecorderOptions = {}) {
		...
		this.redactToolDiagnostics = composeToolDiagnosticRedactor({
