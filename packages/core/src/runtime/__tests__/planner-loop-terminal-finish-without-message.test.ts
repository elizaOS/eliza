...
describe("planner-loop — terminal-only FINISH without evaluator message", () => {
	it.each([
		{ proposed: "B", correction: undefined },
		{
			proposed: "At 22:32 UTC: Mira’s backpack is orange.\nKeep  both spaces.",
			correction: undefined,
		},
		{
			proposed: "Mira’s backpack is black.",
			correction: "Mira’s backpack is orange.",
		},
	])(
		"finishes with the approved or corrected terminal reply: $proposed",
		async ({ proposed, correction }) => {
