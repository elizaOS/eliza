...
const CONTEXT_KEYWORD_STEMS: Record<string, readonly string[]> = {
	automation: ["action.createTask", "action.triggerCreate"],
	browser: ["contextSignal.web_search"],
	calendar: ["contextSignal.calendar"],
	contacts: ["action.searchContacts", "contextSignal.search_entity"],
	documents: ["action.processDocuments", "action.searchDocuments"],
	email: ["contextSignal.gmail"],
	messaging: [
	...
	phone: ["contextSignal.send_message"],
	social: ["contextSignal.send_message", "contextSignal.read_messages"],
	social_posting: ["contextSignal.send_message"],
	tasks: ["action.createTask", "action.manageTasks"],
	todos: ["action.createTask", "action.manageTasks"],
	web: ["contextSignal.web_search"],
};
