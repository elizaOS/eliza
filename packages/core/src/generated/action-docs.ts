...
export const allActionsSpec = {
  ...
  "actions": [
    ...
    {
      "name": "BLOCK",
      "description": "Block or unblock specific phone apps (Family Controls / Usage Access) ",
      "parameters": [
        {
          "name": "target",
      ...
      "descriptionCompressed": "block/unblock specific phone apps + desktop websites (NOT calendar time-blocks); actions block|unblock|status|request_permission|release|list_active; web requires confirmed:true",
      "exampleCalls": [
        {
    ...
    },
    {
      ...
      "parameters": [
        ...
        },
        {
          ...
          "descriptionCompressed": "details: calendarId start end (ISO-8601) eventId newTitle description location attendees timeMin timeMax timeZone — for create/update/delete_event only"
        },
        {
          "name": "durationMinutes",
