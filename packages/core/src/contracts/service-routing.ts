...
import { SERVICE_CAPABILITIES } from "@elizaos/core/contracts/service-routing-types";

export { DEPLOYMENT_TARGET_RUNTIMES } from "@elizaos/core/contracts/deployment-types";
export {
