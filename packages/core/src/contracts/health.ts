 ...
 * (`packages/testing/scenario-runner/test/mocks/fixtures/lifeops-presence-day.ts`) requires that the types
 * stay in `@elizaos/core`, and the cross-file dependencies inside
 ...
 *
 *   import type { LifeOpsHealthSignal } from "@elizaos/core";
 *
 * The runtime semantics are identical to importing from `@elizaos/core`
