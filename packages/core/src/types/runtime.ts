...
export interface MessageConnectorReactionParams extends MessageConnectorMessageOpParams {
  emoji: string;
}

export interface MessageConnectorEditParams extends MessageConnectorMessageOpParams {
  content: Content;
}

export interface MessageConnectorPinParams extends MessageConnectorMessageOpParams {
  pin?: boolean;
}
