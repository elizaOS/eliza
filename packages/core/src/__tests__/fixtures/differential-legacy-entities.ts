 ...
 * existed at the PR #27941 merge base — commit 126807701e, blob
 * 1bd2754a9515c7278b67c7cd90e9b8581f5a30fa (git blob sha1). Regeneration verifies the bytes still
 * hash to the pinned blob. Generated by
 * generate-differential-fixture.mjs from verified git bytes.
