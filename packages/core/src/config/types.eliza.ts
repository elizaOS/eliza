...
import { type AudioConfig } from "./types.messages.js";
import { type BroadcastConfig } from "./types.messages.js";
import { type CustomActionDef } from "../contracts/config.js";
import { type DatabaseProviderType } from "../contracts/config.js";
import { type DeploymentTargetConfig } from "../contracts/service-routing.js";
import { type DiscoveryConfig } from "./types.gateway.js";
import { type GatewayConfig } from "./types.gateway.js";
import { type HooksConfig } from "./types.hooks.js";
import { type LinkedAccountFlagsConfig } from "../contracts/service-routing.js";
import { type MediaConfig } from "../contracts/config.js";
import { type MessagesConfig } from "./types.messages.js";
import { type ReleaseChannel } from "../contracts/config.js";
import { type RolesConfig } from "../roles.js";
import { type ServiceRoutingConfig } from "../contracts/service-routing.js";
import { type SessionConfig } from "../types/channel-config.js";
import { type SessionSendPolicyConfig } from "../types/channel-config.js";
import { type TalkConfig } from "@elizaos/core/config/types.gateway";
import { type ToolsConfig } from "@elizaos/core/config/types.tools";
export type { AudioElevenlabsConfig, AudioElevenlabsSfxConfig, AudioElevenlabsVoiceSettings, AudioFalConfig, AudioGenConfig, AudioGenProvider, AudioKind, AudioProviderRoutingConfig, AudioSunoConfig, CustomActionDef, CustomActionHandler, DatabaseProviderType, ImageConfig, ImageFalConfig, ImageGoogleConfig, ImageOpenaiConfig, ImageProvider, ImageXaiConfig, MediaConfig, MediaMode, ReleaseChannel, VideoConfig, VideoFalConfig, VideoGoogleConfig, VideoOpenaiConfig, VideoProvider, VisionAnthropicConfig, VisionConfig, VisionGoogleConfig, VisionOllamaConfig, VisionOpenaiConfig, VisionProvider, VisionXaiConfig, } from "@elizaos/core/contracts/config";
...
export type ModelApi = "openai-completions" | "openai-responses" | "anthropic-messages" | "google-generative-ai" | "bedrock-converse-stream";
...
export type ConnectorFieldValue = string | number | boolean | string[] | {
...
export type ConnectorConfig = {
    [key: string]: ConnectorFieldValue;
};
export type ElizaConfig = {
    ...
    wallet?: {
        ...
        cloud?: Partial<Record<"evm" | "solana", {
