...
- named-person relationship requests ("follow up with David", "last talked to Alice", "how long since I spoke with Sam") must include contacts when available; add tasks only as a secondary context for reminders
