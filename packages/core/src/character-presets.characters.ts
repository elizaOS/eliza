...
export const CHARACTER_DEFINITIONS: CharacterDefinition[] = [
    {
        ...
        // setDefaultAgentName).
        templates: {
            authFailedReply: "I can't connect because this account isn't authorized. The account owner needs to fix that before you retry.",
            insufficientCreditsReply: "I can't respond because this account has no usage left. The account owner needs to add more.",
            noModelProviderReply: "I can't respond because I'm not connected yet. The person setting me up needs to finish that first.",
            rateLimitedReply: "Too many requests reached me at once. Try again in a few seconds.",
            transientFailureReply: "Something went wrong before I could answer. Try again in a moment.",
        },
        style: {
            all: [
