...
class MockDatabaseAdapter extends DatabaseAdapter {
  ...
  updateEntity(_entity: Entity): Promise<void> {
    throw new Error("Method not implemented.");
  }
  getComponent(
    _entityId: UUID,
  ...
  createComponent(_component: Component): Promise<boolean> {
    throw new Error("Method not implemented.");
  }
  updateComponent(_component: Component): Promise<void> {
    throw new Error("Method not implemented.");
  }
  deleteComponent(_componentId: UUID): Promise<void> {
    throw new Error("Method not implemented.");
  }
  getLogs(_params: {
    entityId?: UUID;
  ...
  deleteLog(_logId: UUID): Promise<void> {
    throw new Error("Method not implemented.");
  }
  getWorld(_id: UUID): Promise<World | null> {
    throw new Error("Method not implemented.");
  }
  getAllWorlds(): Promise<World[]> {
    throw new Error("Method not implemented.");
  }
  createWorld(_world: World): Promise<UUID> {
    throw new Error("Method not implemented.");
  }
  updateWorld(_world: World): Promise<void> {
    throw new Error("Method not implemented.");
  }
  removeWorld(_id: UUID): Promise<void> {
    throw new Error("Method not implemented.");
  }
  getRooms(_worldId: UUID): Promise<Room[]> {
    throw new Error("Method not implemented.");
  }
  updateRoom(_room: Room): Promise<void> {
    throw new Error("Method not implemented.");
  }
  deleteRoom(_roomId: UUID): Promise<void> {
    throw new Error("Method not implemented.");
  }
  getParticipantsForEntity(_entityId: UUID): Promise<Participant[]> {
    throw new Error("Method not implemented.");
  }
  updateRelationship(_params: {
    sourceEntityId: UUID;
    targetEntityId: UUID;
    tags?: string[];
  ...
  getAgent(_agentId: UUID): Promise<Agent | null> {
    throw new Error("Method not implemented.");
  }
  getAgents(): Promise<Agent[]> {
    throw new Error("Method not implemented.");
  }
  createAgent(_agent: Partial<Agent>): Promise<boolean> {
    throw new Error("Method not implemented.");
  }
  updateAgent(_agentId: UUID, _agent: Partial<Agent>): Promise<boolean> {
    throw new Error("Method not implemented.");
  }
  deleteAgent(_agentId: UUID): Promise<boolean> {
    throw new Error("Method not implemented.");
  }
  ensureAgentExists(_agent: Partial<Agent>): Promise<void> {
    throw new Error("Method not implemented.");
  }
  ensureEmbeddingDimension(_dimension: number): Promise<void> {
    throw new Error("Method not implemented.");
  }
  getCache<T>(_key: string): Promise<T | undefined> {
    throw new Error("Method not implemented.");
  }
  setCache<T>(_key: string, _value: T): Promise<boolean> {
    throw new Error("Method not implemented.");
  }
  deleteCache(_key: string): Promise<boolean> {
    throw new Error("Method not implemented.");
  }
  createTask(_task: Task): Promise<UUID> {
    throw new Error("Method not implemented.");
  }
  getTasks(_params: { roomId?: UUID; tags?: string[] }): Promise<Task[]> {
    throw new Error("Method not implemented.");
  }
  getTask(_id: UUID): Promise<Task | null> {
    throw new Error("Method not implemented.");
  }
  getTasksByName(_name: string): Promise<Task[]> {
    throw new Error("Method not implemented.");
  }
  updateTask(_id: UUID, _task: Partial<Task>): Promise<void> {
    throw new Error("Method not implemented.");
  }
  deleteTask(_id: UUID): Promise<void> {
    throw new Error("Method not implemented.");
  }
  /**
