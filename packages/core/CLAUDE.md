...
- Define runtime contracts under `src/types` or their owning core module and export through the root barrel. Pure reusable contracts and runtime primitives belong to core; host/HTTP contracts belong to shared or the host.
