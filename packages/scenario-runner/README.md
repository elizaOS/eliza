...
`strict-fixtures` or `model-free`. The migration ratchet currently records 47
strict or explicitly model-free and 73 legacy `pr-deterministic` scenario sources across
