...
export interface MessagingTrajectoryReceipt {
  exportId: string;
...
function parseReplay(value: unknown): MessagingReplayReceipt {
...
function parseTrajectory(value: unknown): MessagingTrajectoryReceipt {
