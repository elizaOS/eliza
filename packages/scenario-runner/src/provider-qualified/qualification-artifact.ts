...
import {
  authorizeProviderQualificationArtifactForRelease,
  type ProviderQualificationReleaseTrustPolicy,
} from "./release-trust-policy.ts";
import { requireCanonicalProviderCanaryScenarioDefinition } from "./scenario-snapshot.ts";
import type {
...
export const PROVIDER_QUALIFICATION_ARTIFACT_SCHEMA =
  "eliza.provider-qualification-artifact.v6" as const;
export const PROVIDER_QUALIFICATION_VERIFIER_TRANSCRIPT_SCHEMA =
  "eliza.provider-qualification-verifier-transcript.v2" as const;
...
export interface ProviderQualificationVerifierTranscript {
  ...
  proofDigests: {
    ...
    deploymentAttestationIssuerPinsSha256: string;
...
export interface ProviderQualificationReverificationCapsule {
  ...
  publicKeyPins: {
    ...
    deploymentAttestationIssuers: readonly [
      ProviderQualificationPublicKeyPin,
      ...ProviderQualificationPublicKeyPin[],
    ];
  ...
  return snapshot(
    {
      ...
      proofDigests: {
        ...
        deploymentAttestationIssuerPinsSha256: canonicalSha256(
          input.pins.deploymentAttestationIssuers,
          "deploymentAttestationIssuerPins",
        ),
  ...
  return snapshot(
    {
      ...
      rawControllerMaterialSha256: input.rawControllerMaterialSha256,
      observerDeploymentAttestationSha256:
        input.observerDeploymentAttestationSha256,
...
export function reverifyProviderQualificationArtifact(
  ...
  requireCanonicalProviderCanaryScenarioDefinition(
    artifact.reverification.scenarioDefinition,
  );
  authorizeProviderQualificationArtifactForRelease({
    artifact,
  ...
  const deploymentAttestationIssuerKeys = publicKeyPem(
    capsule.publicKeyPins.deploymentAttestationIssuers,
    "reverification.publicKeyPins.deploymentAttestationIssuers",
  );
  ...
  const decision = deriveProviderQualification({
    ...
    pinnedDeploymentAttestationIssuerPublicKeysPem:
      deploymentAttestationIssuerKeys,
  ...
  const expectedReport = qualifiedReportProjection({
    ...
    rawControllerMaterialSha256:
      expectedTranscript.proofDigests.rawControllerMaterialSha256,
    observerDeploymentAttestationSha256:
      expectedTranscript.proofDigests.observerDeploymentAttestationSha256,
  ...
  if (
    ...
    artifact.observerEvidenceSha256 !==
      expectedTranscript.proofDigests.observerEnvelopeSha256 ||
    artifact.rawControllerMaterialSha256 !==
      expectedTranscript.proofDigests.rawControllerMaterialSha256 ||
    artifact.observerDeploymentAttestationSha256 !==
      expectedTranscript.proofDigests.observerDeploymentAttestationSha256 ||
...
export function validateProviderQualificationArtifact(
  ...
  if (
    ...
    artifact.reverification.signedObserverEvidence.payload
      .rawControllerMaterialSha256 !== artifact.rawControllerMaterialSha256 ||
    artifact.reverification.signedSemanticJudgeEvidence.payload
      .rawControllerMaterialSha256 !== artifact.rawControllerMaterialSha256 ||
    artifact.reverification.signedSemanticJudgeEvidence.payload
      .observerEvidenceSha256 !== artifact.observerEvidenceSha256 ||
    artifact.reverification.signedSemanticJudgeEvidence.payload
      .observerDeploymentAttestationSha256 !==
      artifact.observerDeploymentAttestationSha256 ||
...
export function assembleProviderQualificationArtifact(
  ...
  const deploymentAttestationIssuers =
  ...
  const decision = deriveProviderQualification({
    ...
    pinnedDeploymentAttestationIssuerPublicKeysPem:
      deploymentAttestationIssuers.map((pin) => pin.spkiPem) as [
        string,
        ...string[],
      ],
  ...
  const rawControllerMaterialSha256 =
    verifierTranscript.proofDigests.rawControllerMaterialSha256;
  const observerDeploymentAttestationSha256 =
    verifierTranscript.proofDigests.observerDeploymentAttestationSha256;
