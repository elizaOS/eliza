...
describe("provider controller-orchestrator bridge", () => {
  ...
  it("passes one Google raw-controller result through remote signers and the real qualifier", async () => {
    ...
    const deploymentAttestationIssuer = generateKeyPairSync("ed25519");
    ...
    const deploymentAttestationIssuerPem = publicPem(
      ...
      observer: {
        ...
        async complete() {
          ...
          const statement = {
            ...
            issuerKeyId: providerObserverKeyId(deploymentAttestationIssuerPem),
            ...
            issuedAtIso: iso(7_000),
            expiresAtIso: iso(240_000),
          } as const;
          return {
            deploymentAttestation: {
              ...
              signature: signPayload(
                ...
                deploymentAttestationIssuer.privateKey,
              ).toString("base64url"),
            },
    ...
    const result = await executeExternalProviderCanary({
      ...
      pinnedDeploymentAttestationIssuerPublicKeysPem: [
        deploymentAttestationIssuerPem,
      ],
      pinnedSemanticJudgePublicKeysPem: [judgePem],
      capabilities: {
