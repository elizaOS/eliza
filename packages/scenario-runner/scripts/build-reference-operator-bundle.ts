...
function configurationTemplate(): unknown {
  ...
  const responseAuthentication = (administrativeDomain: string) => ({
    responseOrganizationId: administrativeDomain,
    responsePublicKeyPem: placeholderPem,
    responseKeyId: placeholderHash,
    responseServiceIdentitySha256: placeholderHash,
  });
    ...
    PROVIDER_CANARY_SCENARIO_IDS.map((scenarioId) => {
      ...
      return [
        scenarioId,
        {
          ...
          observerAttestationStatementSha256: placeholderHash,
          controller: {
            ...
            ...responseAuthentication("controller-operator"),
          },
          observer: {
            ...
            ...responseAuthentication("independent-observer"),
          },
          semanticJudge: {
            ...
            keyId: placeholderHash,
            serviceIdentitySha256: placeholderHash,
            ...responseAuthentication("independent-judge"),
          },
          cleanup: {
            ...
            ...responseAuthentication("cleanup-operator"),
          },
          pinnedObserverPublicKeysPem: [placeholderPem],
          pinnedDeploymentAttestationIssuerPublicKeysPem: [placeholderPem],
  ...
  return {
    ...
    secretBrokerAdministrativeDomain: "secret-broker-operator",
    secretBrokerOrganizationId: "secret-broker-operator",
    secretBrokerPublicKeyPem: placeholderPem,
    secretBrokerKeyId: placeholderHash,
    secretBrokerServiceIdentitySha256: placeholderHash,
    deployments,
  };
}
