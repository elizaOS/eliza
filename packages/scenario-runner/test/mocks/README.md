...
| `eliza-cloud-managed-google` | OAuth connection list; agent connector binding list | No live Google consent callback, vault token refresh, or authenticated MCP tool call |
