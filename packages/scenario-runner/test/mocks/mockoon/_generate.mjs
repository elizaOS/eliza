  ...
  routes: [
    ...
    route(
      ...
      "v1/eliza/plaid/sync",
      {
        added: [
          {
            transaction_id: "txn_2026_05_09_a",
            account_id: "acct_001",
            amount: 4.75,
          ...
          {
            transaction_id: "txn_2026_05_09_b",
            account_id: "acct_001",
            amount: 18.42,
            iso_currency_code: "USD",
            unofficial_currency_code: null,
          ...
          {
            transaction_id: "txn_2026_05_09_c",
            account_id: "acct_002",
            amount: -2500.0,
            iso_currency_code: "USD",
            unofficial_currency_code: null,
    ...
    route("post", "v1/eliza/plaid/revoke", { revoked: true }, "plaid"),
  ],
});
