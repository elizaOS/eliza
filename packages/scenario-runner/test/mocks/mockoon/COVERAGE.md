...
| plaid           | 18809 | Plaid via Eliza Cloud relay (`/v1/eliza/plaid/link-token`, `exchange`, `sync`, `revoke`)  | `lifeops.payments/payments.plaid-mfa-fail`, `test/scenarios/payments/` (2 scenarios) |
