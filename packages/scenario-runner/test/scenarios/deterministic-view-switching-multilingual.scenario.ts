/**
 * Exercises structured navigation authority against localized request text.
...
import { CURATED_MULTILINGUAL } from "../../../../plugins/plugin-app-control/src/actions/view-matrix.fixtures";
import {
  jsonResponse,
...
const inputs = CURATED_MULTILINGUAL.map(({ lang, phrase }) => ({
  name: `${lang}: ${phrase}`,
  text: phrase,
}));
const views = [
...
export default scenario({
  ...
  title: "Structured navigation authority with localized request text",
  domain: "scenario-runner",
  tags: ["pr", "deterministic", "app-control", "views", "multilingual"],
