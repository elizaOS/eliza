    ...
    fixtures: [
      ...
      },
      {
        ...
        match: {
          ...
          // Capability-discovery coverage owns the exact progressive surface.
          // This route remains strict on model type and current-turn input so
          // context-expanded children and global discovery tools may evolve
          // without turning a TODO execution test into a stale roster test.
        },
        response: {
          json: {
            text: "",
