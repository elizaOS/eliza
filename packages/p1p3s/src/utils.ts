...
import type { ExpressionStatement, Node as SyntaxNode } from 'esprima-next';
import { parse as esprimaParse, Syntax } from 'esprima-next';
import FormData from 'form-data';
import { jsonrepair } from 'jsonrepair';
import merge from 'lodash/merge.js';
import { ALPHABET } from './constants.js';
import { ManualExecutionCancelledError } from './errors/execution-cancelled.error.js';
import type { BinaryFileType, IDisplayOptions, INodeProperties, JsonObject } from './interfaces.js';
...
export function isCommunityPackageName(packageName: string): boolean {
	...
	// Community packages names start with <@username/>workflows-nodes- not followed by word 'base'
