...
export const IWorkflowsRequestOperationPaginationBaseSchema = z.object({
	type: z.string(),
	properties: z.record(z.string(), z.unknown()),
});

export const IWorkflowsRequestOperationPaginationGenericSchema: z.ZodType<IWorkflowsRequestOperationPaginationGeneric> =
	IWorkflowsRequestOperationPaginationBaseSchema.extend({
...
export const IWorkflowsRequestOperationPaginationOffsetSchema: z.ZodType<IWorkflowsRequestOperationPaginationOffset> =
	IWorkflowsRequestOperationPaginationBaseSchema.extend({
...
export const IWorkflowsRequestOperationsSchema: z.ZodType<IWorkflowsRequestOperations> = z.object({
	pagination: z
		.union([
			IWorkflowsRequestOperationPaginationGenericSchema,
			IWorkflowsRequestOperationPaginationOffsetSchema,
...
export const INodePropertyRoutingSchema: z.ZodType<INodePropertyRouting> = z.object({
	operations: IWorkflowsRequestOperationsSchema.optional(),
