...
describe('x402 Middleware', () => {
  ...
  describe('createX402Middleware', () => {
    ...
    test('should throw error when wallet address does not start with 0x', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
      process.env.X402_WALLET_ADDRESS = '1234567890123456789012345678901234567890';
      ...
      // Act & Assert
      expect(() => createX402Middleware(routeConfig)).toThrow(
        'X402_WALLET_ADDRESS must start with 0x'
      );
    });

    test('should throw error when wallet address is too short', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
      process.env.X402_WALLET_ADDRESS = '0x123456';
      ...
      // Act & Assert
      expect(() => createX402Middleware(routeConfig)).toThrow(
        'X402_WALLET_ADDRESS must be 42 characters long'
      );
    });

    test('should throw error when wallet address is too long', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
      process.env.X402_WALLET_ADDRESS = '0x12345678901234567890123456789012345678901234';
    ...
    test('should throw error when wallet address contains non-hex characters', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
      process.env.X402_WALLET_ADDRESS = '0x123456789012345678901234567890123456GHIJ';
      ...
      // Act & Assert
      expect(() => createX402Middleware(routeConfig)).toThrow(
        'X402_WALLET_ADDRESS must be a valid Ethereum address'
      );
    });

    test('should accept valid lowercase wallet address', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
    ...
    test('should accept valid uppercase wallet address', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
      process.env.X402_WALLET_ADDRESS = '0x1234567890ABCDEF1234567890ABCDEF12345678';
    ...
    test('should accept valid mixed case wallet address', () => {
      // Arrange - reset env
      process.env = { ...originalEnv };
      process.env.X402_ENABLED = 'true';
      process.env.X402_WALLET_ADDRESS = '0x1234567890AbCdEf1234567890aBcDeF12345678';
