...
<CardGroup cols={2}>
  <Card title="Add Capabilities" icon="puzzle-piece" href="/plugins/architecture">
  ...
  <Card title="Connect Platforms" icon="plug" href="/plugins/registry">
...
The message pipeline executes planned tool calls through the planned-tool executor:
...
await executePlannedToolCall(
  runtime,
  { message, state, activeContexts, userRoles },
