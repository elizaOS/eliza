...
```json
{
  ...
  "scripts": {
    ...
    "build:desktop": "ELIZA_APP_NAME=Milady ELIZA_APP_ID=com.miladyai.milady ELIZA_NAMESPACE=milady node scripts/run-eliza-app-core-script.mjs desktop-build.mjs build --variant=base",
