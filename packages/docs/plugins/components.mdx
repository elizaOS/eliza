...
| `MESSAGE` | Send to specific room | "Message the team..." |
...
| Action           | Description      | Example Trigger    |
| ---------------- | ---------------- | ------------------ |
| `GENERATE_MEDIA` | Create AI media  | "Draw a cat"       |
...
| `documentsProvider`      | Character Knowledge | Document snippets, recent documents |
