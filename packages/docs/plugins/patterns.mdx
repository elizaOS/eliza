...
For the action result shape, see [The ActionResult Interface](#the-actionresult-interface). For component basics, see [Plugin Components](/plugins/architecture).
...
<Tip>
  **Guides**: [Create a Plugin](/plugins/create-a-plugin) | [Publish a
  Plugin](/plugins/publish)
</Tip>
...
<Card title="Plugin Schemas" icon="list" href="/plugins/schemas">
  ...
  <Card title="Plugin Migration" icon="arrow-right" href="/plugins/plugin-eject">
