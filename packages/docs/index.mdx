---
title: Overview
description: "elizaOS — the agentic operating system. Build agents in TypeScript, Python, or Rust."
---

<img src="/brand/banners/elizaos_banner.svg" alt="elizaOS" />

<Tip>
  **elizaOS** — the open agentic operating system. Three commands. Runs
  anywhere.
</Tip>

## Build agents in your language
...
<Tabs>
  <Tab title="TypeScript">
    ```bash npx elizaos create my-agent-app --template project cd my-agent-app
