...
| [Local AI](https://github.com/elizaos-plugins/plugin-local-ai) | `@elizaos/plugin-local-inference` | — | À la demande | **Modèles locaux en processus.** Exécute des modèles GGUF directement sans serveur externe. |
