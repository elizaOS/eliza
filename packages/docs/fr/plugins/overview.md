...
2. **Plugins pré-enregistrés** — `@elizaos/plugin-sql` et `@elizaos/plugin-local-inference` sont pré-enregistrés avant `runtime.initialize()` pour éviter les conditions de concurrence.
