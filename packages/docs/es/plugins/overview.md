...
2. **Plugins pre-registrados** — `@elizaos/plugin-sql` y `@elizaos/plugin-local-inference` se pre-registran antes de `runtime.initialize()` para prevenir condiciones de carrera.
