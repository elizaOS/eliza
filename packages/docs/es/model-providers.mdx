...
| [Local AI](https://github.com/elizaos-plugins/plugin-local-ai) | `@elizaos/plugin-local-inference` | — | Bajo demanda | **Modelos locales en proceso.** Ejecuta modelos GGUF directamente sin servidor externo. |
