...
The per-source transform matrix is generated by
[`scripts/prepare_native_tool_calling_data.py`](scripts/prepare_native_tool_calling_data.py)
at `data/native/SOURCE_MATRIX.md`.
...
the command and generated-artifact inventory above; the separate trajectory
alignment audit note was never committed to this repository.
