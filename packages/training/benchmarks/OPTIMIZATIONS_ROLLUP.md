...
- **GPU `optimize_for_milady.py` re-run** — TurboQuant now *calibrates* (it auto-skipped on CPU) → `milady_manifest.json` carries the real `tbq3_0` V-cache config.
