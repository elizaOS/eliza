#!/usr/bin/env python3
"""Validate DFlash release policy or a distilled drafter against its target.
...
Checks performed:
  ...
  0. For DFlash-disabled tiers (currently 0_8b), no drafter GGUF is allowed;
     validation emits an explicit fail-open no-drafter policy report.
