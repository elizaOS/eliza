"""Build the eliza-1-2b full-corpus SFT splits.

Concatenates the benchmark-aligned `datasets/eliza1-sft-2b/{train,val,test}.jsonl`
...
SRC_BENCH = ROOT / "datasets" / "eliza1-sft-2b"
