...
This is the top rung of the Eliza-1 GGUF ladder. It intentionally reuses the
same llama.cpp conversion path as the Q6_K wrapper, changing only the
quantization level and sidecar name so the train -> quantize -> publish
pipeline stays reproducible across Q3_K_M/Q4_K_M/Q5_K_M/Q6_K/Q8_0.
"""
