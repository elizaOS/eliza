...
AGENT_NAMES = [
    ...
    "milady", "Eliza", "Hex", "Cipher", "Quill", "Cobalt",
]
...
def random_memory(rng: random.Random, persona: dict, agent: str,
    ...
    pool_user = [
        f"hey, you around?",
        f"need help with something quick",
        f"working on the deploy",
        f"the build is broken on main",
        f"can you double-check this",
        f"looking at the {rng.choice(['logs', 'metrics', 'CI run', 'PR'])}",
        f"got a sec?",
        f"earlier today I was working on auth",
        f"so I rebased onto develop",
        f"the test suite is flaky again",
    ]
    pool_agent = [
        f"yes, what's up?",
        f"sure — I'm here.",
...
COMPUTER_SCENARIOS = [
    ...
    {"op": "type", "msg": "enter the text 'milady-deploy-v2'",
     "args": {"action": "type", "text": "milady-deploy-v2"}},
...
ASSIGN_ISSUE_SCENARIOS = [
    ...
    {"msg": "add bob as assignee on milady/milady#101",
     "args": {"repo": "milady/milady", "number": 101, "assignees": ["bob"]}},
    ...
    {"msg": "put hina on milady/training#88",
     "args": {"repo": "milady/training", "number": 88, "assignees": ["hina"]}},
    ...
    {"msg": "raj should own milady/training#3, confirmed",
     "args": {"repo": "milady/training", "number": 3, "assignees": ["raj"], "confirmed": True}},
...
CREATE_ISSUE_SCENARIOS = [
    ...
    {"msg": "create a bug report in milady/milady: 'Crash on startup when ANTHROPIC_API_KEY is empty' (confirmed)",
     "args": {"repo": "milady/milady", "title": "Crash on startup when ANTHROPIC_API_KEY is empty",
              "body": "Repro: launch milady with empty key — runtime panics in eliza.ts.",
              "confirmed": True}},
    ...
    {"msg": "open 'Update CONTRIBUTING.md' on elizaOS/eliza, assignees [noah]",
     "args": {"repo": "elizaOS/eliza", "title": "Update CONTRIBUTING.md",
              ...
              "assignees": ["noah"]}},
    {"msg": "create a feature request: 'Add /reset slash command' in milady/milady (confirmed)",
     "args": {"repo": "milady/milady", "title": "Add /reset slash command",
...
LIST_PRS_SCENARIOS = [
    ...
    {"msg": "list closed PRs on milady/milady",
     "args": {"repo": "milady/milady", "state": "closed"}},
    ...
    {"msg": "list PRs on milady/training",
     "args": {"repo": "milady/training"}},
...
REVIEW_PR_SCENARIOS = [
    ...
    {"msg": "leave a comment on milady/milady#7: 'looking good, minor nit on naming'",
     "args": {"repo": "milady/milady", "number": 7, "action": "comment",
    ...
    {"msg": "post 'thanks!' as a comment on milady/training#41",
     "args": {"repo": "milady/training", "number": 41, "action": "comment",
              "body": "thanks!"}},
