...
def test_lookup_by_hf_id_short_name_or_eliza_name() -> None:
    ...
    assert get("Qwen/Qwen3.5-9B-Base").short_name == "qwen3.5-9b"
    ...
    assert get("27b-128k").short_name == "qwen3.6-27b"
    assert get("27b-256k").short_name == "qwen3.6-27b"
    assert get("qwen3.6-27b-128k").short_name == "qwen3.6-27b"
    assert get("qwen3.6-27b-256k").short_name == "qwen3.6-27b"
    assert get("Qwen/Qwen3.6-27B-128K").short_name == "qwen3.6-27b"
    assert get("Qwen/Qwen3.6-27B-256K").short_name == "qwen3.6-27b"
    assert get("Qwen/Qwen3.5-27B-128K").short_name == "qwen3.6-27b"
    assert get("Qwen/Qwen3.5-27B-256K").short_name == "qwen3.6-27b"
    assert get("eliza-1-27b-128k").short_name == "qwen3.6-27b"
