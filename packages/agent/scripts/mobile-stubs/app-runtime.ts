// Mobile agent bundle shim for the app runtime hooks that the on-device
// agent can safely import without pulling in the desktop dashboard stack.
"use strict";

// Mobile agent bundle shim for @elizaos/app.
//
// The app package root is a broad desktop/node barrel that re-exports UI,
