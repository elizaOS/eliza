...
import { parseJunitSummary } from "../../scripts/lib/junit-summary.ts";
import { runPool } from "../../scripts/lib/test-task-pool.ts";
...
function selectTestFiles(discoveredFiles: string[], args: string[]) {
...
export function parseAgentTestArgs(argv: string[]) {
  let junit = false;
...
export function mergeAgentJunit(fragments: string[], destination: string) {
