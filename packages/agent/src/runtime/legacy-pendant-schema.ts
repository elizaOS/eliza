/**
 * Retains historical host-owned pendant tables after capture service removal.
 * Existing eliza migration snapshots own these rows; omitting the definitions
 * would request destructive drops during ordinary startup. Preserve the exact
 * columns, tenant keys and constraints without enabling capture or processing.
 */
