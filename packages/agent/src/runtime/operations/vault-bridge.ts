 ...
 *   - `apiKeyRef` is itself undefined or empty
 *   - the vault has no entry for the ref (e.g. the user removed it)
 *   - the master key is unavailable (e.g. headless CI without a keychain)
 *
