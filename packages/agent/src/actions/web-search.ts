...
export const webSearchAction: Action = {
  ...
  descriptionCompressed:
    "search web current information use Eliza Cloud host Google search available, w/ Brave search local fallback use need real-time recent information train data",
