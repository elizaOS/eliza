...
export const settingsAction: Action = {
  ...
  parameters: [
    ...
    },
    {
      name: "backend",
      description:
        "[set_backend] The backend to route to. For coding: elizaos (Eliza Code), pi-agent, claude, or codex. For brain: a loaded provider id (e.g. anthropic, openai, cerebras).",
      required: false,
      schema: { type: "string" as const },
    },
    {
