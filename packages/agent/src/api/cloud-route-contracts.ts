...
export type AgentCloudBillingRouteHandler = (req: http.IncomingMessage, res: http.ServerResponse, pathname: string, method: string, state: AgentCloudProxyRouteState) => Promise<boolean>;
export type AgentCloudCompatRouteHandler = AgentCloudBillingRouteHandler;
export type AgentCloudRelayRouteHandler = (req: http.IncomingMessage, res: http.ServerResponse, pathname: string, method: string, state: AgentCloudRelayRouteState, helpers: RouteHelpers) => Promise<boolean>;
export type AgentCloudRouteHandler = (req: http.IncomingMessage, res: http.ServerResponse, pathname: string, method: string, state: AgentCloudRouteState) => Promise<boolean>;
export type AgentCloudStatusRouteHandler = (ctx: AgentCloudStatusRouteContext) => Promise<boolean>;
