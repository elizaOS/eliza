 ...
 * text from its session jsonl. Falls back to a port-status check for
 * port-bound build tasks, then a terse "no output captured" message.
 * Never echoes back the user's prompt or the validator's analysis.
 */
