...
export function getBrowserWorkspaceElementSearchTexts(element: Element): string[] {
	const labelText =
...
export function normalizeBrowserWorkspaceSelectorSyntax(selector: string): string {
