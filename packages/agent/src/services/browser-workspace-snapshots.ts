...
export function buildBrowserWorkspaceDocumentSnapshotText(document: Document): string {
...
export function readBrowserWorkspaceStorage(storage: Storage): Record<string, string> {
