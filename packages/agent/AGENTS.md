...
Retiring a feature must not implicitly drop existing profile data. Retain its schema or supply an explicit data migration; never bypass destructive-migration protection to make a profile boot.
