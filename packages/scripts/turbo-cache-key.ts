...
import { listWorkspaceDirs as listWorkspaceDirsFromSeam } from "./lib/workspaces.ts";
...
const ROOT_INPUTS = new Set([
  ...
  "packages/scripts/turbo-cache-key.ts",
  "packages/scripts/rewrite-dist-relative-imports-node-esm.ts",
...
function printHelp() {
  console.log(`Usage: node packages/scripts/turbo-cache-key.ts [options]
