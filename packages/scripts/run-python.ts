...
//
// Usage:
//   node packages/scripts/run-python.ts -m pytest path/to/tests -v
//   node packages/scripts/run-python.ts script.py arg1 arg2
...
if (args.length === 0) {
  console.error("Usage: node packages/scripts/run-python.ts <args...>");
  process.exit(2);
}
