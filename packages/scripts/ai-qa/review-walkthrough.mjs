 ...
 *
 * Usage:
 *   node packages/scripts/ai-qa/review-walkthrough.mjs [--run-dir reports/walkthrough/<id>]
...
export function buildVerdictMarkdown({ runId, model, lane, totals, results }) {
  ...
  lines.push("");
  lines.push(
    "Generated by `packages/scripts/ai-qa/review-walkthrough.mjs`. Each row is a per-step",
