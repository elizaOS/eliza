...
const rollbackStandbyMigration = readFileSync(
  new URL(
    "../../cloud/shared/src/db/migrations/0184_rollback_standby_state.sql",
    import.meta.url,
  ),
  "utf8",
);
const restoreValidationMigration = readFileSync(
  new URL(
    "../../cloud/shared/src/db/migrations/0185_agent_snapshot_restore_validations.sql",
    import.meta.url,
  ),
  "utf8",
);
