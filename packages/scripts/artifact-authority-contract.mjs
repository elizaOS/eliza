...
// The ESM loader realpath-resolves import.meta.url while argv[1] keeps the
// invoked spelling (e.g. macOS /var vs /private/var tmp symlink), so both
// sides must be realpath'd before comparing.
const isMain =
