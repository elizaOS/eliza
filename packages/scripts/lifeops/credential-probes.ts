 ...
 * node packages/scripts/lifeops/credential-probes.ts [family ...]). PATH_PROBES /
 ...
 * env-layers.ts without mutating the process — mutation would destroy the
...
// packages/scripts/cloud/siwe-test-login.ts uses as its auth proof. There is no
// /api/v1/me.
