 ...
 *
 *   node packages/scripts/audit-tee-secret-leak.ts            # gate
 *   node packages/scripts/audit-tee-secret-leak.ts --json     # machine output
 *   node packages/scripts/audit-tee-secret-leak.ts --self-test
 */
