 ...
 *
 * Usage:
 *   bun packages/scripts/plugins/plugin-personal-assistant/translate-action-examples.mjs \
...
function renderRegistryPack({ actionName, locale, translations }) {
  const lines = [];
  lines.push(
    "// AUTOGENERATED by packages/scripts/plugins/plugin-personal-assistant/translate-action-examples.mjs",
  );
