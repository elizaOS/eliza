...
Usage:
    python packages/scripts/plugins/plugin-vision/native/doctr.cpp/convert.py --variant db_mobilenet_v3_large --out vision/doctr-det.gguf
    python packages/scripts/plugins/plugin-vision/native/doctr.cpp/convert.py --variant crnn_mobilenet_v3_small --out vision/doctr-rec.gguf
