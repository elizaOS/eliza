...
Usage:
    python packages/scripts/plugins/plugin-vision/native/yolo.cpp/convert.py --variant yolov8n
    python packages/scripts/plugins/plugin-vision/native/yolo.cpp/convert.py --variant yolov8n --out <state-dir>/models/vision/yolov8n.gguf
