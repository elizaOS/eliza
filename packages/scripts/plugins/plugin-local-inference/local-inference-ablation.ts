...
function printHelp() {
  console.log(`Usage: node packages/scripts/plugins/plugin-local-inference/local-inference-ablation.ts [options]
...
Options:
  ...
  --config packages/scripts/plugins/plugin-local-inference/local-inference-ablation.config.json
