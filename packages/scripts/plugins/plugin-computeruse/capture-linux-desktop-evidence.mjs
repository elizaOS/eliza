...
import { executeTerminal } from "../../../../plugins/plugin-computeruse/src/platform/terminal.ts";
...
function usage() {
  return [
    `Usage: bun ../../packages/scripts/plugins/plugin-computeruse/${SCRIPT_NAME} [--out <dir>] [--skip-browser]`,
    "",
...
async function main() {
  ...
  const manifest = {
    ...
    evidence: {
      ...
      validator: `bun ../../packages/scripts/plugins/plugin-computeruse/${SCRIPT_NAME} (${gitHead})`,
