...
function usage() {
  return [
    "Usage: node ../../packages/scripts/plugins/plugin-computeruse/validate-platform-evidence.mjs [--require-complete] [manifest ...]",
    "",
...
function relativeFromHere(here, value) {
  return path.isAbsolute(value)
    ? value
    : path.resolve(here, "../../../../plugins/plugin-computeruse", value);
}
