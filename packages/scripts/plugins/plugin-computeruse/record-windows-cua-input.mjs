 ...
 * user's apps.
 *
 * Run: bun ../../packages/scripts/plugins/plugin-computeruse/record-windows-cua-input.mjs
 */
...
\`packages/scripts/plugins/plugin-computeruse/record-windows-cua-input.mjs\`:
