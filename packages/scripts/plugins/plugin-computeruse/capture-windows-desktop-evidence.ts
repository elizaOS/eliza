...
import { isBrowserAvailable } from "../../../../plugins/plugin-computeruse/src/platform/browser.ts";
import { detectPlatformCapabilities } from "../../../../plugins/plugin-computeruse/src/platform/capabilities.ts";
import { normalizeCaptureRegion } from "../../../../plugins/plugin-computeruse/src/platform/capture.ts";
import {
  readClipboard,
  writeClipboard,
} from "../../../../plugins/plugin-computeruse/src/platform/clipboard.ts";
import { commandExists } from "../../../../plugins/plugin-computeruse/src/platform/helpers.ts";
import {
  analyzePngScreenshot,
  screenshotQualityIssues,
} from "../../../../plugins/plugin-computeruse/src/platform/screenshot-quality.ts";
import { validateFilePath } from "../../../../plugins/plugin-computeruse/src/platform/security.ts";
import { WINDOWS_PRIMARY_SCREEN_SIZE_COMMAND } from "../../../../plugins/plugin-computeruse/src/platform/windows-list.ts";
import { ComputerUseService } from "../../../../plugins/plugin-computeruse/src/services/computer-use-service.ts";
...
const SCRIPT_NAME = "capture-windows-desktop-evidence.ts";
...
function usage() {
  return [
    `Usage: bun ../../packages/scripts/plugins/plugin-computeruse/${SCRIPT_NAME} [--out <dir>] [--skip-browser] [--skip-input]`,
    "",
...
async function main() {
  ...
  const manifest = {
    ...
    evidence: {
      ...
      validator: `bun ../../packages/scripts/plugins/plugin-computeruse/${SCRIPT_NAME} (${head})`,
