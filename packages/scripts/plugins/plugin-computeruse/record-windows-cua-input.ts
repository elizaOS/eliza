 ...
 *
 * The capture harness (`capture-windows-desktop-evidence.ts`) proves the input
 ...
 * user's apps.
 *
 * Run: bun ../../packages/scripts/plugins/plugin-computeruse/record-windows-cua-input.ts
 */
...
\`packages/scripts/plugins/plugin-computeruse/record-windows-cua-input.ts\`:
