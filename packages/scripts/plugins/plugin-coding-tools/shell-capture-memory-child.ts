...
import { readShellOutputArtifactPage } from "../../../../plugins/plugin-coding-tools/src/lib/shell-output-artifact.ts";
import { ForegroundShellCapture } from "../../../../plugins/plugin-coding-tools/src/lib/shell-streaming-capture.ts";
