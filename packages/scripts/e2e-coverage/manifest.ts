 ...
 *
 * This is an evidence catalog, not interaction authority. Runtime view/control
 * ownership is generated by `audit:view-operation-ledger`; entries here prove
 * selected real paths without creating or exempting operations.
 *
