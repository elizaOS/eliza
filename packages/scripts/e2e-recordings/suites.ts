 ...
 * run-all.ts orchestrator iterates this list to execute each suite and collect
...
export const UI_E2E_SUITES = [
  ...
  },
  {
    ...
    checkCommand: [
      "node",
      "packages/scripts/e2e-recordings/capture-android-emu.ts",
      "--check",
    ],
    coverage:
  ...
  },
  {
    ...
    checkCommand: [
      "node",
      "packages/scripts/e2e-recordings/capture-ios-sim.ts",
      "--check",
    ],
    coverage:
