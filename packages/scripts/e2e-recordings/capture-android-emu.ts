 ...
 * other native capture scripts via native-capture-common.ts.
 */
...
} from "../../app/scripts/lib/android-capture.ts";
import {
  ...
  resolveApk,
  resolveEmulator,
} from "../../app/scripts/lib/android-device.ts";
import {
  argValue,
  copyArtifact,
  createCaptureLog,
