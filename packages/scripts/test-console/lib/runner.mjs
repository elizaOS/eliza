 ...
 *
 * Result classification parses run-all-tests' `[eliza-test] PASS/SKIP/FAIL
 * <label>` lines before falling back to the process exit code, so an explicit
 * skip remains distinguishable from a passing test.
 */
