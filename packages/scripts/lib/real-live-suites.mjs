...
export const GUARDED_REAL_LIVE_SUITES = [
  ...
  },
  {
    ...
    notes: "public API, no credential; also runs nightly in external-api-live-drift.yml",
  },
  {
  ...
  },
  {
    ...
    notes: "public CoinGecko API, no credential; also runs nightly in external-api-live-drift.yml",
  },
  {
