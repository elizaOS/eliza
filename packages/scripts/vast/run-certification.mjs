...
const USAGE = `Usage: node packages/scripts/vast/run-certification.mjs --sha <commit> [options]
...
export function buildOnstart(opts) {
  const lines = [
    ...
    "  node packages/scripts/gpu-vision/serve.mjs --vlm --verify || fail gpu-vision-serve",
    "else",
