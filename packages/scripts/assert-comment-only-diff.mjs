 ...
 *
 * Usage:
 *   node packages/scripts/assert-comment-only-diff.mjs [base-ref]   # default origin/develop
 *   node packages/scripts/assert-comment-only-diff.mjs --self-test  # planted-diff self-check
 */
