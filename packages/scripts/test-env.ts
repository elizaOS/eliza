 ...
 *
 * Usage:
 *   node packages/scripts/test-env.ts              # PR lane (default, no keys)
 *   node packages/scripts/test-env.ts --lane=post-merge
 *
 * Then `eval "$(node packages/scripts/test-env.ts)"` in your shell, or pipe to
