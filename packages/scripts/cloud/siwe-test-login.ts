 ...
 *
 * Usage:
 *   bun packages/scripts/cloud/siwe-test-login.ts                      # against https://api.eliza.app
 *   bun packages/scripts/cloud/siwe-test-login.ts --base http://127.0.0.1:8787
 *   bun packages/scripts/cloud/siwe-test-login.ts --json            # machine-readable
 *   PRIVATE_KEY=0x... bun packages/scripts/cloud/siwe-test-login.ts    # reuse a fixed wallet
 *
