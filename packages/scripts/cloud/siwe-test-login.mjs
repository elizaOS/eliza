 ...
 *
 * Usage:
 *   bun packages/scripts/cloud/siwe-test-login.mjs                      # against https://api.eliza.app
 *   bun packages/scripts/cloud/siwe-test-login.mjs --base http://127.0.0.1:8787
 *   bun packages/scripts/cloud/siwe-test-login.mjs --json            # machine-readable
 *   PRIVATE_KEY=0x... bun packages/scripts/cloud/siwe-test-login.mjs    # reuse a fixed wallet
 *
