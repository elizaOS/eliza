 ...
 *
 * Usage:
 *   node packages/scripts/assert-comment-only-diff.ts [base-ref]   # default origin/develop
 *   node packages/scripts/assert-comment-only-diff.ts --self-test  # planted-diff self-check
 */
