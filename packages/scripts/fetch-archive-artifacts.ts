 ...
 *
 *   bun packages/scripts/fetch-archive-artifacts.ts        # deliberate operator invocation
 *
...
async function main() {
  ...
  if (
    ...
    fail([
      ...
      "Run it deliberately instead:  bun packages/scripts/fetch-archive-artifacts.ts",
    ]);
  }
  ...
  if (digest === null) {
    fail([
      ...
      "Check network access to github.com and re-run:  bun packages/scripts/fetch-archive-artifacts.ts",
    ]);
  }
  ...
  try {
    ...
    fail([
      ...
      "The checkout was not marked as synced; fix the underlying problem and re-run:  bun packages/scripts/fetch-archive-artifacts.ts",
    ]);
  }
}
