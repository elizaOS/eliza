...
export async function runProbes(
  ...
  probes.push({
    ...
    fix: "node packages/scripts/gpu-vision/setup.mjs && node packages/scripts/gpu-vision/serve.mjs  (GPU host; sets ELIZA_GPU_VISION_URL / serve.json)",
  });
...
async function main() {
  ...
  if (options.help) {
    console.log(
      "Usage: node packages/scripts/evidence-doctor.mjs [--json] [--strict]\n\n" +
