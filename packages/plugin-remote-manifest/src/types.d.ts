export declare const HOST_PERMISSIONS: readonly ["windows", "tray", "notifications", "storage", "manage-remote-plugins"];
export declare const BUN_PERMISSIONS: readonly ["read", "write", "env", "run", "ffi", "addons", "worker"];
export declare const REMOTE_PLUGIN_ISOLATIONS: readonly ["shared-worker", "isolated-process"];
...
export type LegacyRemotePluginPermission = "bun" | "bun:fs" | "bun:env" | "bun:child_process" | "bun:ffi" | "bun:addons" | HostPermission;
...
export type RemotePluginPermissionTag = `host:${HostPermission}` | `bun:${BunPermission}` | `isolation:${RemotePluginIsolation}`;
...
export type HostAction = "notify" | "window-create" | "window-set-title" | "window-set-frame" | "window-set-always-on-top" | "show-context-menu" | "set-application-menu" | "clear-application-menu" | "set-tray" | "set-tray-menu" | "remove-tray" | "focus-window" | "close-window" | "open-bunny-window" | "open-manager" | "stop-remote-plugin" | "emit-view" | "emit-remote-plugin-event" | "log";
export interface HostActionMessage {
    type: "action";
    action: HostAction;
    payload?: JsonValue;
}
export type HostRequestMethod = "open-file-dialog" | "open-path" | "show-item-in-folder" | "clipboard-write-text" | "window-get-frame" | "invoke-remote-plugin" | "list-remote-plugins" | "start-remote-plugin" | "stop-remote-plugin" | "agent-manager-start" | "agent-manager-stop" | "agent-manager-restart" | "agent-manager-status" | "agent-manager-health" | "agent-manager-logs-tail" | "get-auth-token" | "set-auth-token" | "dynamic-view-register" | "dynamic-view-unregister" | "dynamic-view-list" | "dynamic-view-open" | "dynamic-view-close" | "dynamic-view-push" | "dynamic-view-sessions" | "trace-session-start" | "trace-session-complete" | "trace-session-cancel" | "trace-session-error" | "trace-event-record" | "trace-session-list" | "trace-session-get" | "trace-session-summary" | "trace-events-tail" | "trace-events-search" | "trace-view-open" | "voice-status" | "voice-components" | "voice-start" | "voice-stop" | "voice-interrupt" | "voice-inject-transcript" | "voice-speak" | "voice-transcribe-audio" | "voice-synthesize-speech" | "voice-latency" | "voice-recent-turns" | "screen-get-primary-display" | "screen-get-cursor-screen-point";
...
export type RemotePluginWorkerMessage = WorkerRequestMessage | WorkerEventMessage | WorkerInitMessage | HostActionMessage | HostRequestMessage | HostResponseMessage | WorkerResponseMessage | WorkerReadyMessage | WorkerAnnouncePluginMessage | WorkerAnnounceDynamicMessage | WorkerInitCompleteMessage | WorkerRpcMessage | WorkerRpcResultMessage | HostRpcMessage | HostRpcResultMessage | StreamChunkMessage | StreamEndMessage;
/**
 ...
 */
export type PluginSurfaceKind = "action" | "provider" | "service" | "model" | "event" | "route" | "evaluator" | "tests";
