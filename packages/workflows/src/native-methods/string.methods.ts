	...
	functions: {
		...
		search: {
			doc: {
				...
				examples: [
					{
						example: '"Neat workflows node".search(/n[^ ]*/)',
						evaluated: '5',
						description: "Pos of first word starting with 'n'",
					},
					{
						example: '"Neat workflows node".search(/n[^ ]*/i)',
						evaluated: '0',
						description:
		...
		slice: {
			doc: {
				...
				examples: [
					{ example: "'Hello from workflows'.slice(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from workflows'.slice(6)", evaluated: "'from workflows'" },
					{ example: "'Hello from workflows'.slice(-3)", evaluated: "'workflows'" },
				],
				section: 'edit',
				docURL:
		...
		substring: {
			doc: {
				...
				description:
					'Extracts a fragment of the string at the given position. For more advanced extraction, see <code>match()</code>.',
				examples: [
					{ example: "'Hello from workflows'.substring(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from workflows'.substring(6)", evaluated: "'from workflows'" },
				],
				section: 'edit',
				docURL:
