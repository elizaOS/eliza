...
import { tryToParseDateTime } from '../type-validation.js';
...
function isNumeric(value: string) {
	...
	return !Number.isNaN(value as unknown as number) && !Number.isNaN(parseFloat(value));
}
...
removeMarkdown.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-removeMarkdown',
...
removeTags.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-removeTags',
...
toDateTime.doc = {
	...
	returnType: 'DateTime',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toDateTime',
	examples: [
...
toBoolean.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toBoolean',
	examples: [
...
toFloat.doc = {
	...
	hidden: true,
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toDecimalNumber',
};
...
toSentenceCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toSentenceCase',
};
...
toSnakeCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toSnakeCase',
};
...
toTitleCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toTitleCase',
};
...
urlEncode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-urlEncode',
	examples: [
...
urlDecode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-urlDecode',
	examples: [
...
replaceSpecialChars.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-replaceSpecialChars',
...
length.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.workflows.io/code/builtin/data-transformation-functions/strings',
};
...
isDomain.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-isDomain',
	examples: [
		{ example: '"workflows.io".isDomain()', evaluated: 'true' },
		{ example: '"http://workflows.io".isDomain()', evaluated: 'false' },
...
isEmail.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-isEmail',
	examples: [
...
isNumeric.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-isNumeric',
	examples: [
...
isEmpty.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-isEmpty',
	examples: [
...
isNotEmpty.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-isNotEmpty',
	examples: [
...
toJsonString.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toJsonString',
	examples: [
		{
...
extractEmail.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-extractEmail',
	examples: [
...
extractDomain.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-extractDomain',
	examples: [
		{ example: '"me@example.com".extractDomain()', evaluated: "'example.com'" },
		{ example: '"http://workflows.io/workflows".extractDomain()', evaluated: "'workflows.io'" },
		{
...
extractUrl.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-extractUrl',
	examples: [
		{ example: '"Check out http://workflows.io".extractUrl()', evaluated: "'http://workflows.io'" },
	],
};
...
extractUrlPath.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-extractUrlPath',
	examples: [
		{ example: '"http://workflows.io/workflows".extractUrlPath()', evaluated: "'/workflows'" },
		{
			example: '"Check out http://workflows.io/workflows".extractUrl().extractUrlPath()',
			evaluated: "'/workflows'",
		},
	],
};
...
parseJson.doc = {
	...
	returnType: 'any',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-parseJson',
	examples: [
...
base64Encode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-base64Encode',
};
...
base64Decode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-base64Decode',
};
...
toNumber.doc = {
	...
	returnType: 'number',
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/strings/#string-toNumber',
	examples: [
