...
import { toDateTime as stringToDateTime } from './string-extensions.js';
...
isDst.doc = {
	...
	section: 'query',
	docURL: 'https://docs.workflows.io/code/builtin/data-transformation-functions/dates/#date-isDst',
};
...
beginningOf.doc = {
	...
	docURL:
		'https://docs.workflows.io/code/builtin/data-transformation-functions/dates/#date-beginningOf',
};
...
format.doc = {
	...
	docURL: 'https://docs.workflows.io/code/builtin/data-transformation-functions/dates/#date-format',
};
...
minus.doc = {
	...
	docURL: 'https://docs.workflows.io/code/builtin/data-transformation-functions/dates/#date-minus',
};
...
plus.doc = {
	...
	docURL: 'https://docs.workflows.io/code/builtin/data-transformation-functions/dates/#date-plus',
};
...
diffTo.doc = {
	...
	docURL: 'https://docs.workflows.io/code/builtin/data-transformation-functions/dates/#date-diffTo',
};
