import type { IDataObject, INode, JsonObject } from '../../interfaces.js';
import { isTraversableObject, jsonParse } from '../../utils.js';
import { ExecutionBaseError } from './execution-base.error.js';
