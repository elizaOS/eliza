...
import type { INode, INodeParameters, NodeParameterValueType } from './interfaces.js';
...
const SPLIT_OUT_NODE_TYPE = 'workflows-nodes-base.splitOut';
	...
	const nodeRegexps = ACCESS_PATTERNS.map(
		(pattern) =>
			[
				...
				// avoid compiling the expensive regex for rare historical ways of accessing nodes
