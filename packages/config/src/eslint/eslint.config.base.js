...
export const baseConfig = [
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      // Formatting rules disabled — Prettier owns all whitespace/style formatting.
      // Keeping these on causes indent/spacing conflicts with Prettier that are
      // impossible to resolve (eslint --fix changes are reverted by prettier --write
      // and vice versa). See: https://prettier.io/docs/en/integrating-with-linters.html
      indent: 'off',
      semi: 'off',
      quotes: 'off',
      'comma-dangle': 'off',
