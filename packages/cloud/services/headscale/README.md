...
| `tag:eliza-remote-host` | User-owned Mac/VPS runtime hosts enrolled from Eliza Settings | The Cloud relay on API/TLS ports only; no host-to-host or agent-fleet access. |
