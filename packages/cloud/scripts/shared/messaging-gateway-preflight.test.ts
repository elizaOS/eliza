...
} from "./messaging-gateway-preflight-contract.ts";

const REPOSITORY_ROOT = path.resolve(import.meta.dirname, "../../../..");
const SCRIPT = path.join(
  REPOSITORY_ROOT,
  "packages/cloud/scripts/shared/messaging-gateway-preflight.ts",
);
    ...
    test: {
      ...
      steps: [
        ...
        },
        {
          ...
          "working-directory": ".",
          run: "bun test packages/cloud/scripts/shared/messaging-gateway-preflight.test.ts",
        },
        {
