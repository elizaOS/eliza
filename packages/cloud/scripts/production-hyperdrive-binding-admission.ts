...
export const ALLOWED_NON_RUNTIME_CHANGES = new Map([
  ...
  [
    "packages/cloud/scripts/production-hyperdrive-binding-admission.ts",
    new Set(["A", "M"]),
  ],
  [
    "packages/cloud/scripts/production-hyperdrive-binding-admission.test.ts",
    new Set(["A", "M"]),
  ],
  [
    "packages/cloud/scripts/staging-release-certification.test.ts",
    new Set(["M"]),
  ],
  [
