...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname =
    ...
    ("id", "catalog_organization_id", "catalog_agent_id", "lifecycle_generation",
      "lifecycle_revision", "manifest_digest"); END IF;
END $$;
...
CREATE TABLE IF NOT EXISTS "agent_backup_restore_receipts" (
  ...
  "restore_attempt_id" uuid NOT NULL, "backup_id" uuid NOT NULL,
  ...
  CONSTRAINT "agent_backup_restore_receipts_seed_receipt_fkey" FOREIGN KEY
    ("seed_receipt_id", "organization_id", "agent_id", "restore_attempt_id",
      "target_activation_generation", "seed_receipt_digest") REFERENCES
    "agent_vault_key_seed_receipts" ("id", "organization_id", "agent_id",
      "restore_attempt_id", "target_activation_generation", "receipt_digest") ON DELETE RESTRICT,
  CONSTRAINT "agent_backup_restore_receipts_activation_publication_fkey" FOREIGN KEY
    ("activation_publication_id", "organization_id", "agent_id",
      "target_activation_generation", "activation_purpose", "activation_receipt_sha256")
    REFERENCES "agent_activation_publications" ("id", "organization_id", "agent_id",
      "activation_generation", "purpose", "activation_receipt_sha256") ON DELETE RESTRICT,
  CONSTRAINT "agent_backup_restore_receipts_backup_authority_fkey" FOREIGN KEY
    ("backup_id", "organization_id", "agent_id", "source_activation_generation",
      "source_lifecycle_revision", "manifest_sha256") REFERENCES "agent_sandbox_backups"
    ("id", "catalog_organization_id", "catalog_agent_id", "lifecycle_generation",
      "lifecycle_revision", "manifest_digest") ON DELETE RESTRICT,
