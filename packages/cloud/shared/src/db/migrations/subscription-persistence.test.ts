...
const migrationNames = [
  "0269_subscription_lifecycle_authority.sql",
  "0270_organization_entitlement_projection.sql",
  "0271_subscription_allowance_periods.sql",
  "0272_billing_funding_reservations.sql",
  "0273_subscription_allowance_transactions.sql",
] as const;
