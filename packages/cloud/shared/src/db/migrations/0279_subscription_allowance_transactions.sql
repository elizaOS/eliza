CREATE TABLE "subscription_allowance_transactions" (
  ...
  CONSTRAINT "subscription_allowance_transactions_kind_check" CHECK (kind IN ('grant','reserve','settle','refund','expire','clawback','close')),
