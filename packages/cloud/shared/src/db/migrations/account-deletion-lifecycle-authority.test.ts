...
const migrationNames = [
  ...
  "0316_account_deletion_lifecycle_authority.sql",
  "0317_account_deletion_phase_receipts.sql",
  "0318_account_deletion_exports.sql",
  "0319_account_deletion_canceling_state.sql",
  "0320_account_deletion_admission_recovery.sql",
] as const;
