-- Ordinary candidate cleanup uses the existing two-phase replacement fence.
ALTER TABLE "agent_sandbox_replacement_attempts"
  DROP CONSTRAINT IF EXISTS "agent_sandbox_replacement_attempts_settlement_shape_check";
