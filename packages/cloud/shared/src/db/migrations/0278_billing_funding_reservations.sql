CREATE TABLE "billing_funding_reservations" (
  ...
  CONSTRAINT "billing_funding_reservations_status_check" CHECK (status IN ('reserved','settled','partially_refunded','refunded') AND funding_class IN ('allowance_eligible','cash_only')),
