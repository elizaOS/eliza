...
export const usageRecords = pgTable(
  "usage_records",
  {
    ...
    input_cost: numeric("input_cost", { precision: 16, scale: 6 }).default("0.000000"),
    output_cost: numeric("output_cost", { precision: 16, scale: 6 }).default("0.000000"),
    markup: numeric("markup", { precision: 16, scale: 6 }).default("0.000000"),
