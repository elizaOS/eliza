...
export const pooledCredentials = pgTable("pooled_credentials", {
...
export const pooledCredentialUsage = pgTable("pooled_credential_usage", {
    id: uuid("id").defaultRandom().primaryKey(),
    organization_id: uuid("organization_id")
        .notNull()
        .references(() => organizations.id, { onDelete: "cascade" }),
    ...
    uniqueIndex("pooled_credential_usage_cred_user_day_idx").on(table.credential_id, table.user_id, table.day),
]);
