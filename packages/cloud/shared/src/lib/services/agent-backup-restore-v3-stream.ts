...
import { AGENT_BACKUP_RESTORE_V3_STREAM_COMPONENTS, AGENT_BACKUP_RESTORE_V3_STREAM_RECEIPT_FORMAT, type AgentBackupRestoreV3AuthorityFence, type AgentBackupRestoreV3AuthorityObservation, type AgentBackupRestoreV3CandidateReceipt, AgentBackupRestoreV3CandidateReceiptSchema, type AgentBackupRestoreV3CandidateSealAuthority, type AgentBackupRestoreV3CandidateSealAuthorization, type AgentBackupRestoreV3ComponentReceipt, type AgentBackupRestoreV3ExactReadReceiptProof, type AgentBackupRestoreV3IsolatedCandidateStaging, type AgentBackupRestoreV3OperationControl, type AgentBackupRestoreV3SourceAuthority, type AgentBackupRestoreV3SourceAuthorityObject, AgentBackupRestoreV3SourceAuthorityObjectSchema, type AgentBackupRestoreV3SourceObjectReceipt, type AgentBackupRestoreV3StagingSession, computeAgentBackupRestoreV3SourceAuthoritySha256, createAgentBackupRestoreV3CandidateSealAuthorizationRequest, parseAgentBackupRestoreV3AuthorityFence, parseAgentBackupRestoreV3SourceAuthority, parseAgentBackupRestoreV3StagingSession, validateAgentBackupRestoreV3CandidateContext, validateAgentBackupRestoreV3CandidateSealAuthorization } from "@elizaos/core/contracts/agent-backup-restore-v3-stream";
import { type AgentBackupManifestV3, parseAgentBackupManifestV3 } from "@elizaos/core/contracts/agent-backup-manifest-v3";
import {
