...
describe.skipIf(!postgresUrl)("generic purchaser runtime with PostgreSQL and Stripe HTTP", () => {
  beforeAll(async () => {
    ...
    for (const tag of [
      ...
      "0409_app_billing_provider_verifications",
      ...
      "0415_app_billing_seat_mutations",
      ...
      "0422_app_billing_sales_fence",
      "0423_app_billing_refund_commands",
      ...
      "0428_app_billing_deletion_dispositions",
      "0429_app_billing_deletion_disposition_guards",
      "0430_app_billing_customer_closures",
      "0431_app_billing_customer_closure_guards",
      "0432_app_billing_resume_payment_progress",
      "0433_app_billing_paid_resume_progress",
      "0434_app_billing_deletion_checkout",
      "0435_app_billing_applied_revision",
      "0436_app_billing_completed_checkout",
      "0437_app_billing_deletion_cancellation",
      ...
      "0443_billing_financial_history_retention",
      "0444_app_billing_customer_terminal_obligations",
      "0445_app_billing_customer_command_shape",
      "0446_app_billing_terminal_buyer_commands",
      "0447_app_billing_customer_command_identity",
      "0448_app_billing_customer_execution_lease",
      "0449_app_billing_customer_completion_guard",
      "0450_app_billing_customer_command_guard",
      "0451_app_billing_refund_observations",
      "0452_app_billing_refund_recovery_authority",
      "0453_app_billing_refund_observation_guards",
      "0454_app_billing_customer_retention",
      "0455_app_billing_refund_actor_recovery",
      "0456_app_billing_observed_customer_retention",
      "0457_app_billing_refund_phase_obligations",
      "0458_app_billing_completion_owner_locks",
      "0459_app_billing_completion_scope_decisions",
      "0460_app_billing_completion_validations",
      "0461_app_billing_completion_inventory",
      "0462_app_billing_completion_validation_locks",
      "0463_app_billing_completion_validation_guards",
      "0464_app_billing_completion_commit_validation",
      "0465_app_billing_completion_mutation_fence",
      "0466_app_billing_customer_receipt_digests",
      "0467_app_billing_cancellation_evidence",
      "0468_app_billing_checkout_cleanup_receipts",
      "0469_app_billing_checkout_cleanup_evidence",
    ]) {
