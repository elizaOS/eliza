...
export const PROVISIONING_JOB_TEST_TABLES: readonly string[] = [
  ...
  "rollback_standby_generation" uuid,
  "rollback_standby_rollout_id" uuid,
  "rollback_standby_source_job_id" uuid,
  "rollback_standby_decision_job_id" uuid,
  "rollback_standby_verified_backup_id" uuid,
  "rollback_standby_restore_validation_id" uuid,
  ...
  "rollback_standby_sandbox_id" text,
  "rollback_standby_node_id" text,
  "rollback_standby_container_name" text,
  "rollback_standby_container_id" text,
  "rollback_standby_bridge_url" text,
  "rollback_standby_health_url" text,
  "rollback_standby_bridge_port" integer,
  "rollback_standby_web_ui_port" integer,
  "rollback_standby_headscale_ip" text,
  "rollback_standby_vpn_node_id" text,
  "rollback_standby_docker_image" text,
  "rollback_standby_image_digest" text,
  "rollback_standby_previous_docker_image" text,
  "rollback_standby_previous_image_digest" text,
  "rollback_standby_environment_revision" integer,
  "rollback_standby_allocation_counted" boolean,
  "rollback_standby_primary_sandbox_id" text,
  "rollback_standby_primary_node_id" text,
  "rollback_standby_primary_container_name" text,
  "rollback_standby_primary_container_id" text,
  "rollback_standby_primary_vpn_node_id" text,
  "rollback_standby_primary_replacement_attempt_id" uuid,
  "rollback_standby_created_at" timestamptz,
