...
export async function runWithLifecycleTimeout(operation: Promise<void>, action: string, label: string, id: string): Promise<void> {
...
export const safeClose = async (closeable: {
    close(): Promise<void>;
}, label: string, id: string): Promise<void> => {
...
export async function stopRuntimeServices(runtime: AgentRuntime, id: string, label: string): Promise<void> {
