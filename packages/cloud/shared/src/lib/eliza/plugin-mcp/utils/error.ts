...
import { errorAnalysisTemplate as errorAnalysisPrompt } from "@elizaos/shared";
...
export async function handleMcpError(state: State, mcpProvider: McpProvider, error: unknown, runtime: IAgentRuntime, message: Memory, type: "tool" | "resource", callback?: HandlerCallback): Promise<ActionResult> {
