...
export const SSE_HEARTBEAT_INTERVAL = parseNonNegativeInteger(process.env.SSE_HEARTBEAT_INTERVAL, 30); // Send heartbeat every N polls
 ...
 */
export const SSE_MAX_CONNECTIONS_PER_ORG = parseNonNegativeInteger(process.env.SSE_MAX_CONNECTIONS_PER_ORG, 10);
export const SSE_BACKOFF_INITIAL_MS = parseNonNegativeInteger(process.env.SSE_BACKOFF_INITIAL_MS, 500);
export const SSE_BACKOFF_MAX_MS = parseNonNegativeInteger(process.env.SSE_BACKOFF_MAX_MS, 5000);
export const SSE_BACKOFF_MULTIPLIER = Number.parseFloat(process.env.SSE_BACKOFF_MULTIPLIER || "1.5");
/**
