...
Finally, a large 'Card' at the bmilaidym with a 'Heading' "Revenue Over Time" and a placeholder 'Image' to represent a line chart.`,
    matchers: [
      new MessageTypeMatcher("surfaceUpdate"),
