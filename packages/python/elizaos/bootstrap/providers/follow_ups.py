"""
Follow-ups Provider - Provides follow-up reminder information.

This provider retrieves and formats upcoming follow-up reminders
for use in prompts.
"""
...
async def get_follow_ups_context(
    ...
    Returns formatted information about scheduled follow-ups
    including overdue items and suggestions.
    """
    ...
    try:
        ...
        runtime.logger.error(
            {"src": "provider:follow_ups", "error": str(e)},
            "Error getting follow-ups",
        )
        return ProviderResult(
            text="Error retrieving follow-up information.",
            values={},
            data={},
        )
