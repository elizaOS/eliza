// Reads `<pkg>/content/**/_meta.ts` at build time and turns it into a sidebar
// tree, plus a map of /docs/<slug> → lazy MDX loader. The MDX sources live in
// `packages/cloud-frontend/content/`. Types for the nav tree live in
// `@elizaos/ui`; this file is app-local because `import.meta.glob` paths are
// resolved from the Vite app root.
