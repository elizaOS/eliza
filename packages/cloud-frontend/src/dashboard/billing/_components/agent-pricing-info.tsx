    ...
    <BrandCard className="relative">
      ...
      <div className="relative z-10 space-y-4">
        ...
        <p className="text-[10px] text-white/20 font-mono">
          Min. {formatUSD(AGENT_PRICING.MINIMUM_DEPOSIT)} · Never expires ·
          Suspends at {formatUSD(AGENT_PRICING.LOW_CREDIT_WARNING)} ·{" "}
          {AGENT_PRICING.GRACE_PERIOD_HOURS}h grace
        </p>
      </div>
    </BrandCard>
  );
