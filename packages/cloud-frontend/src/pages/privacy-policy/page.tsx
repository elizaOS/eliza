    ...
    <div className="theme-cloud flex min-h-screen w-full flex-col bg-black font-poppins text-white">
      ...
      <main id="main" className="flex-1 px-6 pt-32 pb-16 sm:px-8 lg:px-12">
        <div className="mx-auto w-full max-w-4xl space-y-10">
          <Link
            to="/login"
            className="inline-flex items-center gap-2 text-sm text-white/60 transition-colors hover:text-[var(--brand-orange)]"
          >
          ...
          <div className="flex flex-col items-center justify-between gap-4 border-t border-white/14 pt-8 sm:flex-row">
            <Link
              to="/terms-of-service"
              className="text-sm text-white/60 underline underline-offset-4 transition-colors hover:text-[var(--brand-orange)]"
            >
              Terms of Service
            </Link>
            <Link
              to="/login"
              className="text-sm text-white/60 transition-colors hover:text-[var(--brand-orange)]"
            >
              Return to login
            </Link>
          </div>
