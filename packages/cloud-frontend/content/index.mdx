...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-6 mb-8">
  <div className="docs-feature-card">
    <div className="flex items-center gap-3 mb-4">
      ...
      <div className="font-bold text-slate-950">Agent Runtime</div>
    </div>
  ...
  <div className="docs-feature-card">
    <div className="flex items-center gap-3 mb-4">
      ...
      <div className="font-bold text-slate-950">Chat Completions</div>
    </div>
    <div className="text-slate-700 text-sm leading-relaxed">
  ...
  <div className="docs-feature-card">
    <div className="flex items-center gap-3 mb-4">
      ...
      <div className="font-bold text-slate-950">Model Gateway</div>
    </div>
    <div className="text-slate-700 text-sm leading-relaxed">
      Route agent requests through configured text and embedding providers from
      one API interface.
    </div>
  </div>
  <div className="docs-feature-card">
    <div className="flex items-center gap-3 mb-4">
      ...
      <div className="font-bold text-slate-950">Knowledge Base</div>
    </div>
    <div className="text-slate-700 text-sm leading-relaxed">
  ...
  <div className="docs-feature-card">
    <div className="flex items-center gap-3 mb-4">
      ...
      <div className="font-bold text-slate-950">MCP Integration</div>
    </div>
    <div className="text-slate-700 text-sm leading-relaxed">
  ...
  <div className="docs-feature-card">
    <div className="flex items-center gap-3 mb-4">
      ...
      <div className="font-bold text-slate-950">Containers</div>
    </div>
    <div className="text-slate-700 text-sm leading-relaxed">
...
<p className="text-slate-700 mb-6">
  Operate your hosted agent runtime, connect the full Eliza app, and manage
  account access from the dashboard.
</p>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 mb-8">
  ...
  >
    <div className="relative z-10">
      ...
      <div className="font-bold text-slate-950 mb-1 group-hover:text-[#ff8a24] transition-colors">
        Deploy Agents
      </div>
      <div className="text-slate-700 text-sm">Create, deploy, and monitor</div>
    </div>
  </a>
  <a
    href="/docs/apps"
  ...
  >
    <div className="relative z-10">
      ...
      <div className="font-bold text-slate-950 mb-1 group-hover:text-[#0b35f1] transition-colors">
        Connect Devices
      </div>
      <div className="text-slate-700 text-sm">Use your agent in Eliza</div>
    </div>
  </a>
  <a
    href="/docs/billing"
  ...
  >
    <div className="relative z-10">
      ...
      <div className="font-bold text-slate-950 mb-1 group-hover:text-[#22c55e] transition-colors">
        Billing & Payments
      </div>
      <div className="text-slate-700 text-sm">Credits, invoices, and usage</div>
    </div>
  </a>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-6">
  <a href="/docs/api" className="docs-api-card no-underline group">
    <div className="font-semibold text-slate-950 text-sm group-hover:text-[#ff8a24] transition-colors">
      REST API
    </div>
  </a>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
  <a href="/docs/sdks" className="docs-resource-card no-underline group">
    <div className="font-semibold text-slate-950 mb-0.5 group-hover:text-[#ff8a24] transition-colors">
      SDKs & Libraries
    </div>
    <div className="text-slate-700 text-sm">TypeScript, Python, and more</div>
  </a>
  <a href="/docs/errors" className="docs-resource-card no-underline group">
    <div className="font-semibold text-slate-950 mb-0.5 group-hover:text-[#ff8a24] transition-colors">
      Error Handling
    </div>
    <div className="text-slate-700 text-sm">Error codes and troubleshooting</div>
  </a>
  <a href="/docs/rate-limits" className="docs-resource-card no-underline group">
    <div className="font-semibold text-slate-950 mb-0.5 group-hover:text-[#ff8a24] transition-colors">
      Rate Limits
    </div>
    <div className="text-slate-700 text-sm">Usage quotas and limits</div>
  </a>
  <a href="/docs/changelog" className="docs-resource-card no-underline group">
    <div className="font-semibold text-slate-950 mb-0.5 group-hover:text-[#ff8a24] transition-colors">
      Changelog
    </div>
    <div className="text-slate-700 text-sm">Latest updates and releases</div>
  </a>
</div>
...
<div className="docs-help-box">
  <h3 className="!mt-0 !mb-4 !border-0 !text-base font-bold text-slate-950 !p-0">
    Need Help?
  </h3>
