...
Route: `/dashboard/documents`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-documents.png`
- desktop hover: `../desktop/dashboard-documents--hover.png`
- mobile: `../mobile/dashboard-documents.png`
