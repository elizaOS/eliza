...
Route: `/dashboard/security`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-security.png`
- desktop hover: `../desktop/dashboard-security--hover.png`
- mobile: `../mobile/dashboard-security.png`
