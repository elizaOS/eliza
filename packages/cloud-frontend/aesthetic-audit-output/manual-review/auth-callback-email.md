# Manual review — auth-callback-email

Route: `/auth/callback/email`

Screenshots:
- desktop: `../desktop/auth-callback-email.png`
- desktop hover: `../desktop/auth-callback-email--hover.png`
- mobile: `../mobile/auth-callback-email.png`
