# Manual review — dashboard-agent-detail

Route: `/dashboard/agents/e2e-fixture`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-agent-detail.png`
- desktop hover: `../desktop/dashboard-agent-detail--hover.png`
- mobile: `../mobile/dashboard-agent-detail.png`
