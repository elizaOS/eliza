...
Route: `/dashboard/admin/redemptions`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-admin-redemptions.png`
- desktop hover: `../desktop/dashboard-admin-redemptions--hover.png`
- mobile: `../mobile/dashboard-admin-redemptions.png`
