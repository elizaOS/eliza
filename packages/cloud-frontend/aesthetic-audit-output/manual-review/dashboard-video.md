# Manual review — dashboard-video

Route: `/dashboard/video`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-video.png`
- desktop hover: `../desktop/dashboard-video--hover.png`
- mobile: `../mobile/dashboard-video.png`
