# Manual review — dashboard-app-detail

Route: `/dashboard/apps/e2e-fixture`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-app-detail.png`
- desktop hover: `../desktop/dashboard-app-detail--hover.png`
- mobile: `../mobile/dashboard-app-detail.png`
