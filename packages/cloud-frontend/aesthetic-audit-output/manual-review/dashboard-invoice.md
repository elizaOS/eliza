# Manual review — dashboard-invoice

Route: `/dashboard/invoices/e2e-fixture`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-invoice.png`
- desktop hover: `../desktop/dashboard-invoice--hover.png`
- mobile: `../mobile/dashboard-invoice.png`
