# Manual review — dashboard-gallery

Route: `/dashboard/gallery`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-gallery.png`
- desktop hover: `../desktop/dashboard-gallery--hover.png`
- mobile: `../mobile/dashboard-gallery.png`
