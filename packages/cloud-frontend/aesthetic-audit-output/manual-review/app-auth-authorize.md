# Manual review — app-auth-authorize

Route: `/app-auth/authorize`

Screenshots:
- desktop: `../desktop/app-auth-authorize.png`
- desktop hover: `../desktop/app-auth-authorize--hover.png`
- mobile: `../mobile/app-auth-authorize.png`
