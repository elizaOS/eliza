# Manual review — dashboard-image

Route: `/dashboard/image`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-image.png`
- desktop hover: `../desktop/dashboard-image--hover.png`
- mobile: `../mobile/dashboard-image.png`
