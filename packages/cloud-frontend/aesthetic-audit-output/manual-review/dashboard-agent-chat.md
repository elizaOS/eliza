# Manual review — dashboard-agent-chat

Route: `/dashboard/agents/e2e-fixture/chat`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-agent-chat.png`
- desktop hover: `../desktop/dashboard-agent-chat--hover.png`
- mobile: `../mobile/dashboard-agent-chat.png`
