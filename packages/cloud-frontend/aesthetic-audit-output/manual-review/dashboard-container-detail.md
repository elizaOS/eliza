# Manual review — dashboard-container-detail

Route: `/dashboard/containers/e2e-fixture`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-container-detail.png`
- desktop hover: `../desktop/dashboard-container-detail--hover.png`
- mobile: `../mobile/dashboard-container-detail.png`
