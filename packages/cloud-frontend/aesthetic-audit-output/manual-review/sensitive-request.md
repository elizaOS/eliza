# Manual review — sensitive-request

Route: `/sensitive-requests/e2e-fixture`

Screenshots:
- desktop: `../desktop/sensitive-request.png`
- desktop hover: `../desktop/sensitive-request--hover.png`
- mobile: `../mobile/sensitive-request.png`
