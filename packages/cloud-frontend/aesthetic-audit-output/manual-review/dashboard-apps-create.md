# Manual review — dashboard-apps-create

Route: `/dashboard/apps/create`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-apps-create.png`
- desktop hover: `../desktop/dashboard-apps-create--hover.png`
- mobile: `../mobile/dashboard-apps-create.png`
