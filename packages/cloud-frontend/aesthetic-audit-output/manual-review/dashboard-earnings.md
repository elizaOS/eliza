...
Route: `/dashboard/earnings`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-earnings.png`
- desktop hover: `../desktop/dashboard-earnings--hover.png`
- mobile: `../mobile/dashboard-earnings.png`
