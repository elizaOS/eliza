...
Route: `/dashboard/admin/infrastructure`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-admin-infra.png`
- desktop hover: `../desktop/dashboard-admin-infra--hover.png`
- mobile: `../mobile/dashboard-admin-infra.png`
