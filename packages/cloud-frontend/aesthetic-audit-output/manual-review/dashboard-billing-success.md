# Manual review — dashboard-billing-success

Route: `/dashboard/billing/success`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-billing-success.png`
- desktop hover: `../desktop/dashboard-billing-success--hover.png`
- mobile: `../mobile/dashboard-billing-success.png`
