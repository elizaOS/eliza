# Manual review — dashboard-my-agents

Route: `/dashboard/my-agents`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-my-agents.png`
- desktop hover: `../desktop/dashboard-my-agents--hover.png`
- mobile: `../mobile/dashboard-my-agents.png`
