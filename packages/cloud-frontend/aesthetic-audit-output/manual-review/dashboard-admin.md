...
Route: `/dashboard/admin`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-admin.png`
- desktop hover: `../desktop/dashboard-admin--hover.png`
- mobile: `../mobile/dashboard-admin.png`
