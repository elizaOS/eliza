# Manual review — dashboard-voices

Route: `/dashboard/voices`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-voices.png`
- desktop hover: `../desktop/dashboard-voices--hover.png`
- mobile: `../mobile/dashboard-voices.png`
