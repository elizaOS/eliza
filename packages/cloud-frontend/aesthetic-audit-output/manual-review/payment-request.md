# Manual review — payment-request

Route: `/payment/e2e-fixture`

Screenshots:
- desktop: `../desktop/payment-request.png`
- desktop hover: `../desktop/payment-request--hover.png`
- mobile: `../mobile/payment-request.png`
