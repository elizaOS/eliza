# Manual review — payment-app-charge

Route: `/payment/app-charge/e2e-fixture/e2e-fixture`

Screenshots:
- desktop: `../desktop/payment-app-charge.png`
- desktop hover: `../desktop/payment-app-charge--hover.png`
- mobile: `../mobile/payment-app-charge.png`
