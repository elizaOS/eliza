# Manual review — dashboard-analytics

Route: `/dashboard/analytics`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-analytics.png`
- desktop hover: `../desktop/dashboard-analytics--hover.png`
- mobile: `../mobile/dashboard-analytics.png`
