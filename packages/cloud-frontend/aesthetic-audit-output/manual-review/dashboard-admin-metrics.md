...
Route: `/dashboard/admin/metrics`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-admin-metrics.png`
- desktop hover: `../desktop/dashboard-admin-metrics--hover.png`
- mobile: `../mobile/dashboard-admin-metrics.png`
