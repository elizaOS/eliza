# Manual review — dashboard-container-agent

Route: `/dashboard/containers/agents/e2e-fixture`  (auth-required)

Screenshots:
- desktop: `../desktop/dashboard-container-agent.png`
- desktop hover: `../desktop/dashboard-container-agent--hover.png`
- mobile: `../mobile/dashboard-container-agent.png`
