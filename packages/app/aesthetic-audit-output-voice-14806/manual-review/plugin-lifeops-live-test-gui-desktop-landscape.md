# plugin-lifeops-live-test-gui (desktop-landscape)

- **path:** `/lifeops-live-test`
- **bundle provenance:** n/a (not a remote-bundle route)
- **bundle component:** n/a
- **bundle view id:** n/a
- **verdict:** good
- **console errors:** 0
...
- **border/divider density:** 4.6296 (6 edges / 1M px)
- **text density:** 2.5309 chars / 10K px
- **whitespace ratio:** 0.9028
