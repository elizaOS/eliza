# plugin-todos-gui (mobile-portrait)

- **path:** `/todos`
- **bundle provenance:** real-dist
- **bundle component:** TodosView
- **bundle view id:** todos
- **verdict:** good
- **console errors:** 0
...
- **readable content chars:** 266
- **horizontal overflow:** 0px
- **border/divider density:** 0 (0 edges / 1M px)
- **text density:** 3.5545 chars / 10K px
- **whitespace ratio:** 0.8959
