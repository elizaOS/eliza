# builtin-character-select (ipad-portrait)
...
- **readable content chars:** 338
- **horizontal overflow:** 0px
- **border/divider density:** 4.1339 (4 edges / 1M px)
- **text density:** 1.9119 chars / 10K px
- **whitespace ratio:** 0.6691
