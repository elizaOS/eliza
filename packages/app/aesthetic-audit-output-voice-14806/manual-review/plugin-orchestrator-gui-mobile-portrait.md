# plugin-orchestrator-gui (mobile-portrait)

- **path:** `/orchestrator`
- **bundle provenance:** real-dist
- **bundle component:** OrchestratorView
- **bundle view id:** orchestrator
- **verdict:** good
- **console errors:** 0
...
- **readable content chars:** 261
- **horizontal overflow:** 0px
- **border/divider density:** 3.038 (1 edges / 1M px)
- **text density:** 3.5241 chars / 10K px
- **whitespace ratio:** 0.7454
