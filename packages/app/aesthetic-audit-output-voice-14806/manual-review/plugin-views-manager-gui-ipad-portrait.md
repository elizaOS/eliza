# plugin-views-manager-gui (ipad-portrait)

- **path:** `/views`
- **bundle provenance:** real-dist
- **bundle component:** ViewManagerView
- **bundle view id:** views-manager
- **verdict:** good
- **console errors:** 0
- **render-state issues:** none
...
- **readable content chars:** 555
- **horizontal overflow:** 0px
- **border/divider density:** 6.2009 (6 edges / 1M px)
- **text density:** 3.6482 chars / 10K px
- **whitespace ratio:** 0.8668
