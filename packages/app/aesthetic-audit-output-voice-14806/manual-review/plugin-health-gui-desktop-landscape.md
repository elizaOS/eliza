# plugin-health-gui (desktop-landscape)

- **path:** `/health`
- **bundle provenance:** real-dist
- **bundle component:** HealthView
- **bundle view id:** health
- **verdict:** good
- **console errors:** 0
...
- **readable content chars:** 528
- **horizontal overflow:** 0px
- **border/divider density:** 9.2593 (12 edges / 1M px)
- **text density:** 2.662 chars / 10K px
- **whitespace ratio:** 0.9444
