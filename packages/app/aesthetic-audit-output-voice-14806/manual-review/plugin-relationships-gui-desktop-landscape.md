# plugin-relationships-gui (desktop-landscape)

- **path:** `/relationships`
- **bundle provenance:** real-dist
- **bundle component:** RelationshipsView
- **bundle view id:** relationships
- **verdict:** good
- **console errors:** 0
...
- **readable content chars:** 358
- **horizontal overflow:** 0px
- **border/divider density:** 12.3457 (16 edges / 1M px)
- **text density:** 1.5201 chars / 10K px
- **whitespace ratio:** 0.9437
