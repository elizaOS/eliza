# plugin-finances-gui (desktop-landscape)

- **path:** `/finances`
- **bundle provenance:** real-dist
- **bundle component:** FinancesView
- **bundle view id:** finances
- **verdict:** good
- **console errors:** 0
...
- **readable content chars:** 315
- **horizontal overflow:** 0px
- **border/divider density:** 6.1728 (8 edges / 1M px)
- **text density:** 1.25 chars / 10K px
- **whitespace ratio:** 0.9664
