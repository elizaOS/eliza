# builtin-trajectories (desktop-landscape)
...
- **readable content chars:** 192
- **horizontal overflow:** 0px
- **border/divider density:** 3.858 (5 edges / 1M px)
- **text density:** 0.4012 chars / 10K px
- **whitespace ratio:** 0.946
