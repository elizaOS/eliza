# builtin-relationships (desktop-landscape)
...
- **readable content chars:** 232
- **horizontal overflow:** 0px
- **border/divider density:** 7.716 (10 edges / 1M px)
- **text density:** 0.6713 chars / 10K px
- **whitespace ratio:** 0.7568
