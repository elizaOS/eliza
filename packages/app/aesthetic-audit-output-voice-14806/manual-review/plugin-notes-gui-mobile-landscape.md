# plugin-notes-gui (mobile-landscape)
...
- **border-radius violations (off-token):** 22px, 999px
...
- **readable content chars:** 343
- **horizontal overflow:** 0px
- **border/divider density:** 0 (0 edges / 1M px)
- **text density:** 2.4 chars / 10K px
- **whitespace ratio:** 0.5557
