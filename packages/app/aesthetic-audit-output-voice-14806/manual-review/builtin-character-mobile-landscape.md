# builtin-character (mobile-landscape)
...
- **readable content chars:** 392
- **horizontal overflow:** 0px
- **border/divider density:** 9.1141 (3 edges / 1M px)
- **text density:** 2.0051 chars / 10K px
- **whitespace ratio:** 0.4824
