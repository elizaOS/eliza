# plugin-goals-gui (desktop-landscape)

- **path:** `/goals`
- **bundle provenance:** real-dist
- **bundle component:** GoalsView
- **bundle view id:** goals
- **verdict:** good
- **console errors:** 0
...
- **readable content chars:** 370
- **horizontal overflow:** 0px
- **border/divider density:** 12.3457 (16 edges / 1M px)
- **text density:** 1.659 chars / 10K px
- **whitespace ratio:** 0.9528
