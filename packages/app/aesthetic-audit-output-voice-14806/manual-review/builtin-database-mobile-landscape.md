# builtin-database (mobile-landscape)
...
- **readable content chars:** 252
- **horizontal overflow:** 0px
- **border/divider density:** 15.1902 (5 edges / 1M px)
- **text density:** 3.0684 chars / 10K px
- **whitespace ratio:** 0.7201
