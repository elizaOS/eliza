/**
 * Colocated coverage for app's process-handler error utilities. The
 * module re-exports `formatUncaughtError` and `shouldIgnoreUnhandledRejection`
 * from `@elizaos/shared`; this suite drives the app entry so
...
describe("app error-handlers re-export", () => {
