 ...
 * no-op default to the app implementation, exposing real vault /
...
describe("installAgentHostBridge", () => {
  it("wires app host capabilities into the agent host-bridge seam", () => {
    _resetAgentHostBridge();
    ...
    // The app bridge replaces the no-op default with real implementations.
