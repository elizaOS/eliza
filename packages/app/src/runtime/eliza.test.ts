/**
 * Unit coverage for app's Eliza runtime loader: public wrappers around
...
vi.mock("@elizaos/agent", async () => {
  ...
  return {
    ...
    loadElizaConfig: () => ({}),
    resolveDefaultAgentWorkspaceDir: () => "/tmp/app-eliza-workspace",
...
describe("scanDropInPlugins", () => {
  ...
  beforeEach(() => {
    root = makeTempDir("app-eliza-dropin-");
  });
...
describe("resolvePackageEntry", () => {
  ...
  beforeEach(() => {
    pkgRoot = makeTempDir("app-eliza-pkg-");
  });
