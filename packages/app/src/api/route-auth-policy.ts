/**
 * Auth-policy table plus enforcement gate for the app compat HTTP surface.
 *
 ...
 * `isCompatManagedRoute` reports whether a path falls under an app-owned
...
export const COMPAT_ROUTE_AUTH_POLICIES: readonly CompatRouteAuthPolicy[] = [
  ...
  ownerExact("config.reload", "POST", "/api/config/reload"),
