...
import { type AppEntry } from "@elizaos/core/catalog";
...
export async function handleCatalogRoutes(req: http.IncomingMessage, res: http.ServerResponse, state: CompatRuntimeState): Promise<boolean> {
