/**
 * Drives the app `automation-node-contributors` re-export against the real
...
describe("app automation-node-contributors re-export", () => {
  beforeEach(() => {
    clearAutomationNodeContributorsForTests();
  });
  ...
  it("shares the contributor Map across the app and shared import paths", () => {
