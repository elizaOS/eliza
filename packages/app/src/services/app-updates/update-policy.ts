...
import { getBuildVariant } from "@elizaos/ui/build-variant";
import { isElizaOS } from "@elizaos/core/platform/eliza-os";
    ...
    switch (installMethod) {
        ...
        default:
            return {
                ...
                detail: "The connected agent reports update metadata, but its install authority is not known to the app.",
            };
    }
}
