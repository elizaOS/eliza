const t="__ELIZA_BROWSER_TABS_REGISTRY__",n=`
(() => {
  const send = (payload) => {
    try {
...
`;function r(e){typeof window>"u"||(e?window[t]=e:delete window[t])}export{n as B,r as s};
//# sourceMappingURL=browser-tabs-renderer-registry-CCGK5S6p.js.map
