 ...
 *
 * Usage:
 *   npx tsx packages/app/test/design-review/run-onboarding-review.ts
 *   ELIZA_DESIGN_REVIEW_HEADLESS=1 npx tsx packages/app/test/design-review/run-onboarding-review.ts
 */
