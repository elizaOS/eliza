...
| `social-alpha` | `gui` | `/social-alpha` | Trust leaderboard domain gives clear score, rank, and recommender analytics affordances. | Needs screenshot review for table density, empty states, and finance-context status cues. | Verify leaderboard rows, rank metrics, and loading/error states render without broken assets. |
