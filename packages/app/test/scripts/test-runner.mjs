/**
 * Sequential full-suite entry: runs the app, homepage, app,
...
// Script lives at eliza/packages/app/test/scripts/ — repo root is 5 levels up
...
const appCoreRoot = path.join(elizaRoot, "packages", "app");
