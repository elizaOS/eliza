...
const unitShards = [
  ...
  },
  {
    ...
    patterns: [
      ...collectTestFiles(
        "eliza/packages/app/src",
        "eliza/packages/shared/src",
        "eliza/packages/app/test/live-agent",
        "eliza/packages/app/scripts",
      ),
      ...[
        "eliza/packages/app/platforms/electrobun/src/menu-reset-from-main.test.ts",
        "eliza/packages/app/platforms/electrobun/src/diagnostic-format.test.ts",
        "eliza/packages/app/platforms/electrobun/src/native/steward.test.ts",
        "eliza/packages/app/platforms/electrobun/src/application-menu.test.ts",
      ].filter((file) => fs.existsSync(path.join(repoRoot, file))),
    ],
  },
