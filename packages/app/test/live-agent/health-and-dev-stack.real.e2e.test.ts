 ...
 *
 * Boots a REAL AgentRuntime (PGLite-backed) + the REAL app HTTP stack on
 ...
 *   - GET /api/dev/stack          packages/app/src/api/dev-compat-routes.ts:49
 *                                 + packages/app/src/api/dev-stack.ts:53
 *   - GET /api/dev/route-catalog  packages/app/src/api/dev-compat-routes.ts:68
