/** Exercises real runtime critical paths behavior with deterministic app test fixtures. */
...
function realRuntimeSpecs(): string[] {
  ...
  // against the app runtime/server (packages/app), wallet against real chains
  // in plugins/plugin-wallet.
  const tracked = execFileSync(
    "git",
    ["ls-files", "packages/app", "packages/app", "plugins/plugin-wallet"],
