...
test.describe.serial("android local runtime (real on-device agent)", () => {
  test("on-device agent answers /api/health and /api/status", async ({ page }) => {
  ...
  test("chat surface mounts and composer is interactive", async ({ page }) => {
