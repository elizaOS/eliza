 ...
 *
 * Usage:
 *   node eliza/packages/app/scripts/desktop-stack-status.ts
 *   node eliza/packages/app/scripts/desktop-stack-status.ts --json
 */

import { gatherDesktopStackStatus } from "./lib/desktop-stack-status.ts";
