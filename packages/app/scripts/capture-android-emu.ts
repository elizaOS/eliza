...
// Reuses the shared adb/serial resolution in lib/android-device.ts.
//
// Flags:
...
import { startChunkedAndroidScreenRecord } from "./lib/android-capture.ts";
import { resolveAdb, resolveSerial } from "./lib/android-device.ts";
import {
  captureBackendLog,
  evidenceBaseName,
  evidencePath,
