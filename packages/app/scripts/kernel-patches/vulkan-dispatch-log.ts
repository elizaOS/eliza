...
function usage() {
  return [
    "Usage:",
    "  node packages/app/scripts/kernel-patches/vulkan-dispatch-log.ts <log>",
    "  node packages/app/scripts/kernel-patches/vulkan-dispatch-log.ts <baseline.log> <candidate.log>",
  ].join("\n");
}
