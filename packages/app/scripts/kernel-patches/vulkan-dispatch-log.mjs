...
function usage() {
  return [
    "Usage:",
    "  node packages/app/scripts/kernel-patches/vulkan-dispatch-log.mjs <log>",
    "  node packages/app/scripts/kernel-patches/vulkan-dispatch-log.mjs <baseline.log> <candidate.log>",
  ].join("\n");
}
