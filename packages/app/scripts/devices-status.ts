...
import { readDevicectlDeviceList } from "./ios-device-devicectl.ts";
import { DEFAULT_APP_BUNDLE_ID } from "./ios-device-lib.ts";
import {
  APP_ID,
  listDevices,
...
import { isDeviceLeased } from "./lib/device-lease.ts";
import {
  buildDeviceStatusRow,
  formatDeviceStatusTable,
  hasNonFreshDevice,
  renderDeviceStatusEvidenceSvg,
} from "./lib/devices-status.ts";
import {
  readDeployLedger,
...
import { analyzeScreenshot, closeOcrEngines } from "./lib/visual-qa.ts";
