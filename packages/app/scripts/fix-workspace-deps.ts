 ...
 *
 * Same idea as eliza's scripts/fix-workspace-deps.ts:
 *
 ...
 *
 * Usage:
 *   bun scripts/fix-workspace-deps.ts
 *   bun scripts/fix-workspace-deps.ts --check
 *   bun scripts/fix-workspace-deps.ts --restore
 *   bun scripts/fix-workspace-deps.ts --restore --ref origin/main
 *
