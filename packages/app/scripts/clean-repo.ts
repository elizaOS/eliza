 ...
 *
 * Usage:
 *   node scripts/clean-repo.ts           # standard clean (dist, Vite, plugins, turbo, forge test artifacts, …)
 *   node scripts/clean-repo.ts --deep    # also Electrobun/Electron local build outputs + generated preload
 *
...
} from "./capacitor-plugin-names.ts";
