 ...
 * `visual-qa.ts` analyzer (OCR + dominant palette + brand-colour fractions).
 ...
 *
 * Usage:
 *   node scripts/visual-qa-live.ts --base http://127.0.0.1:2138 [--out DIR] [--strict]
 */
...
import { analyzeScreenshot, changeMetric } from "./lib/visual-qa.ts";
