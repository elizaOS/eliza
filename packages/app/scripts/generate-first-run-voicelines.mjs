#!/usr/bin/env node
/**
 * Generate static MP3 voicelines for first-run character catchphrases.
 *
 * Usage:
 *   ELEVENLABS_API_KEY=sk_... node scripts/generate-first-run-voicelines.mjs
 *
 * Output: packages/app/public/audio/first-run/{characterId}-{lang}.mp3
 */
...
const OUTPUT_DIR = resolve("packages/app/public/audio/first-run");
...
// eliza/packages/core/src/character-presets.characters.ts
const CHARACTERS = [
  {
    id: "chen",
    voice: "sarah",
