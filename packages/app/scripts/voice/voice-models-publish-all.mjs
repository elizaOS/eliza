 ...
 *
 * Usage:
 *   node packages/app/scripts/voice/voice-models-publish-all.mjs              # publish all
 *   node packages/app/scripts/voice/voice-models-publish-all.mjs --dry-run # print commands only
 *   node packages/app/scripts/voice/voice-models-publish-all.mjs --model asr  # publish one model
 *
 * Prerequisites:
