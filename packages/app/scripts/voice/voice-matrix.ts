...
const CELLS = [
  ...
  },
  {
    ...
    command: ["node", "packages/app/scripts/voice/voice-openwakeword-eval.ts"],
    evidence: [
  ...
  },
  {
    ...
    command: ["node", "packages/app/scripts/voice/stage-b-stt-bench.ts"],
  ...
  },
  {
    ...
    class: "stt-evaluation",
    command: ["node", "packages/app/scripts/voice/voice-stage-b-eval.ts"],
    evidence: [
