...
// SCRIPT_DIR is packages/app/scripts; the repo root is three levels up.
...
const TYPE_HEADER = `// Generated by packages/app/scripts/write-homepage-release-data.mjs.
