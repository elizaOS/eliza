 ...
 * `eliza/packages/app/scripts/lib/allocate-loopback-port.mjs` resolves **ELIZA_API_PORT** (default
...
if (process.argv.includes("--help") || process.argv.includes("-h")) {
  console.log(`Usage: bun run dev:desktop [options]
       ELIZA_DESKTOP_VITE_WATCH=1 bun eliza/packages/app/scripts/dev-platform.mjs   # same as bun run dev
