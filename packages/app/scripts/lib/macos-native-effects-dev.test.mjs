...
const cwd = "/repo";
const source =
  "/repo/packages/app/platforms/electrobun/native/macos/window-effects.mm";
const output =
  "/repo/packages/app/platforms/electrobun/src/libMacWindowEffects.dylib";
...
describe("macOS native effects dev plan", () => {
  ...
  it("builds a missing source-checkout artifact", () => {
    expect(plan()).toEqual({
      kind: "build",
      packageDir: "/repo/packages/app/platforms/electrobun",
      dylibPath: output,
    });
  });
