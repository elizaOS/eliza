/**
 * Orchestrator-only settings table for `eliza/packages/app/scripts/dev-platform.mjs`.
...
export function formatOrchestratorDesktopDevBanner(p) {
  ...
  const rows = [
    ...
    {
      setting: "Initial vite build (packages/app/web-dist)",
  ...
  const footer =
    ...
    "Other env: inherited process.env; see docs/apps/desktop-local-development.md and @elizaos/core/runtime-env.\n";
