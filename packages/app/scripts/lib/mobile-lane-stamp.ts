 ...
 *
 * `run-mobile-build.ts` uses (1) to drive the dist-reuse decision (a
 ...
 * `packages/app/scripts/mobile-release-preflight.ts` uses (4) for the
 * sideload lane.
 */
 ...
 * build in `run-mobile-build.ts`, and (b) the precedence the vite
