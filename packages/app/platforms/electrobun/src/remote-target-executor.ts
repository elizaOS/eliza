 ...
 */
import { REMOTE_AGENT_CHAT_TIMEOUT_MS } from "@elizaos/core/contracts/remote-agent-request";
import { REMOTE_AGENT_RESPONSE_LIMIT_BYTES } from "@elizaos/core/contracts/remote-agent-request";
import { classifyRemoteAgentRequestPath } from "@elizaos/core/contracts/remote-agent-request";
...
import { type RemoteTargetCommandExecutor } from "./remote-target-runner";
import { type RemoteTargetEffectResult } from "./remote-target-runner";
...
export class LoopbackRemoteTargetExecutor implements RemoteTargetCommandExecutor {
    ...
    async execute(input: {
        action: "agent.request" | "agent.message" | "agent.pause" | "agent.resume" | "agent.stop" | "agent.status";
