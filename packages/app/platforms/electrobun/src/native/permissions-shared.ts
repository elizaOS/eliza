...
export { type PermissionCheckResult, type PermissionId, type PermissionState, type PermissionStatus, type Platform, type SystemPermissionDefinition } from "@elizaos/core/contracts/permissions";
...
export const SYSTEM_PERMISSIONS: SystemPermissionDefinition[] = [
    ...
    },
    {
        id: "location",
        name: "Location",
        description: "Read the device's current location for travel-time, time-zone, and place-aware planning. Mobile uses GPS; desktop falls back to coarse IP geolocation.",
        icon: "map-pin",
        platforms: ["darwin", "win32", "linux"],
    ...
    },
    {
        id: "health",
        name: "Apple Health",
        description: "Read HealthKit data such as sleep and wellness signals from paired devices",
        icon: "heart-pulse",
        platforms: ["darwin"],
    ...
    },
    {
        ...
        description: "Read protected local app data such as Messages databases when explicitly enabled",
        icon: "hard-drive",
        platforms: ["darwin"],
    ...
    },
    {
        id: "wifi",
        name: "Wi-Fi Scans",
        description: "Scan nearby Wi-Fi networks; Android gates scan results behind Location",
        icon: "wifi",
        platforms: ["android"],
    ...
    },
    {
        id: "app-blocking",
        name: "App Blocking",
        description: "Select and block distracting apps with Screen Time or Android usage controls",
        icon: "shield-ban",
        platforms: ["ios", "android"],
    ...
    },
    {
        ...
        description: "Allow background monitoring to keep LifeOps and device signals current",
        icon: "battery",
        platforms: ["android"],
        requiredForFeatures: ["lifeops", "mobile-signals"],
    },
];
const PERMISSION_MAP = new Map<SystemPermissionId, SystemPermissionDefinition>(SYSTEM_PERMISSIONS.map((p) => [p.id, p]));
export function isPermissionApplicable(id: SystemPermissionId, platform: Platform): boolean {
