 ...
 */
import { type AgentAutomationMode as SharedAgentAutomationMode } from "@elizaos/core/api/agent-api-types";
import { type DatabaseBackupResult } from "./database";
import { type DatabaseResetResult } from "./database";
import { type DatabaseSnapshot } from "./database";
import { type DynamicViewCloseParams } from "./dynamic-views/types";
import { type DynamicViewManifest } from "./dynamic-views/types";
import { type DynamicViewOpenParams } from "./dynamic-views/types";
import { type DynamicViewPushParams } from "./dynamic-views/types";
import { type DynamicViewRegisterParams } from "./dynamic-views/types";
import { type DynamicViewSession } from "./dynamic-views/types";
import { type DynamicViewUnregisterParams } from "./dynamic-views/types";
...
import { type LaunchBugReportBundleInfo } from "./launch/types";
import { type LaunchEventsTailParams } from "./launch/types";
import { type LaunchEventsTailResult } from "./launch/types";
...
import { type ShellAuthorityCommandPush } from "./shell-sync-relay";
import { type ShellAuthorityCommandResult } from "./shell-sync-relay";
import { type ShellAuthorityCompleteCommandParams } from "./shell-sync-relay";
import { type ShellAuthorityConnectParams } from "./shell-sync-relay";
import { type ShellAuthorityDeliverParams } from "./shell-sync-relay";
import { type ShellAuthorityDeliveryPush } from "./shell-sync-relay";
import { type ShellAuthorityDispatchCommandParams } from "./shell-sync-relay";
import { type ShellAuthorityPublishSnapshotParams } from "./shell-sync-relay";
import { type ShellAuthorityState } from "./shell-sync-relay";
...
import { type TraceRecordEventParams } from "./trace/types";
import { type TraceSearchParams } from "./trace/types";
import { type TraceSession } from "./trace/types";
import { type TraceSessionStatus } from "./trace/types";
import { type TraceStartSessionParams } from "./trace/types";
import { type TraceSummary } from "./trace/types";
import { type TraceTailParams } from "./trace/types";
import { type TraceTailResult } from "./trace/types";
import { type TradePermissionMode as SharedTradePermissionMode } from "@elizaos/core/contracts/wallet-types";
import { type TriggerHealthSnapshot as SharedTriggerHealthSnapshot } from "@elizaos/core/api/agent-api-types";
import { type VoiceComponentSnapshot } from "./voice/types";
import { type VoiceInjectTranscriptParams } from "./voice/types";
import { type VoiceInterruptParams } from "./voice/types";
import { type VoiceLatencySummary } from "./voice/types";
import { type VoicePipelineSnapshot } from "./voice/types";
import { type VoiceSpeakParams } from "./voice/types";
import { type VoiceStartParams } from "./voice/types";
import { type VoiceStopParams } from "./voice/types";
import { type VoiceSynthesisResult } from "./voice/types";
import { type VoiceSynthesizeSpeechParams } from "./voice/types";
import { type VoiceTranscribeAudioParams } from "./voice/types";
...
// -- Desktop --
export { type ExistingElizaInstallInfo, type ExistingElizaInstallSource } from "@elizaos/core/contracts/host-types";
...
export type DesktopSessionStorageType = "cookies" | "localStorage" | "sessionStorage" | "indexedDB" | "webSQL" | "cache" | "all";
...
// -- Permissions --
export { type PermissionId, type PermissionState, type PermissionStatus } from "@elizaos/core/contracts/permissions";
...
export type RendererSecureStoreKind = "session.device_auth" | "session.steward_token" | "runtime.active_server" | "runtime.agent_profiles";
...
export interface RendererSecureStoreStatus {
    backend: "macos_keychain" | "windows_credential_manager" | "linux_secret_service" | "file_encrypted_fallback" | "none";
    available: boolean;
    synchronized: false;
...
export type NativeEditorId = "vscode" | "cursor" | "windsurf" | "antigravity" | "zed" | "sublime";
...
export type AgentStatusState = "not_started" | "starting" | "running" | "stopped" | "restarting" | "error";
    ...
    bun: RPCSchema<{
        requests: {
            ...
            desktopSetBottomBarSurfaceState: {
                params: {
                    state: "CLOSED" | "INPUT" | "INPUT_MENU" | "OPEN_UNDER_HALF" | "OPEN_HALF_OR_OVER" | "MAXIMIZED";
                };
                response: undefined;
            };
            ...
            desktopOpenSurfaceWindow: {
                params: {
                    surface: "chat" | "browser" | "release" | "triggers" | "plugins" | "connectors" | "cloud";
                    browse?: string;
                    alwaysOnTop?: boolean;
                };
...
export const CHANNEL_TO_RPC_METHOD: Record<string, string> = {
    ...
    "desktop:resolveWorkspaceFolderBookmark": "desktopResolveWorkspaceFolderBookmark",
    "desktop:releaseWorkspaceFolderBookmarks": "desktopReleaseWorkspaceFolderBookmarks",
    // Gateway
 ...
 */
export const RPC_MESSAGE_TO_PUSH_CHANNEL: Record<string, string> = Object.fromEntries(Object.entries(PUSH_CHANNEL_TO_RPC_MESSAGE).map(([k, v]) => [v, k]));
