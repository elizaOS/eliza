 ...
 * `packages/app/platforms/electrobun/app/` (not under the host app).
 *
 * Usage:
 *   node packages/app/platforms/electrobun/scripts/sync-web-assets.mjs
 *
...
const sourceDir = path.join(appRoot, "web-dist");
