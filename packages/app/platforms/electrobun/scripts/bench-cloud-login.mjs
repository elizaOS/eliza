 ...
 *
 * Usage:
 *   bun run --cwd packages/app/platforms/electrobun bench:cloud-login
 *   bun run --cwd packages/app/platforms/electrobun bench:cloud-login -- --rounds 10 --api-base https://api-staging.eliza.app
 *
 * Flags:
