...
[`packages/app/scripts/run-mobile-build.mjs`](../../scripts/run-mobile-build.mjs)
...
under `packages/app/platforms/android/app/build/outputs/apk/debug/`.
...
```bash
node packages/app/scripts/run-mobile-build.mjs android-cloud-audit /absolute/path/app-release.aab
```
...
[`packages/ui/src/platform/android-runtime.ts`](../../../src/ui/platform/android-runtime.ts)
...
```bash
adb install -r packages/app/platforms/android/app/build/outputs/apk/debug/app-debug.apk
