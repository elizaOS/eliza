...
| 13 | Auto-scroll at bottom vs reading-scrollback (single-commit >80px growth, no-yank scrollback, jump-to-latest re-pin; mouse + touch) | thread | `ContinuousChatOverlay.tsx` | L3 `run-chat-sheet-e2e.mjs` (`AUTOSCROLL` leg + screenshots/video) |
