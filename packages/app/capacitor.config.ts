...
const config: CapacitorConfig = {
  ...
  plugins: {
    ...
    // Eliza brand: orange splash with white logo. PNG assets (Splash.imageset
    // on iOS, drawable/splash.png on Android) still need to be regenerated by
    // a designer from /brand/logos/logo_white_orangebg.svg on an #FF5800 field.
    SplashScreen: {
