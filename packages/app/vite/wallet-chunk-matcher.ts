...
// facade ids named after wallet entry points such as `useWalletModal`. Keep
// those wallet deps/facades in the same lazy crypto chunk; otherwise Rollup can
// emit an eager helper chunk named after `useWalletModal` and put the bn.js
// graph there.
