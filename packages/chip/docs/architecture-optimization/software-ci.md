...
| AOSP RISC-V platform      | `compiler/aosp/manifest.xml`                       | `TODO_PIN_AOSP_RISCV_BRANCH_SHA` (BLOCKED; no upstream Tier 1)     | `docs/evidence/compiler/aosp-branch-pin.yaml`, `scripts/check_rva23_compliance.py::rva23.aosp_branch_pin`                                                                                                  |
