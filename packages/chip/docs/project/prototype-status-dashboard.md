...
Snapshot: updated after the 2026-05-19 full OpenLane release run.
...
| C: PD, package, board, SI/PI | BLOCK | Full OpenLane run `RUN_2026-05-19_05-08-54` produced final layout artifacts and clean DRC/LVS, but antenna, hold, max-slew, and max-cap closure remain blocked. |
