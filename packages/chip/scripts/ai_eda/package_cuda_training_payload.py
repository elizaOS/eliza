...
def write_run_plan(out_dir: Path, selected: list[dict[str, Any]], args: argparse.Namespace) -> Path:
    ...
    plan = {
        ...
        "required_remote_commands": [
            ...
            "python3 scripts/ai_eda/bootstrap_ai_eda_stack.py --profile setup-check --run-id <cuda-host> --asset tilos-macroplacement --asset openroad-eda-corpus --asset circuitnet3 --asset chipbench-d --asset openabc-d --asset aieda-idata --asset edalearn",
            "python3 scripts/ai_eda/bootstrap_ai_eda_stack.py --profile local-smoke --run-id <cuda-host> --asset tilos-macroplacement --asset openroad-eda-corpus --asset circuitnet3 --asset chipbench-d --asset openabc-d --asset aieda-idata --asset edalearn",
            "python3 scripts/ai_eda/bootstrap_ai_eda_stack.py --profile training-handoff --run-id <cuda-host> --asset tilos-macroplacement --asset openroad-eda-corpus --asset circuitnet3 --asset chipbench-d --asset openabc-d --asset aieda-idata --asset edalearn --include-torch",
            ...
            "python3 scripts/ai_eda/convert_aieda_idata_to_internal_records.py --run-id <cuda-host> --sample-limit 64",
