        ...
        "candidate_tasks": [
            {
                ...
                "target": "future RISCOF, riscv-arch-test, and riscv-dv use must be pinned and tied to a buildable E1-compatible DUT, ISS, and result signature",
                "acceptance_gates": [
            ...
            },
            {
                ...
                "target": "future OpenOCD, RISC-V debug, and sigrok capture flows must be pinned to E1 debug policy, board debug IO, probe identity, command logs, and acquisition hashes",
                "acceptance_gates": [
                    "make fpga-check",
