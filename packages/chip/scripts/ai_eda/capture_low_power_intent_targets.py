    ...
    report = {
        ...
        "candidate_tasks": [
            ...
            },
            {
                ...
                "target": "future Yosys or LLM-assisted clock-gating candidates must preserve RTL behavior and pass scan, CDC/RDC, timing, synthesis, and power evidence gates",
                "acceptance_gates": [
                    "make rtl-check",
                    "make formal",
                    "make synth",
