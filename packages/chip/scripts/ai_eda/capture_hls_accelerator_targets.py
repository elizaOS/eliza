    ...
    report = {
        ...
        "candidate_tasks": [
            ...
            },
            {
                ...
                "target": "future LLM-DSE, iDSE, MPM-LLM4DSE, or TimelyHLS-style directive and accelerator-parameter search for bounded E1 kernels",
            ...
            },
            {
                ...
                "target": "future HLS QoR models, HLS benchmark datasets, FlexLLM libraries, or TAPA/RapidStream backends must remain metadata-only until revisions, licenses, tool versions, generated artifacts, and replay manifests are reviewed",
