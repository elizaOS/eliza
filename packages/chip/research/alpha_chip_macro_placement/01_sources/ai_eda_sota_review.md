...
| Power, thermal, IR drop, and PDN | AgenticTCAD, TcadGPT, DeepOHeat, 2D-ThermAl, ThermEDGe/IREDGe, WACA-UNet, IR-Drop-Predictor, EDA IR-Drop Prediction, OpeNPDN, AiEDA, RTLMUL | Capture TCAD-derived device/leakage/self-heating assumptions and power/thermal/PDN target tasks only; block generated TCAD decks, power maps, thermal maps, PDNs, IR-drop predictions, TOPS/W, and thermal claims until authorized process decks, calibration, measured traces, package models, PDNSim/OpenROAD labels, and signoff evidence exist. |
