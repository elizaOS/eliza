...
| RTL generation | RTL-Coder, ChipCraftX RTLGen 7B, ChipSeek, RTLSeek, OpenLLM-RTL, VerilogEval, CVDP | Evaluate against small E1-style tasks; block generated RTL, RL training, inference, and PPA claims until lint, simulation, synthesis, formal where applicable, contamination checks, and review pass. |
