...
Solid parts: 89. Pairs checked: 3916. Trajectory samples: 21. Virtual keepout volumes excluded: 5.
...
- review: `orange_screw_boss_3` vs `orange_battery_left_rib` 0.105 mm^3 still nested
- review: `orange_screw_boss_4` vs `orange_battery_right_rib` 0.105 mm^3 still nested
- review: `orange_screw_boss_5` vs `orange_battery_left_rib` 4.41 mm^3 still nested
- review: `orange_screw_boss_6` vs `orange_battery_right_rib` 4.41 mm^3 still nested
