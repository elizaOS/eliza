...
- PASS: `flush_back_molded_depth` target molded slab depth <=12.0 mm with a fully flush flat back: zero rear solid protrusion and no package outside the enclosure datum
