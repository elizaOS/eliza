...
import type { SkillFrontmatter, SkillMetadata, SkillInvocationPolicy } from "./types.js";
...
/**
 * Resolve OpenClaw-specific metadata from skill frontmatter
 *
 * @param frontmatter - Parsed skill frontmatter
 * @returns Normalized metadata object
 */
export function resolveSkillMetadata(frontmatter: SkillFrontmatter): SkillMetadata {
 ...
 */
export function resolveSkillInvocationPolicy(frontmatter: SkillFrontmatter): SkillInvocationPolicy {
