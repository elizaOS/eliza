...
TASK: Writing new tests
  → Read [skills/property-based-testing/references/generating.md](skills/property-based-testing/references/generating.md) (test generation patterns and examples)
  → Then [skills/property-based-testing/references/strategies.md](skills/property-based-testing/references/strategies.md) if input generation is complex

TASK: Designing a new feature
  → Read [skills/property-based-testing/references/design.md](skills/property-based-testing/references/design.md) (Property-Driven Development approach)

TASK: Code is difficult to test (mixed I/O, missing inverses)
  → Read [skills/property-based-testing/references/refactoring.md](skills/property-based-testing/references/refactoring.md) (refactoring patterns for testability)

TASK: Reviewing existing PBT tests
  → Read [skills/property-based-testing/references/reviewing.md](skills/property-based-testing/references/reviewing.md) (quality checklist and anti-patterns)

TASK: Need library reference
  → Read [skills/property-based-testing/references/libraries.md](skills/property-based-testing/references/libraries.md) (PBT libraries by language, includes smart contract tools)
```
