...
- For commands, pattern operators, and taint mode syntax, see [quick-reference.md](skills/semgrep-rule-creator/references/quick-reference.md).
- For detailed workflow and examples, you MUST see [workflow.md](skills/semgrep-rule-creator/references/workflow.md)
