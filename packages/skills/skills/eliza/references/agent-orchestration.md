...
The agent orchestrator creates a PTY session for coding workers such as Claude, Codex, Gemini, Aider, shell/Eliza Code-compatible sessions, and future agent runtimes. Each worker gets:
