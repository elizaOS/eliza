...
export const sendMessageAction: Action = {
  ...
  validate: async (
    ...
    // const getRegisteredSources = runtime.getRegisteredSources;
    // const registeredSources = (getRegisteredSources && getRegisteredSources()) || [];
  ...
  handler: async (
    ...
    try {
      ...
      if (targetData.targetType === "user") {
        ...
        const sendDirectMessage = service && service.sendDirectMessage;
        ...
        const targetRoom = rooms.find((r) => {
          ...
          return (
            ...
            (targetData.identifiers && targetData.identifiers.roomName && targetData.identifiers.roomName.toLowerCase())
          );
        });
        ...
        if (!targetRoom) {
          ...
          return {
            ...
            values: {
              ...
              targetType: "room",
              roomName: (targetData.identifiers && targetData.identifiers.roomName),
            },
            data: {
              actionName: "SEND_MESSAGE",
        ...
        const sendRoomMessage = service && service.sendRoomMessage;
