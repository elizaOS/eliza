...
import localAiPlugin from "../../../../plugins/plugin-local-ai/index.browser";
import localdbPlugin from "../../../../plugins/plugin-localdb/index.browser";
...
export async function requestAgentMoveDecision(
  ...
  const decisionPrompt = [
    ...
    "thought: I'll head to the Town Square to see who's around.",
    "actions: REPLY,MOVE",
    "text: I'm walking to the Town Square to check the crossroads.",
    "params:",
    "  MOVE:",
    "    target: Town Square",
    "",
    "thought: I'll swing by the Market to listen for rumors.",
    "actions: REPLY,MOVE",
    "text: Heading to the Market to see who's trading today.",
    "params:",
    "  MOVE:",
    "    target: Market",
    "",
    "thought: I want to check the Bridge by the river.",
    "actions: REPLY,MOVE",
    "text: Walking to the Bridge to see who's crossing.",
    "params:",
    "  MOVE:",
    "    target: Bridge",
    "",
    "thought: I'll warm up by the Camp for a moment.",
    "actions: REPLY,MOVE",
    "text: Heading to the Camp to warm up by the fire.",
    "params:",
    "  MOVE:",
    "    target: Camp",
    "",
    "thought: I'll take a look at the Waterfall.",
    "actions: REPLY,MOVE",
    "text: Walking to the Waterfall to check the path.",
    "params:",
    "  MOVE:",
    "    target: Waterfall",
    "",
    "thought: I'll head toward the East Windmill.",
    "actions: REPLY,MOVE",
    "text: Walking to the East Windmill to survey the fields.",
    "params:",
    "  MOVE:",
    "    target: East Windmill",
    "",
    "thought: I'll check on the South Windmill.",
    "actions: REPLY,MOVE",
    "text: Heading to the South Windmill to see the farms.",
    "params:",
    "  MOVE:",
    "    target: South Windmill",
    "",
    "thought: I'll head toward the West Windmill.",
    "actions: REPLY,MOVE",
    "text: Walking to the West Windmill to stay inconspicuous.",
    "params:",
    "  MOVE:",
    "    target: West Windmill",
    "",
    "thought: I should go talk to Maren Sol.",
    "actions: REPLY,MOVE",
    "text: I'll walk over to Maren Sol for a quick check-in.",
    "params:",
    "  MOVE:",
    "    target: Maren Sol",
    "",
    "thought: I want to move to a specific tile.",
    "actions: REPLY,MOVE",
    "text: Heading to the crossroads.",
    "params:",
    "  MOVE:",
    "    x: 12",
    "    y: 8",
...
export async function requestAgentGameDecision(
  ...
  const decisionPrompt = [
    ...
    "",
    "Action examples (copy the structure):",
    "thought: It's night, I'll protect Maren Sol.",
    "actions: MAFIA_PROTECT",
    "text: I'll keep an eye out tonight.",
    "params:",
    "  MAFIA_PROTECT:",
    "    target: Maren Sol",
    "",
    "thought: Daytime vote: I suspect Juniper Vale.",
    "actions: MAFIA_VOTE",
    "text: I think we should vote out Juniper Vale.",
    "params:",
    "  MAFIA_VOTE:",
    "    target: Juniper Vale",
  ].join("\n");
