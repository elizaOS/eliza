 ...
 *
 * Canonical rule: `ELIZA_STATE_DIR` wins, then `ELIZA_STATE_DIR` (historical
 * alias), then `<homedir>/.eliza`. Every caller that wants to touch the
 ...
 * `ELIZA_STATE_DIR` → `ELIZA_STATE_DIR` → `~/.eliza` precedence.
 */
