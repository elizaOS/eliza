...
/**
 * Extracts recent messages from composed state (same shape as
 * `@elizaos/shared/recent-messages-state`). Kept in-package so
 * `tsconfig.declarations.json` emit stays within `rootDir`.
 */
