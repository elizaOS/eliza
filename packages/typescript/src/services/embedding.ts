...
export class EmbeddingGenerationService extends Service {
	...
	async initialize(): Promise<void> {
		...
		// BatchQueue: task system owns WHEN (repeat EMBEDDING_DRAIN tick); we own WHAT (dequeue,
		// embed, persist). No maxSize — bottleneck is embedding I/O, not queue length; see docs/BATCH_QUEUE.md.
