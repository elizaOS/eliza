...
export const allActionsSpec = {
	...
	actions: [
		...
		},
		{
			...
			description:
				"Start an n8n workflow so it processes triggers and runs automatically. ",
			parameters: [],
			similes: [
				"ACTIVATE_WORKFLOW",
				"ENABLE_WORKFLOW",
		...
		},
		{
			name: "CLONE_PLUGIN",
			description:
				"Clone a plugin repository for local development and modification",
			parameters: [],
			similes: [
				"clone plugin",
				"download plugin",
		...
		},
		{
			name: "EVALUATE_TRUST",
			description:
				"Evaluates the trust score and profile for a specified entity",
			parameters: [],
			similes: [
				"check trust score",
				"evaluate trust",
		...
		},
		{
			name: "FORGET",
			description:
				"Remove a stored memory by ID or by matching content description",
			parameters: [],
			similes: [
				"forget",
				"remove-memory",
		...
		},
		{
			name: "LOAD_PLUGIN",
			description:
				"Load a plugin that is currently in the ready or unloaded state",
			parameters: [],
			similes: [
				"load plugin",
				"enable plugin",
		...
		},
		{
			name: "REMEMBER",
			description:
				"Store a piece of information as a long-term memory for later recall",
			parameters: [],
			similes: [
				"remember",
				"memorize",
