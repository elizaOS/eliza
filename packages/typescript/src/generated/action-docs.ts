...
export const coreActionsSpec = {
  ...
  actions: [
    ...
    },
    {
      ...
      similes: ["NO_RESPONSE", "SILENT"],
      parameters: [],
    },
    {
      name: "NONE",
      description:
        "Explicitly take no action. Use when an action list is required but nothing should be done.",
      similes: ["NOOP"],
      parameters: [],
    },
    {
    ...
    },
    {
      name: "ADD_CONTACT",
      description:
        "Add a new contact to the rolodex with basic details and notes.",
      similes: ["CREATE_CONTACT", "NEW_CONTACT", "SAVE_CONTACT"],
      parameters: [
        {
          name: "name",
    ...
    },
    {
      ...
      similes: ["EDIT_CONTACT", "MODIFY_CONTACT"],
      parameters: [
        {
          name: "name",
          description:
    ...
    },
    {
      ...
      similes: ["FIND_CONTACTS", "LOOKUP_CONTACTS"],
      parameters: [
        {
          name: "query",
    ...
    },
    {
      ...
      similes: ["SELECT_OPTION", "PICK_OPTION"],
      parameters: [
        {
          name: "taskId",
    ...
    },
    {
      name: "FOLLOW_ROOM",
      description:
        "Follow a room so the agent receives and processes messages from it.",
      similes: ["SUBSCRIBE_ROOM"],
      parameters: [
        {
          name: "roomId",
    ...
    },
    {
      name: "UNFOLLOW_ROOM",
      description:
        "Unfollow a room so the agent stops receiving messages from it.",
      similes: ["UNSUBSCRIBE_ROOM"],
      parameters: [
        {
          name: "roomId",
    ...
    },
    {
      ...
      similes: ["SET_SETTINGS", "CHANGE_SETTINGS"],
      parameters: [
        {
          name: "updates",
          description:
    ...
    },
    {
      name: "UPDATE_ENTITY",
      description:
        "Update stored entity information by applying explicit field updates.",
      similes: ["EDIT_ENTITY", "MODIFY_ENTITY"],
      parameters: [
        {
          name: "entityId",
          description: "The entity id to update.",
    ...
    },
    {
      ...
      similes: ["IMAGE", "DRAW", "CREATE_IMAGE"],
      parameters: [
        {
          name: "prompt",
...
export const allActionsSpec = {
  ...
  actions: [
    ...
    },
    {
      name: "CANCEL_GOAL",
      description:
        "Cancels and deletes a goal item from the user's task list immediately.",
      parameters: [],
    ...
    },
    {
      ...
      description:
        "Lists currently running applications on the target machine.",
      parameters: [],
    ...
    },
    {
      name: "CREATE_GOAL",
      description:
        "Creates a new long-term achievable goal for the agent or a user.",
      parameters: [],
    ...
    },
    {
      ...
      parameters: [],
      similes: ["ORDER_INFO", "VIEW_ORDER", "SHOW_ORDER", "ORDER_STATUS"],
    },
    {
