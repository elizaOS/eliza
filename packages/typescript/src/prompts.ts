...
- in group conversations, if the latest message is addressed to someone else and not to {{agentName}}, IGNORE even when {{agentName}} appears incidentally in a repo name, URL, quote, or third-person reference
