...
describe("Role Provider", () => {
  ...
  beforeEach(async () => {
    ...
    (mockRuntime.getWorld as ReturnType<typeof mock>).mockResolvedValue({
    ...
    (mockRuntime.getEntityById as ReturnType<typeof mock>).mockResolvedValue(
      null,
    );
  ...
  it("should retrieve and format role hierarchy", async () => {
    ...
    (mockRuntime.getWorld as ReturnType<typeof mock>).mockImplementation(
      async (id) => {
  ...
  it("should handle missing entity gracefully (now expecting rejection)", async () => {
    ...
    (mockRuntime.getRoom as ReturnType<typeof mock>).mockRejectedValue(
