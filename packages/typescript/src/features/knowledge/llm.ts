...
import { logActiveTrajectoryLlmCall, withStandaloneTrajectory } from "../../trajectory-utils";
...
async function generateLocalEmbedding(
  ...
  if (!Array.isArray(embedding)) {
    throw new Error("Local embedding model returned an invalid embedding payload");
  }
