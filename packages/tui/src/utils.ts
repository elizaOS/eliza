 ...
 * @param backgroundFn - Background color function
 * @returns Line with background applied and padded to width
 */
export function applyBackgroundToLine(line: string, width: number, backgroundFn: (text: string) => string): string {
	...
	return backgroundFn(withPadding);
}
