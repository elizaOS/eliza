 ...
 * inherits the app font variables and themes through `currentColor`, so setting
 * the parent text color recolors the whole logo.
 */
export function FeedFullLogo({
  className,
  withMark = true,
  "aria-label": ariaLabel = "feed",
  ...props
}: FeedFullLogoProps) {
  ...
  return (
    ...
    >
      ...
      <text
        ...
        y={418}
        fill="currentColor"
        fontFamily="var(--font-geist-sans, var(--font-sans, system-ui)), system-ui, -apple-system, 'Segoe UI', Helvetica, Arial, sans-serif"
        fontSize={380}
        fontWeight={800}
        letterSpacing={0}
      >
