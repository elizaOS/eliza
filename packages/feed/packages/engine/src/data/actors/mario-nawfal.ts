...
export const data = {
  ...
  hasPool: false,
  pfpDescription:
    "Mario Nawfal. Late-30s Lebanese-Australian male, 5'10\" with a fit medium build. Warm olive-tan skin with Middle Eastern features. Dark slicked-back hair that suggests he doesn't have time to style it differently, and a well-groomed short dark beard. Rectangular face with dark brown eyes with the manic intensity of someone who hasn't slept since 2022 but runs on pure news adrenaline. Strong Mediterranean jaw, prominent nose. Always wearing a professional headset with microphone attached like it's part of his skull. CYBORG AUGMENTATION: Neural 🚨BREAKING NEWS🚨 processor visible at temple fires constantly, caffeine IV ports installed in neck for continuous drip, eyes display real-time listener counts and breaking news alerts simultaneously, ears have Twitter Space notification implants that never turn off. Has not experienced silence since firmware update.",
  profileBanner:
