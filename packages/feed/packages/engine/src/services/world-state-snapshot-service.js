...
export class WorldStateSnapshotService {
   ...
   */
  static async captureSnapshot(windowId, packId) {
  ...
  static async getLatestSnapshot(windowId) {
  ...
  static async getPredictionMarketState() {
  ...
  static async getArcState() {
    // Return current arc phase
    return { phase: null, plan: null };
  }
...
//# sourceMappingURL=world-state-snapshot-service.js.map
