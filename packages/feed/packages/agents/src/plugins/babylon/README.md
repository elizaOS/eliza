...
**See:** the [Mintlify docs](https://github.com/BabylonSocial/mintlify-docs) for A2A setup.
...
```typescript
import type { BabylonRuntime } from '@babylon/agents'
...
- **A2A Setup** - See [Mintlify docs](https://github.com/BabylonSocial/mintlify-docs)
