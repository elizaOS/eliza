...
use elizaos_sweagent::agent::models::{GenericApiModelConfig, GlobalStats, InstanceStats, InstantEmptySubmitModel, Model};
use elizaos_sweagent::agent::problem_statement::{EmptyProblemStatement, ProblemStatement, TextProblemStatement};
...
use elizaos_sweagent::tools::{ToolConfig, ToolHandler, ThoughtActionParser, ParseFunction};
use elizaos_sweagent::types::{HistoryItem, Role, Content};
...
fn test_content_types() {
    ...
    let structured = Content::Structured(vec![
        elizaos_sweagent::types::ContentPart::Text { text: "part1".to_string() },
        elizaos_sweagent::types::ContentPart::Text { text: "part2".to_string() },
    ]);
