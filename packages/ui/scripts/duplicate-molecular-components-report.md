...
| content-state | `ContentState` in `packages/ui/src/components/composites/page-panel/content-state.tsx` | 4 | `packages/ui/src/components/composites/page-panel/content-state.stories.tsx`<br>`packages/ui/src/components/composites/page-panel/content-state.test.tsx` | Empty and loading presentation inside page-panel placements. |
