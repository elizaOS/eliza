 ...
 *
 * Usage: node scripts/bake-view-icons.ts [srcDir]   (default /tmp/view-icons)
 */
...
// not run gen-view-icons.ts (or passed an explicit srcDir), the source
...
if (!existsSync(srcDir)) {
  console.error(
    `[bake-view-icons] source directory ${srcDir} does not exist; ` +
      "run scripts/gen-view-icons.ts first (FAL_KEY required) or pass the icon directory as an argument. " +
...
const ts = `// AUTO-GENERATED by scripts/bake-view-icons.ts — do not edit by hand.
