export const meta = {
  name: "add-ui-stories-v2-settings",
  description: "Add Storybook stories using the mock-provider harness (no-schema)",
  phases: [{ title: "Write stories" }],
};

const targets = ["src/components/settings/LoadContentPackForm.tsx","src/components/settings/LoadedPacksList.tsx","src/components/settings/ProviderPanels.tsx","src/components/settings/ProviderRoutingPanel.tsx","src/components/settings/ProviderSwitcher.tsx","src/components/settings/RemotePluginHostSection.tsx","src/components/settings/RuntimeSettingsSection.tsx","src/components/settings/SecretsManagerSection.tsx","src/components/settings/SecuritySettingsSection.tsx","src/components/settings/SubscriptionStatus.tsx","src/components/settings/VaultInventoryPanel.tsx","src/components/settings/VoiceConfigView.tsx","src/components/settings/VoiceProfileSection.tsx","src/components/settings/VoiceSection.tsx","src/components/settings/VoiceSectionMount.tsx","src/components/settings/VoiceTierBanner.tsx","src/components/settings/WalletKeysSection.tsx","src/components/settings/WalletRpcSection.tsx","src/components/settings/XRSettingsSection.tsx","src/components/settings/appearance-primitives.tsx","src/components/settings/permission-controls.tsx","src/components/settings/settings-control-primitives.tsx","src/components/settings/vault-tabs/LoginsTab.tsx","src/components/settings/vault-tabs/OverviewTab.tsx","src/components/settings/vault-tabs/RoutingTab.tsx","src/components/settings/vault-tabs/SecretsTab.tsx"];
const batchName = "settings";
