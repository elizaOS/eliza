...
type OnboardingClient = Pick<ElizaClient, "getAuthStatus" | "getBaseUrl" | "getStatus" | "provisionCloudSandbox" | "setBaseUrl" | "setToken" | "startAgent" | "submitOnboarding" | "updateConfig">;
import { type scanProviderCredentials } from "../bridge";
import type { UiLanguage } from "../i18n";
import { type Tab } from "../navigation";
import { type OnboardingNextOptions } from "./internal";
import type { AppState, CompleteOnboardingOptions, OnboardingStep } from "./types";
...
export interface OnboardingCallbacksDeps {
    ...
    setOnboardingDetectedProviders: (v: AppState["onboardingDetectedProviders"]) => void;
