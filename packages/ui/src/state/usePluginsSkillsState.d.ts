 ...
 * tested).
 */
export declare function pickPrimaryCredentialParam<
  P extends {
    key: string;
    sensitive: boolean;
  },
...
export declare function usePluginsSkillsState({
  setActionNotice,
  setPendingRestart,
  setPendingRestartReasons,
  showRestartBanner,
  ...
  plugins: PluginInfo[];
  setPlugins: import("react").Dispatch<
    import("react").SetStateAction<PluginInfo[]>
  >;
  pluginFilter: "connector" | "all" | "ai-provider" | "feature" | "streaming";
  setPluginFilter: import("react").Dispatch<
    import("react").SetStateAction<
      "connector" | "all" | "ai-provider" | "feature" | "streaming"
    >
  >;
  pluginStatusFilter: "all" | "enabled" | "disabled";
  setPluginStatusFilter: import("react").Dispatch<
    import("react").SetStateAction<"all" | "enabled" | "disabled">
  >;
  pluginSearch: string;
  setPluginSearch: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  pluginSettingsOpen: Set<string>;
  setPluginSettingsOpen: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  pluginAdvancedOpen: Set<string>;
  setPluginAdvancedOpen: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  pluginSaving: Set<string>;
  setPluginSaving: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  pluginSaveSuccess: Set<string>;
  setPluginSaveSuccess: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  loadPlugins: (_options?: { silent?: boolean }) => Promise<void>;
  ensurePluginsLoaded: (options?: { refresh?: boolean }) => Promise<void>;
  ...
  skills: SkillInfo[];
  setSkills: import("react").Dispatch<
    import("react").SetStateAction<SkillInfo[]>
  >;
  skillsSubTab: "browse" | "my";
  setSkillsSubTab: import("react").Dispatch<
    import("react").SetStateAction<"browse" | "my">
  >;
  skillCreateFormOpen: boolean;
  setSkillCreateFormOpen: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  skillCreateName: string;
  setSkillCreateName: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillCreateDescription: string;
  setSkillCreateDescription: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillCreating: boolean;
  setSkillCreating: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  skillReviewReport: SkillScanReportSummary | null;
  setSkillReviewReport: import("react").Dispatch<
    import("react").SetStateAction<SkillScanReportSummary | null>
  >;
  skillReviewId: string;
  setSkillReviewId: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillReviewLoading: boolean;
  setSkillReviewLoading: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  skillToggleAction: string;
  setSkillToggleAction: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillsMarketplaceQuery: string;
  setSkillsMarketplaceQuery: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillsMarketplaceResults: SkillMarketplaceResult[];
  setSkillsMarketplaceResults: import("react").Dispatch<
    import("react").SetStateAction<SkillMarketplaceResult[]>
  >;
  skillsMarketplaceError: string;
  setSkillsMarketplaceError: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillsMarketplaceLoading: boolean;
  setSkillsMarketplaceLoading: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  skillsMarketplaceAction: string;
  setSkillsMarketplaceAction: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  skillsMarketplaceManualGithubUrl: string;
  setSkillsMarketplaceManualGithubUrl: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  ...
  setStorePlugins: import("react").Dispatch<
    import("react").SetStateAction<RegistryPlugin[]>
  >;
  storeSearch: string;
  setStoreSearch: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  storeFilter: "connector" | "all" | "installed" | "ai-provider" | "feature";
  setStoreFilter: import("react").Dispatch<
    import("react").SetStateAction<
      "connector" | "all" | "installed" | "ai-provider" | "feature"
    >
  >;
  storeLoading: boolean;
  setStoreLoading: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  storeInstalling: Set<string>;
  setStoreInstalling: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  storeUninstalling: Set<string>;
  setStoreUninstalling: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  storeError: string | null;
  setStoreError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  storeDetailPlugin: RegistryPlugin | null;
  setStoreDetailPlugin: import("react").Dispatch<
    import("react").SetStateAction<RegistryPlugin | null>
  >;
  storeSubTab: "plugins" | "skills";
  setStoreSubTab: import("react").Dispatch<
    import("react").SetStateAction<"plugins" | "skills">
  >;
  catalogSkills: CatalogSkill[];
  setCatalogSkills: import("react").Dispatch<
    import("react").SetStateAction<CatalogSkill[]>
  >;
  catalogTotal: number;
  setCatalogTotal: import("react").Dispatch<
    import("react").SetStateAction<number>
  >;
  catalogPage: number;
  setCatalogPage: import("react").Dispatch<
    import("react").SetStateAction<number>
  >;
  catalogTotalPages: number;
  setCatalogTotalPages: import("react").Dispatch<
    import("react").SetStateAction<number>
  >;
  catalogSort: "name" | "downloads" | "stars" | "updated";
  setCatalogSort: import("react").Dispatch<
    import("react").SetStateAction<"name" | "downloads" | "stars" | "updated">
  >;
  catalogSearch: string;
  setCatalogSearch: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  catalogLoading: boolean;
  setCatalogLoading: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  catalogError: string | null;
  setCatalogError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  catalogDetailSkill: CatalogSkill | null;
  setCatalogDetailSkill: import("react").Dispatch<
    import("react").SetStateAction<CatalogSkill | null>
  >;
  catalogInstalling: Set<string>;
  setCatalogInstalling: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
  catalogUninstalling: Set<string>;
  setCatalogUninstalling: import("react").Dispatch<
    import("react").SetStateAction<Set<string>>
  >;
};
