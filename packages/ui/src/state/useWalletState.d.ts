...
export declare function useWalletState({
  ...
  setWalletAddresses: import("react").Dispatch<
    import("react").SetStateAction<WalletAddresses | null>
  >;
  setInventoryView: import("react").Dispatch<
    import("react").SetStateAction<"tokens" | "nfts">
  >;
  setInventorySort: import("react").Dispatch<
    import("react").SetStateAction<"symbol" | "value" | "chain">
  >;
  setInventorySortDirection: import("react").Dispatch<
    import("react").SetStateAction<"asc" | "desc">
  >;
  setInventoryChainFilters: import("react").Dispatch<
    import("react").SetStateAction<InventoryChainFilters>
  >;
  setWalletError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  setRegistryError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  setMintResult: import("react").Dispatch<
    import("react").SetStateAction<MintResult | null>
  >;
  setMintError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
