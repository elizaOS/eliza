...
export declare function useCloudState({
  setActionNotice,
  loadWalletConfig,
  t,
  disconnectLocked,
  ...
  setElizaCloudEnabled: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudVoiceProxyAvailable: boolean;
  setElizaCloudVoiceProxyAvailable: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudConnected: boolean;
  setElizaCloudConnected: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudHasPersistedKey: boolean;
  setElizaCloudHasPersistedKey: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudCredits: number | null;
  setElizaCloudCredits: import("react").Dispatch<
    import("react").SetStateAction<number | null>
  >;
  elizaCloudCreditsLow: boolean;
  setElizaCloudCreditsLow: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudCreditsCritical: boolean;
  setElizaCloudCreditsCritical: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudAuthRejected: boolean;
  setElizaCloudAuthRejected: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudCreditsError: string | null;
  setElizaCloudCreditsError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  elizaCloudTopUpUrl: string;
  setElizaCloudTopUpUrl: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  elizaCloudUserId: string | null;
  setElizaCloudUserId: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  elizaCloudStatusReason: string | null;
  setElizaCloudStatusReason: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  cloudDashboardView: "overview" | "billing";
  setCloudDashboardView: import("react").Dispatch<
    import("react").SetStateAction<"overview" | "billing">
  >;
  elizaCloudLoginBusy: boolean;
  setElizaCloudLoginBusy: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
  elizaCloudLoginError: string | null;
  setElizaCloudLoginError: import("react").Dispatch<
    import("react").SetStateAction<string | null>
  >;
  elizaCloudDisconnecting: boolean;
  setElizaCloudDisconnecting: import("react").Dispatch<
    import("react").SetStateAction<boolean>
  >;
