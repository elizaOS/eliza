...
export type AutonomyRunHealthStatus = "ok" | "gap_detected" | "recovered" | "partial";
...
export declare function buildAutonomyGapReplayRequests(runHealthByRunId: AutonomyRunHealthMap, store: AutonomyEventStore): AutonomyGapReplayRequest[];
export declare function hasPendingAutonomyGaps(runHealthByRunId: AutonomyRunHealthMap): boolean;
export declare function markPendingAutonomyGapsPartial(runHealthByRunId: AutonomyRunHealthMap, ts?: number): AutonomyRunHealthMap;
export declare function mergeAutonomyEvents({ existingEvents, store, incomingEvents, runHealthByRunId, maxEvents, replay, }: MergeAutonomyEventsOptions): MergeAutonomyEventsResult;
