...
export declare function useBackendConnectionSync({ setBackendConnection, }: {
    setBackendConnection: (value: AppState["backendConnection"]) => void;
}): void;
export declare function useAgentGreetingEffects({ agentState, loadWorkbench, activeConversationId, conversationMessages, chatSending, fetchGreeting, activeConversationIdRef, conversationMessagesRef, greetingFiredRef, greetingInFlightConversationRef, }: {
