...
export declare function useDataLoaders(deps: DataLoadersDeps): {
  applyAutonomyEventMerge: (
    ...
    replay?: boolean,
  ) => import("./autonomy").MergeAutonomyEventsResult;
  ...
  getStewardAddresses: () => Promise<
    import("@elizaos/shared").StewardWalletAddressesResponse
  >;
  getStewardBalance: (
    chainId?: number,
  ) => Promise<import("@elizaos/shared").StewardBalanceResponse>;
  getStewardTokens: (
    chainId?: number,
  ) => Promise<import("@elizaos/shared").StewardTokenBalancesResponse>;
  ...
  approveStewardTx: (
    txId: string,
  ) => Promise<import("..").StewardApprovalActionResponse>;
  rejectStewardTx: (
    txId: string,
    reason?: string,
  ) => Promise<import("..").StewardApprovalActionResponse>;
