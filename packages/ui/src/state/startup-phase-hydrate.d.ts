...
import { type CodingAgentSession, type Conversation, type ConversationMessage, type StreamEventEnvelope } from "../api";
 ...
 */
export declare function runHydrating(deps: HydratingDeps, dispatch: (event: StartupEvent) => void, cancelled: {
    current: boolean;
}): Promise<void>;
/**
 ...
 */
export declare function bindReadyPhase(depsRef: React.MutableRefObject<ReadyPhaseDeps | undefined>): () => void;
