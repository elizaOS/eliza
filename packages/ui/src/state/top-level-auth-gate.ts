 ...
 * resolves starts agent/status/chat pollers that all 401. This applies during
 * first-run too: the public auth probe may resolve before any protected shell
 * store mounts, while onboarding retains ownership of the eventual login UI.
 */
