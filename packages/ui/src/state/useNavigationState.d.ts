...
import { type ShellView, type TabCommittedDetail, type UiShellMode } from "./internal";
...
export declare function useNavigationState(deps: NavigationStateDeps): {
    lastNativeTab: Tab;
    setLastNativeTabState: import("react").Dispatch<import("react").SetStateAction<Tab>>;
