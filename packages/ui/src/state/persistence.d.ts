...
export declare function normalizeCompanionVrmPowerMode(
  value: unknown,
): CompanionVrmPowerMode;
/**
...
export declare function saveCompanionVrmPowerMode(
...
export declare function normalizeCompanionHalfFramerateMode(
  raw: string | null | undefined,
): CompanionHalfFramerateMode;
export declare function loadCompanionHalfFramerateMode(): CompanionHalfFramerateMode;
export declare function saveCompanionHalfFramerateMode(
...
export declare function savePersistedOnboardingComplete(
  complete: boolean,
): void;
...
export declare function savePersistedActivePackUrl(
  packUrl: string | null,
): void;
 ...
 */
export declare function replaceServerFavoriteApps(
 ...
 */
export declare function toggleServerFavoriteApp(
  appName: string,
  isFavorite: boolean,
): Promise<string[] | null>;
...
export declare function saveContinuousChatMode(
  mode: ContinuousChatModeValue,
): void;
...
export declare function savePersistedActiveServer(
