...
export declare function useExportImportState(): {
    ...
    setExportPassword: import("react").Dispatch<import("react").SetStateAction<string>>;
    setExportIncludeLogs: import("react").Dispatch<import("react").SetStateAction<boolean>>;
    setExportError: import("react").Dispatch<import("react").SetStateAction<string | null>>;
    setExportSuccess: import("react").Dispatch<import("react").SetStateAction<string | null>>;
    setImportPassword: import("react").Dispatch<import("react").SetStateAction<string>>;
    setImportFile: import("react").Dispatch<import("react").SetStateAction<File | null>>;
    setImportError: import("react").Dispatch<import("react").SetStateAction<string | null>>;
    setImportSuccess: import("react").Dispatch<import("react").SetStateAction<string | null>>;
