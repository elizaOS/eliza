...
export type ConnectorTokenKey = "telegramToken" | "discordToken" | "whatsAppSessionPath" | "twilioAccountSid" | "twilioAuthToken" | "twilioPhoneNumber" | "blooioApiKey" | "blooioPhoneNumber" | "githubToken";
...
export interface OnboardingStateHook {
    ...
    setRemoteStatus: (status: RemoteConnectionState["status"], error?: string | null) => void;
    setDetectedProviders: (value: AppState["onboardingDetectedProviders"]) => void;
...
export declare function useOnboardingState(cloudOnly?: boolean): OnboardingStateHook;
