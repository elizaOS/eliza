...
export declare function useLogsState(): {
    ...
    setLogTagFilter: import("react").Dispatch<import("react").SetStateAction<string>>;
    setLogLevelFilter: import("react").Dispatch<import("react").SetStateAction<string>>;
    setLogSourceFilter: import("react").Dispatch<import("react").SetStateAction<string>>;
