...
const EMPTY_TASK: TaskActivity = Object.freeze({
	taskId: "",
	subagents: Object.freeze([]) as SubagentActivity[],
	plan: Object.freeze([]) as SwarmActivityPlanEntry[],
	lastSeq: 0,
	updatedAt: 0,
});
...
function applyEvent(raw: SwarmEvent): void {
	...
	if (activity.parentSessionId) agent.parentSessionId = activity.parentSessionId;
