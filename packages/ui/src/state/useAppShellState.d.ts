...
export declare function useAppShellState(): {
    ...
    setOwnerNameState: import("react").Dispatch<import("react").SetStateAction<string | null>>;
    setAppsSubTab: (value: "browse" | "running" | "games") => void;
    setAgentSubTab: import("react").Dispatch<import("react").SetStateAction<"inventory" | "documents" | "character">>;
    setPluginsSubTab: import("react").Dispatch<import("react").SetStateAction<"connectors" | "plugins" | "features">>;
    setDatabaseSubTab: import("react").Dispatch<import("react").SetStateAction<"media" | "tables" | "vectors">>;
    setFavoriteApps: (apps: string[]) => void;
    setRecentApps: (apps: string[]) => void;
    setConfigRaw: import("react").Dispatch<import("react").SetStateAction<Record<string, unknown>>>;
    setConfigText: import("react").Dispatch<import("react").SetStateAction<string>>;
};
