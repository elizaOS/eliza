...
export declare function confirmDesktopAction(options: DesktopConfirmOptions): Promise<boolean>;
export declare function alertDesktopMessage(options: DesktopAlertOptions): Promise<void>;
export {};
