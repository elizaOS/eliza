...
export declare function requestDesktopBridge<T>(
  rpcMethod: string,
  ipcChannel: string,
  params?: unknown,
): Promise<T | null>;
export declare function openDesktopSettingsWindow(
  tabHint?: string,
): Promise<void>;
export declare function openDesktopSurfaceWindow(
...
export declare function formatDesktopWorkspaceSummary(
