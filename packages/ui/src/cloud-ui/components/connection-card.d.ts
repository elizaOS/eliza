...
declare function ConnectionLoadingCard({
  className,
}: {
  className?: string;
}): import("react/jsx-runtime").JSX.Element;
declare function ConnectionConnectedBadge({
  label,
  className,
}: {
  label?: string;
...
declare function ConnectionIdentityPanel({
  icon,
  title,
  subtitle,
  children,
  ...
  className,
  actions,
}: ConnectionIdentityPanelProps): import("react/jsx-runtime").JSX.Element;
...
declare function ConnectionCallout({
  title,
  items,
  children,
  tone,
  className,
}: ConnectionCalloutProps): import("react/jsx-runtime").JSX.Element;
...
declare function ConnectionInstructions({
  title,
  open,
  onOpenChange,
  children,
  triggerClassName,
  contentClassName,
}: ConnectionInstructionsProps): import("react/jsx-runtime").JSX.Element;
...
declare function ConnectionCopyRow({
  label,
  value,
  onCopied,
  copyLabel,
  className,
}: ConnectionCopyRowProps): import("react/jsx-runtime").JSX.Element;
...
declare function ConnectionDisconnectAction({
  title,
  description,
  onDisconnect,
  isDisconnecting,
  ...
  confirmLabel,
  triggerIcon,
}: ConnectionDisconnectActionProps): import("react/jsx-runtime").JSX.Element;
declare function ConnectionFooterActions({
  note,
  children,
  className,
}: {
...
declare function ConnectionCard({
  name,
  icon,
  description,
  status,
  ...
  statusBadge,
  className,
}: ConnectionCardProps): import("react/jsx-runtime").JSX.Element;
