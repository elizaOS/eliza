...
export declare function ListActionMenu({ label, items, align, contentClassName, triggerClassName, onTriggerClick, }: ListActionMenuProps): import("react/jsx-runtime").JSX.Element;
