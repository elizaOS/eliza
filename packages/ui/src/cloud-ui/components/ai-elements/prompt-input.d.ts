...
import { InputGroupAddon, InputGroupButton, InputGroupTextarea } from "../input-group";
...
export declare function PromptInputAttachments({ className, children, ...props }: PromptInputAttachmentsProps): import("react/jsx-runtime").JSX.Element | null;
