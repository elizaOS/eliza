...
export declare const Reasoning: import("react").MemoExoticComponent<
  ({
    className,
    isStreaming,
    open,
    ...
    children,
    ...props
  }: ReasoningProps) => import("react/jsx-runtime").JSX.Element
>;
export type ReasoningTriggerProps = ComponentProps<typeof CollapsibleTrigger>;
export declare const ReasoningTrigger: import("react").MemoExoticComponent<
  ({
    className,
    children,
    ...props
  }: ReasoningTriggerProps) => import("react/jsx-runtime").JSX.Element
>;
...
export declare const ReasoningContent: import("react").MemoExoticComponent<
  ({
    className,
    children,
    ...props
  }: ReasoningContentProps) => import("react/jsx-runtime").JSX.Element
>;
