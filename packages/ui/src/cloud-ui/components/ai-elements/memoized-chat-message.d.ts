...
declare function ChatMessageComponent(
  props: MemoizedChatMessageProps,
): import("react/jsx-runtime").JSX.Element;
export declare const MemoizedChatMessage: import("react").MemoExoticComponent<
  typeof ChatMessageComponent
>;
