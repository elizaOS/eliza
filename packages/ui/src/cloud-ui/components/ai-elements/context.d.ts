...
export declare const ContextContentHeader: ({ children, className, ...props }: ContextContentHeader) => import("react/jsx-runtime").JSX.Element;
export type ContextContentBody = ComponentProps<"div">;
export declare const ContextContentBody: ({ children, className, ...props }: ContextContentBody) => import("react/jsx-runtime").JSX.Element;
export type ContextContentFooter = ComponentProps<"div">;
export declare const ContextContentFooter: ({ children, className, ...props }: ContextContentFooter) => import("react/jsx-runtime").JSX.Element;
