...
export declare function LogViewer({ title, subtitle, badges, fetchedAt, childrenBeforeSearch, search, levelFilter, lineCountControl, loading, error, errorTitle, retryLabel, onRetry, showRetryOnError, emptyState, filteredEmptyState, isFilteredEmpty: isFilteredEmptyOverride, lines, entries, onRefresh, onCopyAll, onDownload, onToggleStreaming, streaming, copyDisabled, downloadDisabled, refreshTitle, copyTitle, downloadTitle, streamingTitle, heightClassName, contentRef, lineClassName, entryClassName, entryLevelVariant, entryLevelBorderColor, onCopyEntry, className, }: LogViewerProps): import("react/jsx-runtime").JSX.Element;
export {};
