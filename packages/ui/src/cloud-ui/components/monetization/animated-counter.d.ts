...
export declare function AnimatedCounter({
  value,
  prefix,
  suffix,
  decimals,
  ...
  className,
  onComplete,
}: AnimatedCounterProps): import("react/jsx-runtime").JSX.Element;
...
export declare function AnimatedCounterWithLabel({
  label,
  labelClassName,
  valueClassName,
  trend,
  ...counterProps
}: AnimatedCounterWithLabelProps): import("react/jsx-runtime").JSX.Element;
