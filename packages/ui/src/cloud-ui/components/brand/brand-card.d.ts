...
export declare function BrandCard({
  children,
  className,
  hover,
  corners,
  ...
  asChild,
  ...props
}: BrandCardProps): import("react/jsx-runtime").JSX.Element;
...
export declare function AgentCard({
  title,
  description,
  icon,
  color,
  action,
  className,
}: AgentCardProps): import("react/jsx-runtime").JSX.Element;
