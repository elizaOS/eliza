...
declare const lockOnButtonVariants: (
  props?:
    | ({
...
export declare const LockOnButton: React.ForwardRefExoticComponent<
  LockOnButtonProps & React.RefAttributes<HTMLButtonElement>
>;
