...
export type AnyRenderTelemetryEvent = RenderTelemetryEvent | ProfilerRenderTelemetryEvent;
type RenderTelemetrySink = (event: AnyRenderTelemetryEvent) => void;
export declare function setRenderTelemetrySink(sink: RenderTelemetrySink | null): void;
export declare function useRenderGuard(name: string): void;
export declare function RenderTelemetryProfiler({ children, id, }: {
    children: ReactNode;
    id?: string;
