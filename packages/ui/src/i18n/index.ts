 ...
 */
import { DEFAULT_UI_LANGUAGE } from "./messages";
import { MESSAGES } from "./messages";
import { UI_LANGUAGES } from "./messages";
import { ensureLanguageLoaded } from "./messages";
...
export function t(lang: UiLanguage | string | null | undefined, key: string, vars?: TranslationVars): string {
...
export function createTranslator(lang: UiLanguage | string | null | undefined, defaultVars?: TranslationVars) {
    const normalized = normalizeLanguage(lang);
...
export { DEFAULT_UI_LANGUAGE, ensureLanguageLoaded, MESSAGES, type MessageDict, UI_LANGUAGES, type UiLanguage, };
