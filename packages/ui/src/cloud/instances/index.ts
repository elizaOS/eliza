 ...
 *   - `cloud/agents`            → the Instances table (list / create / status)
 *   - `cloud/agents/:id`        → agent detail (overview / wallet / txns /
 *                                     policies / actions / backups / logs)
 *   - `cloud/my-agents`         → character library + agent console
 *
 ...
 *
 * The cloud shell mounts the `/cloud/containers*` → `/cloud/agents*`
...
export const AGENTS_ROUTE_PATH = "cloud/agents";
export const AGENT_DETAIL_ROUTE_PATH = "cloud/agents/:id";
export const MY_AGENTS_ROUTE_PATH = "cloud/my-agents";
