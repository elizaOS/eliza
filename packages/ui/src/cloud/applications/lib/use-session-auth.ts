/**
 * Synchronous "is the user logged in" answer for the applications cloud domain.
 *
 ...
 *
 * Scoped to the applications domain; mirrors the documents-domain copy. The
 * shell can promote these to shared cloud infra once the duplication is worth
 * collapsing.
 */
