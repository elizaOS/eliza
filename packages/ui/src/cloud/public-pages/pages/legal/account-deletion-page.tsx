    ...
    <div className="theme-cloud min-h-[100dvh] bg-bg px-6 py-16 font-sans text-txt sm:px-8">
      <main className="mx-auto max-w-3xl space-y-8">
        ...
        <section className="space-y-5 rounded-lg border border-border bg-bg-elevated p-6">
          ...
          <h2 className="text-xl font-semibold">Check your deletion status</h2>
          <p className="text-muted-strong">
            Sign in to load the current server-owned availability for your
            account. A deletion is scheduled only when this page displays an
        ...
        <section className="space-y-3">
          ...
          <p className="leading-relaxed text-muted-strong">
            When an authenticated deletion lifecycle is available and accepts a
            request, it covers your Eliza login identity, profile, sessions, API
            keys, personal conversations, agents, connectors, and other data
            associated only with your account. Content owned by a shared
            organization requires transfer before account deletion.
          </p>
          <p className="leading-relaxed text-muted-strong">
