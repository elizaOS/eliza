...
describe("CompactOnboarding", () => {
  it("offers cloud and local choices with advanced collapsed by default", () => {
  ...
  it("hides the local option when local runtime is unavailable", () => {
    ...
    expect(screen.getByTestId("onboarding-option-cloud")).toBeTruthy();
    expect(screen.queryByTestId("onboarding-option-local")).toBeNull();
  });
