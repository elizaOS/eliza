...
export function CompactOnboarding(): React.ReactElement {
  ...
  const canShowLocalRuntime = !cloudOnly && localRuntimeAvailable;
          ...
          <div className="flex w-full flex-col items-center gap-8 motion-safe:animate-[shell-overlay-in_220ms_ease-out]">
            ...
            {onRemote ? (
              ...
              <div className="flex w-full flex-col gap-5">
                <h1 className="text-center text-[20px] font-semibold tracking-normal">
                  ...
                  >
                    ...
                    <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                      <span className="flex items-center gap-2">
                        ...
                        <span className="rounded-full bg-[#FF5800]/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-normal text-[#FF5800]">
                          Recommended
                        </span>
                      </span>
                  ...
                  >
                    ...
                    <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                      <span className="flex items-center gap-2">
                        ...
                        <span className="rounded-full bg-white/10 px-2 py-0.5 text-[10px] font-bold uppercase tracking-normal text-white/60">
                          Offline
                        </span>
                      </span>
              ...
              <>
                ...
                <div className="mt-1 flex w-full flex-col gap-3">
                  {/* PRIMARY: the simplest cloud sign-in path. */}
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                      ...
                      <span className="text-[12px] leading-snug text-black/55">
                        Use managed auth, sync, and cloud-backed agents.
                      </span>
                    </span>
                    <ArrowRight className="h-5 w-5 shrink-0 text-[#FF5800]/60 transition-transform duration-200 group-hover:translate-x-0.5 motion-reduce:transition-none" />
                  </button>
                  ...
                  {canShowLocalRuntime ? (
                    ...
                    >
                      ...
                      <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                        ...
                        <span className="text-[12px] leading-snug text-white/55">
                          Keep the agent here and choose inference next.
                        </span>
                      </span>
                      <ArrowRight className="h-4 w-4 shrink-0 text-white/40 transition-transform group-hover:translate-x-0.5 motion-reduce:transition-none" />
                    </button>
                  ...
                  {!cloudOnly ? (
                    <div
                      data-testid="onboarding-advanced"
                      className="group mt-1 w-full rounded-xl border border-white/10 bg-black/25 text-left"
                    >
                      <button
                        type="button"
                        data-testid="onboarding-advanced-toggle"
                        aria-expanded={advancedOpen}
                        onClick={() => setAdvancedOpen((open) => !open)}
                        className="flex w-full items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-[13px] font-medium text-white/60 transition-colors hover:bg-white/[0.06] hover:text-white/85"
                      >
                      ...
                      {advancedOpen ? (
                        <div className="border-t border-white/10 p-3">
                          <button
                            ...
                            className="group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-colors hover:bg-white/[0.06] disabled:opacity-40"
                          >
                            <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-white/[0.10]">
                            ...
                            <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                              ...
                              <span className="text-[12px] leading-snug text-white/50">
                                Use a self-hosted server address and optional
                                token.
                              </span>
                            </span>
                            <ArrowRight className="h-4 w-4 shrink-0 text-white/40 transition-transform group-hover:translate-x-0.5 motion-reduce:transition-none" />
