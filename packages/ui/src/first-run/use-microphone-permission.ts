...
export interface MicrophonePermissionController extends MicrophonePermissionState {
...
function hasClientPermissionApi(): boolean {
    return (typeof client.requestPermission === "function" &&
...
async function openMicrophoneSettingsViaClient(): Promise<void> {
    if (typeof client.openPermissionSettings !== "function")
        return;
    try {
