...
export function defaultProviderForRuntime(runtime: FirstRunRuntime): FirstRunDefaultProvider {
    switch (runtime) {
        case "cloud":
            return "elizacloud";
        case "local":
...
function buildFirstRunLinkedAccounts(args: BuildFirstRunConnectionArgs): LinkedAccountFlagsConfig {
...
function buildDeploymentTarget(args: {
    ...
    if (args.persistRuntimeOnConnectedRemote)
...
function buildFirstRunLlmRoute(args: {
    ...
    if (args.source.firstRunProvider === "elizacloud" &&
...
function buildFirstRunModelConfig(args: BuildFirstRunConnectionArgs): FirstRunModelConfig {
    return {
        ...
        responseHandlerModel: trimToUndefined(args.firstRunResponseHandlerModel ?? ""),
...
function shouldUseCloudDefaults(args: {
    ...
    return (args.firstRunProvider === "elizacloud" ||
...
function buildFirstRunServiceRouting(args: {
    ...
    if (shouldUseCloudDefaults({
        ...
        Object.assign(serviceRouting, buildDefaultElizaCloudServiceRouting({
            base: serviceRouting,
            includeInference: args.shouldConfigureRuntimeProvider &&
            ...
            excludeServices: args.deploymentTarget.runtime === "cloud"
                ? undefined
                : ["embeddings"],
            ...args.models,
        }));
...
function buildFirstRunCapabilitySetup(args: BuildFirstRunConnectionArgs): FirstRunCapabilitySetup | undefined {
