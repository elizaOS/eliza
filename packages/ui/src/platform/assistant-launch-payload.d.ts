export declare const ASSISTANT_LAUNCH_TEXT_KEYS: readonly [
  "text",
  "q",
  "query",
  "body",
];
export declare const ASSISTANT_LAUNCH_PARAM_KEYS: readonly [
  "text",
  "q",
  "query",
  "body",
...
export declare function readAssistantLaunchPayloadFromHash(
  hash: string,
): AssistantLaunchPayload | null;
export declare function buildAssistantLaunchMetadata(
  payload: AssistantLaunchPayload,
): Record<string, unknown>;
export declare function claimAssistantLaunchPayloadFromHash(
  hash: string,
  options?: AssistantLaunchPayloadClaimOptions,
): AssistantLaunchPayload | null;
export declare function consumeAssistantLaunchPayloadFromHash(
  hash: string,
