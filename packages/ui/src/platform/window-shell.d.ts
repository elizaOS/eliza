...
export declare function resolveWindowShellRoute(
  search?: string,
): WindowShellRoute;
export declare function isDetachedWindowShell(
...
>;
export declare function isPillWindowShell(
  route: WindowShellRoute,
): route is Extract<
  WindowShellRoute,
  {
...
>;
export declare function shouldInstallMainWindowOnboardingPatches(
  route: WindowShellRoute,
): boolean;
export declare function resolveDetachedShellTarget(
  route: WindowShellRoute,
): DetachedShellTarget;
export declare function resolveDetachedShellPathname(
  route: WindowShellRoute,
): string;
export declare function syncDetachedShellLocation(
  route: WindowShellRoute,
  args?: {
