...
export declare function useLinkedSidebarSelection<T extends string = string>({ contentTopOffset, enabled, selectedId, topAlignedId, }: UseLinkedSidebarSelectionOptions<T>): {
