...
import { type VoiceContinuousMode, type VoiceContinuousStatus, type VoiceSpeakerMetadata } from "../voice/voice-chat-types";
...
export type ContinuousChatCancellationReason = "user-speech" | "user-stop" | "mode-changed" | "unmounted";
 ...
 */
export declare function useContinuousChat(options: UseContinuousChatOptions): ContinuousChatState;
