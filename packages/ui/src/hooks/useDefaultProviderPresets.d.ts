 ...
 * is undefined.
 */
import { type DefaultVoiceProviderResult, type PresetPlatform, type PresetRuntimeMode } from "../voice/voice-provider-defaults";
...
export declare function useDefaultProviderPresets(options?: UseDefaultProviderPresetsOptions): UseDefaultProviderPresetsResult;
