...
export interface ElectrobunRendererRpc {
    ...
    offMessage: (messageName: string, listener: ElectrobunMessageListener) => void;
}
export declare function getElectrobunRendererRpc(): ElectrobunRendererRpc | undefined;
...
export type DesktopCarrotPermissionTag = `host:${"windows" | "tray" | "notifications" | "storage" | "manage-carrots"}` | `bun:${"read" | "write" | "env" | "run" | "ffi" | "addons" | "worker"}` | `isolation:${"shared-worker" | "isolated-process"}`;
export interface DesktopCarrotPermissionGrant {
    host?: Partial<Record<"windows" | "tray" | "notifications" | "storage" | "manage-carrots", boolean>>;
    bun?: Partial<Record<"read" | "write" | "env" | "run" | "ffi" | "addons" | "worker", boolean>>;
...
export type DesktopCarrotWorkerState = "stopped" | "starting" | "running" | "error";
...
export declare function migrateDesktopStateDir(fromPath: string): Promise<StateDirMigrationResult | null>;
export declare function resolveDesktopWorkspaceFolderBookmark(bookmark: string): Promise<WorkspaceFolderBookmarkResolveResult | null>;
...
export declare function listDesktopCarrots(): Promise<DesktopCarrotListEntry[] | null>;
export declare function getDesktopCarrotStoreSnapshot(): Promise<DesktopCarrotStoreSnapshot | null>;
export declare function getDesktopCarrot(id: string): Promise<DesktopInstalledCarrotSnapshot | null>;
...
export declare function startDesktopCarrotWorker(id: string): Promise<DesktopCarrotWorkerStatus | null>;
export declare function stopDesktopCarrotWorker(id: string): Promise<DesktopCarrotWorkerStatus | null>;
export declare function getDesktopCarrotWorkerStatus(id: string): Promise<DesktopCarrotWorkerStatus | null>;
export declare function listDesktopCarrotWorkerStatuses(): Promise<DesktopCarrotWorkerStatus[] | null>;
export declare function getDesktopCarrotLogs(id: string, maxBytes?: number): Promise<DesktopCarrotLogsSnapshot | null>;
export declare function subscribeDesktopBridgeEvent(options: {
    rpcMessage: string;
    ipcChannel: string;
    listener: ElectrobunMessageListener;
}): () => void;
export declare function subscribeDesktopCarrotStoreChanged(listener: (snapshot: DesktopCarrotStoreSnapshot) => void): () => void;
export declare function subscribeDesktopCarrotWorkerChanged(listener: (status: DesktopCarrotWorkerStatus) => void): () => void;
