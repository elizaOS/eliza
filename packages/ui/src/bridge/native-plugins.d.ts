...
export declare function getNativePlugin<T extends NativePlugin>(name: string): T;
...
export type MobileSignalsPermissionTarget = "all" | "health" | "screenTime" | "notifications";
...
export type PushNotificationPermissionState = "prompt" | "prompt-with-rationale" | "granted" | "denied";
...
export interface MobileSignalsPluginLike extends NativePlugin {
    ...
    requestPermissions(options?: MobileSignalsRequestPermissionsOptions): Promise<MobileSignalsPermissionStatus>;
