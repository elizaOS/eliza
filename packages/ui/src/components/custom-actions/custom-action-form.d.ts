...
export declare const editorDialogContentClassName = "w-[min(calc(100%_-_2rem),48rem)] max-h-[min(90vh,56rem)] overflow-hidden rounded-2xl border border-border/70 bg-card/96 p-0 shadow-2xl backdrop-blur-xl";
export declare const editorFieldLabelClassName = "text-xs text-muted";
export declare const editorInputClassName = "rounded-xl border-border bg-surface text-txt placeholder:text-muted/50 focus-visible:ring-accent/25";
export declare const editorTextareaClassName = "rounded-xl border-border bg-surface text-txt placeholder:text-muted/50 focus-visible:ring-accent/25 resize-none";
export declare const editorMonoTextareaClassName = "rounded-xl border-border bg-surface text-txt placeholder:text-muted/50 focus-visible:ring-accent/25 resize-none font-mono";
export declare const editorSectionCardClassName = "flex flex-col gap-3 rounded-xl border border-border/70 bg-bg/20 p-3";
