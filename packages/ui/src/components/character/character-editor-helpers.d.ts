...
export declare function getOnboardingPresetStyles(
  options: unknown,
): readonly OnboardingPreset[];
export declare function replaceCharacterToken(
  value: string,
  name: string,
): string;
export declare function buildCharacterDraftFromPreset(
 ...
 */
export declare function shouldApplyPresetDefaults(
