...
export declare function CharacterIdentityPanel({ bioText, handleFieldEdit, t, }: CharacterIdentityPanelProps): import("react/jsx-runtime").JSX.Element;
export declare function CharacterStylePanel({ d, pendingStyleEntries, styleEntryDrafts, handlePendingStyleEntryChange, handleAddStyleEntry, handleRemoveStyleEntry, handleStyleEntryDraftChange, handleCommitStyleEntry, handleReorderStyleEntries, t, }: CharacterStylePanelProps): import("react/jsx-runtime").JSX.Element;
export declare function CharacterExamplesPanel({ d, normalizedMessageExamples, handleFieldEdit, t, }: CharacterExamplesPanelProps): import("react/jsx-runtime").JSX.Element;
