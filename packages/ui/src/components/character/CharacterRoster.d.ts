...
export declare const SLANT_CLIP =
  "polygon(32px 0, 100% 0, calc(100% - 32px) 100%, 0 100%)";
export declare const INSET_CLIP =
...
export declare function resolveRosterEntries(
...
export declare function CharacterRoster({
  entries,
  selectedId,
  onSelect,
  variant,
  testIdPrefix,
}: CharacterRosterProps): import("react/jsx-runtime").JSX.Element;
