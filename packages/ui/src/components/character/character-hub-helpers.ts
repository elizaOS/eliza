/**
 * Record-shaping helper for the promoted Character sub-views: maps an API
 * `ExperienceRecord` into the `CharacterExperienceRecord` view-model the
 * Experience workspace renders. Pure, no React — the view calls it on fetched
 * data. (The former hub section list + overview/history mappers went away with
 * the overview CTA grid in #13591.)
 */
