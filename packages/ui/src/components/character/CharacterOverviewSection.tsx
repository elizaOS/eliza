...
function HubTile({
  ...
  return (
    <button
      ...
      className="group relative flex h-full w-full min-h-[8rem] min-w-0 flex-col overflow-hidden rounded-2xl bg-card/60 p-4 text-left transition-colors hover:bg-accent/5    sm:min-h-[12rem] sm:p-5"
