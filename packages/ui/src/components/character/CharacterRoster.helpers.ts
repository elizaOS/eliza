...
export const SLANT_CLIP = "polygon(32px 0, 100% 0, calc(100% - 32px) 100%, 0 100%)";
export const INSET_CLIP = "polygon(0px 0, 100% 0, calc(100% - 4px) 100%, -8px 100%)";
export function resolveRosterEntries(styles: readonly StylePreset[]): CharacterRosterEntry[] {
