...
describe("TranscriptBody word-sync highlight", () => {
    it("highlights exactly the word active at the playback time", () => {
        const { rerender } = render(<TranscriptBody transcript={transcript} currentTimeMs={0}/>);
    ...
    it("seeks to a word's start on click", () => {
        ...
        render(<TranscriptBody transcript={transcript} currentTimeMs={0} onSeekMs={onSeekMs}/>);
    ...
    it("falls back to a clickable segment when it has no word timings", () => {
        ...
        render(<TranscriptBody transcript={noWords} currentTimeMs={500} onSeekMs={onSeekMs}/>);
