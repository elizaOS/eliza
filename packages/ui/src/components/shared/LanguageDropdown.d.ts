...
export declare const LANGUAGE_DROPDOWN_TRIGGER_CLASSNAME = "!h-11 !min-h-11 !rounded-xl !px-3.5";
...
export declare function LanguageDropdown({ uiLanguage, setUiLanguage, t, className, triggerClassName, variant, menuPlacement, }: LanguageDropdownProps): import("react/jsx-runtime").JSX.Element;
