...
export declare const RELEASE_NOTES_PARTITION = "persist:app-release-notes";
export declare const SESSION_PARTITIONS: readonly [
  {
    readonly partition: "persist:default";
    readonly label: "Default app session";
  },
  {
    readonly partition: "persist:app-release-notes";
    readonly label: "Release notes BrowserView";
  },
];
