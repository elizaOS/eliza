...
export declare function VoiceSection({ tier, tierSummary, prefs, onPrefsChange, profilesClient, modelsPanel, wakeWordEnabled, onWakeWordToggle, className, }: VoiceSectionProps): React.ReactElement;
