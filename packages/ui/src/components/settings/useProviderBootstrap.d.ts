...
export declare function useProviderBootstrap(selection: ReturnType<typeof useProviderSelection>, cloudModel: ReturnType<typeof useCloudModelConfig>): ProviderBootstrapState;
