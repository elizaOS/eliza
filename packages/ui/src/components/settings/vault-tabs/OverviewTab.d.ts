 ...
 */
import type { BackendStatus, InstallableBackendId, InstallMethod, ManagerPreferences } from "./types";
...
export declare function OverviewTab(props: OverviewTabProps): import("react/jsx-runtime").JSX.Element;
...
export declare function BackendRow(props: BackendRowProps): import("react/jsx-runtime").JSX.Element;
...
export declare function InstallSheet({ backendId, backendLabel, methods, onCancel, onComplete, }: InstallSheetProps): import("react/jsx-runtime").JSX.Element;
...
export declare function SigninSheet({ backendId, backendLabel, onCancel, onComplete, }: SigninSheetProps): import("react/jsx-runtime").JSX.Element;
export {};
