...
export declare function VaultModal({ open, onOpenChange, initialTab, initialFocusKey, initialFocusProfileId, onConsumeInitial, }: VaultModalProps): import("react/jsx-runtime").JSX.Element;
export { LoginsTab as SavedLoginsPanel } from "./vault-tabs/LoginsTab";
export { BackendRow, InstallSheet, SigninSheet, } from "./vault-tabs/OverviewTab";
