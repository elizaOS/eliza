...
export declare function LocalProviderPanel({
  cloudCallsDisabled,
  routingModeSaving,
  onSelectLocalOnly,
}: {
...
export declare function CloudPanel({
  cloudCallsDisabled,
  isCloudSelected,
  routingModeSaving,
  onSelectCloud,
...
}: CloudPanelProps): import("react/jsx-runtime").JSX.Element;
...
export declare function SubscriptionPanel({
  selection,
  description,
...
export declare function ApiKeyPanel({
  selectedProvider,
  panelLabel,
  visibleProviderPanelId,
  resolvedSelectedId,
  ...
  handlePluginConfigSave,
  loadPlugins,
}: ApiKeyPanelProps): import("react/jsx-runtime").JSX.Element;
