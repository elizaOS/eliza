...
export declare function ProviderRoutingPanel({ largeModelOptions, cloudModelSchema, modelValues, currentLargeModel, modelSaving, modelSaveSuccess, onModelFieldChange, localEmbeddings, onToggleLocalEmbeddings, showCloudControls, elizaCloudConnected, }: ProviderRoutingPanelProps): import("react/jsx-runtime").JSX.Element | null;
