...
export declare const ConfigRenderer: React.ForwardRefExoticComponent<
  ConfigRendererProps & React.RefAttributes<ConfigRendererHandle>
>;
...
export declare const defaultRegistry: FieldRegistry<
  {
    ...
    keyvalue: {
      validator: import("zod").ZodRecord<
        import("zod").ZodString,
        import("zod").ZodString
      >;
      description: string;
