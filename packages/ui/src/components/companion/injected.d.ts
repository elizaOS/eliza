...
export declare function resolveCompanionInferenceNotice(
  args: ResolveCompanionInferenceNoticeArgs,
): CompanionInferenceNotice | null;
export declare function CompanionInferenceAlertButton({
  notice,
  onClick,
}: {
...
export declare function CompanionGlobalOverlay():
