...
import { WALLPAPER_GLASS } from "../shell/wallpaper-idiom";
...
const SHAPE_CLASS =
  "grid aspect-square shrink-0 place-items-center overflow-hidden rounded-[22.37%]";
...
export function LauncherAppIcon({
  ...
  return (
    <div
      className={cn(
        SHAPE_CLASS,
        // Borrow the chat composer's dark, wallpaper-aware material at icon
        // scale. Depth stays inside the squircle, with no floating card shadow.
        WALLPAPER_GLASS.launcherIcon,
        className,
      )}
      data-launcher-icon=""
