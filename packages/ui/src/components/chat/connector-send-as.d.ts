...
export declare function normalizeConnectorSendAsContext(
  context: ConnectorSendAsContext | null | undefined,
): NormalizedConnectorSendAsContext | null;
export declare function connectorAccountDisplayName(
  account: Pick<
    ConnectorAccountRecord,
    "label" | "handle" | "externalId" | "id"
  >,
): string;
export declare function isConnectorAccountUsable(
  account: ConnectorAccountRecord | null | undefined,
): boolean;
export declare function shouldShowConnectorAccountPicker(
  context: ConnectorSendAsContext | null | undefined,
  accounts: ConnectorAccountRecord[],
): boolean;
export declare function buildConnectorSendAsMetadata(
  context: ConnectorSendAsContext | null | undefined,
  account: ConnectorAccountRecord | null | undefined,
): Record<string, unknown> | undefined;
export declare function mergeConnectorSendAsMetadata(
  metadata: Record<string, unknown> | undefined,
  sendAsMetadata: Record<string, unknown> | undefined,
): Record<string, unknown> | undefined;
export declare function connectorWriteConfirmationKey(
  context: ConnectorSendAsContext | null | undefined,
  account: ConnectorAccountRecord | null | undefined,
): string | null;
