		...
		<div data-testid="plan-checklist" className="flex flex-col gap-1">
			...
			<ul className="flex flex-col gap-0.5">
				{entries.map((entry, i) => {
					...
					return (
						<li
							// Plan entries have no stable id; content+index is stable within
							// a single snapshot render and the list is short.
							key={`${i}-${entry.content}`}
...
export { STATUS_ICON as PIPELINE_STATUS_ICON, STATUS_TONE as PIPELINE_STATUS_TONE };
