 ...
 */
export declare function getConnectorModes(
  connectorId: string,
  options?: {
 ...
 */
export declare function modeToSetupPluginId(
  connectorId: string,
  modeId: string,
): string | null;
export declare function getDefaultConnectorModeId(
  connectorId: string,
  modes: ConnectorMode[],
): string;
export declare function ConnectorModeSelector({
  connectorId,
  selectedMode,
  onModeChange,
  elizaCloudConnected,
 ...
 */
export declare function useConnectorMode(
  connectorId: string,
  options?: {
    elizaCloudConnected?: boolean;
  },
  ...
  modes: ConnectorMode[];
  selectedMode: string;
  setSelectedMode: import("react").Dispatch<
