...
export declare const CONNECTOR_ACCOUNT_MANAGEMENT_PANEL_PREFIX =
...
export declare function normalizeConnectorCatalogId(
  connectorId: string,
): string;
export declare function getConnectorPluginManagedAccountOption(
  connectorId: string | undefined,
): ConnectorPluginManagedAccountOption | null;
export declare function hasConnectorPluginManagedAccounts(
  connectorId: string | undefined,
): boolean;
export declare function connectorAccountManagementPanelPluginId(
  connectorId: string,
): string | null;
export declare function parseConnectorAccountManagementPanelPluginId(
  pluginId: string,
): {
  provider: string;
  connectorId: string;
} | null;
export declare function getConnectorPluginManagedAccountCreateInput(
  connectorId: string,
): ConnectorAccountCreateInput | undefined;
export declare function getConnectorPurposeOption(
  value: ConnectorAccountRole | undefined,
): ConnectorAccountOption<ConnectorAccountRole>;
export declare function getConnectorPrivacyOption(
  value: ConnectorAccountPrivacy | undefined,
): ConnectorAccountOption<ConnectorAccountPrivacy>;
export declare function getConnectorPrivacyConfirmationRequirement(
  current: ConnectorAccountPrivacy | undefined,
  next: ConnectorAccountPrivacy,
): ConnectorPrivacyConfirmationRequirement;
export declare function isConnectorPrivacyConfirmationSatisfied(
  requirement: ConnectorPrivacyConfirmationRequirement,
  typedValue: string,
  publicAcknowledged: boolean,
): boolean;
export declare function getConnectorRoleConfirmationRequirement(
  current: ConnectorAccountRole | undefined,
  next: ConnectorAccountRole,
): ConnectorRoleConfirmationRequirement;
export declare function isConnectorRoleConfirmationSatisfied(
