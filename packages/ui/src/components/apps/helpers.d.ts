...
export declare const DEFAULT_VIEWER_SANDBOX =
...
export type AppCatalogSectionKey =
  ...
  | "finance"
  | "other";
export declare const APP_CATALOG_SECTION_LABELS: Record<
  AppCatalogSectionKey,
  string
>;
export declare const APPS_VIEW_HIDDEN_APP_NAMES: readonly [
  "@elizaos/app",
...
export declare function isCuratedGameApp(
  app: Pick<RegistryAppInfo, "category" | "name">,
): boolean;
export declare function shouldShowAppInAppsView(
  app: Pick<RegistryAppInfo, "category" | "name">,
  options?: {
    isProd?: boolean;
    showAllApps?: boolean;
...
export declare function filterAppsForCatalog(
  apps: RegistryAppInfo[],
  {
    activeAppNames,
    isProd,
...
export declare function getDefaultAppsCatalogSelection(
  apps: RegistryAppInfo[],
  options?: {
    isProd?: boolean;
    showAllApps?: boolean;
...
export declare function getAppCatalogSectionKey(
  app: Pick<
    RegistryAppInfo,
    "name" | "displayName" | "description" | "category"
  >,
): AppCatalogSectionKey;
export declare function getAppCatalogSectionLabel(
  app: Pick<
    RegistryAppInfo,
    "name" | "displayName" | "description" | "category"
  >,
): string;
export declare function groupAppsForCatalog(
  apps: RegistryAppInfo[],
  {
    favoriteAppNames,
  }?: {
...
export declare function getAppSessionModeLabel(
  app: Pick<RegistryAppInfo, "session">,
): string | null;
export declare function getAppSessionFeatureLabels(
  app: Pick<RegistryAppInfo, "session">,
): string[];
/**
...
export declare function findAppBySlug(
