export type GameOperatorEventTone = "user" | "success" | "info" | "warning" | "error";
...
export declare function GameOperatorShell({ surfaceTestId, title, statusLabel, statusTone, objective, detailItems, primaryActions, suggestedActions, events, emptyEventsLabel, draft, inputPlaceholder, sendLabel, sendingLabel, canSend, sending, chatInputTestId, chatSendTestId, noticeTestId, variant, onDraftChange, onSendDraft, onCommand, }: GameOperatorShellProps): import("react/jsx-runtime").JSX.Element;
