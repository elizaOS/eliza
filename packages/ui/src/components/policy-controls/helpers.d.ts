...
export declare function findPolicy(policies: PolicyRule[], type: PolicyType): PolicyRule | undefined;
...
export declare function approvedAddressValue(entry: string | ApprovedAddressEntry): string;
