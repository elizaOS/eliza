...
export declare function useTrainingJobDetail(
  jobId: string,
...
export declare function useInferenceStats(
  label: string,
  lastMinutes?: number,
  pollIntervalMs?: number,
): ApiState<InferenceStats>;
...
export declare function useJobLogs(
  jobId: string,
  tail?: number,
): {
  refetch: () => Promise<void>;
 ...
 */
export declare function useTrainingBudget(
  jobId: string,
  pollIntervalMs?: number,
): {
  refetch: () => Promise<void>;
