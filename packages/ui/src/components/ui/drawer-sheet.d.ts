...
declare const DrawerSheetTrigger: React.ForwardRefExoticComponent<
...
declare const DrawerSheetClose: React.ForwardRefExoticComponent<
  DialogPrimitive.DialogCloseProps & React.RefAttributes<HTMLButtonElement>
>;
declare const DrawerSheetOverlay: React.ForwardRefExoticComponent<
  Omit<
...
>;
declare const DrawerSheetContent: React.ForwardRefExoticComponent<
  Omit<
...
declare const DrawerSheetTitle: React.ForwardRefExoticComponent<
  Omit<
...
>;
declare const DrawerSheetDescription: React.ForwardRefExoticComponent<
  Omit<
