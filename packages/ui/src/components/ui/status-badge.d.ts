...
export type StatusVariant = "success" | "warning" | "danger" | "error" | "info" | "neutral" | "processing" | "muted";
export type StatusTone = StatusVariant;
export declare function statusToneForBoolean(condition: boolean, onTone?: StatusVariant, offTone?: StatusVariant): StatusVariant;
