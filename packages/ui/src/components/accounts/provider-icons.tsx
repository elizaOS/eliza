...
function Glyph({ path, title, viewBox = "0 0 24 24", className, ...rest }: BrandGlyphProps & {
    path: string;
    viewBox?: string;
}) {
    return (<svg viewBox={viewBox} role={title ? "img" : "presentation"} aria-hidden={title ? undefined : true} aria-label={title} className={className} fill="currentColor" {...rest}>
...
export function CerebrasMark(props: BrandGlyphProps) {
    return (<Glyph {...props} viewBox="0 0 24 24" path="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 2.4a7.6 7.6 0 1 1 0 15.2 7.6 7.6 0 0 1 0-15.2zm0 2.9a4.7 4.7 0 1 0 0 9.4 4.7 4.7 0 0 0 0-9.4zm0 2.3a2.4 2.4 0 1 1 0 4.8 2.4 2.4 0 0 1 0-4.8z"/>);
}
// Eliza Cloud — the eliza spark mark (simplified, currentColor)
export function ElizaCloudMark(props: BrandGlyphProps) {
    return (<Glyph {...props} viewBox="0 0 24 24" path="M6.5 6.5A5.5 5.5 0 0 1 12 1a5.5 5.5 0 0 1 5.5 5.5c1.93.24 3.5 1.9 3.5 3.98A4.02 4.02 0 0 1 16.98 14.5H7.02A4.02 4.02 0 0 1 3 10.48c0-2.08 1.57-3.74 3.5-3.98zM7 17.4h10v2.1H7zm2.6 3.4h4.8V23H9.6z"/>);
}
...
export function ApiKeyMark(props: BrandGlyphProps) {
    return (<Glyph {...props} viewBox="0 0 24 24" path="M14.5 3a6.5 6.5 0 1 0 4.96 10.7L23 17.24V21h-3v-2h-2v-2h-2.24l-1.06-1.06A6.5 6.5 0 0 0 14.5 3zm0 3a3.5 3.5 0 1 1 0 7 3.5 3.5 0 0 1 0-7z"/>);
}
// Local / on-device — a monitor+chip glyph
export function LocalMark(props: BrandGlyphProps) {
    return (<Glyph {...props} viewBox="0 0 24 24" path="M4 3h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-6v2h3v2H7v-2h3v-2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm5 5v4h6V8H9z"/>);
}
const PROVIDER_MARKS: Record<LinkedAccountProviderId, (props: BrandGlyphProps) => ReactElement> = {
