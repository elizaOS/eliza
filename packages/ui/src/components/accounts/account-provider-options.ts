...
export const ACCOUNT_PROVIDER_OPTIONS: AccountProviderOption[] = [
    {
        ...
        category: "coding",
        description: "Browser login for your Claude plan. Powers coding agents and workflows.",
    ...
    },
    {
        ...
        category: "coding",
        description: "Managed by Gemini CLI outside this app; orchestrated spawning is not wired yet.",
    ...
    },
    {
        ...
        category: "coding",
        description: "Dedicated coding-endpoint credential; no coding-agent spawn backend is wired yet.",
    ...
    },
    {
        ...
        category: "coding",
        description: "Dedicated coding-endpoint key for model inference. Kimi ACP uses a separate kimi login OAuth session and never receives this key.",
    ...
    },
    {
        ...
        name: "DeepSeek API",
        category: "chat",
        description: "Direct DeepSeek API billing for model inference; coding-agent spawning is not wired yet.",
        eligibility: ["chat", "API key"],
    },
    {
        id: "zai-api",
    ...
    },
    {
        ...
        name: "OpenRouter",
        category: "chat",
        description: "OpenRouter credits or BYOK for model inference and coding agents. Choose a model when starting a coding agent.",
    ...
    },
    {
        ...
        name: "xAI API",
        category: "chat",
        description: "Metered xAI API access for Grok model inference and coding agents; separate from Grok subscription login.",
        eligibility: ["model inference", "code-agent", "API key"],
    },
];
export function getAccountProviderOption(providerId: LinkedAccountProviderId): AccountProviderOption | undefined {
