...
export declare const APP_WORKSPACE_CHROME_CHAT_STORAGE_KEY =
  "app-workspace-chrome:chat-collapsed";
export declare const APP_WORKSPACE_CHROME_CHAT_WIDTH_STORAGE_KEY =
...
export declare function AppWorkspaceChatCollapseButton({
  testId,
...
export declare function AppWorkspaceChrome({
  nav,
  main,
  chat,
  chatScope,
