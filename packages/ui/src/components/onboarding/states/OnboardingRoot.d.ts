import { type OnboardingFlowState, type OnboardingStateId } from "../../../onboarding/state-machine";
...
export declare function OnboardingRoot(props: OnboardingRootProps): React.JSX.Element;
