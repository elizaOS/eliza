 ...
 */
import type { CatalogModel, DownloadJob, HardwareProbe, InstalledModel, ModelBucket } from "../../api/client-local-inference";
...
export declare function computeFit(model: CatalogModel, hardware: HardwareProbe): FitLevel;
/**
 ...
 */
export declare function findInstalled(model: CatalogModel, installed: InstalledModel[]): InstalledModel | undefined;
export declare function findDownload(modelId: string, downloads: DownloadJob[]): DownloadJob | undefined;
/**
 ...
 */
export declare function findCatalogModel(id: string, catalog: CatalogModel[]): CatalogModel | undefined;
export declare function groupByBucket(models: CatalogModel[]): Map<ModelBucket, CatalogModel[]>;
