...
function RuntimeButton(props: {
  ...
  return (
    <button
      ...
      className={[
        "inline-flex min-h-[3.25rem] items-center justify-center gap-2 rounded-lg border px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_32px_rgba(0,0,0,0.28)] transition",
        props.active
          ? "border-white/44 bg-white/24"
          : "border-white/18 bg-black/26 hover:border-white/34 hover:bg-white/14",
      ].join(" ")}
    >
...
function GlassButton(props: {
  ...
  return (
    <button
      ...
      className={[
        "inline-flex min-h-[3rem] min-w-[7rem] items-center justify-center gap-2 rounded-lg border px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_32px_rgba(0,0,0,0.26)] transition disabled:pointer-events-none disabled:opacity-45",
        props.variant === "primary"
          ? "border-white/42 bg-white/24 hover:bg-white/30"
          : "border-white/18 bg-black/28 hover:border-white/32 hover:bg-white/14",
      ].join(" ")}
    >
      {Icon ? (
        <Icon
...
function BareInput(props: {
  ...
  return (
    <input
      ...
      className={[
        "w-full border-0 border-b-2 border-white/72 bg-transparent px-2 pb-3 text-center font-medium text-white outline-none placeholder:text-white/50 focus:border-white",
        "shadow-[0_18px_30px_rgba(0,0,0,0.18)] [text-shadow:0_8px_22px_rgba(0,0,0,0.82)]",
...
function RuntimeDetail(props: {
  ...
  return (
    <p className="min-h-5 text-center text-sm text-white/72 [text-shadow:0_6px_18px_rgba(0,0,0,0.75)]">
      {detail}
    </p>
  );
}
...
function FirstRunStatus(props: {
  ...
  if (props.busyText) {
    return (
      <p className="inline-flex min-h-[2.5rem] items-center justify-center gap-2 rounded-lg border border-white/16 bg-black/24 px-4 py-2 text-sm text-white/82 shadow-[0_14px_28px_rgba(0,0,0,0.22)] [text-shadow:0_6px_18px_rgba(0,0,0,0.75)]">
  ...
  return (
    <p className="max-w-[40rem] rounded-lg border border-red-200/30 bg-red-950/34 px-4 py-2 text-center text-sm text-red-50 shadow-[0_14px_28px_rgba(0,0,0,0.22)] [text-shadow:0_6px_18px_rgba(0,0,0,0.75)]">
      {message}
    </p>
  );
}
...
function FirstRunVoiceControl(props: {
  ...
  return (
    <div className="flex min-h-[2.75rem] flex-wrap items-center justify-center gap-3 text-white/78 [text-shadow:0_6px_18px_rgba(0,0,0,0.75)]">
      <button
        type="button"
        onClick={() => {
        ...
        className="inline-flex min-h-11 min-w-[8.5rem] items-center justify-center bg-transparent px-2 py-2 text-sm font-semibold text-white transition [text-shadow:0_3px_8px_rgba(0,0,0,0.95),0_12px_22px_rgba(0,0,0,0.72)] hover:text-white/88 focus-visible:outline-none focus-visible:underline"
      >
        {buttonLabel}
      </button>
      {detail ? (
  ...
  return (
    <div className="flex w-full flex-col items-center gap-4">
      ...
      {props.draft.runtime === "cloud" ? (
        <div className="flex min-h-[2.5rem] items-center gap-2 rounded-lg border border-white/14 bg-black/22 px-4 py-2 text-sm text-white/80 shadow-[0_14px_28px_rgba(0,0,0,0.2)]">
          <Checkbox
...
export function FirstRunShell({
  ...
  return (
    <div
      ...
      className="first-run-screen relative flex min-h-[100dvh] w-full overflow-hidden bg-transparent text-white"
    >
      <div
        aria-hidden="true"
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0.34) 58%, rgba(0,0,0,0.24) 100%)",
        }}
      />
      <div className="relative z-10 flex min-h-[100dvh] w-full flex-col px-4 py-4 sm:px-6 sm:py-6">
        <div className="flex h-12 items-center">
          {canBack ? (
            <button
              type="button"
              onClick={goBack}
              className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-white/18 bg-black/28 text-white shadow-[0_16px_32px_rgba(0,0,0,0.24)] transition hover:border-white/34 hover:bg-white/14"
              aria-label="Back"
            >
        ...
        <div className="mx-auto flex w-full max-w-[70rem] flex-1 flex-col items-center justify-center gap-10 pb-[8vh] pt-6">
          <h1 className="min-h-[8.5rem] max-w-[64rem] text-center text-4xl font-semibold leading-tight text-white [text-shadow:0_18px_38px_rgba(0,0,0,0.96)] sm:min-h-[10rem] sm:text-6xl">
            {renderedPrompt}
