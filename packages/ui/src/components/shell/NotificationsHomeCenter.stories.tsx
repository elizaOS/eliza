  ...
  render: () => (
    <Seeded
      notifications={[
        {
          title: "Take the tour",
          body: "New here? A two-minute guided tour runs right in the chat — messaging, voice, and navigating by asking.",
          category: "general",
          priority: "normal",
          deepLink: "/chat",
        },
        {
          ...
          body: "Stuck or curious? Just ask in the chat — your agent answers questions and can restart the tour.",
          category: "general",
          priority: "low",
          deepLink: "/chat",
        },
