...
export function parseShellControllerCommand(value: unknown): ShellControllerCommand | null {
...
export function parseShellAuthorityState(value: unknown): ShellAuthorityState | null {
    if (!isRecord(value))
        return null;
...
export function parseShellAuthorityCommandRequest(value: unknown): ShellAuthorityCommandRequest | null {
    if (!isRecord(value))
        return null;
...
export function parseShellAuthorityDelivery(value: unknown): ShellAuthorityDelivery | null {
    if (!isRecord(value))
        return null;
