 ...
 * ONLY on fine-pointer / hover-capable devices — the gate is pointer
 * *capability*, not viewport width, so they never appear on touch/coarse
 * phones/tablets where the swipe gesture is the sole navigation.
 *
