...
// dedicated launch tokens are used. Whitelabel seam: hosts override
// `--launch-bg` / `--launch-fg`; the literal fallbacks are the elizaOS defaults.
const LAUNCH_SURFACE =
  "bg-[var(--launch-bg,#000000)] text-[var(--launch-fg,#fff)]";
