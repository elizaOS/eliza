          ...
          >
            ...
            {threadPresented ? (
              ...
              >
                ...
                {!threadAtBottom && visibleMessages.length > 0 ? (
                  <Button
                    type="button"
                    variant="ghost"
                    size="sm"
                    ...
                    data-testid="chat-sheet-jump-to-latest"
                    className={cn(
                      "pointer-events-auto absolute bottom-2 left-1/2 z-20 h-auto -translate-x-1/2 gap-1.5 rounded-full border px-3 py-1.5 text-xs font-medium transition-colors",
                      "border-white/15 bg-black/50 text-white/85 hover:border-white/25 hover:bg-black/65 hover:text-white",
                      FLOAT_SHADOW,
                    )}
                  >
