 ...
 */
export declare function useTelegramChatMode(
  plugin: PluginInfo,
...
export declare function TelegramChatModeToggle({
  allowAll,
  onToggle,
}: {
  allowAll: boolean;
...
export declare function TelegramPluginConfig({
  plugin,
  pluginConfigs,
  onParamChange,
}: {
...
export declare function PluginConfigForm({
  plugin,
  pluginConfigs,
  onParamChange,
  hiddenKeys,
