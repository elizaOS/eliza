import type { Conversation, ConversationMetadata } from "../../api/client-types-chat";
export type PageScope = "page-browser" | "page-character" | "page-automations" | "page-apps" | "page-connectors" | "page-phone" | "page-plugins" | "page-lifeops" | "page-settings" | "page-wallet";
...
export declare function isPageScopedConversation(conversation: Pick<Conversation, "metadata"> | null | undefined): boolean;
export declare function isPageScopedConversationMetadata(metadata: ConversationMetadata | null | undefined): boolean;
export declare function buildPageScopedConversationMetadata(scope: PageScope, options?: {
 ...
 */
export declare function buildPageScopedRoutingMetadata(scope: PageScope, options?: {
    sourceConversationId?: string;
    pageId?: string;
