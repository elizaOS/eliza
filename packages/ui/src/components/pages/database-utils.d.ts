...
export declare function CellPopover({ value, onClose, }: {
    value: string;
    onClose: () => void;
}): import("react/jsx-runtime").JSX.Element;
export declare function ResultsGrid({ columns, rows, columnMeta, sortCol, sortDir, onSort, onCellClick, }: {
    columns: string[];
...
export declare function PaginationBar({ total, offset, limit, onPrev, onNext, }: {
    total: number;
    offset: number;
    limit: number;
    onPrev: () => void;
