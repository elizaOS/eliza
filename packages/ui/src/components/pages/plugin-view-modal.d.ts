...
export declare function PluginGameModal({ effectiveGameSelected, gameMobileDetail, gameNarrow, gameVisiblePlugins, isConnectorLikeMode, pluginConfigs, pluginSaveSuccess, pluginSaving, resultLabel, saveLabel, savedLabel, savingLabel, sectionTitle, selectedPlugin, selectedPluginLinks, t, togglingPlugins, onBack, onConfigSave, onOpenExternalUrl, onParamChange, onSelectPlugin, onTestConnection, onTogglePlugin, }: PluginGameModalProps): import("react/jsx-runtime").JSX.Element;
export {};
