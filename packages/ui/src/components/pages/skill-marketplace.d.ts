...
export declare function MarketplaceCard({ item, installedSkill, skillsMarketplaceAction, onInstall, onUninstall, onEnable, onDisable, onCopy, onDetails, }: {
...
export declare function InstallModal({ skills, skillsMarketplaceQuery, skillsMarketplaceResults, skillsMarketplaceError, skillsMarketplaceLoading, skillsMarketplaceAction, skillsMarketplaceManualGithubUrl, searchSkillsMarketplace, installSkillFromMarketplace, uninstallMarketplaceSkill, installSkillFromGithubUrl, enableSkill, disableSkill, copySkillSource, showSkillDetails, setState, onClose, }: {
    skills: SkillInfo[];
