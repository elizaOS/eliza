...
export declare const DIM_COLUMNS: readonly ["dim_384", "dim_512", "dim_768", "dim_1024", "dim_1536", "dim_3072"];
...
export declare function hasEmbedding(memory: MemoryRecord): memory is MemoryRecord & {
    embedding: number[];
};
...
export interface VectorGraph2DLayout {
    ...
    withEmbeddings: Array<MemoryRecord & {
        embedding: number[];
    }>;
}
...
export declare function buildVectorGraph2DLayout(memories: MemoryRecord[]): VectorGraph2DLayout | null;
export declare function toVectorGraph2DScreenX(x: number, width: number, padding: number, bounds: VectorGraph2DBounds): number;
export declare function toVectorGraph2DScreenY(y: number, height: number, padding: number, bounds: VectorGraph2DBounds): number;
...
export declare function projectTo3D(vectors: number[][]): [number, number, number][];
