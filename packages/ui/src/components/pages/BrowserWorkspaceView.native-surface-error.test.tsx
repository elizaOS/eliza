 ...
 * copy with an Open-third-party escape hatch and NO Retry; transient keeps the
...
describe("BrowserWorkspaceView native surface error states", () => {
  it("permanent capability denial: honest copy + Open third-party, NO Retry", async () => {
    ...
    const openExternal = screen.getByRole("button", {
      name: "Open third-party",
    });
    await act(async () => {
