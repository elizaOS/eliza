...
export declare function getDocumentUploadFilename(
  file: DocumentUploadFile,
): string;
export declare function shouldReadDocumentFileAsText(
  file: Pick<File, "type" | "name">,
): boolean;
export declare function isSupportedDocumentFile(
  file: Pick<File, "name">,
): boolean;
export declare function UploadZone({
  fileInputId,
  onFilesUpload,
  onTextUpload,
  onUrlUpload,
