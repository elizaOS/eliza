...
export declare function paramsToSchema(params: PluginParamDef[], pluginId: string): {
...
export declare function getPluginResourceLinks(plugin: Pick<PluginInfo, "id" | "homepage" | "parameters" | "repository" | "setupGuideUrl">, options?: {
    draftConfig?: Record<string, string>;
}): Array<{
    key: string;
    url: string;
}>;
export declare function pluginResourceLinkLabel(t: TranslateFn, key: string): string;
export declare const SUBGROUP_DISPLAY_ORDER: readonly ["ai-provider", "connector", "streaming", "voice", "blockchain", "devtools", "documents", "agents", "media", "automation", "storage", "gaming", "feature-other", "showcase"];
...
export type PluginsViewMode = "all" | "all-social" | "connectors" | "streaming" | "social";
...
export declare function comparePlugins(left: PluginInfo, right: PluginInfo): number;
export declare function matchesPluginFilters(plugin: PluginInfo, searchLower: string, statusFilter: StatusFilter): boolean;
export declare function sortPlugins(filteredPlugins: PluginInfo[], pluginOrder: string[], allowCustomOrder: boolean): PluginInfo[];
