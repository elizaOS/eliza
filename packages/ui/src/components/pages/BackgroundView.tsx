...
export function BackgroundView() {
  return (
    <ShellViewAgentSurface viewId="background">
      ...
      <div className="eliza-chat-scroll absolute inset-x-0 top-0 bottom-[calc(var(--eliza-mobile-nav-offset,0px)+max(var(--safe-area-bottom,0px),var(--android-gesture-inset-bottom,0px))+var(--eliza-chat-clearance,5.25rem)+1rem)] flex flex-col items-center overflow-y-auto px-4 pt-[var(--view-pad-top)] pb-4 pe-[var(--eliza-chat-side-clearance,0px)]">
