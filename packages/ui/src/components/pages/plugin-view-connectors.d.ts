...
interface ConnectorPluginGroupsProps {
    ...
    handleConnectorExpandedChange: (pluginId: string, nextExpanded: boolean) => void;
    ...
    handleParamChange: (pluginId: string, paramKey: string, value: string) => void;
    ...
    renderResolvedIcon: (plugin: PluginInfo, options?: {
        className?: string;
...
export declare function ConnectorPluginGroups(props: ConnectorPluginGroupsProps): import("react/jsx-runtime").JSX.Element[];
export {};
