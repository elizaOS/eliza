...
export declare const ChatModalView: import("react").MemoExoticComponent<({ variant, showSidebar, onSidebarClose, onPtySessionClick, }: ChatModalViewProps) => import("react/jsx-runtime").JSX.Element>;
export {};
