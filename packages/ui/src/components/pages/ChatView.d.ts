...
export declare function ChatView({ variant, onPtySessionClick, }: ChatViewProps): import("react/jsx-runtime").JSX.Element;
/**
 ...
 */
export declare function TerminalChannelPanel({ activeSessionId, sessions, onClose, loadingLabel, }: {
