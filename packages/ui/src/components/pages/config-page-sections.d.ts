...
export declare function CloudRpcStatus({ connected, loginBusy, onLogin, }: CloudRpcStatusProps): import("react/jsx-runtime").JSX.Element | null;
export declare function buildRpcRendererConfig(t: TranslateFn, selectedProvider: string, providerConfigs: RpcSectionConfigMap, rpcFieldValues: Record<string, string>): {
...
export declare function RpcConfigSection<T extends string>({ title, description, options, selectedProvider, onSelect, providerConfigs, rpcFieldValues, onRpcFieldChange, cloud, containerClassName, t, }: RpcSectionProps<T>): import("react/jsx-runtime").JSX.Element;
export declare function renderRpcProviderButtons<T extends string>(options: readonly RpcProviderOption<T>[], selectedProvider: T, onSelect: (provider: T) => void, containerClassName: string, tFallback?: (key: string) => string): import("react/jsx-runtime").JSX.Element;
export declare function CloudServicesSection(): import("react/jsx-runtime").JSX.Element | null;
export {};
