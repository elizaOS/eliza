 ...
 */
import type { CreateTriggerRequest, TriggerSummary, TriggerType, TriggerWakeMode, UpdateTriggerRequest } from "../../api/client";
...
export declare function durationUnitLabel(unit: DurationUnit, t: TranslateFn): string;
...
export declare function getTemplateName(template: HeartbeatTemplate, t: (key: string, options?: Record<string, unknown>) => string): string;
export declare function getTemplateInstructions(template: HeartbeatTemplate, t: (key: string, options?: Record<string, unknown>) => string): string;
 ...
 */
export declare function nextRunsForInterval(intervalMs: number, count: number, from?: Date): Date[];
/**
 * Compute the next N fire dates for a cron expression.
 * Returns an empty array when parsing fails.
 */
export declare function nextRunsForCron(expr: string, count: number, from?: Date): Date[];
/**
 ...
 */
export declare function validateTriggerKind(form: TriggerFormState, t: TranslateFn): string | null;
export declare function validateForm(form: TriggerFormState, t: TranslateFn): string | null;
export declare function toneForLastStatus(status?: string): "success" | "warning" | "danger" | "muted";
export declare function localizedExecutionStatus(status: string, t: TranslateFn): string;
