      ...
      <div
        className={
          isCompanionDock
            ...
            : "relative flex min-h-0 flex-1 flex-col rounded-sm border border-border/60 ring-1 ring-white/5 overflow-hidden bg-[linear-gradient(180deg,color-mix(in_srgb,var(--card)_90%,transparent),color-mix(in_srgb,var(--bg)_86%,transparent))] backdrop-blur-xl"
        }
      >
