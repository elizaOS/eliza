...
export interface SidebarScrollRegionProps extends React.HTMLAttributes<HTMLDivElement> {
    variant?: SidebarVariant;
}
...
export interface SidebarHeaderStackProps extends React.HTMLAttributes<HTMLDivElement> {
}
export interface SidebarFilterBarOption {
    value: string;
    label: React.ReactNode;
}
export interface SidebarFilterBarProps extends React.HTMLAttributes<HTMLDivElement> {
    selectValue: string;
