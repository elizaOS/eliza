...
export declare function buildSidebarAutoRailItems(children: React.ReactNode): SidebarAutoRailItem[];
export declare function buildSidebarAutoRailItemsFromDom(container: HTMLElement): SidebarAutoRailItem[];
