...
export declare const ChatMessage: React.MemoExoticComponent<({ message, isGrouped, agentName, children, labels, onCopy, onSpeak, onEdit, onDelete, replyTarget, userMessagesOnRight, }: ChatMessageProps) => import("react/jsx-runtime").JSX.Element>;
