...
const meta = {
    ...
    args: {
        ...
        reason: "I can add this to your Apple Reminders so it nudges you on your phone too.",
...
export const Denied: Story = {
    args: {
        ...
        reason: "Screen recording was turned off. Re-enable it in System Settings so I can capture the window.",
