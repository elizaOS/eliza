...
declare function ChatSidebarRoot({ activeConversationId, confirmDeleteId, conversations, deletingId, labels, mobile, onCancelDelete, onClose, onConfirmDelete, onCreate, onOpenActions, onRequestDeleteConfirm, onRequestRename, onSearchChange, onSearchClear, onSelect, searchValue, testId, unreadConversations, variant, }: ChatSidebarProps): import("react/jsx-runtime").JSX.Element;
export declare const ChatSidebar: typeof ChatSidebarRoot & {
    Content: {
        ...
        ItemButton: React.ForwardRefExoticComponent<import("..").SidebarItemButtonProps & React.RefAttributes<HTMLButtonElement>>;
        ...
        Item: React.ForwardRefExoticComponent<import("..").SidebarItemProps & React.RefAttributes<HTMLElement>>;
        RailMedia: typeof import("..").SidebarRailMedia;
        RailItem: React.ForwardRefExoticComponent<import("..").SidebarRailItemProps & React.RefAttributes<HTMLButtonElement>>;
    };
