...
function MessageActionButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "keyboard-focus-emphasis bg-transparent p-0 text-white/60 transition-[color,transform] duration-150 hover:text-white active:scale-95 max-md:h-8 max-md:w-8 pointer-coarse:h-11 pointer-coarse:w-11",
        bare
          ? "h-7 w-7 rounded-none hover:bg-transparent active:bg-transparent"
