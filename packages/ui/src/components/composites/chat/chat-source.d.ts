...
export declare function normalizeChatSourceKey(source: string | null | undefined): string | null;
export declare function registerChatSourceMetaEntries(entries: Record<string, ChatSourceMeta>): void;
export declare function registerChatReactionEmojiRenderer(renderer: ((emoji: string) => React.ReactNode | null) | null): void;
export declare function renderChatReactionEmoji(emoji: string): React.ReactNode | null;
export declare function getChatSourceMeta(source: string): ChatSourceMeta;
export declare function ChatSourceIcon({ source, className, decorative, }: {
    className?: string;
    decorative?: boolean;
    source: string;
 ...
 * the badge entirely).
 */
export declare function resolveChatVoiceSpeakerLabel(speaker: ChatVoiceSpeaker | null | undefined): string | null;
/**
 ...
 */
export declare function ChatVoiceSpeakerBadge({ speaker, className, "data-testid": dataTestId, }: {
