...
export type PagePanelVariant = "surface" | "section" | "padded" | "inset" | "shell" | "workspace";
...
export interface PageActionRailProps extends React.HTMLAttributes<HTMLDivElement> {
}
...
export interface PageLoadingStateProps extends React.HTMLAttributes<HTMLDivElement> {
    heading: React.ReactNode;
    description?: React.ReactNode;
    variant?: "panel" | "surface" | "workspace";
}
export interface PagePanelFrameProps extends React.HTMLAttributes<HTMLDivElement> {
}
export interface PagePanelContentAreaProps extends React.HTMLAttributes<HTMLDivElement> {
}
export interface PagePanelToolbarProps extends React.HTMLAttributes<HTMLDivElement> {
}
export interface PagePanelCollapsibleSectionProps extends Omit<React.HTMLAttributes<HTMLElement>, "title"> {
    as?: PanelElement;
    actions?: React.ReactNode;
    bordered?: boolean;
...
//# sourceMappingURL=page-panel-types.d.ts.map