...
> & {
  CollapsibleSection: import("react").ForwardRefExoticComponent<
    import("./page-panel-types").PagePanelCollapsibleSectionProps &
      import("react").RefAttributes<HTMLElement>
  >;
  ContentArea: import("react").ForwardRefExoticComponent<
    import("./page-panel-types").PagePanelContentAreaProps &
      import("react").RefAttributes<HTMLDivElement>
  >;
  Header: typeof PanelHeader;
  Frame: import("react").ForwardRefExoticComponent<
    import("./page-panel-types").PagePanelFrameProps &
      import("react").RefAttributes<HTMLDivElement>
  >;
  ...
  Toolbar: import("react").ForwardRefExoticComponent<
    import("./page-panel-types").PagePanelToolbarProps &
      import("react").RefAttributes<HTMLDivElement>
  >;
};
