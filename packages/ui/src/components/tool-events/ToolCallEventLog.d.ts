...
export declare function getToolCallEventDisplayState(event: NativeToolCallEvent): ToolCallEventDisplayState;
export declare function getToolCallName(event: NativeToolCallEvent): string;
export declare function ToolCallEventLog({ className, event, }: ToolCallEventLogProps): import("react/jsx-runtime").JSX.Element;
