...
// Idempotent with the plugin's own runtime registration.
...
export const BUILTIN_WIDGET_DECLARATIONS: PluginWidgetDeclaration[] = [
  ...
  // Todos — the todo plugin's frontpage widget.
  {
    id: "todo.items",
    pluginId: "todo",
    slot: "home",
 ...
 * renders only when it resolves to a bundled component or carries a `uiSpec`;
