 ...
 */
declare const CHAT_SIDEBAR_VISIBILITY_STORAGE_KEY =
...
export declare function widgetVisibilityKey(
  pluginId: string,
  id: string,
): string;
export declare function loadChatSidebarVisibility(): WidgetVisibilityState;
export declare function saveChatSidebarVisibility(
 ...
 */
export declare function isWidgetVisible(
 ...
 */
export declare function applyChatSidebarVisibility<
  T extends {
