 ...
 */
export declare function registerWidgetComponent(pluginId: string, declarationId: string, Component: ComponentType<WidgetProps>): void;
/** Look up a registered component. */
export declare function getWidgetComponent(pluginId: string, declarationId: string): ComponentType<WidgetProps> | undefined;
/**
 ...
 */
export declare function seedLegacyWidgets(definitions: ReadonlyArray<ChatSidebarWidgetDefinition>): void;
/**
 ...
 */
export declare function registerBuiltinWidgets(definitions: ReadonlyArray<ChatSidebarWidgetDefinition>): void;
