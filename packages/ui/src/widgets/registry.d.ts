...
export { getWidgetComponent, registerBuiltinWidgets, registerWidgetComponent, } from "./registry-store";
/**
 ...
 */
export declare function registerBuiltinWidgetDeclarations(declarations: ReadonlyArray<PluginWidgetDeclaration>, options?: {
 ...
 */
export declare function resolveWidgetsForSlot(slot: WidgetSlot, plugins: readonly WidgetPluginState[], serverDeclarations?: readonly PluginWidgetDeclaration[]): ResolvedWidget[];
import type { ChatSidebarPluginState } from "../components/chat/widgets/types";
export declare function resolveChatSidebarWidgets(plugins: readonly ChatSidebarPluginState[]): {
    id: string;
    pluginId: string;
    order: number;
