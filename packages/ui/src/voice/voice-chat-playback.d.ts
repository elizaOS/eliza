...
export declare function shouldCacheGeneratedSpeech(input: string, segment: SpeechSegmentKind): boolean;
 ...
 */
export declare function isRealSentenceEnd(value: string, matchIndex: number): boolean;
export declare function splitFirstSentence(text: string): {
    complete: boolean;
    firstSentence: string;
    remainder: string;
};
export declare function remainderAfter(fullText: string, firstSentence: string): string;
export declare function queueableSpeechPrefix(text: string, isFinal: boolean): string;
