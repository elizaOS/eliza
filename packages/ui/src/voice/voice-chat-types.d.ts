...
export declare function getSpeechRecognitionCtor():
...
export declare function resolveVoiceMode(
...
export declare function cloneVoiceConfig(
  config:
    | (VoiceConfig & {
  ...
  | null;
export declare function resolveEffectiveVoiceConfig(
  config:
    | (VoiceConfig & {
        provider?: VoiceConfig["provider"] | "openai";
        openai?: {
...
export declare function webSpeechVoiceDebugFields(
  voice: SpeechSynthesisVoice | undefined,
): Record<string, string | boolean | undefined>;
export declare function normalizeSpeechLocale(
  input: string | undefined,
): string;
export declare function localePrefix(locale: string): string;
export declare function matchesVoiceLocale(
