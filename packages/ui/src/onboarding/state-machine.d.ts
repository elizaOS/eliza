...
export type OnboardingStateId = "hello" | "setup" | "cloud-login" | "cloud-chat" | "remote-pair" | "device-security" | "device-mode" | "local-download" | "mic" | "profile-name" | "profile-location" | "tutorial-settings" | "tutorial-subscriptions" | "tutorial-views" | "tutorial-connectors" | "tutorial-permissions" | "home";
...
export declare function reduce(state: OnboardingFlowState, event: OnboardingEvent): OnboardingFlowState;
