...
export declare const VOICE_PREFIX_STEP_META: Record<VoicePrefixStep, VoicePrefixStepMeta>;
/** Tier-aware step list — POOR tier skips the local model download. */
export declare function resolveVoicePrefixSteps(tier: "MAX" | "GOOD" | "OKAY" | "POOR" | null): readonly VoicePrefixStep[];
export declare function nextVoicePrefixStep(current: VoicePrefixStep, tier: "MAX" | "GOOD" | "OKAY" | "POOR" | null): VoicePrefixStep | null;
export declare function previousVoicePrefixStep(current: VoicePrefixStep, tier: "MAX" | "GOOD" | "OKAY" | "POOR" | null): VoicePrefixStep | null;
export declare function voicePrefixIsComplete(current: VoicePrefixStep, tier: "MAX" | "GOOD" | "OKAY" | "POOR" | null): boolean;
