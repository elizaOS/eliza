...
function readStorage(): OnboardingFlowState | undefined {
  ...
  try {
    ...
    return {
      ...
      cloudProvisioningStarted: parsed.cloudProvisioningStarted,
      cloudAgentReady: parsed.cloudAgentReady,
      cloudConversationPushed: parsed.cloudConversationPushed,
      localDownloadStarted: parsed.localDownloadStarted,
      localDownloadReady: parsed.localDownloadReady,
