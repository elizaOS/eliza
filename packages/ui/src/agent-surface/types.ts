...
export type AgentElementRole = "button" | "link" | "text-input" | "number-input" | "textarea" | "select" | "toggle" | "slider" | "tab" | "menu-item" | "list-item" | "card" | "metric" | "status" | "image" | "chart" | "region" | "heading" | "custom";
/** Roles the agent can type into. */
export const FILLABLE_ROLES: ReadonlySet<AgentElementRole> = new Set<AgentElementRole>([
    "text-input",
    "number-input",
    "textarea",
    "select",
...
export const CLICKABLE_ROLES: ReadonlySet<AgentElementRole> = new Set<AgentElementRole>([
    "button",
    "link",
    "toggle",
    "tab",
