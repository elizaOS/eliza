 ...
 */
export declare function resolveDynamic<T>(
 ...
 */
export declare function findFormValue(
  fieldName: string,
 ...
 */
export declare function interpolateString(
  template: string,
 ...
 */
export declare function evaluateLogicExpression(
 ...
 */
export declare function runValidation(
 ...
 */
export declare function defineCatalog<
...
export declare const defaultCatalog: FieldCatalog<
  {
    ...
    group: {
      validator: z.ZodUnion<
        [z.ZodRecord<z.ZodString, z.ZodUnknown>, z.ZodString]
      >;
      description: string;
    };
    table: {
      validator: z.ZodUnion<
        [z.ZodArray<z.ZodRecord<z.ZodString, z.ZodString>>, z.ZodString]
      >;
      description: string;
    };
  },
