 ...
 */
import { type AppBlockerSettingsCardProps } from "@elizaos/core/contracts/personal-assistant";
import { type BrandingConfig } from "./branding";
import { type CodingAgentSession } from "../api/client-types-cloud";
import { type ComponentType } from "react";
import { type WebsiteBlockerSettingsCardProps } from "@elizaos/core/contracts/personal-assistant";
// ---------------------------------------------------------------------------
// Types
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
function resolveAssets(catalog: CharacterCatalogData): ResolvedCharacterAsset[] {
...
export function resolveCharacterCatalog(catalog: CharacterCatalogData): {
    ...
    return {
        ...
        getInjectedCharacter: (catchphrase: string) => byCatchphrase.get(catchphrase) ?? null,
    };
}
