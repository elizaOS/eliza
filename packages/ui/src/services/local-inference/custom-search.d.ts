...
export declare function isLocalModelSearchProviderId(value: string): value is LocalModelSearchProviderId;
export declare function getLocalModelSearchProvider(id: LocalModelSearchProviderId): LocalModelSearchProviderDescriptor;
export declare function wrapLocalModelSearchResults(providerId: LocalModelSearchProviderId, models: CatalogModel[]): LocalModelSearchResult[];
export declare function searchLocalModelProvider(providerId: LocalModelSearchProviderId, query: string, limit?: number): Promise<LocalModelSearchResponse>;
