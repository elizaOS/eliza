import type { CatalogModel, HardwareFitLevel, HardwareProbe, TextGenerationSlot } from "./types";
...
export declare function assessCatalogModelFit(hardware: HardwareProbe, model: CatalogModel, catalog?: CatalogModel[]): HardwareFitLevel;
...
export declare function chooseSmallerFallbackModel(currentModelId: string, hardware: HardwareProbe, slot?: TextGenerationSlot, catalog?: CatalogModel[]): CatalogModel | null;
