...
export declare function resolveLocalInferenceLoadArgs(installed: InstalledModel, overrides?: LocalInferenceLoadOverrides): Promise<LocalInferenceLoadArgs>;
export declare class ActiveModelCoordinator {
    ...
    private getLoader;
    switchTo(runtime: AgentRuntime | null, installed: InstalledModel, overrides?: LocalInferenceLoadOverrides): Promise<ActiveModelState>;
