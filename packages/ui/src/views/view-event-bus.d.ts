 ...
 */
export declare function emitViewEvent(type: string, payload?: ViewEventPayload, sourceViewId?: string): void;
/**
 ...
 */
export declare function onViewEvent(type: string, handler: (event: ViewEvent) => void): () => void;
/**
 * Subscribe to ALL view events. Useful for debugging and middleware.
 * Returns an unsubscribe function.
 */
export declare function onAnyViewEvent(handler: (event: ViewEvent) => void): () => void;
