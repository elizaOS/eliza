 ...
 */
import { type AccountsListProvider } from "./client-agent";
...
export interface ProviderSelectionState {
    ...
    reason: "reset-soonest" | "drain-soonest-reset" | "only-eligible" | "priority" | "round-robin" | "least-used" | "quota-aware" | "least-recently-throttled" | null;
}
/**
