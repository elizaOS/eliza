import type { BrowserWorkspaceSnapshot, BrowserWorkspaceTab, OpenBrowserWorkspaceTabRequest } from "./browser-contracts";
declare module "./client-base" {
    interface ElizaClient {
        ...
        navigateBrowserWorkspaceTab(id: string, url: string): Promise<{
            tab: BrowserWorkspaceTab;
        }>;
