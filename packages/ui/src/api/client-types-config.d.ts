...
import type { ConversationScope, ReleaseChannel, TriggerRunRecord, TriggerSummary } from "./client-types-core";
export type { CloudCodingAgent, CloudCodingContainerSession, CloudCodingContainerStatus, CloudCodingPatch, CloudCodingPatchFormat, CloudCodingPromotion, CloudCodingSyncDirection, CloudCodingSyncResult, CloudContainerArchitecture, CloudVfsBundle, CloudVfsDeletedFile, CloudVfsFile, CloudVfsFileEncoding, CloudVfsSourceKind, CompleteLifeOpsBrowserSessionRequest as CompleteBrowserBridgeSessionRequest, CompleteLifeOpsOccurrenceRequest, ConfirmLifeOpsBrowserSessionRequest as ConfirmBrowserBridgeSessionRequest, CreateLifeOpsBrowserSessionRequest as CreateBrowserBridgeSessionRequest, CreateLifeOpsCalendarEventRequest, CreateLifeOpsDefinitionRequest, CreateLifeOpsGmailReplyDraftRequest, CreateLifeOpsGoalRequest, DisconnectLifeOpsGoogleConnectorRequest, GetLifeOpsCalendarFeedRequest, GetLifeOpsGmailTriageRequest, LifeOpsBrowserSession as BrowserBridgeSession, LifeOpsCalendarEvent, LifeOpsCalendarFeed, LifeOpsDefinitionRecord, LifeOpsGmailMessageSummary, LifeOpsGmailReplyDraft, LifeOpsGmailTriageFeed, LifeOpsGoalRecord, LifeOpsGoalReview, LifeOpsGoogleConnectorStatus, LifeOpsNextCalendarEventContext, LifeOpsOccurrenceExplanation, LifeOpsOccurrenceView, LifeOpsOverview, LifeOpsReminderInspection, LifeOpsReminderPlan, LifeOpsTaskDefinition, PostWorkbenchVfsPromoteToCloudRequest, PromoteVfsToCloudContainerRequest, PromoteVfsToCloudContainerResponse, RequestCodingAgentContainerRequest, RequestCodingAgentContainerResponse, SelectLifeOpsGoogleConnectorPreferenceRequest, SendLifeOpsGmailReplyRequest, SnoozeLifeOpsOccurrenceRequest, StartLifeOpsGoogleConnectorRequest, StartLifeOpsGoogleConnectorResponse, SyncCloudCodingContainerRequest, SyncCloudCodingContainerResponse, UpdateLifeOpsDefinitionRequest, UpdateLifeOpsGoalRequest, } from "@elizaos/shared";
export type { BrowserBridgeCompanionPackageStatus, BrowserBridgeCompanionStatus, BrowserBridgePageContext, BrowserBridgeSettings, BrowserBridgeTabSummary, SyncBrowserBridgeStateRequest, UpdateBrowserBridgeSettingsRequest, } from "./browser-contracts";
...
export type AutomationSource = "workbench_task" | "trigger" | "workflow" | "workflow_draft" | "workflow_shadow" | "automation_draft";
export type AutomationStatus = "active" | "paused" | "completed" | "draft" | "system";
export type AutomationNodeClass = "trigger" | "action" | "context" | "integration" | "agent" | "flow-control";
...
export type VoiceProvider = "elevenlabs" | "robot-voice" | "edge" | "local-inference";
...
//# sourceMappingURL=client-types-config.d.ts.map