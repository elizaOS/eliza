...
import type { ChatFailureKind, ChatTokenUsage, ConnectionTestResult, ContentBlock, Conversation, ConversationChannelType, ConversationGreeting, ConversationMessage, ConversationMetadata, CreateConversationOptions, DatabaseConfigResponse, DatabaseStatus, DocumentBulkUploadResult, DocumentDetail, DocumentFragmentsResponse, DocumentScope, DocumentSearchResponse, DocumentStats, DocumentsResponse, DocumentUpdateResult, DocumentUploadResult, ImageAttachment, LocalInferenceChatMetadata, McpMarketplaceResult, McpRegistryServerDetail, McpServerConfig, McpServerStatus, MemoryBrowseQuery, MemoryBrowseResponse, MemoryFeedQuery, MemoryFeedResponse, MemoryRememberResponse, MemorySearchResponse, MemoryStatsResponse, PostWorkbenchVfsPromoteToCloudRequest, PromoteVfsToCloudContainerRequest, PromoteVfsToCloudContainerResponse, QueryResult, QuickContextResponse, RequestCodingAgentContainerRequest, RequestCodingAgentContainerResponse, ShareIngestItem, ShareIngestPayload, SyncCloudCodingContainerRequest, SyncCloudCodingContainerResponse, TableInfo, TableRowsResponse, TrajectoryConfig, TrajectoryDetailResult, TrajectoryExportOptions, TrajectoryListOptions, TrajectoryListResult, TrajectoryStats, WorkbenchLoadedVfsPlugin, WorkbenchOverview, WorkbenchTask, WorkbenchTodo, WorkbenchVfsCompileResult, WorkbenchVfsDiffEntry, WorkbenchVfsEntry, WorkbenchVfsProject, WorkbenchVfsQuota, WorkbenchVfsSnapshot } from "./client-types";
...
declare module "./client-base" {
    interface ElizaClient {
        ...
        sendConversationMessageStream(id: string, text: string, onToken: (token: string, accumulatedText?: string) => void, channelType?: ConversationChannelType, signal?: AbortSignal, images?: ImageAttachment[], metadata?: Record<string, unknown>): Promise<{
            text: string;
            agentName: string;
            completed: boolean;
            noResponseReason?: "ignored";
