...
export const DEFAULT_DIRECT_CLOUD_BASE_URL = ELIZA_DOMAIN_CONTRACTS.production.marketingOrigin;
export const DEFAULT_DIRECT_CLOUD_APP_BASE_URL = ELIZA_DOMAIN_CONTRACTS.production.cloudAppOrigin;
export const DEFAULT_DIRECT_CLOUD_API_BASE_URL = ELIZA_DOMAIN_CONTRACTS.production.cloudApiOrigin;
export const STAGING_DIRECT_CLOUD_BASE_URL = ELIZA_DOMAIN_CONTRACTS.staging.marketingOrigin;
export const STAGING_DIRECT_CLOUD_APP_BASE_URL = ELIZA_DOMAIN_CONTRACTS.staging.cloudAppOrigin;
export const STAGING_DIRECT_CLOUD_API_BASE_URL = ELIZA_DOMAIN_CONTRACTS.staging.cloudApiOrigin;
/**
...
export const DIRECT_ELIZA_CLOUD_API_BY_HOST = new Map([
    ...
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.marketingHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_API_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.cloudAppHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_API_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.cloudApiHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_API_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.marketingHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_API_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.cloudAppHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_API_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.cloudApiHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_API_BASE_URL] as const),
]);
const DIRECT_ELIZA_CLOUD_WEB_BY_HOST = new Map([
    ...
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.marketingHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.cloudAppHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.cloudApiHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.marketingHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.cloudAppHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.cloudApiHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_BASE_URL] as const),
]);
const DIRECT_ELIZA_CLOUD_APP_BY_HOST = new Map([
    ...
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.marketingHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_APP_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.cloudAppHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_APP_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.production.cloudApiHostnames.map((hostname) => [hostname, DEFAULT_DIRECT_CLOUD_APP_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.marketingHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_APP_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.cloudAppHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_APP_BASE_URL] as const),
    ...LEGACY_ELIZA_DOMAIN_CONTRACTS.staging.cloudApiHostnames.map((hostname) => [hostname, STAGING_DIRECT_CLOUD_APP_BASE_URL] as const),
]);
 ...
 */
export function resolveCanonicalDirectCloudApiBase(cloudBase: string | null | undefined): string {
    const normalized = cloudBase?.trim().replace(/\/+$/, "") ?? "";
    try {
        const host = new URL(normalized).hostname.toLowerCase();
        return (DIRECT_ELIZA_CLOUD_API_BY_HOST.get(host) ??
