...
export type BrowserBridgeSiteAccessMode = "current_site_only" | "granted_sites" | "all_sites";
export type BrowserBridgeCompanionConnectionState = "disconnected" | "connected" | "paused" | "permission_blocked";
