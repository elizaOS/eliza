import { type CloudSetupSessionService, type ContainerHandoffEnvelope, type SetupExtractedFact, type SetupSessionEnvelope, type SetupTranscriptMessage } from "@elizaos/cloud-sdk/cloud-setup-session";
export type CloudSetupStatus = "idle" | "starting" | "ready" | "provisioning" | "handoff" | "error";
...
export declare function useCloudSetupSession(opts?: UseCloudSetupSessionOptions): UseCloudSetupSessionResult;
