...
import { type ConversationScope } from "./client-types-core";
...
import { type ReleaseChannel } from "./client-types-core";
import { type ScheduledTaskView } from "./client-types-core";
import { type SurfaceManifest } from "@elizaos/core";
import { type TriggerRunRecord } from "./client-types-core";
import { type TriggerSummary } from "./client-types-core";
import { type ViewKind } from "@elizaos/core";
export { type CloudCodingAgent, type CloudCodingContainerSession, type CloudCodingContainerStatus, type CloudCodingPatch, type CloudCodingPatchFormat, type CloudCodingPromotion, type CloudCodingSyncDirection, type CloudCodingSyncResult, type CloudContainerArchitecture, type CloudVfsBundle, type CloudVfsDeletedFile, type CloudVfsFile, type CloudVfsFileEncoding, type CloudVfsSourceKind, type PromoteVfsToCloudContainerRequest, type PromoteVfsToCloudContainerResponse, type RequestCodingAgentContainerRequest, type RequestCodingAgentContainerResponse, type SyncCloudCodingContainerRequest, type SyncCloudCodingContainerResponse } from "@elizaos/core/contracts/cloud-coding-containers";
export { type CompleteLifeOpsBrowserSessionRequest as CompleteBrowserBridgeSessionRequest, type CompleteLifeOpsOccurrenceRequest, type ConfirmLifeOpsBrowserSessionRequest as ConfirmBrowserBridgeSessionRequest, type CreateLifeOpsBrowserSessionRequest as CreateBrowserBridgeSessionRequest, type CreateLifeOpsDefinitionRequest, type CreateLifeOpsGmailReplyDraftRequest, type CreateLifeOpsGoalRequest, type DisconnectLifeOpsGoogleConnectorRequest, type GetLifeOpsGmailTriageRequest, type LifeOpsBrowserSession as BrowserBridgeSession, type LifeOpsDefinitionRecord, type LifeOpsGmailMessageSummary, type LifeOpsGmailReplyDraft, type LifeOpsGmailTriageFeed, type LifeOpsGoalRecord, type LifeOpsGoalReview, type LifeOpsGoogleConnectorStatus, type LifeOpsOccurrenceExplanation, type LifeOpsOccurrenceView, type LifeOpsOverview, type LifeOpsReminderInspection, type LifeOpsReminderPlan, type LifeOpsTaskDefinition, type SelectLifeOpsGoogleConnectorPreferenceRequest, type SendLifeOpsGmailReplyRequest, type SnoozeLifeOpsOccurrenceRequest, type StartLifeOpsGoogleConnectorRequest, type StartLifeOpsGoogleConnectorResponse, type UpdateLifeOpsDefinitionRequest, type UpdateLifeOpsGoalRequest } from "@elizaos/core/contracts/personal-assistant";
export { type CreateLifeOpsCalendarEventRequest, type GetLifeOpsCalendarFeedRequest, type LifeOpsCalendarEvent, type LifeOpsCalendarFeed, type LifeOpsNextCalendarEventContext } from "@elizaos/core/contracts/calendar";
export { type PostWorkbenchVfsPromoteToCloudRequest } from "@elizaos/core/contracts/workbench-routes";
export type { BrowserBridgeCompanionStatus, BrowserBridgePageContext, BrowserBridgeSettings, BrowserBridgeTabSummary, SyncBrowserBridgeStateRequest, UpdateBrowserBridgeSettingsRequest, } from "./browser-contracts";
...
export interface UpdateStatus {
    ...
    updateAuthority?: "package-manager" | "os-package-manager" | "developer" | "operator";
    nextAction?: "run-package-manager-command" | "run-git-pull" | "review-installation" | "none";
...
export type PluginMutationApplyMode = "none" | "config_apply" | "plugin_reload" | "runtime_reload" | "restart_required";
...
export type AutomationSource = "workbench_task" | "trigger" | "workflow" | "workflow_draft" | "workflow_shadow" | "automation_draft" | "scheduled_task";
...
// Voice / TTS config
export type VoiceProvider = "eliza-cloud" | "elevenlabs" | "robot-voice" | "edge" | "local-inference";
