 ...
 */
import type { CloudBillingCheckoutRequest, CloudBillingCheckoutResponse, CloudBillingCryptoQuoteRequest, CloudBillingCryptoQuoteResponse, CloudBillingHistoryItem, CloudBillingPaymentMethod, CloudBillingSettings, CloudBillingSettingsUpdateRequest, CloudBillingSummary, CloudCompatAgent, CloudCompatAgentProvisionResponse, CloudCompatAgentStatus, CloudCompatDiscordConfig, CloudCompatJob, CloudCompatLaunchResult, CloudCompatManagedDiscordStatus, CloudCompatManagedGithubStatus, CloudCredits, CloudLoginPersistResponse, CloudLoginPollResponse, CloudLoginResponse, CloudOAuthConnection, CloudOAuthConnectionRole, CloudOAuthInitiateResponse, CloudStatus, CloudTwitterOAuthInitiateResponse, SandboxBrowserEndpoints, SandboxPlatformStatus, SandboxScreenshotPayload, SandboxScreenshotRegion, SandboxStartResponse, SandboxWindowInfo } from "./client-types";
...
declare module "./client-base" {
    interface ElizaClient {
        ...
        cloudLoginPersist(apiKey: string, identity?: {
        ...
        provisionCloudCompatAgent(agentId: string): Promise<CloudCompatAgentProvisionResponse>;
        ...
        createCloudCompatAgentManagedDiscordOauth(agentId: string, request?: {
            returnUrl?: string;
            botNickname?: string;
        }): Promise<{
            success: boolean;
        ...
        updateCloudCompatAgentDiscordConfig(agentId: string, config: CloudCompatDiscordConfig): Promise<{
            success: boolean;
            data: CloudCompatDiscordConfig;
        }>;
        ...
        createCloudCompatAgentManagedGithubOauth(agentId: string, request?: {
            scopes?: string[];
            postMessage?: boolean;
            returnUrl?: string;
        }): Promise<{
        ...
        linkCloudCompatAgentManagedGithub(agentId: string, connectionId: string): Promise<{
            success: boolean;
            data: CloudCompatManagedGithubStatus;
        }>;
        ...
        initiateCloudOauth(platform: string, request?: {
            redirectUrl?: string;
            scopes?: string[];
            connectionRole?: CloudOAuthConnectionRole;
        ...
        sendProvisioningAgentMessage(message: string, agentId?: string): Promise<{
            success: boolean;
