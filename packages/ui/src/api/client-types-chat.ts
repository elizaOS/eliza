...
import { type ConversationMetadata } from "./client-types-core";
...
// module's scope.
export type { ChatFailureKind, ChatTerminalFailure, ChatToolCallEvent, ChatTurnStatus, };
// Conversations
 ...
 * browser bundle.
 */
export type MessageAttachmentContentType = "image" | "video" | "audio" | "document" | "link";
/**
...
export type DocumentProvenanceKind = "import" | "upload" | "learned" | "character" | "url" | "youtube" | "bundled" | "unknown";
...
export interface WorkflowStepManifest {
    id: string;
    label: string;
    kind: "approval" | "branch" | "loop" | "parallel" | "sequence" | "signal" | "task" | "timer" | "ui" | "workflow";
    dependsOn?: string[];
    description?: string;
    agent?: string;
}
export interface WorkflowWidgetManifest {
    ...
    component: "approval" | "chart" | "data-table" | "form" | "issue-list" | "json" | "markdown" | "status";
    dataPath?: string;
    actions?: Array<{
        id: string;
        label: string;
...
export type WorkflowRevisionOperation = "update" | "activate" | "deactivate" | "tags" | "restore" | "delete";
...
export interface WorkflowExecution {
    id: string;
    status: "cancelled" | "continued" | "failed" | "finished" | "paused" | "queued" | "running" | "waiting-approval" | "waiting-event" | "waiting-quota" | "waiting-timer";
    finished: boolean;
    startedAt: string;
...
export interface ContextInspectorEntry {
    ...
    completeness: "complete" | "partial-recoverable" | "partial-source-loss" | "unavailable";
