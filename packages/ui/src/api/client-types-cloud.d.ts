import type { TrajectoryExportOptions as CoreTrajectoryExportOptions, TrajectoryListOptions as CoreTrajectoryListOptions, TrajectoryListResult as CoreTrajectoryListResult, TrajectoryLlmCallRecord as CoreTrajectoryLlmCallRecord, TrajectoryProviderAccessRecord as CoreTrajectoryProviderAccessRecord, TrajectorySummaryRecord as CoreTrajectorySummaryRecord } from "@elizaos/core";
import type { AppSessionConfig, AppUiExtensionConfig, AppViewerConfig, RegistryAppInfo } from "@elizaos/shared";
 ...
 */
export declare function mapAcpSessionsToCodingAgentSessions(acpSessions: RawAcpSession[]): CodingAgentSession[];
/** Maps persisted task threads into the existing CodingAgentSession UI shape. */
export declare function mapTaskThreadsToCodingAgentSessions(taskThreads: CodingAgentTaskThread[]): CodingAgentSession[];
//# sourceMappingURL=client-types-cloud.d.ts.map