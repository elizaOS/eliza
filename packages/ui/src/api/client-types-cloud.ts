...
import { type AppLaunchDiagnosticSeverity } from "@elizaos/core/contracts/apps";
import { type AppLaunchResult } from "@elizaos/core/contracts/apps";
import { type AppRunActionResult } from "@elizaos/core/contracts/apps";
import { type AppRunAwaySummary } from "@elizaos/core/contracts/apps";
import { type AppRunCapabilityAvailability } from "@elizaos/core/contracts/apps";
import { type AppRunEvent } from "@elizaos/core/contracts/apps";
import { type AppRunEventKind } from "@elizaos/core/contracts/apps";
import { type AppRunEventSeverity } from "@elizaos/core/contracts/apps";
import { type AppRunHealth } from "@elizaos/core/contracts/apps";
import { type AppRunHealthDetails } from "@elizaos/core/contracts/apps";
import { type AppRunHealthFacet } from "@elizaos/core/contracts/apps";
import { type AppRunHealthState } from "@elizaos/core/contracts/apps";
import { type AppRunSummary } from "@elizaos/core/contracts/apps";
import { type AppRunViewerAttachment } from "@elizaos/core/contracts/apps";
import { type AppSessionActionResult } from "@elizaos/core/contracts/apps";
import { type AppSessionActivityItem } from "@elizaos/core/contracts/apps";
import { type AppSessionConfig } from "@elizaos/core/contracts/apps";
import { type AppSessionControlAction } from "@elizaos/core/contracts/apps";
import { type AppSessionFeature } from "@elizaos/core/contracts/apps";
import { type AppSessionJsonValue } from "@elizaos/core/contracts/apps";
import { type AppSessionMode } from "@elizaos/core/contracts/apps";
import { type AppSessionRecommendation } from "@elizaos/core/contracts/apps";
import { type AppSessionState } from "@elizaos/core/contracts/apps";
import { type AppStopResult } from "@elizaos/core/contracts/apps";
import { type AppUiExtensionConfig } from "@elizaos/core/contracts/apps";
import { type AppViewerAuthMessage } from "@elizaos/core/contracts/apps";
import { type AppViewerConfig } from "@elizaos/core/contracts/apps";
import { type RegistryAppInfo } from "@elizaos/core/contracts/apps";
import { type TrajectoryExportFormat } from "./client-types-core";
import { type TrajectoryExportOptions as CoreTrajectoryExportOptions } from "@elizaos/core";
import { type TrajectoryListOptions as CoreTrajectoryListOptions } from "@elizaos/core";
import { type TrajectoryListResult as CoreTrajectoryListResult } from "@elizaos/core";
import { type TrajectoryLlmCallRecord as CoreTrajectoryLlmCallRecord } from "@elizaos/core";
import { type TrajectoryProviderAccessRecord as CoreTrajectoryProviderAccessRecord } from "@elizaos/core";
import { type TrajectorySemanticStageRecord } from "@elizaos/core";
import { type TrajectorySummaryRecord as CoreTrajectorySummaryRecord } from "@elizaos/core";
export type { AppLaunchDiagnostic, AppLaunchDiagnosticSeverity, AppLaunchResult, AppRunActionResult, AppRunAwaySummary, AppRunCapabilityAvailability, AppRunEvent, AppRunEventKind, AppRunEventSeverity, AppRunHealth, AppRunHealthDetails, AppRunHealthFacet, AppRunHealthState, AppRunSummary, AppRunViewerAttachment, AppSessionActionResult, AppSessionActivityItem, AppSessionConfig, AppSessionControlAction, AppSessionFeature, AppSessionJsonValue, AppSessionMode, AppSessionRecommendation, AppSessionState, AppStopResult, AppUiExtensionConfig, AppViewerAuthMessage, AppViewerConfig, RegistryAppInfo, };
// Cloud
...
export type CloudOAuthConnectionStatus = "pending" | "active" | "expired" | "revoked" | "error";
...
export interface CloudTwitterOAuthInitiateResponse extends CloudOAuthInitiateResponse {
    oauthToken?: string;
    flow?: "oauth1a" | "oauth2";
    connectionRole?: CloudOAuthConnectionRole;
}
...
export interface TrajectoryProviderAccess extends CoreTrajectoryProviderAccessRecord {
    id: string;
    trajectoryId: string;
    stepId: string;
    providerName: string;
...
export type TrajectoryJsonValue = string | number | boolean | null | TrajectoryJsonValue[] | {
    [key: string]: TrajectoryJsonValue;
};
export type ContextEventType = "message" | "memory" | "provider" | "tool" | "instruction" | "segment" | "metadata" | (string & {});
export type ContextEventRole = "system" | "user" | "assistant" | "tool" | (string & {});
...
export type NativeToolCallStatus = "queued" | "running" | "completed" | "skipped" | "failed";
...
export type PipelineStageName = "input" | "should_respond" | "message_handler" | "plan" | "planner" | "sub_planner" | "actions" | "evaluators" | "evaluator" | "context" | "cache" | (string & {});
...
export type ContextDiffChangeType = "added" | "removed" | "changed" | "unchanged" | (string & {});
...
export type TrajectoryEvent = NativeToolCallEvent | TrajectoryEvaluationEvent | TrajectoryCacheObservation | TrajectoryContextDiff | (TrajectoryEventBase & {
    type: string;
    [key: string]: unknown;
});
...
export interface TrajectoryListResult extends CoreTrajectoryListResult<TrajectoryRecord> {
}
...
export interface CodingAgentTaskThread {
    ...
    title: string;
    kind: string;
    status: "open" | "active" | "waiting_on_user" | "blocked" | "validating" | "done" | "failed" | "archived" | "interrupted";
...
export type OrchestratorRoomParticipantKind = "orchestrator" | "user" | "sub_agent";
...
export interface CodingAgentRestartWithEditedPlanInput extends CodingAgentRestartTaskInput {
    plan: Record<string, unknown>;
    basePlanRevisionId?: string;
    editSummary?: string;
}
 ...
 */
export function mapAcpSessionsToCodingAgentSessions(acpSessions: RawAcpSession[]): CodingAgentSession[] {
...
export function mapTaskThreadsToCodingAgentSessions(taskThreads: CodingAgentTaskThread[]): CodingAgentSession[] {
