 ...
 */
import type { WorkflowDefinition, WorkflowDefinitionGenerateRequest, WorkflowDefinitionGenerateResponse, WorkflowDefinitionResolveClarificationRequest, WorkflowDefinitionWriteRequest, WorkflowExecution, WorkflowStatusResponse } from "./client-types-chat";
declare module "./client-base" {
    interface ElizaClient {
        ...
        updateWorkflowDefinition(id: string, request: WorkflowDefinitionWriteRequest): Promise<WorkflowDefinition>;
        generateWorkflowDefinition(request: WorkflowDefinitionGenerateRequest): Promise<WorkflowDefinitionGenerateResponse>;
        resolveWorkflowClarification(request: WorkflowDefinitionResolveClarificationRequest): Promise<WorkflowDefinitionGenerateResponse>;
