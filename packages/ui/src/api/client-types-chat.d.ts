import type { ConversationMetadata, ConversationScope } from "./client-types-core";
...
export type ChatFailureKind = "insufficient_credits" | "no_provider" | "provider_issue" | "local_inference";
export type LocalInferenceChatStatus = "missing" | "downloading" | "loading" | "failed" | "no_space" | "idle" | "ready" | "cancelled" | "routing";
export interface LocalInferenceChatMetadata {
    intent?: "retry" | "resume" | "redownload" | "download" | "cancel" | "switch_smaller" | "status" | "use_cloud" | "use_local";
...
export type SensitiveRequestStatus = "pending" | "saved" | "submitted" | "fulfilled" | "expired" | "cancelled" | "failed";
export interface SensitiveRequestDelivery {
    mode: "inline_owner_app" | "cloud_authenticated_link" | "tunnel_authenticated_link" | "private_dm" | "public_link" | "dm_or_owner_app_instruction";
    instruction?: string;
...
export type DocumentScope = "global" | "owner-private" | "user-private" | "agent-private";
export type DocumentProvenanceKind = "upload" | "learned" | "character" | "url" | "youtube" | "bundled" | "unknown";
 ...
 */
export type WorkflowConnectionMap = Record<string, {
...
export type WorkflowDefinitionGenerateResponse = WorkflowDefinition | WorkflowDefinitionMissingCredentialsResponse | WorkflowDefinitionNeedsClarificationResponse;
export declare function isMissingCredentialsResponse(res: WorkflowDefinitionGenerateResponse): res is WorkflowDefinitionMissingCredentialsResponse;
export declare function isNeedsClarificationResponse(res: WorkflowDefinitionGenerateResponse): res is WorkflowDefinitionNeedsClarificationResponse;
...
//# sourceMappingURL=client-types-chat.d.ts.map