import type { TrajectoryExportFormat, TriggerLastStatus, TriggerRunRecord, TriggerType, TriggerWakeMode } from "@elizaos/core";
import type { CustomActionDef, CustomActionHandler, DatabaseProviderType, ReleaseChannel, AgentAutomationMode as SharedAgentAutomationMode, ColumnInfo as SharedColumnInfo, ConnectionTestResult as SharedConnectionTestResult, ConversationAutomationType as SharedConversationAutomationType, ConversationMetadata as SharedConversationMetadata, ConversationScope as SharedConversationScope, CreateTriggerRequest as SharedCreateTriggerRequest, DatabaseStatus as SharedDatabaseStatus, QueryResult as SharedQueryResult, RuntimeOrderItem as SharedRuntimeOrderItem, RuntimeServiceOrderItem as SharedRuntimeServiceOrderItem, StreamEventEnvelope as SharedStreamEventEnvelope, StreamEventType as SharedStreamEventType, TableInfo as SharedTableInfo, TradePermissionMode as SharedTradePermissionMode, TriggerHealthSnapshot as SharedTriggerHealthSnapshot, TriggerSummary as SharedTriggerSummary, TriggerTaskMetadata as SharedTriggerTaskMetadata, UpdateTriggerRequest as SharedUpdateTriggerRequest } from "@elizaos/shared";
import type { BrowserBridgeCompanionReleaseManifest } from "./browser-contracts";
export type { CustomActionDef, CustomActionHandler, DatabaseProviderType, ReleaseChannel, TrajectoryExportFormat, TriggerLastStatus, TriggerRunRecord, TriggerType, TriggerWakeMode, };
...
export type SignalPairingStatus = "idle" | "initializing" | "waiting_for_qr" | "connected" | "disconnected" | "timeout" | "error";
...
export type ProviderModelCategory = "chat" | "embedding" | "image" | "tts" | "stt" | "other";
...
export declare function isRateLimitedError(value: unknown): value is ApiError;
...
//# sourceMappingURL=client-types-core.d.ts.map