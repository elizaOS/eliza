...
import type { AppLaunchResult, AppRunActionResult, AppRunSummary, AppSessionActionResult, AppSessionControlAction, AppSessionState, AppStopResult, CatalogSearchResult, CatalogSkill, InstalledAppInfo, InstalledPlugin, PluginInstallResult, PluginMutationResult, RegistryAppInfo, RegistryPlugin, RegistryPluginItem, SkillInfo, SkillMarketplaceResult, SkillScanReportSummary } from "./client-types";
import type { BabylonActivityFeed, BabylonAgentGoal, BabylonAgentStats, BabylonAgentStatus, BabylonAgentSummary, BabylonChat, BabylonChatMessage, BabylonChatMessagesResponse, BabylonChatResponse, BabylonChatsResponse, BabylonLogEntry, BabylonPerpMarket, BabylonPerpPosition, BabylonPerpTradeResult, BabylonPostResult, BabylonPostsResponse, BabylonPredictionMarket, BabylonPredictionMarketsResponse, BabylonSendMessageResult, BabylonTeamChatInfo, BabylonTeamResponse, BabylonToggleResponse, BabylonTradeResult, BabylonWallet } from "./client-types-babylon";
...
declare module "./client-base" {
    interface ElizaClient {
        ...
        sendBabylonTeamChat(content: string, mentions?: string[]): Promise<BabylonChatResponse>;
        toggleBabylonAgent(action: "pause" | "resume" | "toggle"): Promise<BabylonToggleResponse>;
        ...
        getBabylonPredictionMarket(marketId: string): Promise<BabylonPredictionMarket>;
        buyBabylonPredictionShares(marketId: string, side: "yes" | "no", amount: number): Promise<BabylonTradeResult>;
        sellBabylonPredictionShares(marketId: string, side: "yes" | "no", amount: number): Promise<BabylonTradeResult>;
        getBabylonPerpMarkets(): Promise<BabylonPerpMarket[]>;
        getBabylonOpenPerpPositions(): Promise<BabylonPerpPosition[]>;
        closeBabylonPerpPosition(positionId: string): Promise<BabylonPerpTradeResult>;
        getBabylonPosts(opts?: {
            page?: number;
            limit?: number;
            feed?: string;
        }): Promise<BabylonPostsResponse>;
        createBabylonPost(content: string, marketId?: string): Promise<BabylonPostResult>;
        commentOnBabylonPost(postId: string, content: string): Promise<BabylonPostResult>;
        likeBabylonPost(postId: string): Promise<{
            ok: boolean;
        }>;
        getBabylonChats(): Promise<BabylonChatsResponse>;
        getBabylonChatMessages(chatId: string): Promise<BabylonChatMessagesResponse>;
        sendBabylonChatMessage(chatId: string, content: string): Promise<BabylonSendMessageResult>;
