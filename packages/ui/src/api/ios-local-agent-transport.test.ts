/**
 * Exercises dynamic Capacitor proxy loading and boot progress through the
 * shared transport. Native calls are deterministic doubles, not device proof.
 */
...
describe("iOS native proxy and boot progress", () => {
  beforeEach(() => {
    vi.resetModules();
