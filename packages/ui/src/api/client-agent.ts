...
import { connectorAccountAuditPath } from "./client-agent-connector-accounts";
import { connectorAccountOAuthPath } from "./client-agent-connector-accounts";
import { connectorAccountsPath } from "./client-agent-connector-accounts";
import { getAppBlockerPlugin } from "../bridge/native-plugins";
import { getWebsiteBlockerPlugin } from "../bridge/native-plugins";
...
import { mapTaskThreadsToCodingAgentSessions } from "./client-types";
import { normalizeConnectorAccountActionResult } from "./client-agent-connector-accounts";
import { normalizeConnectorAccountRecord } from "./client-agent-connector-accounts";
import { normalizeConnectorAccountsListResponse } from "./client-agent-connector-accounts";
import { openEventSource } from "../utils/event-source";
import { reportRendererDiagnostic } from "../utils/renderer-diagnostics";
import { sanitizeForSettingsDebug } from "@elizaos/core/settings-debug";
import { settingsDebugCloudSummary } from "@elizaos/core/settings-debug";
import { type AgentAutomationMode } from "./client-types";
import { type AgentAutomationModeResponse } from "./client-types";
import { type AgentBootProgress } from "./client-types";
import { type AgentEventsResponse } from "./client-types";
import { type AgentSelfStatusSnapshot } from "./client-types";
import { type AgentStatus } from "./client-types";
import { type AllPermissionsState } from "@elizaos/core/contracts/permissions";
import { type AppBlockerInstalledApp } from "../bridge/native-plugins";
import { type AppBlockerPermissionResult } from "../bridge/native-plugins";
import { type AppBlockerStatusResult } from "../bridge/native-plugins";
import { type AppConfigResponse } from "./client-types";
import { type CharacterData } from "./client-types";
import { type CharacterHistoryResponse } from "./client-types";
import { type CodingAgentAddAgentInput } from "./client-types";
import { type CodingAgentCreatePlanRevisionInput } from "./client-types";
import { type CodingAgentCreateTaskInput } from "./client-types";
import { type CodingAgentForkTaskInput } from "./client-types";
import { type CodingAgentOrchestratorStatus } from "./client-types";
import { type CodingAgentRerunFromEventInput } from "./client-types";
import { type CodingAgentRestartTaskInput } from "./client-types";
import { type CodingAgentRestartWithEditedPlanInput } from "./client-types";
import { type CodingAgentRetryTurnInput } from "./client-types";
import { type CodingAgentScratchWorkspace } from "./client-types";
import { type CodingAgentStatus } from "./client-types";
import { type CodingAgentTaskEventRecord } from "./client-types";
import { type CodingAgentTaskMessageRecord } from "./client-types";
import { type CodingAgentTaskPage } from "./client-types";
import { type CodingAgentTaskPlanRevisionRecord } from "./client-types";
import { type CodingAgentTaskThread } from "./client-types";
import { type CodingAgentTaskThreadDetail } from "./client-types";
import { type CodingAgentTaskTimelineItem } from "./client-types";
import { type CodingAgentUpdateTaskInput } from "./client-types";
import { type CodingAgentValidateTaskInput } from "./client-types";
import { type ConfigSchemaResponse } from "./client-types";
import { type ConnectorAccountActionResult } from "./client-agent-connector-accounts";
import { type ConnectorAccountAuditEventsQuery } from "./client-agent-connector-accounts";
import { type ConnectorAccountAuditEventsResponse } from "./client-agent-connector-accounts";
import { type ConnectorAccountCreateInput } from "./client-agent-connector-accounts";
import { type ConnectorAccountOAuthStartInput } from "./client-agent-connector-accounts";
import { type ConnectorAccountRecord } from "./client-agent-connector-accounts";
import { type ConnectorAccountUpdateInput } from "./client-agent-connector-accounts";
import { type ConnectorAccountsListResponse } from "./client-agent-connector-accounts";
import { type CorePluginsResponse } from "./client-types";
import { type CreateTriggerRequest } from "./client-types";
import { type ExperienceGraphResponse } from "./client-types";
import { type ExperienceListQuery } from "./client-types";
import { type ExperienceListResponse } from "./client-types";
import { type ExperienceMaintenanceResult } from "./client-types";
import { type ExperienceRecord } from "./client-types";
import { type ExperienceUpdateInput } from "./client-types";
...
import { type LaunchSnapshot } from "./client-types";
import { type LogsFilter } from "./client-types";
import { type LogsResponse } from "./client-types";
import { type ModelCatalog } from "./client-types";
import { type ModelsConfigResponse } from "./client-types";
import { type ModelsConfigWriteRequest } from "./client-types";
import { type ModelsConfigWriteResult } from "./client-types";
import { type OrchestratorAccountOverview } from "./client-types";
import { type OrchestratorAccountReadiness } from "./client-types";
...
import { type ProjectListResponse } from "./client-types";
import { type ProjectSummary } from "./client-types";
import { type ProviderModelRecord } from "./client-types";
import { type RawAcpSession } from "./client-types";
import { type RelationshipsActivityResponse } from "./client-types";
import { type RelationshipsGraphQuery } from "./client-types";
import { type RelationshipsGraphSnapshot } from "./client-types";
import { type RelationshipsGraphStats } from "./client-types";
import { type RelationshipsMergeCandidate } from "./client-types";
import { type RelationshipsPersonDetail } from "./client-types";
import { type RelationshipsPersonSummary } from "./client-types";
import { type RuntimeDebugSnapshot } from "./client-types";
import { type SecretInfo } from "./client-types";
import { type SecurityAuditFilter } from "./client-types";
import { type SecurityAuditResponse } from "./client-types";
import { type SecurityAuditStreamEvent } from "./client-types";
import { type SubscriptionStatusResponse } from "@elizaos/core/contracts/first-run-options";
import { type TradePermissionMode } from "./client-types";
import { type TradePermissionModeResponse } from "./client-types";
import { type TriggerEventDispatchResponse } from "./client-types";
import { type TriggerHealthSnapshot } from "./client-types";
import { type TriggerLastStatus } from "./client-types";
import { type TriggerRunRecord } from "./client-types";
import { type TriggerSummary } from "./client-types";
import { type UpdateStatus } from "./client-types";
import { type UpdateTriggerRequest } from "./client-types";
import { type WebsiteBlockerPermissionResult } from "../bridge/native-plugins";
import { type WebsiteBlockerStatusResult } from "../bridge/native-plugins";
...
export { CONNECTOR_SERVER_ROLE_TO_UI_ROLE, type ConnectorAccountActionResult, type ConnectorAccountAuditEventRecord, type ConnectorAccountAuditEventsQuery, type ConnectorAccountAuditEventsResponse, type ConnectorAccountCreateInput, type ConnectorAccountOAuthStartInput, type ConnectorAccountPrivacy, type ConnectorAccountPurpose, type ConnectorAccountRecord, type ConnectorAccountRole, type ConnectorAccountStatus, type ConnectorAccountsListResponse, type ConnectorAccountUpdateInput, normalizeConnectorAccountRecord, } from "./client-agent-connector-accounts";
// ---------------------------------------------------------------------------
...
function mapWebsiteBlockerPermissionResult(permission: WebsiteBlockerPermissionResult): PermissionState {
    return {
...
function mapWebsiteBlockerStatusToPermission(status: WebsiteBlockerStatusResult): PermissionState {
    return {
        id: WEBSITE_BLOCKING_PERMISSION_ID,
...
async function getDesktopStatusRpc<T>(baseUrl: string, rpcMethod: string, params?: unknown): Promise<T | null> {
...
async function invokeLocalDesktopAgentRpc<T>(baseUrl: string, options: {
    rpcMethod: string;
    ipcChannel: string;
    params?: unknown;
}): Promise<T | null> {
...
export type BootstrapExchangeResult = BootstrapExchangeSuccess | BootstrapExchangeFailure;
// ---------------------------------------------------------------------------
...
declare module "./client-base" {
    interface ElizaClient {
        ...
        switchProvider(provider: string, apiKey?: string, primaryModel?: string): Promise<{
            success: boolean;
            provider: string;
            restarting: boolean;
        }>;
        ...
        listConnectorAccounts(provider: string, connectorId?: string, options?: {
            timeoutMs?: number;
            signal?: AbortSignal;
        }): Promise<ConnectorAccountsListResponse>;
        addConnectorAccount(provider: string, connectorId: string | undefined, body?: ConnectorAccountCreateInput): Promise<ConnectorAccountActionResult>;
        startConnectorAccountOAuth(provider: string, connectorId: string | undefined, body?: ConnectorAccountOAuthStartInput): Promise<ConnectorAccountActionResult>;
        patchConnectorAccount(provider: string, connectorId: string | undefined, accountId: string, body: ConnectorAccountUpdateInput): Promise<ConnectorAccountRecord>;
        testConnectorAccount(provider: string, connectorId: string | undefined, accountId: string): Promise<ConnectorAccountActionResult>;
        refreshConnectorAccount(provider: string, connectorId: string | undefined, accountId: string): Promise<ConnectorAccountActionResult>;
        deleteConnectorAccount(provider: string, connectorId: string | undefined, accountId: string): Promise<ConnectorAccountActionResult>;
        makeDefaultConnectorAccount(provider: string, connectorId: string | undefined, accountId: string): Promise<ConnectorAccountActionResult>;
        listConnectorAccountAuditEvents(provider: string, query?: ConnectorAccountAuditEventsQuery): Promise<ConnectorAccountAuditEventsResponse>;
        getTriggers(): Promise<{
        ...
        emitTriggerEvent(eventKind: string, payload?: Record<string, unknown>): Promise<TriggerEventDispatchResponse>;
        ...
        updateModelsConfig(request: ModelsConfigWriteRequest): Promise<ModelsConfigWriteResult>;
        getCorePlugins(): Promise<CorePluginsResponse>;
        toggleCorePlugin(npmName: string, enabled: boolean): Promise<PluginMutationResult>;
        updatePlugin(id: string, config: Record<string, unknown>): Promise<PluginMutationResult>;
        getSecrets(): Promise<{
            secrets: SecretInfo[];
        }>;
        ...
        getRelationshipsActivity(limit?: number, offset?: number): Promise<RelationshipsActivityResponse>;
        ...
        proposeRelationshipsLink(sourceEntityId: string, targetEntityId: string, evidence?: Record<string, unknown>): Promise<{
            id: string;
            status: string;
        }>;
        ...
        listExperiences(options?: ExperienceListQuery): Promise<ExperienceListResponse>;
        ...
        updateExperience(id: string, data: ExperienceUpdateInput): Promise<{
            experience: ExperienceRecord;
        }>;
        ...
        getCodingAgentTaskThread(threadId: string): Promise<CodingAgentTaskThreadDetail | null>;
        ...
        createOrchestratorTask(input: CodingAgentCreateTaskInput): Promise<CodingAgentTaskThreadDetail>;
        pauseOrchestratorTask(taskId: string): Promise<CodingAgentTaskThreadDetail | null>;
        resumeOrchestratorTask(taskId: string): Promise<CodingAgentTaskThreadDetail | null>;
        deleteOrchestratorTask(taskId: string): Promise<boolean>;
        forkOrchestratorTask(taskId: string, input?: CodingAgentForkTaskInput): Promise<CodingAgentTaskThreadDetail | null>;
        addOrchestratorAgent(taskId: string, input: CodingAgentAddAgentInput): Promise<CodingAgentTaskThreadDetail | null>;
        stopOrchestratorAgent(taskId: string, sessionId: string): Promise<boolean>;
        retryOrchestratorTaskTurn(taskId: string, input: CodingAgentRetryTurnInput): Promise<CodingAgentTaskThreadDetail | null>;
        rerunOrchestratorTaskFromEvent(taskId: string, input: CodingAgentRerunFromEventInput): Promise<CodingAgentTaskThreadDetail | null>;
        restartOrchestratorTask(taskId: string, input?: CodingAgentRestartTaskInput): Promise<CodingAgentTaskThreadDetail | null>;
        restartOrchestratorTaskWithEditedPlan(taskId: string, input: CodingAgentRestartWithEditedPlanInput): Promise<CodingAgentTaskThreadDetail | null>;
        listOrchestratorTaskPlanRevisions(taskId: string, options?: {
            cursor?: string;
            limit?: number;
        }): Promise<CodingAgentTaskPage<CodingAgentTaskPlanRevisionRecord>>;
        createOrchestratorTaskPlanRevision(taskId: string, input: CodingAgentCreatePlanRevisionInput): Promise<CodingAgentTaskPlanRevisionRecord | null>;
        listOrchestratorTaskMessages(taskId: string, options?: {
            cursor?: string;
            limit?: number;
        }): Promise<CodingAgentTaskPage<CodingAgentTaskMessageRecord>>;
        postOrchestratorTaskMessage(taskId: string, content: string): Promise<boolean>;
        listOrchestratorTaskEvents(taskId: string, options?: {
            cursor?: string;
            limit?: number;
        }): Promise<CodingAgentTaskPage<CodingAgentTaskEventRecord>>;
        listOrchestratorTaskTimeline(taskId: string, options?: {
            cursor?: string;
            limit?: number;
        ...
        updateOrchestratorTask(taskId: string, input: CodingAgentUpdateTaskInput): Promise<CodingAgentTaskThreadDetail | null>;
        validateOrchestratorTask(taskId: string, input: CodingAgentValidateTaskInput): Promise<CodingAgentTaskThreadDetail | null>;
 ...
 * parse), never throws.
 */
function parseResumeProgress(body: unknown): AgentStatus["resumeProgress"] | undefined {
    if (!body || typeof body !== "object")
        return undefined;
    const data = (body as {
        data?: unknown;
    }).data;
    const src = (data && typeof data === "object" ? data : body) as Record<string, unknown>;
    const status = typeof src.status === "string" ? src.status : undefined;
    if (!status)
        return undefined;
    const jobId = typeof src.jobId === "string" ? src.jobId : undefined;
    const retryAfterMs = typeof src.retryAfterMs === "number" && Number.isFinite(src.retryAfterMs)
        ? src.retryAfterMs
        : undefined;
    const alreadyInProgress = typeof src.alreadyInProgress === "boolean"
...
async function fetchStatusWithResumeProgress(client: ElizaClient): Promise<AgentStatus> {
...
ElizaClient.prototype.getStatus = async function (this: ElizaClient) {
    ...
    try {
        const viaRpc = await getDesktopStatusRpc<AgentStatus>(this.getBaseUrl(), "getAgentStatus");
        if (viaRpc) {
...
ElizaClient.prototype.getBootProgress = async function (this: ElizaClient) {
    try {
        return await getDesktopStatusRpc<AgentBootProgress>(this.getBaseUrl(), "bootProgress");
    }
    catch {
...
ElizaClient.prototype.getLaunchProgress = async function (this: ElizaClient) {
    try {
        return await getDesktopStatusRpc<LaunchSnapshot>(this.getBaseUrl(), "launchProgress");
    }
    catch {
...
ElizaClient.prototype.getAgentSelfStatus = async function (this: ElizaClient) {
    try {
        const viaRpc = await getDesktopStatusRpc<AgentSelfStatusSnapshot>(this.getBaseUrl(), "getAgentSelfStatus");
        if (viaRpc)
            return viaRpc;
    }
    catch {
...
ElizaClient.prototype.getRuntimeSnapshot = async function (this: ElizaClient, opts?) {
    try {
        const viaRpc = await getDesktopStatusRpc<RuntimeDebugSnapshot>(this.getBaseUrl(), "getRuntimeSnapshot", opts);
        if (viaRpc)
            return viaRpc;
    }
    catch {
...
ElizaClient.prototype.setAutomationMode = async function (this: ElizaClient, mode) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<AgentAutomationModeResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.setTradeMode = async function (this: ElizaClient, mode) {
    if (isTradePermissionMode(mode)) {
        try {
            const viaRpc = await invokeLocalDesktopAgentRpc<TradePermissionModeResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.runTerminalCommand = async function (this: ElizaClient, command) {
...
ElizaClient.prototype.getWalletOsStoreStatus = async function (this: ElizaClient) {
    return this.fetch("/api/wallet/os-store");
};
ElizaClient.prototype.postWalletOsStoreAction = async function (this: ElizaClient, action) {
    return this.fetch("/api/wallet/os-store", {
        method: "POST",
...
ElizaClient.prototype.postBootstrapExchange = async function (this: ElizaClient, token: string): Promise<BootstrapExchangeResult> {
    ...
    const status: 400 | 401 | 429 | 503 = reason === "rate_limited"
        ? 429
...
ElizaClient.prototype.getFirstRunOptions = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<FirstRunOptions>(this.getBaseUrl(), {
...
ElizaClient.prototype.submitFirstRun = async function (this: ElizaClient, data) {
    const response = await this.fetch<unknown>("/api/first-run", {
        method: "POST",
        headers: { "Idempotency-Key": crypto.randomUUID() },
        body: JSON.stringify(data),
    });
    await waitForFirstRunActivation(response, (id) => this.fetch(`/api/first-run/activation/${encodeURIComponent(id)}`));
};
...
ElizaClient.prototype.exchangeAnthropicCode = async function (this: ElizaClient, code) {
...
ElizaClient.prototype.submitAnthropicSetupToken = async function (this: ElizaClient, token) {
...
ElizaClient.prototype.getSubscriptionStatus = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<SubscriptionStatusResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.deleteSubscription = async function (this: ElizaClient, provider) {
    return this.fetch(`/api/subscription/${encodeURIComponent(provider)}`, {
        method: "DELETE",
    });
};
ElizaClient.prototype.switchProvider = async function (this: ElizaClient, provider, apiKey?, primaryModel?) {
...
ElizaClient.prototype.exchangeOpenAICode = async function (this: ElizaClient, code) {
...
ElizaClient.prototype.restartAndWait = async function (this: ElizaClient, maxWaitMs = 30000) {
    try {
...
ElizaClient.prototype.getConfig = async function (this: ElizaClient) {
    ...
    try {
        viaRpc = await invokeLocalDesktopAgentRpc<AppConfigResponse>(this.getBaseUrl(), {
            rpcMethod: "getConfig",
            ipcChannel: "agent",
        });
    }
...
ElizaClient.prototype.getConfigSchema = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<ConfigSchemaResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.updateConfig = async function (this: ElizaClient, patch) {
    ...
    let transport = "rpc";
    try {
        out = await invokeLocalDesktopAgentRpc<Record<string, unknown>>(this.getBaseUrl(), {
...
ElizaClient.prototype.saveConnector = async function (this: ElizaClient, name, config) {
    return this.fetch("/api/connectors", {
        method: "POST",
        body: JSON.stringify({ name, config }),
    });
};
ElizaClient.prototype.deleteConnector = async function (this: ElizaClient, name) {
    return this.fetch(`/api/connectors/${encodeURIComponent(name)}`, {
        method: "DELETE",
    });
};
ElizaClient.prototype.listConnectorAccounts = async function (this: ElizaClient, provider, connectorId = provider, options) {
    const path = connectorAccountsPath(provider, connectorId);
    const response = options
        ? await this.fetch<unknown>(path, { signal: options.signal }, { timeoutMs: options.timeoutMs })
        : await this.fetch<unknown>(path);
    return normalizeConnectorAccountsListResponse(provider, connectorId, response);
};
ElizaClient.prototype.addConnectorAccount = async function (this: ElizaClient, provider, connectorId = provider, body = {}) {
    const response = await this.fetch<unknown>(connectorAccountsPath(provider, connectorId), {
        method: "POST",
        body: JSON.stringify(body),
    });
    return normalizeConnectorAccountActionResult(provider, connectorId, response);
};
ElizaClient.prototype.startConnectorAccountOAuth = async function (this: ElizaClient, provider, connectorId = provider, body = {}) {
    const response = await this.fetch<unknown>(connectorAccountOAuthPath(provider, "start"), {
        method: "POST",
        body: JSON.stringify(body),
    });
    return normalizeConnectorAccountActionResult(provider, connectorId, response);
};
ElizaClient.prototype.patchConnectorAccount = async function (this: ElizaClient, provider, connectorId = provider, accountId, body) {
    const response = await this.fetch<unknown>(connectorAccountsPath(provider, connectorId, accountId), {
        method: "PATCH",
        body: JSON.stringify(body),
    });
    return normalizeConnectorAccountRecord(provider, connectorId, response);
};
ElizaClient.prototype.testConnectorAccount = async function (this: ElizaClient, provider, connectorId = provider, accountId) {
    const response = await this.fetch<unknown>(connectorAccountsPath(provider, connectorId, accountId, "test"), { method: "POST" });
    return normalizeConnectorAccountActionResult(provider, connectorId, response);
};
ElizaClient.prototype.refreshConnectorAccount = async function (this: ElizaClient, provider, connectorId = provider, accountId) {
    const response = await this.fetch<unknown>(connectorAccountsPath(provider, connectorId, accountId, "refresh"), { method: "POST" });
    return normalizeConnectorAccountActionResult(provider, connectorId, response);
};
ElizaClient.prototype.deleteConnectorAccount = async function (this: ElizaClient, provider, connectorId = provider, accountId) {
    const response = await this.fetch<unknown>(connectorAccountsPath(provider, connectorId, accountId), { method: "DELETE" });
    return normalizeConnectorAccountActionResult(provider, connectorId, response);
};
ElizaClient.prototype.makeDefaultConnectorAccount = async function (this: ElizaClient, provider, connectorId = provider, accountId) {
    const response = await this.fetch<unknown>(connectorAccountsPath(provider, connectorId, accountId, "default"), { method: "POST" });
    return normalizeConnectorAccountActionResult(provider, connectorId, response);
};
ElizaClient.prototype.listConnectorAccountAuditEvents = async function (this: ElizaClient, provider, query = {}) {
    return this.fetch<ConnectorAccountAuditEventsResponse>(connectorAccountAuditPath(provider, query));
};
...
ElizaClient.prototype.getTrigger = async function (this: ElizaClient, id) {
    return workflowSurfaceClient(this).fetch(`/api/triggers/${encodeURIComponent(id)}`);
};
ElizaClient.prototype.createTrigger = async function (this: ElizaClient, request) {
    return workflowSurfaceClient(this).fetch("/api/triggers", {
        method: "POST",
        body: JSON.stringify(request),
    });
};
ElizaClient.prototype.updateTrigger = async function (this: ElizaClient, id, request) {
    return workflowSurfaceClient(this).fetch(`/api/triggers/${encodeURIComponent(id)}`, {
        method: "PUT",
        body: JSON.stringify(request),
    });
...
ElizaClient.prototype.runTriggerNow = async function (this: ElizaClient, id) {
    return workflowSurfaceClient(this).fetch(`/api/triggers/${encodeURIComponent(id)}/execute`, {
        method: "POST",
    });
};
ElizaClient.prototype.getTriggerRuns = async function (this: ElizaClient, id) {
    return workflowSurfaceClient(this).fetch(`/api/triggers/${encodeURIComponent(id)}/runs`);
};
ElizaClient.prototype.emitTriggerEvent = async function (this: ElizaClient, eventKind, payload = {}) {
    return workflowSurfaceClient(this).fetch(`/api/triggers/events/${encodeURIComponent(eventKind)}`, {
        method: "POST",
...
ElizaClient.prototype.getTriggerHealth = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<TriggerHealthSnapshot>(this.getBaseUrl(), {
...
ElizaClient.prototype.fetchModels = async function (this: ElizaClient, provider, refresh = true) {
    const params = new URLSearchParams({ provider });
    if (refresh)
        params.set("refresh", "true");
    return this.fetch(`/api/models?${params.toString()}`);
};
ElizaClient.prototype.getModelsCatalog = async function (this: ElizaClient, init) {
...
ElizaClient.prototype.getModelsConfig = async function (this: ElizaClient, init) {
    return init === undefined
        ? this.fetch("/api/models/config")
        : this.fetch("/api/models/config", init);
};
ElizaClient.prototype.updateModelsConfig = async function (this: ElizaClient, request) {
    ...
    const body = await this.fetch<Record<string, unknown> | undefined>("/api/models/config", { method: "POST", body: JSON.stringify(request) }, { allowNonOk: true });
    if (body &&
        ...
        return {
            ...
            ...(Array.isArray(body.conflictingServiceEnvKeys)
                ? {
                    conflictingServiceEnvKeys: body.conflictingServiceEnvKeys.filter((key): key is string => typeof key === "string"),
                }
                : {}),
        };
    }
    ...
    if (body && error !== undefined && body.code === "MODEL_CONFIG_INVALID") {
        ...
        const supported = Array.isArray(context.supported)
            ? context.supported.filter((value): value is string => typeof value === "string")
            : undefined;
        return {
            kind: "invalid",
            error,
...
ElizaClient.prototype.getCorePlugins = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<CorePluginsResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.toggleCorePlugin = async function (this: ElizaClient, npmName, enabled) {
    return this.fetch("/api/plugins/core/toggle", {
        method: "POST",
        body: JSON.stringify({ npmName, enabled }),
    });
};
ElizaClient.prototype.updatePlugin = async function (this: ElizaClient, id, config) {
...
ElizaClient.prototype.updateSecrets = async function (this: ElizaClient, secrets) {
...
ElizaClient.prototype.tunnelCredential = async function (this: ElizaClient, input) {
...
ElizaClient.prototype.testPluginConnection = async function (this: ElizaClient, id) {
...
function buildSecurityAuditParams(filter?: SecurityAuditFilter, includeStream = false): URLSearchParams {
    const params = new URLSearchParams();
    if (filter?.type)
...
function parseSecurityAuditPayload(payload: string, onEvent: (event: SecurityAuditStreamEvent) => void): void {
    if (!payload)
        return;
    try {
...
function consumeSecurityAuditEvent(rawEvent: string, onEvent: (event: SecurityAuditStreamEvent) => void): void {
...
async function readSecurityAuditStream(body: ReadableStream<Uint8Array>, onEvent: (event: SecurityAuditStreamEvent) => void): Promise<void> {
...
ElizaClient.prototype.getSecurityAudit = async function (this: ElizaClient, filter?) {
    const qs = buildSecurityAuditParams(filter).toString();
    return this.fetch(`/api/security/audit${qs ? `?${qs}` : ""}`);
};
ElizaClient.prototype.streamSecurityAudit = async function (this: ElizaClient, onEvent, filter?, signal?) {
...
ElizaClient.prototype.getAgentEvents = async function (this: ElizaClient, opts?) {
    const params = new URLSearchParams();
...
ElizaClient.prototype.getRelationshipsGraph = async function (this: ElizaClient, query) {
    const params = new URLSearchParams();
    if (query?.search)
...
ElizaClient.prototype.getRelationshipsPeople = async function (this: ElizaClient, query) {
    const params = new URLSearchParams();
    if (query?.search)
        params.set("search", query.search);
    if (query?.platform)
...
ElizaClient.prototype.getRelationshipsPerson = async function (this: ElizaClient, id) {
    const response = await this.fetch<{
        data: RelationshipsPersonDetail;
    }>(`/api/relationships/people/${encodeURIComponent(id)}`);
    return response.data;
};
ElizaClient.prototype.getRelationshipsActivity = async function (this: ElizaClient, limit?, offset?) {
    const params = new URLSearchParams();
    ...
    const qs = params.toString();
    return this.fetch<RelationshipsActivityResponse>(`/api/relationships/activity${qs ? `?${qs}` : ""}`);
};
ElizaClient.prototype.getRelationshipsCandidates = async function (this: ElizaClient) {
    const response = await this.fetch<{
        data: RelationshipsMergeCandidate[];
    }>("/api/relationships/candidates");
    return response.data;
};
ElizaClient.prototype.acceptRelationshipsCandidate = async function (this: ElizaClient, candidateId) {
    const response = await this.fetch<{
        data: {
            id: string;
            status: string;
        };
    }>(`/api/relationships/candidates/${encodeURIComponent(candidateId)}/accept`, { method: "POST" });
    return response.data;
};
ElizaClient.prototype.rejectRelationshipsCandidate = async function (this: ElizaClient, candidateId) {
    const response = await this.fetch<{
        data: {
            id: string;
            status: string;
        };
    }>(`/api/relationships/candidates/${encodeURIComponent(candidateId)}/reject`, { method: "POST" });
    return response.data;
};
ElizaClient.prototype.proposeRelationshipsLink = async function (this: ElizaClient, sourceEntityId, targetEntityId, evidence) {
    const response = await this.fetch<{
        data: {
            id: string;
            status: string;
...
ElizaClient.prototype.generateCharacterField = async function (this: ElizaClient, field, context, mode?) {
    return this.fetch("/api/character/generate", {
        method: "POST",
        body: JSON.stringify({ field, context, mode }),
    });
};
ElizaClient.prototype.updateCharacter = async function (this: ElizaClient, character) {
    return this.fetch("/api/character", {
        method: "PUT",
        body: JSON.stringify(character),
    });
};
ElizaClient.prototype.listCharacterHistory = async function (this: ElizaClient, options) {
    const params = new URLSearchParams();
...
function appendMultiQueryParam(params: URLSearchParams, key: string, value?: string | string[]): void {
...
function appendTrimmedQueryParam(params: URLSearchParams, key: string, value?: string): void {
    const trimmed = typeof value === "string" ? value.trim() : "";
    if (trimmed)
        params.set(key, trimmed);
}
function appendNumberQueryParam(params: URLSearchParams, key: string, value?: number): void {
    if (typeof value === "number")
        params.set(key, String(value));
}
function appendBooleanQueryParam(params: URLSearchParams, key: string, value?: boolean): void {
    if (typeof value === "boolean")
        params.set(key, String(value));
}
function appendExperienceScalarParams(params: URLSearchParams, options: ExperienceListQuery | undefined, includeOffset: boolean): void {
...
function appendExperienceCollectionParams(params: URLSearchParams, options: ExperienceListQuery | undefined): void {
...
function buildExperienceQueryParams(options: ExperienceListQuery | undefined, includeOffset: boolean): URLSearchParams {
    const params = new URLSearchParams();
    appendExperienceScalarParams(params, options, includeOffset);
    appendExperienceCollectionParams(params, options);
    return params;
}
ElizaClient.prototype.listExperiences = async function (this: ElizaClient, options) {
...
ElizaClient.prototype.getExperienceGraph = async function (this: ElizaClient, options) {
...
ElizaClient.prototype.runExperienceMaintenance = async function (this: ElizaClient, options) {
    const response = await this.fetch<{
...
ElizaClient.prototype.updateExperience = async function (this: ElizaClient, id, data) {
    const response = await this.fetch<{
        data: ExperienceRecord;
    }>(`/api/character/experiences/${encodeURIComponent(id)}`, {
        method: "PATCH",
...
ElizaClient.prototype.deleteExperience = async function (this: ElizaClient, id) {
    return this.fetch(`/api/character/experiences/${encodeURIComponent(id)}`, {
        method: "DELETE",
    });
};
ElizaClient.prototype.getUpdateStatus = async function (this: ElizaClient, force = false) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<UpdateStatus>(this.getBaseUrl(), {
...
ElizaClient.prototype.setUpdateChannel = async function (this: ElizaClient, channel) {
    return this.fetch("/api/update/channel", {
        method: "PUT",
        body: JSON.stringify({ channel }),
    });
};
ElizaClient.prototype.getAgentAutomationMode = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<AgentAutomationModeResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.setAgentAutomationMode = async function (this: ElizaClient, mode) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<AgentAutomationModeResponse>(this.getBaseUrl(), {
            rpcMethod: "setAgentAutomationMode",
            ipcChannel: "agent:setAgentAutomationMode",
...
ElizaClient.prototype.getTradePermissionMode = async function (this: ElizaClient) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<TradePermissionModeResponse>(this.getBaseUrl(), {
...
ElizaClient.prototype.setTradePermissionMode = async function (this: ElizaClient, mode) {
    try {
        const viaRpc = await invokeLocalDesktopAgentRpc<TradePermissionModeResponse>(this.getBaseUrl(), {
            rpcMethod: "setTradePermissionMode",
            ipcChannel: "agent:setTradePermissionMode",
...
ElizaClient.prototype.requestPermission = async function (this: ElizaClient, id) {
    if (id === WEBSITE_BLOCKING_PERMISSION_ID) {
        const plugin = getNativeWebsiteBlockerPluginIfAvailable();
        if (plugin) {
...
ElizaClient.prototype.openPermissionSettings = async function (this: ElizaClient, id) {
    if (id === WEBSITE_BLOCKING_PERMISSION_ID) {
        const plugin = getNativeWebsiteBlockerPluginIfAvailable();
        if (plugin) {
...
ElizaClient.prototype.refreshPermissions = async function (this: ElizaClient) {
    const permissions = await this.fetch<AllPermissionsState>("/api/permissions/refresh", {
        method: "POST",
    });
    const plugin = getNativeWebsiteBlockerPluginIfAvailable();
    if (!plugin) {
...
ElizaClient.prototype.setShellEnabled = async function (this: ElizaClient, enabled) {
...
ElizaClient.prototype.getWebsiteBlockerStatus = async function (this: ElizaClient) {
    const plugin = getNativeWebsiteBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.startWebsiteBlock = async function (this: ElizaClient, options) {
    const plugin = getNativeWebsiteBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.checkAppBlockerPermissions = async function (this: ElizaClient) {
    const plugin = getNativeAppBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.requestAppBlockerPermissions = async function (this: ElizaClient) {
    const plugin = getNativeAppBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.getInstalledAppsToBlock = async function (this: ElizaClient) {
    const plugin = getNativeAppBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.selectAppBlockerApps = async function (this: ElizaClient) {
    const plugin = getNativeAppBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.startAppBlock = async function (this: ElizaClient, options) {
    const plugin = getNativeAppBlockerPluginIfAvailable();
    if (plugin) {
...
ElizaClient.prototype.getCodingAgentStatus = async function (this: ElizaClient) {
...
ElizaClient.prototype.listCodingAgentTaskThreads = async function (this: ElizaClient, options) {
    const params = new URLSearchParams();
...
ElizaClient.prototype.getCodingAgentTaskThread = async function (this: ElizaClient, threadId) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(threadId)}`);
    }
    catch (error) {
...
ElizaClient.prototype.archiveCodingAgentTaskThread = async function (this: ElizaClient, threadId) {
    await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(threadId)}/archive`, { method: "POST" });
    return true;
};
ElizaClient.prototype.reopenCodingAgentTaskThread = async function (this: ElizaClient, threadId) {
    await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(threadId)}/reopen`, { method: "POST" });
    return true;
};
...
ElizaClient.prototype.activateProject = async function (this: ElizaClient, projectId) {
    return this.fetch<ProjectSummary>(`/api/projects/${encodeURIComponent(projectId)}/activate`, { method: "POST" });
};
...
ElizaClient.prototype.getOrchestratorStatus = async function (this: ElizaClient) {
    return this.fetch<CodingAgentOrchestratorStatus>("/api/orchestrator/status");
};
ElizaClient.prototype.getOrchestratorAccounts = async function (this: ElizaClient) {
    return this.fetch<OrchestratorAccountOverview>("/api/orchestrator/accounts");
};
ElizaClient.prototype.getOrchestratorAccountReadiness = async function (this: ElizaClient, opts) {
    ...
    return this.fetch<OrchestratorAccountReadiness>(`/api/orchestrator/accounts/readiness${qs}`, undefined, { allowNonOk: true });
};
ElizaClient.prototype.getOrchestratorRooms = async function (this: ElizaClient) {
    return this.fetch<OrchestratorRoomRosterOverview>("/api/orchestrator/rooms");
};
ElizaClient.prototype.createOrchestratorTask = function (this: ElizaClient, input) {
...
ElizaClient.prototype.pauseOrchestratorTask = async function (this: ElizaClient, taskId) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/pause`, { method: "POST" });
    }
    catch (error) {
        if (error instanceof ApiError && error.status === 404)
            return null;
...
ElizaClient.prototype.resumeOrchestratorTask = async function (this: ElizaClient, taskId) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/resume`, { method: "POST" });
    }
    catch (error) {
        if (error instanceof ApiError && error.status === 404)
            return null;
...
ElizaClient.prototype.deleteOrchestratorTask = async function (this: ElizaClient, taskId) {
    await this.fetch<{
        deleted: boolean;
    }>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}`, { method: "DELETE" });
    return true;
};
ElizaClient.prototype.forkOrchestratorTask = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/fork`, {
            method: "POST",
            body: JSON.stringify(input ?? {}),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.updateOrchestratorTask = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}`, {
            method: "PATCH",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.validateOrchestratorTask = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/validate`, {
            method: "POST",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.addOrchestratorAgent = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/agents`, {
            method: "POST",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.stopOrchestratorAgent = async function (this: ElizaClient, taskId, sessionId) {
    await this.fetch<{
        stopped: boolean;
    }>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/agents/${encodeURIComponent(sessionId)}/stop`, { method: "POST" });
    return true;
};
ElizaClient.prototype.retryOrchestratorTaskTurn = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/retry-turn`, {
            method: "POST",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.rerunOrchestratorTaskFromEvent = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/rerun-from-event`, {
            method: "POST",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.restartOrchestratorTask = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/restart`, {
            method: "POST",
            body: JSON.stringify(input ?? {}),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.restartOrchestratorTaskWithEditedPlan = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskThreadDetail>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/restart-with-edited-plan`, {
            method: "POST",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.listOrchestratorTaskPlanRevisions = function (this: ElizaClient, taskId, options) {
    const params = new URLSearchParams();
    if (options?.cursor)
    ...
    const qs = params.toString();
    return this.fetch<CodingAgentTaskPage<CodingAgentTaskPlanRevisionRecord>>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/plan-revisions${qs ? `?${qs}` : ""}`);
};
ElizaClient.prototype.createOrchestratorTaskPlanRevision = async function (this: ElizaClient, taskId, input) {
    try {
        return await this.fetch<CodingAgentTaskPlanRevisionRecord>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/plan-revisions`, {
            method: "POST",
            body: JSON.stringify(input),
            headers: { "Content-Type": "application/json" },
        });
...
ElizaClient.prototype.listOrchestratorTaskMessages = function (this: ElizaClient, taskId, options) {
    const params = new URLSearchParams();
    if (options?.cursor)
        params.set("cursor", options.cursor);
    if (typeof options?.limit === "number") {
    ...
    const qs = params.toString();
    return this.fetch<CodingAgentTaskPage<CodingAgentTaskMessageRecord>>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/messages${qs ? `?${qs}` : ""}`);
};
ElizaClient.prototype.postOrchestratorTaskMessage = async function (this: ElizaClient, taskId, content) {
    const result = await this.fetch<{
        recorded: boolean;
        forwardedTo: string[];
        failedTo?: Array<{
...
ElizaClient.prototype.listOrchestratorTaskEvents = function (this: ElizaClient, taskId, options) {
    const params = new URLSearchParams();
    if (options?.cursor)
        params.set("cursor", options.cursor);
    if (typeof options?.limit === "number") {
    ...
    const qs = params.toString();
    return this.fetch<CodingAgentTaskPage<CodingAgentTaskEventRecord>>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/events${qs ? `?${qs}` : ""}`);
};
ElizaClient.prototype.listOrchestratorTaskTimeline = function (this: ElizaClient, taskId, options) {
    const params = new URLSearchParams();
    if (options?.cursor)
        params.set("cursor", options.cursor);
    if (typeof options?.limit === "number") {
    ...
    const qs = params.toString();
    return this.fetch<CodingAgentTaskPage<CodingAgentTaskTimelineItem>>(`/api/orchestrator/tasks/${encodeURIComponent(taskId)}/timeline${qs ? `?${qs}` : ""}`);
};
ElizaClient.prototype.streamOrchestratorTask = function (this: ElizaClient, taskId, onChange) {
...
ElizaClient.prototype.pauseAllOrchestratorTasks = async function (this: ElizaClient) {
    const res = await this.fetch<{
        paused: number;
    }>("/api/orchestrator/pause-all", { method: "POST" });
    return res.paused;
};
ElizaClient.prototype.resumeAllOrchestratorTasks = async function (this: ElizaClient) {
    const res = await this.fetch<{
        resumed: number;
    }>("/api/orchestrator/resume-all", { method: "POST" });
    return res.resumed;
};
ElizaClient.prototype.stopCodingAgent = async function (this: ElizaClient, sessionId) {
    try {
...
ElizaClient.prototype.listCodingAgentScratchWorkspaces = async function (this: ElizaClient) {
    return this.fetch<CodingAgentScratchWorkspace[]>("/api/coding-agents/scratch");
};
ElizaClient.prototype.keepCodingAgentScratchWorkspace = async function (this: ElizaClient, sessionId) {
    try {
...
ElizaClient.prototype.deleteCodingAgentScratchWorkspace = async function (this: ElizaClient, sessionId) {
    try {
...
ElizaClient.prototype.promoteCodingAgentScratchWorkspace = async function (this: ElizaClient, sessionId, name?) {
    try {
        const response = await this.fetch<{
            success: boolean;
...
ElizaClient.prototype.spawnShellSession = async function (this: ElizaClient, workdir?: string) {
    const res = await this.fetch<{
        sessionId: string;
...
ElizaClient.prototype.spawnPtySession = async function (this: ElizaClient, options) {
    const res = await this.fetch<{
        session: {
            sessionId: string;
        };
...
ElizaClient.prototype.stopPtySession = async function (this: ElizaClient, sessionId) {
    try {
        await this.fetch<{
            ok: boolean;
        }>(`/api/pty/sessions/${encodeURIComponent(sessionId)}`, { method: "DELETE" });
        return true;
    }
    catch {
        // error-policy:J1 boundary translation — the typed contract is an
...
ElizaClient.prototype.subscribePtyOutput = function (this: ElizaClient, sessionId) {
    this.sendWsMessage({ type: "pty-subscribe", sessionId });
};
ElizaClient.prototype.unsubscribePtyOutput = function (this: ElizaClient, sessionId) {
 ...
 */
export function chunkPtyInput(data: string, maxLength: number = MAX_PTY_INPUT_CHUNK_LENGTH): string[] {
...
ElizaClient.prototype.sendPtyInput = function (this: ElizaClient, sessionId, data) {
...
ElizaClient.prototype.resizePty = function (this: ElizaClient, sessionId, cols, rows) {
    this.sendWsMessage({ type: "pty-resize", sessionId, cols, rows });
};
ElizaClient.prototype.getPtyBufferedOutput = async function (this: ElizaClient, sessionId) {
    try {
        const res = await this.fetch<{
            output: string;
...
ElizaClient.prototype.getStreamingDestinations = async function (this: ElizaClient) {
    return this.fetch("/api/streaming/destinations");
};
ElizaClient.prototype.setActiveDestination = async function (this: ElizaClient, destinationId) {
    return this.fetch("/api/streaming/destination", {
        method: "POST",
        body: JSON.stringify({ destinationId }),
    });
};
ElizaClient.prototype.setStreamVolume = async function (this: ElizaClient, volume) {
...
ElizaClient.prototype.saveStreamVoice = async function (this: ElizaClient, settings) {
    return this.fetch("/api/stream/voice", {
        method: "POST",
        body: JSON.stringify(settings),
    });
};
ElizaClient.prototype.streamVoiceSpeak = async function (this: ElizaClient, text) {
    return this.fetch("/api/stream/voice/speak", {
        method: "POST",
        body: JSON.stringify({ text }),
    });
};
ElizaClient.prototype.getOverlayLayout = async function (this: ElizaClient, destinationId?) {
    const qs = destinationId
        ? `?destination=${encodeURIComponent(destinationId)}`
        : "";
    return this.fetch(`/api/stream/overlay-layout${qs}`);
};
ElizaClient.prototype.saveOverlayLayout = async function (this: ElizaClient, layout, destinationId?) {
    const qs = destinationId
        ? `?destination=${encodeURIComponent(destinationId)}`
        : "";
    return this.fetch(`/api/stream/overlay-layout${qs}`, {
...
ElizaClient.prototype.setStreamSource = async function (this: ElizaClient, sourceType, customUrl?) {
    return this.fetch("/api/stream/source", {
        method: "POST",
...
ElizaClient.prototype.saveStreamSettings = async function (this: ElizaClient, settings) {
    return this.fetch("/api/stream/settings", {
        method: "POST",
        body: JSON.stringify({ settings }),
    });
