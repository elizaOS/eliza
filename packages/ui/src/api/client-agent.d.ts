 ...
 */
import type { AllPermissionsState, OnboardingConnectorConfig as ConnectorConfig, LinkedAccountConfig, LinkedAccountProviderId, OnboardingOptions, PermissionId, PermissionState, ServiceRouteAccountStrategy, SubscriptionStatusResponse } from "@elizaos/shared";
import { type AppBlockerInstalledApp, type AppBlockerPermissionResult, type AppBlockerStatusResult } from "../bridge/native-plugins";
import type { AgentAutomationMode, AgentAutomationModeResponse, AgentEventsResponse, AgentSelfStatusSnapshot, AgentStatus, CharacterData, CharacterHistoryResponse, CodingAgentScratchWorkspace, CodingAgentStatus, CodingAgentTaskThread, CodingAgentTaskThreadDetail, ConfigSchemaResponse, CorePluginsResponse, CreateTriggerRequest, ExperienceGraphResponse, ExperienceListQuery, ExperienceListResponse, ExperienceMaintenanceResult, ExperienceRecord, ExperienceUpdateInput, ExtensionStatus, LogsFilter, LogsResponse, PluginInfo, PluginMutationResult, ProviderModelRecord, RelationshipsActivityResponse, RelationshipsGraphQuery, RelationshipsGraphSnapshot, RelationshipsGraphStats, RelationshipsMergeCandidate, RelationshipsPersonDetail, RelationshipsPersonSummary, RuntimeDebugSnapshot, SecretInfo, SecurityAuditFilter, SecurityAuditResponse, SecurityAuditStreamEvent, StartTrainingOptions, TradePermissionMode, TradePermissionModeResponse, TrainingDatasetRecord, TrainingJobRecord, TrainingModelRecord, TrainingStatus, TrainingTrajectoryDetail, TrainingTrajectoryList, TriggerEventDispatchResponse, TriggerHealthSnapshot, TriggerLastStatus, TriggerRunRecord, TriggerSummary, UpdateStatus, UpdateTriggerRequest } from "./client-types";
...
export type ConnectorAccountPrivacy = "owner_only" | "team_visible" | "semi_public" | "public";
export type ConnectorAccountStatus = "connected" | "pending" | "needs-reauth" | "disconnected" | "error" | "unknown";
...
declare module "./client-base" {
    interface ElizaClient {
        ...
        switchProvider(provider: string, apiKey?: string, primaryModel?: string, options?: {
        ...
        createApiKeyAccount(providerId: LinkedAccountProviderId, body: {
            label: string;
            apiKey: string;
        }): Promise<LinkedAccountConfig>;
        patchAccount(providerId: LinkedAccountProviderId, accountId: string, body: Partial<{
            label: string;
            enabled: boolean;
            priority: number;
        }>): Promise<LinkedAccountConfig>;
        deleteAccount(providerId: LinkedAccountProviderId, accountId: string): Promise<{
            deleted: boolean;
        }>;
        testAccount(providerId: LinkedAccountProviderId, accountId: string): Promise<AccountTestResult>;
        refreshAccountUsage(providerId: LinkedAccountProviderId, accountId: string): Promise<AccountRefreshUsageResult>;
        startAccountOAuth(providerId: LinkedAccountProviderId, body: {
            label: string;
        }): Promise<AccountOAuthStartResult>;
        submitAccountOAuthCode(providerId: LinkedAccountProviderId, body: {
            sessionId: string;
            code: string;
        }): Promise<{
            accepted: boolean;
        }>;
        cancelAccountOAuth(providerId: LinkedAccountProviderId, body: {
            sessionId: string;
        }): Promise<{
            cancelled: boolean;
        }>;
        patchProviderStrategy(providerId: LinkedAccountProviderId, body: {
            strategy: AccountStrategy;
        }): Promise<{
            providerId: LinkedAccountProviderId;
            strategy: AccountStrategy;
        ...
        listConnectorAccounts(provider: string, connectorId?: string): Promise<ConnectorAccountsListResponse>;
