 ...
 */
import type { BscTradeExecuteRequest, BscTradeExecuteResponse, BscTradePreflightResponse, BscTradeQuoteRequest, BscTradeQuoteResponse, BscTradeTxStatusResponse, BscTransferExecuteRequest, BscTransferExecuteResponse, DropStatus, MintResult, VerificationResult, WalletAddresses, WalletBalancesResponse, WalletConfigStatus, WalletConfigUpdateRequest, WalletMarketOverviewResponse, WalletNftsResponse, WalletTradingProfileResponse, WalletTradingProfileSourceFilter, WalletTradingProfileWindow } from "@elizaos/shared";
import type { BrowserWorkspaceSolanaMessageSignatureResult, BrowserWorkspaceSolanaTransactionResult, BrowserWorkspaceWalletMessageSignatureResult, BrowserWorkspaceWalletTransactionResult } from "../components/pages/browser-workspace-wallet";
import type { ApplyProductionWalletDefaultsResponse, RegistrationResult, RegistryConfig, RegistryStatus, VerificationMessageResponse, WalletExportResult, WhitelistStatus } from "./client-types";
import type { StewardApprovalActionResponse, StewardBalanceResponse, StewardHistoryResponse, StewardPendingResponse, StewardSignRequest, StewardSignResponse, StewardStatusResponse, StewardTokenBalancesResponse, StewardWalletAddressesResponse, StewardWebhookEventsResponse, StewardWebhookEventType } from "./client-types-steward";
