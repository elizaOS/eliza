...
export { FIRST_RUN_PROVIDER_CATALOG, type FirstRunProviderId, getDirectAccountProviderForFirstRunProvider, getFirstRunProviderFamily, getFirstRunProviderOption, getStoredFirstRunProviderId, getStoredSubscriptionProvider, getSubscriptionProviderFamily, isSubscriptionProviderSelectionId, normalizeFirstRunProviderId, normalizeSubscriptionProviderSelectionId, type ProviderOption as FirstRunProviderOption, requiresAdditionalRuntimeProvider, SUBSCRIPTION_PROVIDER_SELECTIONS, type SubscriptionProviderSelectionId, sortFirstRunProviders } from "@elizaos/core/contracts/first-run-options";
 ...
 */
export function registerProviderLogo(providerId: string, logos: {
    logoDark?: string;
    logoLight?: string;
}): void {
 ...
 */
export function getProviderLogo(providerId: string, isDarkMode: boolean = true, customLogo?: {
    logoDark?: string;
    logoLight?: string;
}): string {
