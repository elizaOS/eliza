...
import { type ContentPackColorScheme } from "@elizaos/core/contracts/content-pack";
 ...
 */
export function applyContentPack(pack: ResolvedContentPack, deps: ContentPackApplyDeps): void {
...
const COLOR_SCHEME_CSS_MAP: Record<keyof Omit<ContentPackColorScheme, "customProperties">, string> = {
    accent: "--pack-accent",
    bg: "--pack-bg",
    card: "--pack-card",
    border: "--pack-border",
 ...
 */
export function applyColorScheme(scheme: ContentPackColorScheme | undefined, pack?: ResolvedContentPack): () => void {
