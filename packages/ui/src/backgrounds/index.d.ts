export type { BackgroundEditAction, BackgroundEditPayload, } from "./BACKGROUND_EDIT-action-contract";
...
export { getActiveBackground, getBackground, getBackgroundHistory, listBackgrounds, registerBackground, resetBackgroundRegistry, revertBackground, setActiveBackground, } from "./registry";
export { createSlowCloudsBackground } from "./slow-clouds";
export type { BackgroundHandle, BackgroundKind, BackgroundModule, BackgroundState, } from "./types";
