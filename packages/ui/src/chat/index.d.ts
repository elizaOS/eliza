...
export declare function saveSavedCustomCommands(
  commands: SavedCustomCommand[],
): void;
export declare function appendSavedCustomCommand(
  command: SavedCustomCommand,
): void;
export declare function normalizeSlashCommandName(value: string): string;
export declare function expandSavedCustomCommand(
  template: string,
  argsRaw: string,
): string;
