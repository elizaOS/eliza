...
import { type WalletMarketMover } from "@elizaos/core/contracts/wallet";
import { type WalletMarketOverviewSource } from "@elizaos/core/contracts/wallet";
import { type WalletMarketPriceSnapshot } from "@elizaos/core/contracts/wallet";
...
export const MARKET_PRICE_ID_SET: ReadonlySet<string> = new Set(MARKET_PRICE_IDS);
...
type MarketProvider = Pick<WalletMarketOverviewSource, "providerId" | "providerName" | "providerUrl">;
...
export function mapCoinGeckoMarket(input: unknown): CoinGeckoMarketRecord | null {
...
export function parseCoinGeckoMarkets(payload: unknown): CoinGeckoMarketRecord[] {
...
export function buildMarketPriceSnapshots(markets: CoinGeckoMarketRecord[]): WalletMarketPriceSnapshot[] {
 ...
 */
export function buildMarketMovers(markets: CoinGeckoMarketRecord[]): WalletMarketMover[] {
    return markets
