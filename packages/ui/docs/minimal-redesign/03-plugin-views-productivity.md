...
- **Visual structure**: Historical note: the old Feed chrome used a 34vh dark image hero, stat strip, and multiple card sections. Current code uses `FeedView` as the GUI/XR data wrapper and `FeedSpatialView` as the shared presentational surface across GUI, XR, and TUI.
