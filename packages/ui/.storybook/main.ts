  ...
  viteFinal: async (cfg) => {
    ...
    cfg.resolve.alias = [
      ...
      { find: /^@elizaos\/ui\/(.+)$/, replacement: resolve(uiSrc, "$1") },
      {
        ...
        replacement: resolve(
          monorepoRoot,
          "packages/shared/dist/browser-logger.js",
        ),
      },
      {
        ...
        replacement: resolve(
          monorepoRoot,
          "packages/shared/dist/browser-contracts.browser.js",
        ),
      },
      {
        find: /^@elizaos\/shared$/,
      ...
      {
        // Shared owns the built browser-safe runtime values after the core split.
        find: /^@elizaos\/core$/,
        replacement: resolve(
          monorepoRoot,
          "packages/shared/dist/browser-contracts.browser.js",
