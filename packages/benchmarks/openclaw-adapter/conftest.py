"""Pytest bootstrap for the openclaw-adapter test suite.

``openclaw_adapter.client`` imports ``benchmarks.lib.base_benchmark_client``
for the shared retry / cost / telemetry scaffold. That import resolves cleanly
