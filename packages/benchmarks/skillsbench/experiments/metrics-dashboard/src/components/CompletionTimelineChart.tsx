import { BarChart2, Clock, TrendingUp, X } from "lucide-react";
...
import type { JobSummary, ProcessedTrial } from "../types/metrics";
...
export function CompletionTimelineChart({
  ...
  const chartData =
    chartMode === "cumulative" ? cumulativeData : throughputData;
