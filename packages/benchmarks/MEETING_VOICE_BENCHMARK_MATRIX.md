...
| SAMSum: https://huggingface.co/datasets/Samsung/samsum | Dialogue summarization, not meeting-specific. | New; lower-fidelity baseline. | HF dataset; license must be checked before fixture. | `downloaded-eval`, maybe `repo-fixture` after license check. | Baseline summarization scorer only, clearly marked non-meeting. | P2 | 100 short dialogues as a cheap sanity baseline. |
