...
#   COMPACT_METHOD            — override the method spec (default: NaiveSummaryCompactor)
...
# 4. Resolve method. CompactBench's resolver wants <file.py>:<ClassName>, so
#    the spec points at the package's compactors module.
METHOD_FILE="${HERE}/eliza_compactbench/compactors/__init__.py"
