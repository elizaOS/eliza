...
#
# Usage:
#   ./../../scripts/clawbench/run.sh [scenario] [variant]
#
#   ./../../scripts/clawbench/run.sh inbox_triage baseline
#   ./../../scripts/clawbench/run.sh morning_brief optimized
#   ./../../scripts/clawbench/run.sh --list                  # list available scenarios
#
# Prerequisites:
...
# Handle --list flag
if [ "$1" == "--list" ] || [ "$1" == "-l" ]; then
    python ../../scripts/clawbench/run_episode.py --list
    exit 0
fi
