...
Usage:
    python ../../scripts/clawbench/run_episode.py --scenario inbox_triage
    python ../../scripts/clawbench/run_episode.py --scenario inbox_triage --message "Custom prompt"
    python ../../scripts/clawbench/run_episode.py --wait --scenario inbox_triage
"""
