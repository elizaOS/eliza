...
function usage(): string {
  return [
    "Usage: ELIZA_REPO_DIR=/path/to/eliza node --conditions=eliza-source --conditions=development --import tsx scripts/lifeops-bench/export-action-manifest.ts [options]",
    "",
    "Options:",
