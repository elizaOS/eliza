 ...
 *
 * Run::
 *   node scripts/eliza-1/derive-fixtures.mjs
 *   node scripts/eliza-1/derive-fixtures.mjs --dry-run
 */
...
function deriveShouldRespond(rows) {
  ...
  return {
    note:
      ...
      "scripts/eliza-1/derive-fixtures.mjs.",
    origin: "dataset",
...
function derivePlanner(rows) {
  ...
  return {
    note:
      ...
      "probe set. Regenerated by scripts/eliza-1/derive-fixtures.mjs.",
    origin: "dataset",
    derivedFrom: "packages/training/datasets/eliza1-sft-0_6b/test.jsonl",
    cases,
  };
...
function deriveAction(rows) {
  ...
  return {
    note:
      ...
      "split. Regenerated by scripts/eliza-1/derive-fixtures.mjs.",
    origin: "dataset",
    derivedFrom: "packages/training/datasets/eliza1-sft-0_6b/test.jsonl",
    cases,
  };
