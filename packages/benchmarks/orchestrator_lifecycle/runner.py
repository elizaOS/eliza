...
_LIFECYCLE_SYSTEM_HINT = (
    ...
    "resume, cancel, undo a cancellation, or deliver a final summary. When you "
    "delegate work, say so explicitly using phrases like 'spawn a subagent' or "
    "'subagent is running'. When acknowledging scope changes, say 'scope change "
    "acknowledged' and 'updated plan'. When pausing/resuming/cancelling/undoing, "
    "say so explicitly. The user message is the next lifecycle event."
)
