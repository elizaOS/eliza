...
| `loadperf/`, `memperf/`, `mobile-resource/`, `view-bundle-size/` | Direct resource/load/bundle KPI workbenches you run to measure regressions against reference thresholds; not suite-orchestrator adapters. |
