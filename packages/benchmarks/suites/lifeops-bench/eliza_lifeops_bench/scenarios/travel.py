...
Covers provider-catalog flight search, trip-window calendar holds,
out-of-office blocks, and itinerary sharing. Booking flows are
approval-gated by design: searches project available offers and holds remain
pending until the user explicitly approves the external booking.
"""
...
TRAVEL_SCENARIOS: list[Scenario] = [
    Scenario(
        ...
        max_turns=6,
        description=(
            "Flight search against the travel catalog. Returns offers; does NOT "
    ...
    Scenario(
        ...
        instruction=(
            "Remind me on 2026-05-15 at 5am to leave for the airport — uber " "to SFO."
        ),
        ground_truth_actions=[
            Action(
                name="LIFE_CREATE",
