...
# Full OSWorld runs through suites/OSWorld, not this smoke adapter.
...
- The OSWorld adapter here is smoke-only. Full runs use `suites/OSWorld` with a real VM provider and final-state evaluator.
