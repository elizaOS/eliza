...
_ACTION_NAME_ALIASES: dict[str, str] = {
    ...
    "DEVICE_INTENT": "BLOCK",
    "LIFEOPS": "LIFE",
    "SCHEDULED_TASK_ACKNOWLEDGE": "SCHEDULED_TASKS_ACKNOWLEDGE",
    "SCHEDULED_TASK_CANCEL": "SCHEDULED_TASKS_CANCEL",
    "SCHEDULED_TASK_COMPLETE": "SCHEDULED_TASKS_COMPLETE",
    "SCHEDULED_TASKS_CREATE": "SCHEDULED_TASK_CREATE",
    "SCHEDULED_TASK_DISMISS": "SCHEDULED_TASKS_DISMISS",
    "SCHEDULED_TASK_GET": "SCHEDULED_TASKS_GET",
    "SCHEDULED_TASK_HISTORY": "SCHEDULED_TASKS_HISTORY",
    "SCHEDULED_TASK_LIST": "SCHEDULED_TASKS_LIST",
    "SCHEDULED_TASK_REOPEN": "SCHEDULED_TASKS_REOPEN",
    "SCHEDULED_TASK_SKIP": "SCHEDULED_TASKS_SKIP",
