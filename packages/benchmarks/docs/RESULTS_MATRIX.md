...
1. **Registered benchmarks (49)** — every id declared in `registry/commands.py`.
...
in `registry/commands.py`**. They are not part of the canonical 49 and have no
...
The registered set (49), the non-registry adapter set (9), the lane cells, and
