...
OPENAI_API_KEY=sk-... \
  eliza-scenarios run packages/testing/scenarios/conversation-quality/personas
...
eliza-scenarios list packages/testing/scenarios/conversation-quality/personas \
  --validate-scenarios
```
