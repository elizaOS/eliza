...
```bash
bun packages/testing/scenarios/group-chat/_generate.ts
```
...
OPENAI_API_KEY=sk-... \
  eliza-scenarios run packages/testing/scenarios/group-chat
...
eliza-scenarios list packages/testing/scenarios/group-chat
```
