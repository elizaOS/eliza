...
```bash
bun packages/testing/scenarios/group-chat/behavior/_generate-losona.ts
bun packages/testing/scenarios/group-chat/behavior/_generate-static.ts
bun test packages/testing/scenarios/group-chat/behavior/_factory.test.ts
