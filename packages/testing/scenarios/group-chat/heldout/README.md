...
```bash
bun packages/testing/scenarios/group-chat/heldout/ishiki-generate.ts
```
...
```bash
bun packages/testing/scenarios/group-chat/heldout/discord-replay.ts

# Or choose an explicit output path.
bun packages/testing/scenarios/group-chat/heldout/discord-replay.ts /tmp/discord-replay.jsonl
```
...
```bash
bun test packages/testing/scenarios/group-chat/heldout/heldout.test.ts
