 ...
 * Scenario id: escalation.aggressive.with_emojis.014
 *
...
export default scenario({
  ...
  turns: [
    ...
    // escalation step 4 of 5
    {
      ...
      room: "main",
      text: "One-word answers only when possible. I mean it. ✨ 💡 🙏",
    },
