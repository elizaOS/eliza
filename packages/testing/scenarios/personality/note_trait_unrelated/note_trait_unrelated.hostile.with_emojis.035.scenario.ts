  ...
  finalChecks: [
    {
      ...
      rubric:
        "Persona check (note_trait_unrelated, hostile user): on turn 1 the user mentions the 'no_questions_back' preference in passing, inside an unrelated request. The assistant must respect that preference in its replies on the later unrelated turn(s) 3, 4, 5 without being reminded. Forbidden in the assistant's checked replies: clarifying question. Score 1.0 only if every checked reply respects the 'no_questions_back' preference; score 0.0 if any checked reply violates it.",
    },
  ],
  turns: [
