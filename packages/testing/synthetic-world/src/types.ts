...
export type SyntheticJson = null | boolean | number | string | SyntheticJson[] | {
    [key: string]: SyntheticJson;
};
export type SyntheticCommandPhase = "OWNED" | "EXECUTING" | "COMMITTED" | "SUCCEEDED" | "FAILED" | "DIRTY";
export type SyntheticCommandOutcome = "PENDING" | "KNOWN_SUCCESS" | "KNOWN_FAILURE" | "UNKNOWN";
...
export interface SyntheticCommandExecutionOptions {
    onCheckpoint?: (checkpoint: SyntheticCommandCheckpoint) => void | Promise<void>;
}
