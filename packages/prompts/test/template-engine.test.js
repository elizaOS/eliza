...
import * as prompts from "../dist/index.js";
import { compileTemplate } from "../dist/rendering.js";
...
describe("interpreted template rendering", () => {
  ...
  it("renders every authored prompt without a code-generating runtime", () => {
    ...
    const script = `
      ...
      import {compileTemplate} from ${JSON.stringify(new URL("../dist/rendering.js", import.meta.url).href)};
