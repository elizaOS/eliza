...
const TOKEN_ADDRESSES = [
  { name: "Solana", address: "DuMbhu7mvQvqQHGcnikDgb4XegXJRyhUBfdU22uELiZA", id: "solana" },
  { name: "Ethereum", address: "0xea17Df5Cf6D172224892B5477A16ACb111182478", id: "ethereum" },
  { name: "Base", address: "0xea17Df5Cf6D172224892B5477A16ACb111182478", id: "base" },
  { name: "Bsc", address: "0xea17Df5Cf6D172224892B5477A16ACb111182478", id: "bsc" },
] as const;
      ...
      <div className="container mx-auto px-6 py-8 md:py-16 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 items-start">
          <div className="flex flex-col gap-8">
            ...
            <p className="text-sm text-white/60 whitespace-nowrap">© 2026 Eliza AI · USA</p>
          </div>
          ...
          <div className="flex flex-col gap-1 md:gap-2 items-end">
            <nav className="flex flex-col gap-1.5 md:gap-2.5 text-right relative">
                      ...
                      <div className="space-y-4 sm:space-y-0 font-mono text-sm">
                        {TOKEN_ADDRESSES.map((token) => (
                          <button
                            type="button"
                            key={token.id}
                            onClick={() => handleCopyAddress(token.address, token.id)}
                            className="group/token flex flex-col w-full gap-1 sm:gap-0 hover:bg-[#FF5800]/10 sm:p-3 rounded"
                          >
                            <div className="flex items-end gap-1">
                              <span className="text-[#FF5800] font-semibold">{token.name}</span>
              ...
              <a href="/docs" className="text-base text-white transition-colors hover:text-[#FF5800]">
                Docs
              </a>
              <a href="/blog" className="text-base text-white transition-colors hover:text-[#FF5800]">
                Blog
              </a>
              <a href="/privacy-policy" className="text-base text-white transition-colors hover:text-[#FF5800]">
                Privacy
              </a>
              <a href="/terms-of-service" className="text-base text-white transition-colors hover:text-[#FF5800]">
                Terms
              </a>
            </nav>
            <div className="mt-8 flex items-center gap-2.5 md:gap-5">
              ...
              >
                <svg className="size-6 md:size-7" fill="currentColor" viewBox="0 0 50 50">
