...
export const LANDING_DEMO_SCENARIOS: readonly LandingDemoScenario[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: "user", text: "I'll get coffee. need oat milk too" },
      { kind: "member", name: "Eli", text: "I took recycling out" },
      {
        kind: "member",
        name: "Jules",
        text: "whoever started laundry forgot it lol",
      },
      {
        capability: "room-memory",
        kind: "eliza",
      ...
      { kind: "user", text: "ugh fine I'll finish it tonight" },
      { kind: "member", name: "Noor", text: "dishwasher is clean btw" },
      { kind: "member", name: "Eli", text: "I'll empty it later" },
      ...
      { kind: "member", name: "Eli", text: "yeah I'll get them" },
      {
        capability: "conversation-memory",
        kind: "card",
        card: {
      ...
      },
      {
        kind: "member",
        name: "Noor",
        text: "I'll go if it's like 3 things max",
      },
      ...
      { kind: "member", name: "Noor", text: "ok two things I can do" },
      {
        capability: "room-memory",
        kind: "eliza",
