...
/**
 * iMessage phone number for Eliza
 */
const IMESSAGE_PHONE_NUMBER = "+14245074963";
const IMESSAGE_PHONE_FORMATTED = "+1 (424) 507-4963";
...
export default function ConnectedPage() {
  ...
  const handleCopyPhone = async () => {
    await navigator.clipboard.writeText(IMESSAGE_PHONE_NUMBER);
    setCopiedPhone(true);
  ...
  const handleOpenMessages = () => {
    ...
    window.location.href = `sms:${IMESSAGE_PHONE_NUMBER}&body=${encodedBody}`;
  };
