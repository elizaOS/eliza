...
const ELIZA_APP_SMALL_MODEL = process.env.ELIZA_APP_SMALL_MODEL || BITROUTER_DEFAULT_TEXT_MODEL;
const ELIZA_APP_LARGE_MODEL = process.env.ELIZA_APP_LARGE_MODEL || BITROUTER_DEFAULT_TEXT_MODEL;
