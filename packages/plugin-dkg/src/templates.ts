...
export const createDKGMemoryTemplate = `
  ...
  ** Instructions **
  ...
  5. Ensure all fields align with the schema.org ontology and accurately represent the interaction.
  6. Populate datePublished either with a specifically available date, or current time ${new Date().toISOString()}.
