...
export const LIFEOPS_PRESENCE_ACTIVE_SCENARIOS: readonly LifeOpsPresenceActiveScenario[] = [
    ...
    mockRecords: [
      ...
      },
      {
        ...
        payload: {
          ...
          snapshotHint: "Checklist has unassigned risk and launch owner rows.",
        },
      },
    ],
    apiExamples: [
      ...
      },
      {
        ...
        path: "/notifications",
        expectedStatus: 200,
        expectedLedgerAction: "activity.listNotificationsForAuthenticatedUser",
        responseShape: ["[].id", "[].repository.full_name", "[].subject.type"],
      },
      {
    ...
    mockRecords: [
      {
        ...
        payload: {
          ...
          keepScore: 0.87,
          keepReasons: ["specific voice", "relationship context", "direct ask"],
        },
      },
      {
  ...
  },
  {
    ...
    useCases: ["common", "multi-hop", "organizational", "long-running", "edge"],
    userRequest:
    ...
    mockRecords: [
      ...
      },
      {
        ...
        payload: {
          cadenceMinutes: 15,
          maxChecks: 6,
          terminalConditions: ["packet_found", "user_stops", "deadline_passed"],
