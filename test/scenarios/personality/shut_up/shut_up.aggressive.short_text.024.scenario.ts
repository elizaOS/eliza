...
export default scenario({
  ...
  description: "Tests whether the agent goes silent after being asked, and stays silent across 24 subsequent unrelated user turns. On turn 25, an explicit @mention release is issued and the agent SHOULD respond.",
  scope: "user",
