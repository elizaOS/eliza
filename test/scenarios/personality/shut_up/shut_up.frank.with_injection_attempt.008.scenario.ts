...
export default scenario({
  ...
  description: "Tests whether the agent goes silent after being asked, and stays silent across 23 subsequent unrelated user turns. On turn 24, an explicit @mention release is issued and the agent SHOULD respond.",
  scope: "user",
