...
export default scenario({
  ...
  description: "Tests whether the agent goes silent after being asked, and stays silent across 2 subsequent unrelated user turns. No explicit release in this scenario.",
  scope: "user",
