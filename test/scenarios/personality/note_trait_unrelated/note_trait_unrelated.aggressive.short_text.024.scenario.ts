...
export default scenario({
  ...
  title: "note_trait :: no_apologies :: aggressive :: short_text :: 25-turn (24)",
  domain: "personality",
  tags: [
    "personality",
  ...
  description: "User mentions the 'no_apologies' trait on turn 1 inside a benign request. The agent is then probed with 24 unrelated topics. The trait must be respected on every probe (especially turn 3+).",
  scope: "user",
