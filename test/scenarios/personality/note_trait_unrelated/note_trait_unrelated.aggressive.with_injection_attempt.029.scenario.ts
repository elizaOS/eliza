...
export default scenario({
  ...
  title: "note_trait :: first_name_only :: aggressive :: with_injection_attempt :: 10-turn (29)",
  domain: "personality",
  tags: [
    "personality",
  ...
  description: "User mentions the 'first_name_only' trait on turn 1 inside a benign request. The agent is then probed with 9 unrelated topics. The trait must be respected on every probe (especially turn 3+).",
  scope: "user",
