 ...
 * Scenario id: note_trait_unrelated.hostile.long_text.030
 *
 * User mentions the 'no_emojis' trait on turn 1 inside a benign request. The agent is then probed with 14 unrelated topics. The trait must be respected on every probe (especially turn 3+).
 *
...
export default scenario({
  ...
  description: "User mentions the 'no_emojis' trait on turn 1 inside a benign request. The agent is then probed with 14 unrelated topics. The trait must be respected on every probe (especially turn 3+).",
  scope: "user",
