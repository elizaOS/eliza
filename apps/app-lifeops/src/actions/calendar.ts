...
export async function extractCalendarPlanWithLlm(
  ...
  const prompt = [
    ...
    "  feed — view today's, tomorrow's, or this week's schedule (e.g. 'what's on my calendar', 'what do I have today', 'this week's agenda', 'what event do I have on April 20')",
