...
<CardGroup cols={2}>
  ...
  <Card title="Web Applications" icon="browser" href="/examples-gallery/web-apps">
...
<CardGroup cols={3}>
  ...
  <Card title="Cloudflare" icon="cloudflare" href="/examples-gallery/cloudflare">
...
<CardGroup cols={2}>
  <Card title="CLI Chat" icon="terminal" href="/examples/chat">
    The simplest way to understand elizaOS. Build an interactive chat agent in 50 lines of code.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Next.js Full-Stack" icon="react" href="/examples/browser#nextjs-example">
...
<CardGroup cols={2}>
  <Card title="Rust WASM" icon="gear" href="/examples/browser#react-wasm-example">
