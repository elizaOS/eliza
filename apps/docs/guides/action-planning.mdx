...
flowchart TB
    ...
    Step2["Step 2: TWEET<br/>Reads previous results<br/>Composes tweet<br/>Status: completed"]
...
<CardGroup cols={2}>
  <Card title="Actions Reference" icon="bolt" href="/plugins/components#actions">
