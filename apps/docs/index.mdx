...
```
  ...
  <Tab title="Python">
```bash
pip install elizaos                    # Install the package
python -c "from elizaos import *"      # Verify installation
python your_agent.py                   # Run your agent
```
  </Tab>
  <Tab title="Rust">
```bash
cargo add elizaos                      # Add to Cargo.toml
cargo build                            # Build your project
cargo run                              # Run your agent
```
  </Tab>
</Tabs>
