...
<Card
  title={
    <span style={{ display: "flex", alignItems: "center" }}>
      ...
      />
      <span>KOL</span>
      <span className="agent-plugin-pill">plugin-twitter</span>
...
<Card
  title={
    <span style={{ display: "flex", alignItems: "center" }}>
      ...
      <Tooltip tip="plugin-openai, plugin-twitter, plugin-storage-s3, plugin-discord">
        <span className="agent-plugin-stack">
          <span className="agent-plugin-circle">+4</span>
          <span className="agent-plugin-circle"></span>
          <span className="agent-plugin-circle"></span>
...
<Card
  title={
    <span style={{ display: "flex", alignItems: "center" }}>
      ...
      <Tooltip tip="plugin-telegram, plugin-openai, plugin-giphy, plugin-twitter">
        <span className="agent-plugin-stack">
          <span className="agent-plugin-circle">+4</span>
          <span className="agent-plugin-circle"></span>
          <span className="agent-plugin-circle"></span>
