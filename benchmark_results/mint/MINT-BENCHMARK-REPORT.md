...
**Date**: 2026-01-12T11:31:46.380009
**Duration**: 395.7 seconds
**Total Tasks**: 16
...
**Best Success Rate**: 68.8%

### Key Findings

- Good performance with 68.8% success rate
- Multi-turn interaction provides 31.2% improvement

## Configuration Comparison

| Configuration | Success Rate | Passed | Avg Turns | Avg Latency |
|--------------|--------------|--------|-----------|-------------|
| Baseline (no tools/feedback) | 68.8% | 11/16 | 1.0 | 6863ms |
| Full (tools + feedback) | 68.8% | 11/16 | 1.6 | 17867ms |
...
|----------|--------------|--------|-----------|
| ✅ Reasoning | 75.0% | 3/4 | 2.0 |
| ✅ Coding | 75.0% | 3/4 | 2.8 |
| ✅ Decision Making | 75.0% | 3/4 | 2.8 |
| ⚠️ Information Seeking | 50.0% | 2/4 | 3.2 |
...
| Average Latency | 17867ms |
| Total Duration | 285.9s |
...
| Metric | Value |
|--------|-------|
| Avg Turns to Success | 1.64 |
| Avg Turns to Failure | 5.00 |
| Turn Efficiency | 0.256 |
| Multi-turn Gain | +31.2% |
...
*Report generated: 2026-01-12T11:31:46.380009*