...
| Classify Paths | Full branch graph runs its mandatory families directly; PR admission keeps its existing affected closure. Standalone path classifier remains a diagnostic, not full-branch admission. |
