...
| `web.fake-mic.transcript-roundtrip` | pass | web | transcripts-roundtrip-agent-action-parity | command passed (2026-06-29T21:45:06.082Z) | `bun run --cwd packages/app test:e2e test/ui-smoke/transcript-realaudio.spec.ts` |
