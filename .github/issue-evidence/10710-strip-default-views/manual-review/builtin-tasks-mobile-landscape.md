# builtin-tasks (mobile-landscape)
...
- **readable content chars:** 243
- **border/divider density:** 24.3043 (8 edges / 1M px)
- **text density:** 7.2001 chars / 10K px
- **whitespace ratio:** 0.7249
...
Reviewer: Alias of automations surface; flat. Good.
