...
- `node --check packages/app-core/scripts/run-mobile-build.mjs && node --check packages/app-core/scripts/run-mobile-build-android-targets.test.mjs`
- `bunx biome check packages/app-core/scripts/run-mobile-build.mjs packages/app-core/scripts/run-mobile-build-android-targets.test.mjs`
...
- Renderer build completed and wrote `eliza-renderer-build.json buildId=1c26637d9350`.
...
- APK produced at `packages/app-core/platforms/android/app/build/outputs/apk/debug/app-debug.apk`, size `59M`, sha256 `f5821f6824f16a8deb223ee5198c2ecb3f8465e8aa16f51355dd820dfb26cb47`.
