#!/usr/bin/env bash
# Replaces the serving Eliza X image with the personal-routing release.
set -euo pipefail

work="$(mktemp -d)"
trap 'rm -rf "$work"' EXIT
agent_id=4602b3be-2c01-4e7e-9cdc-849604e1bef7
old_image=ghcr.io/elizaos/eliza-demo@sha256:0d4861b638f3a67e701d8de705c1ed2eb1d52bc48e8506dc458ae0e36bc0d99a
new_digest=sha256:d7bbfdc8add09744cf34414280724a64b28479f1338277b797f64b050e8abeaa
