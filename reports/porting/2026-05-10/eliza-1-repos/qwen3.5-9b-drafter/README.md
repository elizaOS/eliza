...
# Qwen3.5 9B drafter (0.6B) — Eliza-1 fused stack
...
- Pairs with elizaos/qwen3.5-9b-optimized
...
# Catalog id: qwen3.5-9b-drafter

# Manual download:
huggingface-cli download elizaos/qwen3.5-9b-drafter qwen3.5-9b-drafter.gguf

# llama-server (with the elizaOS/llama.cpp fork):
./llama-server --hf-repo elizaos/qwen3.5-9b-drafter \
  --hf-file qwen3.5-9b-drafter.gguf \
  --alias eliza1 --ctx-size 8192 --flash-attn
```

## Repo layout

- `qwen3.5-9b-drafter.gguf` — the fused-stack GGUF.
