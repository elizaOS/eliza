...
# Qwen3.5 4B — Eliza-1 fused stack
...
- **DFlash** speculative decoding via elizaos/qwen3.5-4b-drafter
...
# Catalog id: qwen3.5-4b-optimized

# Manual download:
huggingface-cli download elizaos/qwen3.5-4b-optimized qwen3.5-4b-optimized.gguf

# llama-server (with the elizaOS/llama.cpp fork):
./llama-server --hf-repo elizaos/qwen3.5-4b-optimized \
  --hf-file qwen3.5-4b-optimized.gguf \
  --alias eliza1 --ctx-size 8192 --flash-attn
```

## Repo layout

- `qwen3.5-4b-optimized.gguf` — the fused-stack GGUF.
