...
# Eliza-1 2B — Eliza-1 fused stack
...
# Catalog id: eliza-1-2b-optimized

# Manual download:
huggingface-cli download elizaos/eliza-1-2b-optimized eliza-1-2b-optimized.gguf

# llama-server (with the elizaOS/llama.cpp fork):
./llama-server --hf-repo elizaos/eliza-1-2b-optimized \
  --hf-file eliza-1-2b-optimized.gguf \
  --alias eliza1 --ctx-size 8192 --flash-attn
```

## Repo layout

- `eliza-1-2b-optimized.gguf` — the fused-stack GGUF.
