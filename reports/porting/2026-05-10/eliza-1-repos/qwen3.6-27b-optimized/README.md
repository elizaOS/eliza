...
# Qwen3.6 27B — Eliza-1 fused stack
...
- **DFlash** speculative decoding via elizaos/qwen3.6-27b-drafter
...
# Catalog id: qwen3.6-27b-optimized

# Manual download:
huggingface-cli download elizaos/qwen3.6-27b-optimized qwen3.6-27b-optimized.gguf

# llama-server (with the elizaOS/llama.cpp fork):
./llama-server --hf-repo elizaos/qwen3.6-27b-optimized \
  --hf-file qwen3.6-27b-optimized.gguf \
  --alias eliza1 --ctx-size 8192 --flash-attn
```

## Repo layout

- `qwen3.6-27b-optimized.gguf` — the fused-stack GGUF.
