...
# Eliza-1 27B — Milady fused stack
...
the file from `elizaos/eliza-1-27b`; once it lands, the publisher
...
# Catalog id: eliza-1-27b-milady-optimized

# Manual download:
huggingface-cli download milady-ai/eliza-1-27b-milady-optimized eliza-1-27b-milady-optimized.gguf

# llama-server (with the milady fork):
./llama-server --hf-repo milady-ai/eliza-1-27b-milady-optimized \
  --hf-file eliza-1-27b-milady-optimized.gguf \
  --alias milady --ctx-size 8192 --flash-attn
```

## Repo layout

- `eliza-1-27b-milady-optimized.gguf` — the fused-stack GGUF.
...
- Trained from: `elizaos/eliza-1-27b`
