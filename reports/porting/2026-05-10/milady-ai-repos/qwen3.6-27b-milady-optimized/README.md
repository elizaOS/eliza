...
# Qwen3.6 27B — Milady fused stack
...
- **DFlash** speculative decoding via milady-ai/qwen3.6-27b-milady-drafter

## Status

**Placeholder.** The GGUF is not yet uploaded. W5-Pipeline produces
the file from `Qwen/Qwen3.6-27B`; once it lands, the publisher
...
# Catalog id: qwen3.6-27b-milady-optimized

# Manual download:
huggingface-cli download milady-ai/qwen3.6-27b-milady-optimized qwen3.6-27b-milady-optimized.gguf

# llama-server (with the milady fork):
./llama-server --hf-repo milady-ai/qwen3.6-27b-milady-optimized \
  --hf-file qwen3.6-27b-milady-optimized.gguf \
  --alias milady --ctx-size 8192 --flash-attn
```

## Repo layout

- `qwen3.6-27b-milady-optimized.gguf` — the fused-stack GGUF.
