...
- **DFlash** speculative decoding via milady-ai/qwen3.5-9b-milady-drafter
...
# Catalog id: qwen3.5-9b-milady-optimized

# Manual download:
huggingface-cli download milady-ai/qwen3.5-9b-milady-optimized qwen3.5-9b-milady-optimized.gguf

# llama-server (with the milady fork):
./llama-server --hf-repo milady-ai/qwen3.5-9b-milady-optimized \
  --hf-file qwen3.5-9b-milady-optimized.gguf \
  --alias milady --ctx-size 8192 --flash-attn
```

## Repo layout

- `qwen3.5-9b-milady-optimized.gguf` — the fused-stack GGUF.
