...
# Catalog id: eliza-1-9b-milady-optimized

# Manual download:
huggingface-cli download milady-ai/eliza-1-9b-milady-optimized eliza-1-9b-milady-optimized.gguf

# llama-server (with the milady fork):
./llama-server --hf-repo milady-ai/eliza-1-9b-milady-optimized \
  --hf-file eliza-1-9b-milady-optimized.gguf \
  --alias milady --ctx-size 8192 --flash-attn
```

## Repo layout

- `eliza-1-9b-milady-optimized.gguf` — the fused-stack GGUF.
