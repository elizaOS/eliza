...
# Qwen3.5 9B drafter (0.6B) — Milady fused stack
...
- Pairs with milady-ai/qwen3.5-9b-milady-optimized
...
# Catalog id: qwen3.5-9b-milady-drafter

# Manual download:
huggingface-cli download milady-ai/qwen3.5-9b-milady-drafter qwen3.5-9b-milady-drafter.gguf

# llama-server (with the milady fork):
./llama-server --hf-repo milady-ai/qwen3.5-9b-milady-drafter \
  --hf-file qwen3.5-9b-milady-drafter.gguf \
  --alias milady --ctx-size 8192 --flash-attn
```

## Repo layout

- `qwen3.5-9b-milady-drafter.gguf` — the fused-stack GGUF.
